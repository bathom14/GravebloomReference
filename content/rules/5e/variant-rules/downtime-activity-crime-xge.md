...
To attempt a crime, the character makes three checks: Dexterity ([Stealth](rules/5e/skills.md#Stealth)), Dexterity using [thieves' tools](compendium/5e/items/thieves-tools.md), and the player's choice of Intelligence ([Investigation](rules/5e/skills.md#Investigation)), Wisdom ([Perception](rules/5e/skills.md#Perception)), or Charisma ([Deception](rules/5e/skills.md#Deception)).
...
![Crime; Loot Value](compendium/5e/tables/crime-loot-value-xge.md)
...
![Crime Complications](compendium/5e/tables/crime-complications-xge.md)