...
The Spell Points by Level table applies to [bards](compendium/5e/classes/bard-phb.md), [clerics](compendium/5e/classes/cleric-phb.md), [druids](compendium/5e/classes/druid-phb.md), [sorcerers](compendium/5e/classes/sorcerer-phb.md), and [wizards](compendium/5e/classes/wizard-phb.md). For a [paladin](compendium/5e/classes/paladin-phb.md) or [ranger](compendium/5e/classes/ranger-phb.md), halve the character's level in that class and then consult the table. For a [fighter (Eldritch Knight)](compendium/5e/classes/fighter-phb.md) or [rogue (Arcane Trickster)](compendium/5e/classes/rogue-phb.md), divide the character's level in that class by three.
...
![Variant: Spell Points; Spell Point Cost](compendium/5e/tables/variant-spell-points-spell-point-cost.md)

![Variant: Spell Points; Spell Points by Level](compendium/5e/tables/variant-spell-points-spell-points-by-level.md)