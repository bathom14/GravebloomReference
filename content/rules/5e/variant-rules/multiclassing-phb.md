...
![Multiclassing Prerequisites](compendium/5e/tables/multiclassing-prerequisites-phb.md)
...
![Multiclassing Proficiencies](compendium/5e/tables/multiclassing-proficiencies-phb.md)
...
If you have more than one spellcasting class, this table might give you spell slots of a level that is higher than the spells you know or can prepare. You can use those slots, but only to cast your lower-level spells. If a lower-level spell that you cast, like [burning hands](compendium/5e/spells/burning-hands.md), has an enhanced effect when cast using a higher-level slot, you can use the enhanced effect, even though you don't have any spells of that higher level.
