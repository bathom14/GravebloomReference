...
At the end of the required time, the character chooses to make either an Intelligence ([Religion](rules/5e/skills.md#Religion)) check or a Charisma ([Persuasion](rules/5e/skills.md#Persuasion)) check. The total of the check determines the benefits of service, as shown on the Religious Service table.

![Religious Service](compendium/5e/tables/religious-service-xge.md)
...
![Religious Service Complications](compendium/5e/tables/religious-service-complications-xge.md)