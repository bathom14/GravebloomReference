...
The character makes three checks: Wisdom ([Insight](rules/5e/skills.md#Insight)), Charisma ([Deception](rules/5e/skills.md#Deception)), and Charisma ([Intimidation](rules/5e/skills.md#Intimidation)). If the character has proficiency with an appropriate [gaming set](compendium/5e/items/gaming-set.md), that tool proficiency can replace the relevant skill in any of the checks. The DC for each of the checks is `dice:5+2d10|noform|noparens|avg` (`5 + 2d10`); generate a separate DC for each one. Consult the Gambling Results table to see how the character did.

![Gambling Results](compendium/5e/tables/gambling-results-xge.md)
...
![Gambling Complications](compendium/5e/tables/gambling-complications-xge.md)