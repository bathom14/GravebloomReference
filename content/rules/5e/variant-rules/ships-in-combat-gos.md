...
In the case of spells that cover an area, such as [fireball](compendium/5e/spells/fireball.md) or [lightning bolt](compendium/5e/spells/lightning-bolt.md), you might track the exact location of the spell and crew to determine how many sailors it affects. Alternatively, you can roll `dice:1d6|noform|noparens|avg` (`d6`) per level of the spell. The total of the dice is the number of crew members caught in the spell's area.
...
|------|--------------------|
| Small | `dice:1d6\|noform\|noparens\|avg\|text(d6)` |
| Medium | `dice:1d10\|noform\|noparens\|avg\|text(d10)` |
