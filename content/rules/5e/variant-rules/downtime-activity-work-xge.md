...
To determine how much money a character earns, the character makes an ability check: Strength ([Athletics](rules/5e/skills.md#Athletics)), Dexterity ([Acrobatics](rules/5e/skills.md#Acrobatics)), Intelligence using a set of tools, Charisma ([Performance](rules/5e/skills.md#Performance)), or Charisma using a [musical instrument](compendium/5e/items/musical-instrument.md). Consult the Wages table to see how much money is generated according to the total of the check.

![Work; Wages](compendium/5e/tables/work-wages-xge.md)
...
![Work Complications](compendium/5e/tables/work-complications-xge.md)