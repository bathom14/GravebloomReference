...
Only certain combinations of ancestries, such as [half-elves](compendium/5e/races/half-elf-phb.md) and [half-orcs](compendium/5e/races/half-orc-phb.md), already have racial traits described in the fifth edition core rules. You can use these racial traits as is, or create your own "mixed ancestry" from any two races by choosing one or two racial traits from one parent's race and exchanging them for the same number of traits from another parent's race.
