...
- **Skill Proficiencies.** [History](rules/5e/skills.md#History), plus your choice of one from among [Arcana](rules/5e/skills.md#Arcana), [Nature](rules/5e/skills.md#Nature), and [Religion](rules/5e/skills.md#Religion)  
- **Languages.** any two of your choice  
- **Equipment.** The scholar's [robes](compendium/5e/items/robe.md) of your cloister, a writing kit (small [pouch](compendium/5e/items/pouch.md) with a quill, ink, folded parchment, and a small penknife), a borrowed [book](compendium/5e/items/book.md) on the subject of your current study, and a [pouch](compendium/5e/items/pouch.md) containing 10 gp  
...
Use the tables for the [sage](compendium/5e/backgrounds/sage.md) background in the Player's Handbook as the basis for your traits and motivations, modifying the entries when appropriate to suit your identity as a cloistered scholar.
