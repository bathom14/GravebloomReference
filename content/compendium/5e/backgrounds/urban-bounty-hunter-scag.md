...
- **Skill Proficiencies.** Choose two from among [Deception](rules/5e/skills.md#Deception), [Insight](rules/5e/skills.md#Insight), [Persuasion](rules/5e/skills.md#Persuasion), and [Stealth](rules/5e/skills.md#Stealth)  
- **Tool Proficiencies.** Choose two from among one type of gaming set, one musical instrument, and [thieves' tools](compendium/5e/items/thieves-tools.md)  
- **Equipment.** A set of clothes appropriate to your duties and a [pouch](compendium/5e/items/pouch.md) containing 20 gp  
...
Use the tables for the [criminal](compendium/5e/backgrounds/criminal.md) background in the Player's Handbook as the basis for your bounty hunter's traits and motivations, modifying the entries when appropriate to suit your identity as a bounty hunter.
