...
- **Skill Proficiencies.** [Survival](rules/5e/skills.md#Survival), plus one from among [Arcana](rules/5e/skills.md#Arcana), [History](rules/5e/skills.md#History), and [Religion](rules/5e/skills.md#Religion)  
- **Languages.** Any one of your choice  
- **Tool Proficiencies.** Your choice of a gaming set or a musical instrument  
- **Equipment.** Your inheritance, a set of [traveler's clothes](compendium/5e/items/travelers-clothes.md), the tool you choose for this background's tool proficiency (gaming set or musical instrument), and a [pouch](compendium/5e/items/pouch.md) containing 15 gp  
...
Use the tables for the [folk hero](compendium/5e/backgrounds/folk-hero.md) background in the Player's Handbook as the basis for your traits and motivations, modifying the entries when appropriate to suit your identity as an inheritor.
