...
- **Equipment.** A [bottle of colored ink](compendium/5e/items/ink.md), an [ink pen](compendium/5e/items/ink-pen.md), a set of [common clothes](compendium/5e/items/common-clothes-phb.md), and a [pouch](compendium/5e/items/pouch.md) containing 10 gp  
...
You gain the [Initiate of High Sorcery](compendium/5e/feats/initiate-of-high-sorcery-dsotdq.md) feat.
...
When you make your character, roll once on the Mage of High Sorcery Trinkets table instead of on the [Trinkets table](compendium/5e/items/trinket.md) in the Player's Handbook for your starting trinket.
