...
- **Equipment.** A set of [fine clothes](compendium/5e/items/fine-clothes.md) and a [pouch](compendium/5e/items/pouch.md) containing 5 gp  
...
Use the tables for the [guild artisan](compendium/5e/backgrounds/guild-artisan.md) background in the Player's Handbook as the basis for your traits and motivations, modifying the entries when appropriate to suit your identity as a courtier.
