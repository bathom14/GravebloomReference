...
- **Skill Proficiencies.** [Investigation](rules/5e/skills.md#Investigation), [Persuasion](rules/5e/skills.md#Persuasion)  
- **Tool Proficiencies.** Two proficiencies from the House Tool Proficiencies table  
- **Equipment.** A set of [fine clothes](compendium/5e/items/fine-clothes.md), house [signet ring](compendium/5e/items/signet-ring-phb.md), identification papers, and a purse containing 20 gp.  

**House Tool Proficiencies**

| Your House | Proficiencies |
|------------|---------------|
| Cannith | [Alchemist's supplies](compendium/5e/items/alchemists-supplies.md) and [tinker's tools](compendium/5e/items/tinkers-tools.md) |
| Deneith | One gaming set and vehicles (land) |
| Ghallanda | [Brewer's supplies](compendium/5e/items/brewers-supplies.md) and [cook's utensils](compendium/5e/items/cooks-utensils.md) |
| Jorasco | [Alchemist's supplies](compendium/5e/items/alchemists-supplies.md) and [herbalism kit](compendium/5e/items/herbalism-kit.md) |
| Kundarak | [Thieves' tools](compendium/5e/items/thieves-tools.md) and [tinker's tools](compendium/5e/items/tinkers-tools.md) |
| Lyrandar | [Navigator's tools](compendium/5e/items/navigators-tools.md) and vehicles (sea and air) |
| Medani | [Disguise kit](compendium/5e/items/disguise-kit.md) and [thieves' tools](compendium/5e/items/thieves-tools.md) |
| Orien | One gaming set and vehicles (land) |
| Phiarlan | [Disguise kit](compendium/5e/items/disguise-kit.md) and one musical instrument |
| Sivis | [Calligrapher's supplies](compendium/5e/items/calligraphers-supplies.md) and [forgery kit](compendium/5e/items/forgery-kit.md) |
| Tharashk | One gaming set and [thieves' tools](compendium/5e/items/thieves-tools.md) |
| Thuranni | One musical instrument and [poisoner's kit](compendium/5e/items/poisoners-kit.md) |
| Vadalis | [herbalism kit](compendium/5e/items/herbalism-kit.md) and vehicles (land) |
^house-tool-proficiencies
