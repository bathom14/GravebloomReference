...
- **Skill Proficiencies.** [Animal Handling](rules/5e/skills.md#Animal%20Handling), [Survival](rules/5e/skills.md#Survival)  
- **Tool Proficiencies.** One type of artisan's tools, vehicles (land)  
- **Equipment.** A set of artisan's tools (one of your choice), a [shovel](compendium/5e/items/shovel.md), an [iron pot](compendium/5e/items/iron-pot.md), a set of [common clothes](compendium/5e/items/common-clothes-phb.md), and a belt [pouch](compendium/5e/items/pouch.md) containing 10 gp  
