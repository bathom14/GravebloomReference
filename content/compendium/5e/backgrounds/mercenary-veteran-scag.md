...
- **Skill Proficiencies.** [Athletics](rules/5e/skills.md#Athletics), [Persuasion](rules/5e/skills.md#Persuasion)  
- **Tool Proficiencies.** One type of gaming set, vehicles (land)  
- **Equipment.** A uniform of your company ([traveler's clothes](compendium/5e/items/travelers-clothes.md) in quality), an insignia of your rank, a gaming set of your choice, and a [pouch](compendium/5e/items/pouch.md) containing the remainder of your last wages (10 gp).  
...
Use the tables for the [soldier](compendium/5e/backgrounds/soldier.md) background in the Player's Handbook as the basis for your traits and motivations, modifying the entries when appropriate to suit your identity as a mercenary.
