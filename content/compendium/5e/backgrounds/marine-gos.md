...
- **Equipment.** A [dagger](compendium/5e/items/dagger-phb.md) that belonged to a fallen comrade, a folded flag emblazoned with the symbol of your ship or company, a set of [traveler's clothes](compendium/5e/items/travelers-clothes.md), and a belt [pouch](compendium/5e/items/pouch.md) containing 10 gp  
