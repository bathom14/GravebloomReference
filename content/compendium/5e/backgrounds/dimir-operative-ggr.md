...
- **Skill Proficiencies.** [Deception](rules/5e/skills.md#Deception), [Stealth](rules/5e/skills.md#Stealth)  
- **Tool Proficiencies.** [Disguise kit](compendium/5e/items/disguise-kit.md)  
- **Languages.** One of your choice  
- **Equipment.** A Dimir insignia, three small knives, a set of dark-colored [common clothes](compendium/5e/items/common-clothes-phb.md), and the starting equipment of the background described in this chapter for your secondary guild  
...
| Spell Level | Spells |
|-------------|--------|
| Cantrip | [encode thoughts](compendium/5e/spells/encode-thoughts-ggr.md), [mage hand](compendium/5e/spells/mage-hand.md) |
| 1st | [disguise self](compendium/5e/spells/disguise-self.md), [sleep](compendium/5e/spells/sleep.md) |
| 2nd | [detect thoughts](compendium/5e/spells/detect-thoughts.md), [pass without trace](compendium/5e/spells/pass-without-trace.md) |
| 3rd | [gaseous form](compendium/5e/spells/gaseous-form.md), [meld into stone](compendium/5e/spells/meld-into-stone.md), [nondetection](compendium/5e/spells/nondetection.md) |
| 4th | [arcane eye](compendium/5e/spells/arcane-eye.md), [freedom of movement](compendium/5e/spells/freedom-of-movement.md) |
| 5th | [modify memory](compendium/5e/spells/modify-memory.md) |
^dimir-guild-spells

Your magic is meant to be subtle and undetectable, but it might pull shadows or clouds of mist around you as you cast your spells. Using the [encode thoughts](compendium/5e/spells/encode-thoughts-ggr.md) cantrip described below, you can turn a creature's thoughts (including your own) into a thought strand that others can potentially read, share, or steal. These thought strands are treated as valuable currency among the Dimir.
