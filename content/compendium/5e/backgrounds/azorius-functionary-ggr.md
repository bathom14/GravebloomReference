...
- **Skill Proficiencies.** [Insight](rules/5e/skills.md#Insight), [Intimidation](rules/5e/skills.md#Intimidation)  
- **Languages.** Two of your choice  
- **Equipment.** An Azorius insignia, a scroll containing the text of a law important to you, a [bottle of blue ink](compendium/5e/items/ink.md), a [pen](compendium/5e/items/ink-pen.md), a set of [fine clothes](compendium/5e/items/fine-clothes.md), and a belt [pouch](compendium/5e/items/pouch.md) containing 10 gp (Azorius-minted 1-zino coins)  
...
| Spell Level | Spells |
|-------------|--------|
| Cantrip | [friends](compendium/5e/spells/friends.md), [message](compendium/5e/spells/message.md) |
| 1st | [command](compendium/5e/spells/command.md), [ensnaring strike](compendium/5e/spells/ensnaring-strike.md) |
| 2nd | [arcane lock](compendium/5e/spells/arcane-lock.md), [calm emotions](compendium/5e/spells/calm-emotions.md), [hold person](compendium/5e/spells/hold-person.md) |
| 3rd | [clairvoyance](compendium/5e/spells/clairvoyance.md), [counterspell](compendium/5e/spells/counterspell.md) |
| 4th | [compulsion](compendium/5e/spells/compulsion.md), [divination](compendium/5e/spells/divination.md) |
| 5th | [dominate person](compendium/5e/spells/dominate-person.md) |
^azorius-guild-spells

Your magic often takes the form of blue or golden runes floating and glowing in the air in circular patterns or of shimmering azure barriers of magical energy. If you cast [ensnaring strike](compendium/5e/spells/ensnaring-strike.md), for example, the vines created by the spell might appear as rune-inscribed glowing bands that wrap around the target and hold it in place.
