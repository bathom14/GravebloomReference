...
- **Skill Proficiencies.** [Athletics](rules/5e/skills.md#Athletics), [Survival](rules/5e/skills.md#Survival)  
- **Languages.** Any one of your choice  
- **Tool Proficiencies.** One type of musical instrument or artisan's tools  
- **Equipment.** A [hunting trap](compendium/5e/items/hunting-trap.md), a totemic token or set of tattoos marking your loyalty to Uthgar and your tribal totem, a set of [traveler's clothes](compendium/5e/items/travelers-clothes.md), and a [pouch](compendium/5e/items/pouch.md) containing 10 gp  
...
Use the tables for the [outlander](compendium/5e/backgrounds/outlander.md) background in the Player's Handbook as the basis for your traits and motivations, modifying the entries when appropriate to suit your identity as a member of an Uthgardt tribe.
