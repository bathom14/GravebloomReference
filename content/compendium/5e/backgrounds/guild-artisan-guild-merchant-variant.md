...
- **Tool Proficiencies.** One type of artisan's tools, or [navigator's tools](compendium/5e/items/navigators-tools.md), or an additional language  
- **Languages.** One of your choice  
- **Equipment.** A set of artisan's tools (one of your choice) or a [mule](compendium/5e/items/mule.md) and [cart](compendium/5e/items/cart.md), a letter of introduction from your guild, a set of [traveler's clothes](compendium/5e/items/travelers-clothes.md), and a belt [pouch](compendium/5e/items/pouch.md) containing 15 gp  
