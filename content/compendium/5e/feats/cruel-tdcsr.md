...
The challenges and struggles you've faced throughout your life have led you to delight in inflicting pain and anguish upon others. You gain a number of cruelty dice equal to your proficiency bonus. Your cruelty dice are `dice:d6|noform|noparens|avg|text(d6s)` (`d6`). You can roll only one cruelty die per turn, and a cruelty die is spent when you roll it.
...
- When you make a Charisma ([Intimidation](rules/5e/skills.md#Intimidation)) check, spend one cruelty die and add the roll to your check.  
