...
**Prerequisite**: Spellcasting feature or [Rune Carver](compendium/5e/backgrounds/rune-carver-bgg.md)

You've studied the magic of Giant runes, granting you the following benefits:

- **Comprehend Languages.** You learn the [comprehend languages](compendium/5e/spells/comprehend-languages.md) spell. You can cast this spell without expending a spell slot, and you must finish a long rest before you can cast it in this way again. You can also cast this spell using any spell slots you have.  
- **Rune Magic.** You know a number of runes equal to half your proficiency bonus (rounded down), chosen from the Rune Spells table. Whenever you finish a long rest, you can inscribe each rune you know onto one nonmagical weapon, armor, piece of clothing, or other object you touch. You temporarily learn the 1st-level spells that correspond to the runes you inscribed, as specified on the Rune Spells table, and you know those spells until you finish a long rest, when the runes fade. While you are wearing or carrying any rune-marked object, you can cast the spells associated with those runes using any spell slots you have.  
    ...
    | Rune | Spell |  
    |------|-------|  
    | Cloud | [Fog cloud](compendium/5e/spells/fog-cloud.md) |  
    | Death | [Inflict wounds](compendium/5e/spells/inflict-wounds.md) |  
    | Dragon | [Chromatic orb](compendium/5e/spells/chromatic-orb.md) |  
    | Enemy | [Disguise self](compendium/5e/spells/disguise-self.md) |  
    | Fire | [Burning hands](compendium/5e/spells/burning-hands.md) |  
    | Friend | [Speak with animals](compendium/5e/spells/speak-with-animals.md) |  
    | Frost | [Armor of Agathys](compendium/5e/spells/armor-of-agathys.md) |  
    | Hill | [Goodberry](compendium/5e/spells/goodberry.md) |  
    | Journey | [Longstrider](compendium/5e/spells/longstrider.md) |  
    | King | [Command](compendium/5e/spells/command.md) |  
    | Mountain | [Entangle](compendium/5e/spells/entangle.md) |  
    | Stone | [Sanctuary](compendium/5e/spells/sanctuary.md) |  
    | Storm | [Thunderwave](compendium/5e/spells/thunderwave.md) |  
    ^rune-spell