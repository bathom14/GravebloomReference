...
You know the [poison spray](compendium/5e/spells/poison-spray.md) cantrip. You can cast [animal friendship](compendium/5e/spells/animal-friendship.md) an unlimited number of times with this trait, but you can target only snakes with it. Starting at 3rd level, you can also cast [suggestion](compendium/5e/spells/suggestion.md) with this trait. Once you cast it, you can't do so again until you finish a long rest. You can also cast it using any spell slots you have of 2nd level or higher.
