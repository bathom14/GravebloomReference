...
You have [Advantage](rules/5e/variant-rules/advantage-xphb.md) on saving throws you make to avoid or end the [Frightened](rules/5e/conditions.md#Frightened) condition.
...
When you roll a 1 on the `dice:d20|noform|noparens|avg` (`d20`) of a [D20 Test](rules/5e/variant-rules/d20-test-xphb.md), you can reroll the die, and you must use the new roll.

### Naturally Stealthy

You can take the [Hide](rules/5e/actions.md#Hide) action even when you are obscured only by a creature that is at least one size larger than you.
