...
You have advantage on Intelligence ([Investigation](rules/5e/skills.md#Investigation)) and Wisdom ([Insight](rules/5e/skills.md#Insight)) checks.

### Blessing of the Moon Weaver

You know the [light](compendium/5e/spells/light.md) cantrip. When you reach 3rd level, you can cast the [sleep](compendium/5e/spells/sleep.md) spell once with this trait and regain the ability to do so when you finish a long rest. When you reach 5th level, you can cast the [invisibility](compendium/5e/spells/invisibility.md) spell (targeting yourself only) once with this trait and regain the ability to do so when you finish a long rest. Casting these spells with this trait doesn't require material components. Wisdom is your spellcasting ability for these spells.
