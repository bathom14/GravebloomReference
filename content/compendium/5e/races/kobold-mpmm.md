...
- **Craftiness.** You have proficiency in one of the following skills of your choice: [Arcana](rules/5e/skills.md#Arcana), [Investigation](rules/5e/skills.md#Investigation), [Medicine](rules/5e/skills.md#Medicine), [Sleight of Hand](rules/5e/skills.md#Sleight%20of%20Hand), or [Survival](rules/5e/skills.md#Survival).  
- **Defiance.** You have advantage on saving throws to avoid or end the [frightened](rules/5e/conditions.md#Frightened) condition on yourself.  
