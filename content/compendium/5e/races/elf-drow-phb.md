...
You have advantage on saving throws against being [charmed](rules/5e/conditions.md#Charmed), and magic can't put you to sleep.
...
You have disadvantage on attack rolls and on Wisdom ([Perception](rules/5e/skills.md#Perception)) checks that rely on sight when you, the target of your attack, or whatever you are trying to perceive is in direct sunlight.

### Drow Magic

You know the [dancing lights](compendium/5e/spells/dancing-lights.md) cantrip. When you reach 3rd level, you can cast the [faerie fire](compendium/5e/spells/faerie-fire.md) spell once with this trait; you regain the ability to cast it when you finish a long rest. When you reach 5th level, you can also cast the [darkness](compendium/5e/spells/darkness.md) spell once per day with this trait; you regain the ability to cast it when you finish a long rest. Charisma is your spellcasting ability for these spells.

### Drow Weapon Training

You have proficiency with [rapiers](compendium/5e/items/rapier-phb.md), [shortswords](compendium/5e/items/shortsword-phb.md), and [hand crossbows](compendium/5e/items/hand-crossbow-phb.md).
