...
As an action, you can change the color of your carapace to match the color and texture of your surroundings, giving you advantage on Dexterity ([Stealth](rules/5e/skills.md#Stealth)) checks made to [hide](rules/5e/actions.md#Hide) in those surroundings.
