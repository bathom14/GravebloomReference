...
You have advantage on saving throws you make to avoid or end the [frightened](rules/5e/conditions.md#Frightened) condition on yourself. When you fail a saving throw to avoid or end the [frightened](rules/5e/conditions.md#Frightened) condition on yourself, you can choose to succeed instead. Once you succeed on a saving throw in this way, you can't do so again until you finish a long rest.

### Kender Curiosity

Thanks to the mystical origin of your people, you gain proficiency with one of the following skills of your choice: [Insight](rules/5e/skills.md#Insight), [Investigation](rules/5e/skills.md#Investigation), [Sleight of Hand](rules/5e/skills.md#Sleight%20of%20Hand), [Stealth](rules/5e/skills.md#Stealth), or [Survival](rules/5e/skills.md#Survival).
