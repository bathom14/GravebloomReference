...
This ship's main distinctive feature is the fully grown [treant](compendium/5e/bestiary/plant/treant.md) on the aft deck. The treant has a speed of 0 because its roots are woven into the deck; it and the ship are inseparable. If the ship is reduced to 0 hit points, the treant dies of shock. The ship can function if its treant dies, but the treant can never be replaced with another.

When the treant finishes a long rest, it repairs the ship's hull, enabling the ship to regain `dice:4d12|noform|noparens|avg` (`4d12`) hit points, and refreshes the ship's air envelope (turning deadly air into foul air, or foul air into fresh air).
...
- **Cargo** 10 tons tons
- **Crew** 5 crew (plus the [treant](compendium/5e/bestiary/plant/treant.md))
