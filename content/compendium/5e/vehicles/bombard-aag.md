...
**Cannon Ball.** *Ranged Weapon Attack:* `dice:1d20+6|noform|noparens|text(+6)` to hit, range 600/2,400 ft., one target. *Hit:* `dice:16d10|noform|noparens|avg|text(88)` (`16d10`) bludgeoning damage.
```
^statblock