...
Starting at 3rd level, you can use the bonus action granted by your Cunning Action to make a Dexterity ([Sleight of Hand](rules/5e/skills.md#Sleight%20of%20Hand)) check, use your [thieves' tools](compendium/5e/items/thieves-tools.md) to disarm a trap or open a lock, or take the [Use an Object](rules/5e/actions.md#Utilize) action.
...
Starting at 9th level, you have advantage on a Dexterity ([Stealth](rules/5e/skills.md#Stealth)) check if you move no more than half your speed on the same turn.
...
When you reach 17th level, you have become adept at laying ambushes and quickly escaping danger. You can take two turns during the first round of any combat. You take your first turn at your normal initiative and your second turn at your initiative minus 10. You can't use this feature when you are [surprised](rules/5e/conditions.md#Surprised).