...
- 5e/subclass/sorcerer/aberrant-mind
aliases:
- Aberrant Mind
---
# Aberrant Mind
...
`dice: [](sorcerer-phb-aberrant-mind-tce.md#^aberrant-origins)`
...
|----------------|--------|
| 1st | [arms of Hadar](compendium/5e/spells/arms-of-hadar.md), [dissonant whispers](compendium/5e/spells/dissonant-whispers.md), [mind sliver](compendium/5e/spells/mind-sliver.md) |
| 3rd | [calm emotions](compendium/5e/spells/calm-emotions.md), [detect thoughts](compendium/5e/spells/detect-thoughts.md) |
| 5th | [hunger of Hadar](compendium/5e/spells/hunger-of-hadar.md), [sending](compendium/5e/spells/sending.md) |
| 7th | [Evard's black tentacles](compendium/5e/spells/evards-black-tentacles.md), [summon aberration](compendium/5e/spells/summon-aberration.md) |
| 9th | [Rary's telepathic bond](compendium/5e/spells/rarys-telepathic-bond.md), [telekinesis](compendium/5e/spells/telekinesis.md) |
^psionic-spells
...
The telepathic connection lasts for a number of minutes equal to your sorcerer level. It ends early if you are [incapacitated](rules/5e/conditions.md#Incapacitated) or die or if you use this ability to form a connection with a different creature.
...
You gain resistance to psychic damage, and you have advantage on saving throws against being [charmed](rules/5e/conditions.md#Charmed) or [frightened](rules/5e/conditions.md#Frightened).
...
- You can see any [invisible](rules/5e/conditions.md#Invisible) creature within 60 feet of you, provided it isn't behind total cover. Your eyes also turn black or become writhing sensory tendrils.  
...
- Your body, along with any equipment you are wearing or carrying, becomes slimy and pliable. You can move through any space as narrow as 1 inch without squeezing, and you can spend 5 feet of movement to escape from nonmagical restraints or being [grappled](rules/5e/conditions.md#Grappled).  
