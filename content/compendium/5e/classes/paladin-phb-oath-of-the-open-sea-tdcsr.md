...
- 5e/subclass/paladin/open-sea
aliases:
- Oath of the Open Sea
---
# Oath of the Open Sea
*[Paladin](./paladin-phb.md): Sacred Oath*  
...
Such guardians believe in the natural beauty of the sea, often making offerings and prayers to entities or deities such as the [Wildmother](compendium/5e/deities/exandria-the-wildmother-tdcsr.md) or the [Stormlord](compendium/5e/deities/exandria-the-stormlord-tdcsr.md) who influence safe passage. At the same time, they answer the call to hunt the monstrous creatures that too often bloody the waters with wanton violence and ill intent, and which terrorize the folk of the sea and shore.
...
|---------------|--------|
| 3rd | [create or destroy water](compendium/5e/spells/create-or-destroy-water.md), [expeditious retreat](compendium/5e/spells/expeditious-retreat.md) |
| 5th | [augury](compendium/5e/spells/augury.md), [misty step](compendium/5e/spells/misty-step.md) |
| 9th | [call lightning](compendium/5e/spells/call-lightning.md), [freedom of the waves](compendium/5e/spells/freedom-of-the-waves-tdcsr.md)* |
| 13th | [control water](compendium/5e/spells/control-water.md), [freedom of movement](compendium/5e/spells/freedom-of-movement.md) |
| 17th | [commune with nature](compendium/5e/spells/commune-with-nature.md), [freedom of the winds](compendium/5e/spells/freedom-of-the-winds-tdcsr.md)* |
^oath-of-the-open-sea-spells
...
> 
> Creatures in a lightly obscured area have disadvantage only on Wisdom ([Perception](rules/5e/skills.md#Perception)) checks that rely on sight. The rules for when your vision is obscured are described completely in the fifth edition core rules.
^rules-tip-visibility

### Aura of Liberation (Level 7)

Starting at 7th level, you fill nearby creatures with the energy of movement. While you're not [incapacitated](rules/5e/conditions.md#Incapacitated), you and creatures of your choice within 10 feet of you cannot be [grappled](rules/5e/conditions.md#Grappled) or [restrained](rules/5e/conditions.md#Restrained), and ignore penalties on movement and attacks while underwater. Creatures that are already [grappled](rules/5e/conditions.md#Grappled) or [restrained](rules/5e/conditions.md#Restrained) when they enter the aura can spend 5 feet of movement to automatically escape unless they are bound by magic restraints.

### Stormy Waters (Level 15)

At 15th level, you can call on the force of crashing waters as a reaction whenever a creature moves into or out of your reach. The creature takes `dice:1d12|noform|noparens|avg` (`d12`) bludgeoning damage and must succeed on a Strength saving throw against your spell save DC or be knocked [prone](rules/5e/conditions.md#Prone).
...
- You have advantage on Strength ([Athletics](rules/5e/skills.md#Athletics)) checks and you gain a climbing speed equal to your walking speed. If you already have a climbing speed, it is doubled.  
...
- You can take the [Dash](rules/5e/actions.md#Dash) or [Disengage](rules/5e/actions.md#Disengage) action as a bonus action.  
