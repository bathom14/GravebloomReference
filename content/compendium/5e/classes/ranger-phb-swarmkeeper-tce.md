...
- 5e/subclass/ranger/swarmkeeper
aliases:
- Swarmkeeper
---
# Swarmkeeper
...
`dice: [](ranger-phb-swarmkeeper-tce.md#^swarm-appearance)`
...
You learn the [mage hand](compendium/5e/spells/mage-hand.md) cantrip if you don't already know it. When you cast it, the hand takes the form of your swarming nature spirits.
...
| Ranger Level | Spells |
|--------------|--------|
| 3rd | [faerie fire](compendium/5e/spells/faerie-fire.md) |
| 5th | [web](compendium/5e/spells/web.md) |
| 9th | [gaseous form](compendium/5e/spells/gaseous-form.md) |
| 13th | [arcane eye](compendium/5e/spells/arcane-eye.md) |
| 17th | [insect plague](compendium/5e/spells/insect-plague.md) |
^swarmkeeper-spells
...
You can condense part of your swarm into a focused mass that lifts you up. As a bonus action, you gain a flying speed of 10 feet and can hover. This effect lasts for 1 minute or until you are [incapacitated](rules/5e/conditions.md#Incapacitated).
...
- If a creature fails its saving throw against being moved by Gathered Swarm, you can also cause the swarm to knock the creature [prone](rules/5e/conditions.md#Prone).  
