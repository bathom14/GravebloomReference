...
- **Skill Proficiencies**: *Choose 2:* [Athletics](rules/5e/skills.md#Athletics), [Insight](rules/5e/skills.md#Insight), [Intimidation](rules/5e/skills.md#Intimidation), [Medicine](rules/5e/skills.md#Medicine), [Persuasion](rules/5e/skills.md#Persuasion), or [Religion](rules/5e/skills.md#Religion)
- **Weapon Proficiencies**: Simple weapons and Martial weapons
- **Armor Training**: [Light armor](rules/5e/item-types.md#Light%20Armor), [Medium armor](rules/5e/item-types.md#Medium%20Armor), [Heavy armor](rules/5e/item-types.md#Heavy%20Armor), and [Shields](compendium/5e/items/shield.md)

**Starting Equipment:** *Choose A or B:* (A) [Chain Mail](compendium/5e/items/chain-mail.md), [Shield](compendium/5e/items/shield.md), [Longsword](compendium/5e/items/longsword.md), 6 [Javelins](compendium/5e/items/javelin.md), [Holy Symbol](compendium/5e/items/holy-symbol.md), [Priest's Pack](compendium/5e/items/priests-pack.md), and 9 GP; or (B) 150 GP

## Multiclassing Paladin

- **Weapon Proficiencies**: Martial weapons
- **Armor Training**: [Light armor](rules/5e/item-types.md#Light%20Armor), [Medium armor](rules/5e/item-types.md#Medium%20Armor), [Shields](compendium/5e/items/shield.md)
...
Your blessed touch can heal wounds. You have a pool of healing power that replenishes when you finish a [Long Rest](rules/5e/variant-rules/long-rest-xphb.md). With that pool, you can restore a total number of [Hit Points](rules/5e/variant-rules/hit-points-xphb.md) equal to five times your Paladin level.

As a [Bonus Action](rules/5e/variant-rules/bonus-action-xphb.md), you can touch a creature (which could be yourself) and draw power from the pool of healing to restore a number of [Hit Points](rules/5e/variant-rules/hit-points-xphb.md) to that creature, up to the maximum amount remaining in the pool.

You can also expend 5 [Hit Points](rules/5e/variant-rules/hit-points-xphb.md) from the pool of healing power to remove the [Poisoned](rules/5e/conditions.md#Poisoned) condition from the creature; those points don't also restore [Hit Points](rules/5e/variant-rules/hit-points-xphb.md) to the creature.
...
The Paladin Features table shows how many spell slots you have to cast your level 1+ spells. You regain all expended slots when you finish a [Long Rest](rules/5e/variant-rules/long-rest-xphb.md).

#### Prepared Spells of Level 1+

You prepare the list of level 1+ spells that are available for you to cast with this feature. To start, choose two level 1 Paladin spells. [Heroism](compendium/5e/spells/heroism.md) and [Searing Smite](compendium/5e/spells/searing-smite.md) are recommended.
...
Whenever you finish a [Long Rest](rules/5e/variant-rules/long-rest-xphb.md), you can replace one spell on your list with another Paladin spell for which you have spell slots.
...
You can use a [Holy Symbol](compendium/5e/items/holy-symbol.md) as a [Spellcasting Focus](rules/5e/variant-rules/spellcasting-focus-xphb.md) for your Paladin spells.

### Weapon Mastery (Level 1)

Your training with weapons allows you to use the [mastery properties](rules/5e/variant-rules/weapon-mastery-properties-xphb.md) of two kinds of weapons of your choice with which you have proficiency, such as [Longswords](compendium/5e/items/longsword.md) and [Javelins](compendium/5e/items/javelin.md).

Whenever you finish a [Long Rest](rules/5e/variant-rules/long-rest-xphb.md), you can change the kinds of weapons you chose. For example, you could switch to using the [mastery properties](rules/5e/variant-rules/weapon-mastery-properties-xphb.md) of [Halberds](compendium/5e/items/halberd.md) and [Flails](compendium/5e/items/flail.md).
...
You always have the [Divine Smite](compendium/5e/spells/divine-smite.md) spell prepared. In addition, you can cast it without expending a spell slot, but you must finish a [Long Rest](rules/5e/variant-rules/long-rest-xphb.md) before you can cast it in this way again.

### Channel Divinity (Level 3)

You can channel divine energy directly from the Outer Planes, using it to fuel magical effects. You start with one such effect: Divine Sense, which is described below. Other Paladin features give additional Channel Divinity effect options. Each time you use this class's Channel Divinity, you choose which effect from this class to create.

You can use this class's Channel Divinity twice. You regain one of its expended uses when you finish a [Short Rest](rules/5e/variant-rules/short-rest-xphb.md), and you regain all expended uses when you finish a [Long Rest](rules/5e/variant-rules/long-rest-xphb.md). You gain an additional use when you reach Paladin level 11.

If a Channel Divinity effect requires a saving throw, the DC equals the spell save DC from this class's Spellcasting feature.

### Divine Sense (Level 3)

As a [Bonus Action](rules/5e/variant-rules/bonus-action-xphb.md), you can open your awareness to detect Celestials, Fiends, and Undead. For the next 10 minutes or until you have the [Incapacitated](rules/5e/conditions.md#Incapacitated) condition, you know the location of any creature of those types within 60 feet of yourself, and you know its creature type. Within the same radius, you also detect the presence of any place or object that has been consecrated or desecrated, as with the [Hallow](compendium/5e/spells/hallow.md) spell.
...
You gain the [Ability Score Improvement](compendium/5e/feats/ability-score-improvement.md) feat or another feat of your choice for which you qualify. You gain this feature again at Paladin levels 8, 12, and 16.
...
You can call on the aid of an otherworldly steed. You always have the [Find Steed](compendium/5e/spells/find-steed.md) spell prepared.

You can also cast the spell once without expending a spell slot, and you regain the ability to do so when you finish a [Long Rest](rules/5e/variant-rules/long-rest-xphb.md).

### Aura of Protection (Level 6)

You radiate a protective, unseeable aura in a 10-foot [Emanation](rules/5e/variant-rules/emanation-area-of-effect-xphb.md) that originates from you. The aura is inactive while you have the [Incapacitated](rules/5e/conditions.md#Incapacitated) condition.
...
As a [Magic](rules/5e/actions.md#Magic) action, you can expend one use of this class's Channel Divinity to overwhelm foes with awe. As you present your [Holy Symbol](compendium/5e/items/holy-symbol.md) or weapon, you can target a number of creatures equal to your Charisma modifier (minimum of one creature) that you can see within 60 feet of yourself. Each target must succeed on a Wisdom saving throw or have the [Frightened](rules/5e/conditions.md#Frightened) condition for 1 minute or until it takes any damage. While [Frightened](rules/5e/conditions.md#Frightened) in this way, a target can do only one of the following on its turns: move, take an action, or take a [Bonus Action](rules/5e/variant-rules/bonus-action-xphb.md).

### Aura of Courage (Level 10)

You and your allies have [Immunity](rules/5e/variant-rules/immunity-xphb.md) to the [Frightened](rules/5e/conditions.md#Frightened) condition while in your Aura of Protection. If a [Frightened](rules/5e/conditions.md#Frightened) ally enters the aura, that condition has no effect on that ally while there.

### Radiant Strikes (Level 11)

Your strikes now carry supernatural power. When you hit a target with an attack roll using a Melee weapon or an [Unarmed Strike](rules/5e/variant-rules/unarmed-strike-xphb.md), the target takes an extra `dice:1d8|noform|noparens|avg` (`d8`) Radiant damage.
...
When you use Lay On Hands on a creature, you can also remove one or more of the following conditions from the creature: [Blinded](rules/5e/conditions.md#Blinded), [Charmed](rules/5e/conditions.md#Charmed), [Deafened](rules/5e/conditions.md#Deafened), [Frightened](rules/5e/conditions.md#Frightened), [Paralyzed](rules/5e/conditions.md#Paralyzed), or [Stunned](rules/5e/conditions.md#Stunned). You must expend 5 [Hit Points](rules/5e/variant-rules/hit-points-xphb.md) from the healing pool of Lay On Hands for each of these conditions you remove; those points don't also restore [Hit Points](rules/5e/variant-rules/hit-points-xphb.md) to the creature.
...
Your Aura of Protection is now a 30-foot [Emanation](rules/5e/variant-rules/emanation-area-of-effect-xphb.md).

### Epic Boon (Level 19)

You gain an Epic Boon feat or another feat of your choice for which you qualify. [Boon of Truesight](compendium/5e/feats/boon-of-truesight.md) is recommended.
