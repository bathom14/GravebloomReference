...
- **Skill Proficiencies**: *Choose 2:* [Animal Handling](rules/5e/skills.md#Animal%20Handling), [Arcana](rules/5e/skills.md#Arcana), [Insight](rules/5e/skills.md#Insight), [Medicine](rules/5e/skills.md#Medicine), [Nature](rules/5e/skills.md#Nature), [Perception](rules/5e/skills.md#Perception), [Religion](rules/5e/skills.md#Religion), or [Survival](rules/5e/skills.md#Survival)
- **Weapon Proficiencies**: Simple weapons
- **Tool Proficiencies**: [Herbalism Kit](compendium/5e/items/herbalism-kit.md)
- **Armor Training**: [Light armor](rules/5e/item-types.md#Light%20Armor) and [Shields](compendium/5e/items/shield.md)

**Starting Equipment:** *Choose A or B:* (A) [Leather Armor](compendium/5e/items/leather-armor.md), [Shield](compendium/5e/items/shield.md), [Sickle](compendium/5e/items/sickle.md), [Druidic Focus (Quarterstaff)](compendium/5e/items/druidic-focus.md), [Explorer's Pack](compendium/5e/items/explorers-pack.md), [Herbalism kit](compendium/5e/items/herbalism-kit.md), 9 GP; or (B) 50 GP

## Multiclassing Druid

- **Armor Training**: [Light armor](rules/5e/item-types.md#Light%20Armor), [Shields](compendium/5e/items/shield.md)
...
You know Druidic, the secret language of Druids. While learning this ancient tongue, you also unlocked the magic of communicating with animals; you always have the [Speak with Animals](compendium/5e/spells/speak-with-animals.md) spell prepared.

You can use Druidic to leave hidden messages. You and others who know Druidic automatically spot such a message. Others spot the message's presence with a successful DC 15 Intelligence ([Investigation](rules/5e/skills.md#Investigation)) check but can't decipher it without magic.
...
- **Magician**  
    ...
    You know one extra cantrip from the Druid spell list. In addition, your mystical connection to nature gives you a bonus to your Intelligence ([Arcana](rules/5e/skills.md#Arcana) or [Nature](rules/5e/skills.md#Nature)) checks. The bonus equals your Wisdom modifier (minimum bonus of +1).  
...
You know two cantrips of your choice from the Druid spell list. [Druidcraft](compendium/5e/spells/druidcraft.md) and [Produce Flame](compendium/5e/spells/produce-flame.md) are recommended.
...
The Druid Features table shows how many spell slots you have to cast your level 1+ spells. You regain all expended slots when you finish a [Long Rest](rules/5e/variant-rules/long-rest-xphb.md).

#### Prepared Spells of Level 1+

You prepare the list of level 1+ spells that are available for you to cast with this feature. To start, choose four level 1 spells from the Druid spell list. [Animal Friendship](compendium/5e/spells/animal-friendship.md), [Cure Wounds](compendium/5e/spells/cure-wounds.md), [Faerie Fire](compendium/5e/spells/faerie-fire.md), and [Thunderwave](compendium/5e/spells/thunderwave.md) are recommended.
...
Whenever you finish a [Long Rest](rules/5e/variant-rules/long-rest-xphb.md), you can change your list of prepared spells, replacing any of the spells with other Druid spells for which you have spell slots.
...
You can use a [Druidic Focus](compendium/5e/items/druidic-focus.md) as a [Spellcasting Focus](rules/5e/variant-rules/spellcasting-focus-xphb.md) for your Druid spells.

### Wild Companion (Level 2)

You can summon a nature spirit that assumes an animal form to aid you. As a [Magic](rules/5e/actions.md#Magic) action, you can expend a spell slot or a use of Wild Shape to cast the [Find Familiar](compendium/5e/spells/find-familiar.md) spell without Material components.

When you cast the spell in this way, the familiar is Fey and disappears when you finish a [Long Rest](rules/5e/variant-rules/long-rest-xphb.md).

### Wild Shape (Level 2)

The power of nature allows you to assume the form of an animal. As a [Bonus Action](rules/5e/variant-rules/bonus-action-xphb.md), you shape-shift into a Beast form that you have learned for this feature (see "Known Forms" below). You stay in that form for a number of hours equal to half your Druid level or until you use Wild Shape again, have the [Incapacitated](rules/5e/conditions.md#Incapacitated) condition, or die. You can also leave the form early as a [Bonus Action](rules/5e/variant-rules/bonus-action-xphb.md).

#### Number of Uses

You can use Wild Shape twice. You regain one expended use when you finish a [Short Rest](rules/5e/variant-rules/short-rest-xphb.md), and you regain all expended uses when you finish a [Long Rest](rules/5e/variant-rules/long-rest-xphb.md).

You gain additional uses when you reach certain Druid levels, as shown in the Wild Shape column of the Druid Features table.

#### Known Forms

You know four Beast forms for this feature, chosen from among Beast stat blocks that have a maximum [Challenge Rating](rules/5e/variant-rules/challenge-rating-xphb.md) of 1/4 and that lack a [Fly Speed](rules/5e/variant-rules/fly-speed-xphb.md) (see appendix B for stat block options). The [Rat](compendium/5e/bestiary/beast/rat.md), [Riding Horse](compendium/5e/bestiary/beast/riding-horse.md), [Spider](compendium/5e/bestiary/beast/spider.md), and [Wolf](compendium/5e/bestiary/beast/wolf.md) are recommended. Whenever you finish a [Long Rest](rules/5e/variant-rules/long-rest-xphb.md), you can replace one of your known forms with another eligible form.

When you reach certain Druid levels, your number of known forms and the maximum [Challenge Rating](rules/5e/variant-rules/challenge-rating-xphb.md) for those forms increases, as shown in the Beast Shapes table. In addition, starting at level 8, you can adopt a form that has a [Fly Speed](rules/5e/variant-rules/fly-speed-xphb.md).
...
- **Temporary Hit Points.** When you assume a Wild Shape form, you gain a number of [Temporary Hit Points](rules/5e/variant-rules/temporary-hit-points-xphb.md) equal to your Druid level.  
- **Game Statistics.** Your game statistics are replaced by the Beast's stat block, but you retain your creature type; [Hit Points](rules/5e/variant-rules/hit-points-xphb.md); [Hit Point Dice](rules/5e/variant-rules/hit-point-dice-xphb.md); Intelligence, Wisdom, and Charisma scores; class features; languages; and feats. You also retain your skill and saving throw proficiencies and use your [Proficiency Bonus](rules/5e/variant-rules/proficiency-xphb.md) for them, in addition to gaining the proficiencies of the creature. If a skill or saving throw modifier in the Beast's stat block is higher than yours, use the one in the stat block.  
- **No Spellcasting.** You can't cast spells, but shape-shifting doesn't break your [Concentration](rules/5e/conditions.md#Concentration) or otherwise interfere with a spell you've already cast.  
...
You gain the [Ability Score Improvement](compendium/5e/feats/ability-score-improvement.md) feat or another feat of your choice for which you qualify. You gain this feature again at Druid levels 8, 12, and 16.

### Wild Resurgence (Level 5)

Once on each of your turns, if you have no uses of Wild Shape left, you can give yourself one use by expending a spell slot (no action required).

In addition, you can expend one use of Wild Shape (no action required) to give yourself a level 1 spell slot, but you can't do so again until you finish a [Long Rest](rules/5e/variant-rules/long-rest-xphb.md).
...
You gain an Epic Boon feat or another feat of your choice for which you qualify. [Boon of Dimensional Travel](compendium/5e/feats/boon-of-dimensional-travel.md) is recommended.
...
Whenever you roll [Initiative](rules/5e/variant-rules/initiative-xphb.md) and have no uses of Wild Shape left, you regain one expended use of it.

#### Nature Magician

You can convert uses of Wild Shape into a spell slot (no action required). Choose a number of your unexpended uses of Wild Shape and convert them into a single spell slot, with each use contributing 2 spell levels. For example, if you convert two uses of Wild Shape, you produce a level 4 spell slot. Once you use this benefit, you can't do so again until you finish a [Long Rest](rules/5e/variant-rules/long-rest-xphb.md).
