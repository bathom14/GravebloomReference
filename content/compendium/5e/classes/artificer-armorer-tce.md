...
You gain proficiency with heavy armor. You also gain proficiency with [smith's tools](compendium/5e/items/smiths-tools.md). If you already have this tool proficiency, you gain proficiency with one other type of [artisan's tools](compendium/5e/items/artisans-tools.md) of your choice.
...
|-----------------|-------|
| 3rd | [magic missile](compendium/5e/spells/magic-missile.md), [thunderwave](compendium/5e/spells/thunderwave.md) |
| 5th | [mirror image](compendium/5e/spells/mirror-image.md), [shatter](compendium/5e/spells/shatter.md) |
| 9th | [hypnotic pattern](compendium/5e/spells/hypnotic-pattern.md), [lightning bolt](compendium/5e/spells/lightning-bolt.md) |
| 13th | [fire shield](compendium/5e/spells/fire-shield.md), [greater invisibility](compendium/5e/spells/greater-invisibility.md) |
| 17th | [passwall](compendium/5e/spells/passwall.md), [wall of force](compendium/5e/spells/wall-of-force.md) |
^armorer-spells
...
Your metallurgical pursuits have led to you making armor a conduit for your magic. As an action, you can turn a suit of armor you are wearing into Arcane Armor, provided you have [smith's tools](compendium/5e/items/smiths-tools.md) in hand.
...
You can change the armor's model whenever you finish a short or long rest, provided you have [smith's tools](compendium/5e/items/smiths-tools.md) in hand.
...
- **Dampening Field**  
    ...
    You have advantage on Dexterity ([Stealth](rules/5e/skills.md#Stealth)) checks. If the armor normally imposes disadvantage on such checks, the advantage and disadvantage cancel each other, as normal.  

### Extra Attack (Level 5)

*5th-level Armorer feature*

You can attack twice, rather than once, whenever you take the [Attack](rules/5e/actions.md#Attack) action on your turn.
