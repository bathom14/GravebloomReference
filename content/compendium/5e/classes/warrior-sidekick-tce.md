...
- **Tools**: none
- **Skills**: Two skills of your choice from the following list: [Acrobatics](rules/5e/skills.md#Acrobatics), [Animal Handling](rules/5e/skills.md#Animal%20Handling), [Athletics](rules/5e/skills.md#Athletics), [Intimidation](rules/5e/skills.md#Intimidation), [Nature](rules/5e/skills.md#Nature), [Perception](rules/5e/skills.md#Perception), and [Survival](rules/5e/skills.md#Survival).
...
The sidekick can attack twice, instead of once, whenever it takes the [Attack](rules/5e/actions.md#Attack) action on its turn.
