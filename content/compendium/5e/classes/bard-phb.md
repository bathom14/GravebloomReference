...
- **Tools**: three [musical instruments](compendium/5e/items/musical-instrument.md) of your choice
- **Skills**: choose any 3 [skills](rules/5e/skills.md)

You start with the following items, plus anything provided by your background.

- (a) a [rapier](compendium/5e/items/rapier-phb.md), (b) a [longsword](compendium/5e/items/longsword-phb.md), or (c) any simple weapon
- (a) a [diplomat's pack](compendium/5e/items/diplomats-pack.md) or (b) an [entertainer's pack](compendium/5e/items/entertainers-pack.md)
- (a) a [lute](compendium/5e/items/lute-phb.md) or (b) any other musical instrument
- [Leather armor](compendium/5e/items/leather-armor-phb.md), and a [dagger](compendium/5e/items/dagger-phb.md)
...
- **Armor**: [light armor](rules/5e/item-types.md#Light%20Armor)
- **Tools**: one [musical instrument](compendium/5e/items/musical-instrument.md) of your choice
- **Skills**: choose any 1 [skill](rules/5e/skills.md)
...
You can make a bard quickly by following these suggestions. First, Charisma should be your highest ability score, followed by Dexterity. Second, choose the [entertainer](compendium/5e/backgrounds/entertainer.md) background. Third, choose the [dancing lights](compendium/5e/spells/dancing-lights.md) and [vicious mockery](compendium/5e/spells/vicious-mockery.md) cantrips, along with the following 1st-level spells: [charm person](compendium/5e/spells/charm-person.md), [detect magic](compendium/5e/spells/detect-magic.md), [healing word](compendium/5e/spells/healing-word.md), and [thunderwave](compendium/5e/spells/thunderwave.md).
...
`dice: [](bard-phb.md#^defining-work)`
...
`dice: [](bard-phb.md#^instrument)`

| dice: d6 | Instrument |
|----------|------------|
| 1 | A masterfully crafted halfling fiddle |
| 2 | A mithral [horn](compendium/5e/items/horn-phb.md) made by elves |
| 3 | A zither made with drow spider silk |
| 4 | An orcish [drum](compendium/5e/items/drum-phb.md) |
...
`dice: [](bard-phb.md#^embarrassment)`
...
| 6 | When you sat on your [lute](compendium/5e/items/lute-phb.md) by mistake during the final stanza of "Starlight Serenade" |
^embarrassment
...
For example, if you know the 1st-level spell [cure wounds](compendium/5e/spells/cure-wounds.md) and have a 1st-level and a 2nd-level spell slot available, you can cast [cure wounds](compendium/5e/spells/cure-wounds.md) using either slot.
...
You can use a [musical instrument](compendium/5e/items/musical-instrument.md) as a spellcasting focus for your bard spells.
...
*2nd-level bard [optional feature](rules/5e/variant-rules/optional-class-features-tce.md)*
...
*4th-level bard [optional feature](rules/5e/variant-rules/optional-class-features-tce.md)*
...
At 6th level, you gain the ability to use musical notes or words of power to disrupt mind-influencing effects. As an action, you can start a performance that lasts until the end of your next turn. During that time, you and any friendly creatures within 30 feet of you have advantage on saving throws against being [frightened](rules/5e/conditions.md#Frightened) or [charmed](rules/5e/conditions.md#Charmed). A creature must be able to hear you to gain this benefit. The performance ends early if you are [incapacitated](rules/5e/conditions.md#Incapacitated) or silenced or if you voluntarily end it (no action required).
