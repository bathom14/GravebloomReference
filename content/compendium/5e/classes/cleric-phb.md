...
- **Tools**: none
- **Skills**: choose 2 from [History](rules/5e/skills.md#History), [Insight](rules/5e/skills.md#Insight), [Medicine](rules/5e/skills.md#Medicine), [Persuasion](rules/5e/skills.md#Persuasion), and [Religion](rules/5e/skills.md#Religion)

You start with the following items, plus anything provided by your background.

- (a) a [mace](compendium/5e/items/mace-phb.md) or (b) a [warhammer](compendium/5e/items/warhammer-phb.md) (if proficient)
- (a) [scale mail](compendium/5e/items/scale-mail-phb.md), (b) [leather armor](compendium/5e/items/leather-armor-phb.md), or (c) [chain mail](compendium/5e/items/chain-mail-phb.md) (if proficient)
...
- A [shield](compendium/5e/items/shield-phb.md) and a [holy symbol](compendium/5e/items/holy-symbol.md)
...
You can make a cleric quickly by following these suggestions. First, Wisdom should be your highest ability score, followed by Strength or Constitution. Second, choose the [acolyte](compendium/5e/backgrounds/acolyte.md) background.
...
You can use a [holy symbol](compendium/5e/items/holy-symbol.md) as a spellcasting focus for your cleric spells.
...
A turned creature must spend its turns trying to move as far away from you as it can, and it can't willingly move to a space within 30 feet of you. It also can't take reactions. For its action, it can use only the [Dash](rules/5e/actions.md#Dash) action or try to escape from an effect that prevents it from moving. If there's nowhere to move, the creature can use the [Dodge](rules/5e/actions.md#Dodge) action.

### Channel Divinity: Harness Divine Power (Level 2)
_Source: Tasha's Cauldron of Everything p. 30_

*2nd-level cleric [optional feature](rules/5e/variant-rules/optional-class-features-tce.md)*
...
*4th-level cleric [optional feature](rules/5e/variant-rules/optional-class-features-tce.md)*
