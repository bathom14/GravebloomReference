...
- **Tools**: none
- **Skills**: choose 2 from [Arcana](rules/5e/skills.md#Arcana), [History](rules/5e/skills.md#History), [Insight](rules/5e/skills.md#Insight), [Investigation](rules/5e/skills.md#Investigation), [Medicine](rules/5e/skills.md#Medicine), and [Religion](rules/5e/skills.md#Religion)

You start with the following items, plus anything provided by your background.

- (a) a [quarterstaff](compendium/5e/items/quarterstaff-phb.md) or (b) a [dagger](compendium/5e/items/dagger-phb.md)
- (a) a [component pouch](compendium/5e/items/component-pouch.md) or (b) an [arcane focus](compendium/5e/items/arcane-focus.md)
- (a) a [scholar's pack](compendium/5e/items/scholars-pack.md) or (b) an [explorer's pack](compendium/5e/items/explorers-pack.md)
- A [spellbook](compendium/5e/items/spellbook-phb.md)
...
You can make a wizard quickly by following these suggestions. First, Intelligence should be your highest ability score, followed by Constitution or Dexterity. If you plan to join the School of Enchantment, make Charisma your next-best score. Second, choose the [sage](compendium/5e/backgrounds/sage.md) background. Third, choose the [mage hand](compendium/5e/spells/mage-hand.md), [light](compendium/5e/spells/light.md), and [ray of frost](compendium/5e/spells/ray-of-frost.md) cantrips, along with the following 1st-level spells for your spellbook: [burning hands](compendium/5e/spells/burning-hands.md), [charm person](compendium/5e/spells/charm-person.md), [feather fall](compendium/5e/spells/feather-fall.md), [mage armor](compendium/5e/spells/mage-armor.md), [magic missile](compendium/5e/spells/magic-missile.md), and [sleep](compendium/5e/spells/sleep.md).
...
`dice: [](wizard-phb.md#^eccentricities)`
...
For example, if you're a 3rd-level wizard, you have four 1st-level and two 2nd-level spell slots. With an Intelligence of 16, your list of prepared spells can include six spells of 1st or 2nd level, in any combination, chosen from your spellbook. If you prepare the 1st-level spell [magic missile](compendium/5e/spells/magic-missile.md), you can cast it using a 1st-level or a 2nd-level slot. Casting the spell doesn't remove it from your list of prepared spells.
...
You can use an [arcane focus](compendium/5e/items/arcane-focus.md) as a spellcasting focus for your wizard spells.
...
> 
> **Copying from a Spell Scroll.** A wizard spell on a spell scroll can be copied just as spells in spellbooks can be copied. When you copy a spell from a spell scroll, you must succeed on an Intelligence ([Arcana](rules/5e/skills.md#Arcana)) check with a DC equal to 10 + the spell's level. If the check succeeds, the spell is successfully copied. Whether the check succeeds or fails, the spell scroll is destroyed.
> 
...
*3rd-level wizard [optional feature](rules/5e/variant-rules/optional-class-features-tce.md)*
