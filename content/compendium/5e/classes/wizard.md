...
- **Skill Proficiencies**: *Choose 2:* [Arcana](rules/5e/skills.md#Arcana), [History](rules/5e/skills.md#History), [Insight](rules/5e/skills.md#Insight), [Investigation](rules/5e/skills.md#Investigation), [Medicine](rules/5e/skills.md#Medicine), or [Religion](rules/5e/skills.md#Religion)
- **Weapon Proficiencies**: Simple weapons

**Starting Equipment:** *Choose A or B:* (A) 2 [Daggers](compendium/5e/items/dagger.md), [Arcane Focus](compendium/5e/items/arcane-focus.md) ([Quarterstaff](compendium/5e/items/quarterstaff.md)), [Robe](compendium/5e/items/robe.md), Spellbook, [Scholar's Pack](compendium/5e/items/scholars-pack.md), and 5 GP; or (B) 55 GP
...
You know three Wizard cantrips of your choice. [Light](compendium/5e/spells/light.md), [Mage Hand](compendium/5e/spells/mage-hand.md), and [Ray of Frost](compendium/5e/spells/ray-of-frost.md) are recommended. Whenever you finish a [Long Rest](rules/5e/variant-rules/long-rest-xphb.md), you can replace one of your cantrips from this feature with another Wizard cantrip of your choice.

When you reach Wizard levels 4 and 10, you learn another Wizard cantrip of your choice, as shown in the Cantrips column of the Wizard Features table.

#### Spellbook

Your wizardly apprenticeship culminated in the creation of a unique book: your spellbook. It is a Tiny object that weighs 3 pounds, contains 100 pages, and can be read only by you or someone casting [Identify](compendium/5e/spells/identify.md). You determine the book's appearance and materials, such as a gilt-edged tome or a collection of vellum bound with twine.

The book contains the level 1+ spells you know. It starts with six level 1 Wizard spells of your choice. [Detect Magic](compendium/5e/spells/detect-magic.md), [Feather Fall](compendium/5e/spells/feather-fall.md), [Mage Armor](compendium/5e/spells/mage-armor.md), [Magic Missile](compendium/5e/spells/magic-missile.md), [Sleep](compendium/5e/spells/sleep.md), and [Thunderwave](compendium/5e/spells/thunderwave.md) are recommended.

Whenever you gain a Wizard level after 1, add two Wizard spells of your choice to your spellbook. Each of these spells must be of a level for which you have spell slots, as shown in the Wizard Features table. The spells are the culmination of arcane research you do regularly.

#### Spell Slots

The Wizard Features table shows how many spell slots you have to cast your level 1+ spells. You regain all expended slots when you finish a [Long Rest](rules/5e/variant-rules/long-rest-xphb.md).
...
Whenever you finish a [Long Rest](rules/5e/variant-rules/long-rest-xphb.md), you can change your list of prepared spells, replacing any of the spells there with spells from your spellbook.
...
You can use an [Arcane Focus](compendium/5e/items/arcane-focus.md) or your spellbook as a [Spellcasting Focus](rules/5e/variant-rules/spellcasting-focus-xphb.md) for your Wizard spells.

> [!note] Expanding and Replacing a Spellbook
> 
> The spells you add to your spellbook as you gain levels reflect your ongoing magical research, but you might find other spells during your adventures that you can add to the book. You could discover a Wizard spell on a [Spell Scroll](compendium/5e/items/spell-scroll.md), for example, and then copy it into your spellbook.
> 
...
You can cast any spell as a [Ritual](rules/5e/variant-rules/ritual-xphb.md) if that spell has the [Ritual](rules/5e/variant-rules/ritual-xphb.md) tag and the spell is in your spellbook. You needn't have the spell prepared, but you must read from the book to cast a spell in this way.

### Arcane Recovery (Level 1)

You can regain some of your magical energy by studying your spellbook. When you finish a [Short Rest](rules/5e/variant-rules/short-rest-xphb.md), you can choose expended spell slots to recover. The spell slots can have a combined level equal to no more than half your Wizard level (round up), and none of the slots can be level 6 or higher. For example, if you're a level 4 Wizard, you can recover up to two levels' worth of spell slots, regaining either one level 2 spell slot or two level 1 spell slots.

Once you use this feature, you can't do so again until you finish a [Long Rest](rules/5e/variant-rules/long-rest-xphb.md).

### Scholar (Level 2)

While studying magic, you also specialized in another field of study. Choose one of the following skills in which you have proficiency: [Arcana](rules/5e/skills.md#Arcana), [History](rules/5e/skills.md#History), [Investigation](rules/5e/skills.md#Investigation), [Medicine](rules/5e/skills.md#Medicine), [Nature](rules/5e/skills.md#Nature), or [Religion](rules/5e/skills.md#Religion). You have [Expertise](rules/5e/variant-rules/expertise-xphb.md) in the chosen skill.
...
You gain the [Ability Score Improvement](compendium/5e/feats/ability-score-improvement.md) feat or another feat of your choice for which you qualify. You gain this feature again at Wizard levels 8, 12, and 16.

### Memorize Spell (Level 5)

Whenever you finish a [Short Rest](rules/5e/variant-rules/short-rest-xphb.md), you can study your spellbook and replace one of the level 1+ Wizard spells you have prepared for your Spellcasting feature with another level 1+ spell from the book.
...
Whenever you finish a [Long Rest](rules/5e/variant-rules/long-rest-xphb.md), you can study your spellbook and replace one of those spells with an eligible spell of the same level from the book.
...
Choose two level 3 spells in your spellbook as your signature spells. You always have these spells prepared, and you can cast each of them once at level 3 without expending a spell slot. When you do so, you can't cast them in this way again until you finish a [Short](rules/5e/variant-rules/short-rest-xphb.md) or [Long Rest](rules/5e/variant-rules/long-rest-xphb.md). To cast either spell at a higher level, you must expend a spell slot.