...
|-------------|-----------------|
| 3 | [Cure Wounds](compendium/5e/spells/cure-wounds.md), [Moonbeam](compendium/5e/spells/moonbeam.md), [Starry Wisp](compendium/5e/spells/starry-wisp.md) |
| 5 | [Conjure Animals](compendium/5e/spells/conjure-animals.md) |
| 7 | [Fount of Moonlight](compendium/5e/spells/fount-of-moonlight.md) |
| 9 | [Mass Cure Wounds](compendium/5e/spells/mass-cure-wounds.md) |
^circle-of-the-moon-spells
...
The maximum [Challenge Rating](rules/5e/variant-rules/challenge-rating-xphb.md) for the form equals your Druid level divided by 3 (round down).
...
You gain a number of [Temporary Hit Points](rules/5e/variant-rules/temporary-hit-points-xphb.md) equal to three times your Druid level.
...
You magically transport yourself, reappearing amid a burst of moonlight. As a [Bonus Action](rules/5e/variant-rules/bonus-action-xphb.md), you teleport up to 30 feet to an unoccupied space you can see, and you have [Advantage](rules/5e/variant-rules/advantage-xphb.md) on the next attack roll you make before the end of this turn.

You can use this feature a number of times equal to your Wisdom modifier (minimum of once), and you regain all expended uses when you finish a [Long Rest](rules/5e/variant-rules/long-rest-xphb.md). You can also regain uses by expending a level 2+ spell slot for each use you want to restore (no action required).
