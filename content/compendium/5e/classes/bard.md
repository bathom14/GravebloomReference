...
- **Skill Proficiencies**: Choose 3 [skills](rules/5e/skills.md)
- **Weapon Proficiencies**: Simple weapons
- **Tool Proficiencies**: Choose three [Musical Instruments](compendium/5e/items/musical-instrument.md)
- **Armor Training**: [Light armor](rules/5e/item-types.md#Light%20Armor)

**Starting Equipment:** *Choose A or B:* (A) [Leather Armor](compendium/5e/items/leather-armor.md), 2 [Dagger](compendium/5e/items/dagger.md), [Musical Instrument](compendium/5e/items/musical-instrument.md) of your choice, [Entertainer's Pack](compendium/5e/items/entertainers-pack.md), 19 GP; or (B) 90 GP

## Multiclassing Bard

- **Skill Proficiencies**: Choose 1 [skill](rules/5e/skills.md)
- **Tool Proficiencies**: Choose one [Musical Instrument](compendium/5e/items/musical-instrument.md)
- **Armor Training**: [Light armor](rules/5e/item-types.md#Light%20Armor)
...
As a [Bonus Action](rules/5e/variant-rules/bonus-action-xphb.md), you can inspire another creature within 60 feet of yourself who can see or hear you. That creature gains one of your Bardic Inspiration dice. A creature can have only one Bardic Inspiration die at a time.

Once within the next hour when the creature fails a [D20 Test](rules/5e/variant-rules/d20-test-xphb.md), the creature can roll the Bardic Inspiration die and add the number rolled to the `dice:d20|noform|noparens|avg` (`d20`), potentially turning the failure into a success. A Bardic Inspiration die is expended when it's rolled.

#### Number of Uses

You can confer a Bardic Inspiration die a number of times equal to your Charisma modifier (minimum of once), and you regain all expended uses when you finish a [Long Rest](rules/5e/variant-rules/long-rest-xphb.md).
...
You know two cantrips of your choice from the Bard spell list. [Dancing Lights](compendium/5e/spells/dancing-lights.md) and [Vicious Mockery](compendium/5e/spells/vicious-mockery.md) are recommended.
...
The Bard Features table shows how many spell slots you have to cast your level 1+ spells. You regain all expended slots when you finish a [Long Rest](rules/5e/variant-rules/long-rest-xphb.md).

#### Prepared Spells of Level 1+

You prepare the list of level 1+ spells that are available for you to cast with this feature. To start, choose four level 1 spells from the Bard spell list. [Charm Person](compendium/5e/spells/charm-person.md), [Color Spray](compendium/5e/spells/color-spray.md), [Dissonant Whispers](compendium/5e/spells/dissonant-whispers.md), and [Healing Word](compendium/5e/spells/healing-word.md) are recommended.
...
You can use a [Musical Instrument](compendium/5e/items/musical-instrument.md) as a [Spellcasting Focus](rules/5e/variant-rules/spellcasting-focus-xphb.md) for your Bard spells.

### Expertise (Level 2)

You gain [Expertise](rules/5e/variant-rules/expertise-xphb.md) in two of your skill proficiencies of your choice. [Performance](rules/5e/skills.md#Performance) and [Persuasion](rules/5e/skills.md#Persuasion) are recommended if you have proficiency in them.

At Bard level 9, you gain [Expertise](rules/5e/variant-rules/expertise-xphb.md) in two more of your skill proficiencies of your choice.

### Jack of All Trades (Level 2)

You can add half your [Proficiency Bonus](rules/5e/variant-rules/proficiency-xphb.md) (round down) to any ability check you make that uses a skill proficiency you lack and that doesn't otherwise use your [Proficiency Bonus](rules/5e/variant-rules/proficiency-xphb.md).

For example, if you make a Strength ([Athletics](rules/5e/skills.md#Athletics)) check and lack [Athletics](rules/5e/skills.md#Athletics) proficiency, you can add half your [Proficiency Bonus](rules/5e/variant-rules/proficiency-xphb.md) to the check.

> [!note] A Bard's Repertoire
> 
> Does your Bard beat a [drum](compendium/5e/items/drum.md) while chanting the deeds of ancient heroes? Strum a [lute](compendium/5e/items/lute.md) while crooning romantic tunes? Perform arias of stirring power? Recite dramatic monologues from classic tragedies? Use the rhythm of a folk dance to coordinate the movement of allies in battle? Compose naughty limericks?
> 
...
You gain the [Ability Score Improvement](compendium/5e/feats/ability-score-improvement.md) feat or another feat of your choice for which you qualify. You gain this feature again at Bard levels 8, 12, and 16.

### Font of Inspiration (Level 5)

You now regain all your expended uses of Bardic Inspiration when you finish a [Short](rules/5e/variant-rules/short-rest-xphb.md) or [Long Rest](rules/5e/variant-rules/long-rest-xphb.md).
...
You can use musical notes or words of power to disrupt mind-influencing effects. If you or a creature within 30 feet of you fails a saving throw against an effect that applies the [Charmed](rules/5e/conditions.md#Charmed) or [Frightened](rules/5e/conditions.md#Frightened) condition, you can take a [Reaction](rules/5e/variant-rules/reaction-xphb.md) to cause the save to be rerolled, and the new roll has [Advantage](rules/5e/variant-rules/advantage-xphb.md).
...
When you roll [Initiative](rules/5e/variant-rules/initiative-xphb.md), you regain expended uses of Bardic Inspiration until you have two if you have fewer than that.

### Epic Boon (Level 19)

You gain an Epic Boon feat or another feat of your choice for which you qualify. [Boon of Spell Recall](compendium/5e/feats/boon-of-spell-recall.md) is recommended.

### Words of Creation (Level 20)

You have mastered two of the Words of Creation: the words of life and death. You therefore always have the [Power Word Heal](compendium/5e/spells/power-word-heal.md) and [Power Word Kill](compendium/5e/spells/power-word-kill.md) spells prepared. When you cast either spell, you can target a second creature with it if that creature is within 10 feet of the first target.