...
- 5e/subclass/sorcerer/lunar
aliases:
- Lunar Sorcery
---
# Lunar Sorcery
*[Sorcerer](./sorcerer-phb.md): Sorcerous Origin*  
...
|----------------|-----------------|----------------|---------------------|
| 1st | [shield](compendium/5e/spells/shield.md) | [ray of sickness](compendium/5e/spells/ray-of-sickness.md) | [color spray](compendium/5e/spells/color-spray.md) |
| 3rd | [lesser restoration](compendium/5e/spells/lesser-restoration.md) | [blindness/deafness](compendium/5e/spells/blindness-deafness.md) | [alter self](compendium/5e/spells/alter-self.md) |
| 5th | [dispel magic](compendium/5e/spells/dispel-magic.md) | [vampiric touch](compendium/5e/spells/vampiric-touch.md) | [phantom steed](compendium/5e/spells/phantom-steed.md) |
| 7th | [death ward](compendium/5e/spells/death-ward.md) | [confusion](compendium/5e/spells/confusion.md) | [hallucinatory terrain](compendium/5e/spells/hallucinatory-terrain.md) |
| 9th | [Rary's telepathic bond](compendium/5e/spells/rarys-telepathic-bond.md) | [hold monster](compendium/5e/spells/hold-monster.md) | [mislead](compendium/5e/spells/mislead.md) |
^lunar-spells
...
You can call down the radiant light of the moon on command. You learn the [sacred flame](compendium/5e/spells/sacred-flame.md) spell, which doesn't count against the number of sorcerer cantrips you know. When you cast the spell, you can target one creature as normal or target two creatures within range that are within 5 feet of each other.
...
- **Full Moon.** You can use a bonus action to shed bright light in a 10-foot radius and dim light for an additional 10 feet or to douse the light. In addition, you and creatures of your choice have advantage on Intelligence ([Investigation](rules/5e/skills.md#Investigation)) and Wisdom ([Perception](rules/5e/skills.md#Perception)) checks while within the bright light you shed.  
- **New Moon.** You have advantage on Dexterity ([Stealth](rules/5e/skills.md#Stealth)) checks. In addition, while you are entirely in darkness, attack rolls have disadvantage against you.  
...
- **Full Moon.** You radiate moonlight for a moment. Each creature of your choice within 30 feet of you must succeed on a Constitution saving throw against your spell save DC or be [blinded](rules/5e/conditions.md#Blinded) until the end of its next turn. In addition, one creature of your choice in that area regains `dice:3d8|noform|noparens|avg` (`3d8`) hit points.  
- **New Moon.** You momentarily emanate gloom. Each creature of your choice within 30 feet of you must succeed on a Dexterity saving throw against your spell save DC or take `dice:3d10|noform|noparens|avg` (`3d10`) necrotic damage and have its speed reduced to 0 until the end of its next turn. In addition, you become [invisible](rules/5e/conditions.md#Invisible) until the end of your next turn, or until immediately after you make an attack roll or cast a spell.  
