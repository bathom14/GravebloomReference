...
When you join the College of Tragedy at 3rd level, you learn to harness the beauty in failure, finding inspiration in even the direst twists of fate. Whenever you or an ally within 30 feet of you rolls a 1 on the `dice:d20|noform|noparens|avg` (`d20`) for an attack roll, an ability check, or a saving throw, you can use your reaction to soliloquize and regain one expended use of your Bardic Inspiration feature.
...
- When the creature hits a target with a weapon attack or spell attack, that target takes an extra `dice:1d10|noform|noparens|avg` (`d10`) radiant damage.  
