...
- **Skill Proficiencies**: *Choose 2:* [History](rules/5e/skills.md#History), [Insight](rules/5e/skills.md#Insight), [Medicine](rules/5e/skills.md#Medicine), [Persuasion](rules/5e/skills.md#Persuasion), or [Religion](rules/5e/skills.md#Religion)
...
**Starting Equipment:** *Choose A or B:* (A) [Chain Shirt](compendium/5e/items/chain-shirt.md), [Shield](compendium/5e/items/shield.md), [Mace](compendium/5e/items/mace.md), [Holy Symbol](compendium/5e/items/holy-symbol.md), [Priest's Pack](compendium/5e/items/priests-pack.md), 7 GP; or (B) 110 GP
...
You know three cantrips of your choice from the Cleric spell list. [Guidance](compendium/5e/spells/guidance.md), [Sacred Flame](compendium/5e/spells/sacred-flame.md), and [Thaumaturgy](compendium/5e/spells/thaumaturgy.md) are recommended.
...
The Cleric Features table shows how many spell slots you have to cast your level 1+ spells. You regain all expended slots when you finish a [Long Rest](rules/5e/variant-rules/long-rest-xphb.md).

#### Prepared Spells of Level 1+

You prepare the list of level 1+ spells that are available for you to cast with this feature. To start, choose four level 1 spells from the Cleric spell list. [Bless](compendium/5e/spells/bless.md), [Cure Wounds](compendium/5e/spells/cure-wounds.md), [Guiding Bolt](compendium/5e/spells/guiding-bolt.md), and [Shield of Faith](compendium/5e/spells/shield-of-faith.md) are recommended.
...
Whenever you finish a [Long Rest](rules/5e/variant-rules/long-rest-xphb.md), you can change your list of prepared spells, replacing any of the spells there with other Cleric spells for which you have spell slots.
...
You can use a [Holy Symbol](compendium/5e/items/holy-symbol.md) as a [Spellcasting Focus](rules/5e/variant-rules/spellcasting-focus-xphb.md) for your Cleric spells.
...
- **Thaumaturge**  
    ...
    You know one extra cantrip from the Cleric spell list. In addition, your mystical connection to the divine gives you a bonus to your Intelligence ([Arcana](rules/5e/skills.md#Arcana) or [Religion](rules/5e/skills.md#Religion)) checks. The bonus equals your Wisdom modifier (minimum of +1).  

### Channel Divinity (Level 2)

You can channel divine energy directly from the Outer Planes to fuel magical effects. You start with two such effects: Divine Spark and Turn Undead, each of which is described below. Each time you use this class's Channel Divinity, choose which Channel Divinity effect from this class to create. You gain additional effect options at higher Cleric levels.

You can use this class's Channel Divinity twice. You regain one of its expended uses when you finish a [Short Rest](rules/5e/variant-rules/short-rest-xphb.md), and you regain all expended uses when you finish a [Long Rest](rules/5e/variant-rules/long-rest-xphb.md). You gain additional uses when you reach certain Cleric levels, as shown in the Channel Divinity column of the Cleric Features table.

If a Channel Divinity effect requires a saving throw, the DC equals the spell save DC from this class's Spellcasting feature.

### Divine Spark (Level 2)

As a [Magic](rules/5e/actions.md#Magic) action, you point your [Holy Symbol](compendium/5e/items/holy-symbol.md) at another creature you can see within 30 feet of yourself and focus divine energy at it. Roll `dice:1d8|noform|noparens|avg` (`d8`) and add your Wisdom modifier. You either restore [Hit Points](rules/5e/variant-rules/hit-points-xphb.md) to the creature equal to that total or force the creature to make a Constitution saving throw. On a failed save, the creature takes Necrotic or Radiant damage (your choice) equal to that total. On a successful save, the creature takes half as much damage (round down).
...
As a [Magic](rules/5e/actions.md#Magic) action, you present your [Holy Symbol](compendium/5e/items/holy-symbol.md) and censure Undead creatures. Each Undead of your choice within 30 feet of you must make a Wisdom saving throw. If the creature fails its save, it has the [Frightened](rules/5e/conditions.md#Frightened) and [Incapacitated](rules/5e/conditions.md#Incapacitated) conditions for 1 minute. For that duration, it tries to move as far from you as it can on its turns. This effect ends early on the creature if it takes any damage, if you have the [Incapacitated](rules/5e/conditions.md#Incapacitated) condition, or if you die.
...
You gain the [Ability Score Improvement](compendium/5e/feats/ability-score-improvement.md) feat or another feat of your choice for which you qualify. You gain this feature again at Cleric levels 8, 12, and 16.
...
You can call on your deity or pantheon to intervene on your behalf. As a [Magic](rules/5e/actions.md#Magic) action, choose any Cleric spell of level 5 or lower that doesn't require a [Reaction](rules/5e/variant-rules/reaction-xphb.md) to cast. As part of the same action, you cast that spell without expending a spell slot or needing Material components. You can't use this feature again until you finish a [Long Rest](rules/5e/variant-rules/long-rest-xphb.md).
...
When you cast a Cleric cantrip and deal damage to a creature with it, you can give vitality to yourself or another creature within 60 feet of yourself, granting a number of [Temporary Hit Points](rules/5e/variant-rules/temporary-hit-points-xphb.md) equal to twice your Wisdom modifier.
...
You gain an Epic Boon feat or another feat of your choice for which you qualify. [Boon of Fate](compendium/5e/feats/boon-of-fate.md) is recommended.

### Greater Divine Intervention (Level 20)

You can call on even more powerful divine intervention. When you use your Divine Intervention feature, you can choose [Wish](compendium/5e/spells/wish.md) when you select a spell. If you do so, you can't use Divine Intervention again until you finish `dice:2d4|noform|noparens|avg` (`2d4`) Long Rests.