...
Gods of nature are as varied as the natural world itself, from inscrutable gods of the deep forests (such as Silvanus, Obad-Hai, Chislev, Balinor, and [Pan](compendium/5e/deities/greek-pan.md)) to friendly deities associated with particular springs and groves (such as Eldath). Druids revere nature as a whole and might serve one of these deities, practicing mysterious rites and reciting all-but-forgotten prayers in their own secret tongue. But many of these gods have clerics as well, champions who take a more active role in advancing the interests of a particular nature god. These clerics might hunt the evil monstrosities that despoil the woodlands, bless the harvest of the faithful, or wither the crops of those who anger their gods.
...
| Cleric Level | Spells |
|--------------|--------|
| 1st | [animal friendship](compendium/5e/spells/animal-friendship.md), [speak with animals](compendium/5e/spells/speak-with-animals.md) |
| 3rd | [barkskin](compendium/5e/spells/barkskin.md), [spike growth](compendium/5e/spells/spike-growth.md) |
| 5th | [plant growth](compendium/5e/spells/plant-growth.md), [wind wall](compendium/5e/spells/wind-wall.md) |
| 7th | [dominate beast](compendium/5e/spells/dominate-beast.md), [grasping vine](compendium/5e/spells/grasping-vine.md) |
| 9th | [insect plague](compendium/5e/spells/insect-plague.md), [tree stride](compendium/5e/spells/tree-stride.md) |
^nature-domain-spells

### Acolyte of Nature (Level 1)

At 1st level, you learn one druid cantrip of your choice. This cantrip doesn't count against the number of cleric cantrips you know. You also gain proficiency in one of the following skills of your choice: [Animal Handling](rules/5e/skills.md#Animal%20Handling), [Nature](rules/5e/skills.md#Nature), or [Survival](rules/5e/skills.md#Survival).
...
As an action, you present your holy symbol and invoke the name of your deity. Each beast or plant creature that can see you within 30 feet of you must make a Wisdom saving throw. If the creature fails its saving throw, it is [charmed](rules/5e/conditions.md#Charmed) by you for 1 minute or until it takes damage. While it is [charmed](rules/5e/conditions.md#Charmed) by you, it is friendly to you and other creatures you designate.
...
At 17th level, you gain the ability to command animals and plant creatures. While creatures are [charmed](rules/5e/conditions.md#Charmed) by your Charm Animals and Plants feature, you can take a bonus action on your turn to verbally command what each of those creatures will do on its next turn.