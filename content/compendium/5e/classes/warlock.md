...
> <tr class="class-progression"><th class"level">Level</th><th class"pb">PB</th><th class"feature">Features</th><th class="value"><a href="compendium/5e/lists/list-optfeaturetype-ei.md">Invocations</a></th><th class="value">Cantrips</th><th class="value">Prepared Spells</th><th class="value">Spell Slots</th><th class="value">Slot Level</th></tr>
> </thead><tbody>
...
- **Skill Proficiencies**: *Choose 2:* [Arcana](rules/5e/skills.md#Arcana), [Deception](rules/5e/skills.md#Deception), [History](rules/5e/skills.md#History), [Intimidation](rules/5e/skills.md#Intimidation), [Investigation](rules/5e/skills.md#Investigation), [Nature](rules/5e/skills.md#Nature), or [Religion](rules/5e/skills.md#Religion)
- **Weapon Proficiencies**: Simple weapons
- **Armor Training**: [Light armor](rules/5e/item-types.md#Light%20Armor)

**Starting Equipment:** *Choose A or B:* (A) [Leather Armor](compendium/5e/items/leather-armor.md), [Sickle](compendium/5e/items/sickle.md), 2 [Daggers](compendium/5e/items/dagger.md), [Arcane Focus](compendium/5e/items/arcane-focus.md) ([orb](compendium/5e/items/orb.md)), [Book](compendium/5e/items/book.md) (occult lore), [Scholar's Pack](compendium/5e/items/scholars-pack.md), and 15 GP; or (B) 100 GP
...
You have unearthed Eldritch Invocations, pieces of forbidden knowledge that imbue you with an abiding magical ability or other lessons. You gain one invocation of your choice, such as Pact of the Tome. Invocations are described in the "Eldritch Invocation Options^[Optional features from [Eldritch Invocation](compendium/5e/lists/list-optfeaturetype-ei.md); defined in Player's Handbook (2024)]" section later in this class's description.
...
You know two Warlock cantrips of your choice. [Eldritch Blast](compendium/5e/spells/eldritch-blast.md) and [Prestidigitation](compendium/5e/spells/prestidigitation.md) are recommended. Whenever you gain a Warlock level, you can replace one of your cantrips from this feature with another Warlock cantrip of your choice.

When you reach Warlock levels 4 and 10, you learn another Warlock cantrip of your choice, as shown in the Cantrips column of the Warlock Features table.

#### Spell Slots

The Warlock Features table shows how many spell slots you have to cast your Warlock spells of levels 1–5. The table also shows the level of those slots, all of which are the same level. You regain all expended Pact Magic spell slots when you finish a [Short](rules/5e/variant-rules/short-rest-xphb.md) or [Long Rest](rules/5e/variant-rules/long-rest-xphb.md).

For example, when you're a level 5 Warlock, you have two level 3 spell slots. To cast the level 1 spell [Witch Bolt](compendium/5e/spells/witch-bolt.md), you must spend one of those slots, and you cast it as a level 3 spell.

#### Prepared Spells of Level 1+

You prepare the list of level 1+ spells that are available for you to cast with this feature. To start, choose two level 1 Warlock spells. [Charm Person](compendium/5e/spells/charm-person.md) and [Hex](compendium/5e/spells/hex.md) are recommended.
...
You can use an [Arcane Focus](compendium/5e/items/arcane-focus.md) as a [Spellcasting Focus](rules/5e/variant-rules/spellcasting-focus-xphb.md) for your Warlock spells.
...
You can perform an esoteric rite for 1 minute. At the end of it, you regain expended Pact Magic spell slots but no more than a number equal to half your maximum (round up). Once you use this feature, you can't do so again until you finish a [Long Rest](rules/5e/variant-rules/long-rest-xphb.md).
...
You gain the [Ability Score Improvement](compendium/5e/feats/ability-score-improvement.md) feat or another feat of your choice for which you qualify. You gain this feature again at Warlock levels 8, 12, and 16.
...
Once you cast the spell with this feature, you can't do so in this way again until you finish a [Long Rest](rules/5e/variant-rules/long-rest-xphb.md).
...
You can cast your arcanum spell once without expending a spell slot, and you must finish a [Long Rest](rules/5e/variant-rules/long-rest-xphb.md) before you can cast it in this way again.

As shown in the Warlock Features table, you gain another Warlock spell of your choice that can be cast in this way when you reach Warlock levels 13 (level 7 spell), 15 (level 8 spell), and 17 (level 9 spell). You regain all uses of your Mystic Arcanum when you finish a [Long Rest](rules/5e/variant-rules/long-rest-xphb.md).
...
> ![Eldritch Invocation](compendium/5e/lists/list-optfeaturetype-ei.md#Eldritch%20Invocation)
^list-optfeature-ei