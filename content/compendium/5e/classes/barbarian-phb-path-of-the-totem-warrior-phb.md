...
- 5e/subclass/barbarian/totem-warrior
aliases:
- Path of the Totem Warrior
---
# Path of the Totem Warrior
*[Barbarian](./barbarian-phb.md): Primal Path*  
...
Yours is a path that seeks attunement with the natural world, giving you a kinship with beasts. At 3rd level when you adopt this path, you gain the ability to cast the [beast sense](compendium/5e/spells/beast-sense.md) and [speak with animals](compendium/5e/spells/speak-with-animals.md) spells, but only as rituals, as described in "chapter 10".
...
- **Eagle**  
    ...
    While you're raging and aren't wearing heavy armor, other creatures have disadvantage on opportunity attack rolls against you, and you can use the [Dash](rules/5e/actions.md#Dash) action as a bonus action on your turn. The spirit of the eagle makes you into a predator who can weave through the fray with ease.  
...
- **Eagle**  
    ...
    You gain the eyesight of an eagle. You can see up to 1 mile away with no difficulty, able to discern even fine details as though looking at something no more than 100 feet away from you. Additionally, dim light doesn't impose disadvantage on your Wisdom ([Perception](rules/5e/skills.md#Perception)) checks.  

- **Elk**  
    _Source: Sword Coast Adventurer's Guide p. 122_  

    Whether mounted or on foot, your travel pace is doubled, as is the travel pace of up to ten companions while they're within 60 feet of you and you're not [incapacitated](rules/5e/conditions.md#Incapacitated). The elk spirit helps you roam far and fast.  

- **Tiger**  
    _Source: Sword Coast Adventurer's Guide p. 122_  

    You gain proficiency in two skills from the following list: [Athletics](rules/5e/skills.md#Athletics), [Acrobatics](rules/5e/skills.md#Acrobatics), [Stealth](rules/5e/skills.md#Stealth), and [Survival](rules/5e/skills.md#Survival). The cat spirit hones your survival instincts.  
...
At 10th level, you can cast the [commune with nature](compendium/5e/spells/commune-with-nature.md) spell, but only as a ritual. When you do so, a spiritual version of one of the animals you chose for Totem Spirit or Aspect of the Beast appears to you to convey the information you seek.
...
- **Bear**  
    ...
    While you're raging, any creature within 5 feet of you that's hostile to you has disadvantage on attack rolls against targets other than you or another character with this feature. An enemy is immune to this effect if it can't see or hear you or if it can't be [frightened](rules/5e/conditions.md#Frightened).  
...
- **Elk**  
    ...
    While raging, you can use a bonus action during your move to pass through the space of a Large or smaller creature. That creature must succeed on a Strength saving throw (DC 8 + your Strength bonus + your proficiency bonus) or be knocked [prone](rules/5e/conditions.md#Prone) and take bludgeoning damage equal to `dice:1d12|noform|noparens|avg` (`d12`) + your Strength modifier.  
...
- **Wolf**  
    ...
    While you're raging, you can use a bonus action on your turn to knock a Large or smaller creature [prone](rules/5e/conditions.md#Prone) when you hit it with melee weapon attack.