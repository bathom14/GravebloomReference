...
- **Armor**: [light armor](rules/5e/item-types.md#Light%20Armor), [medium armor](rules/5e/item-types.md#Medium%20Armor), [shields](compendium/5e/items/shield-phb.md)
- **Weapons**: simple weapons, martial weapons
- **Tools**: none
- **Skills**: choose 3 from [Animal Handling](rules/5e/skills.md#Animal%20Handling), [Athletics](rules/5e/skills.md#Athletics), [Insight](rules/5e/skills.md#Insight), [Investigation](rules/5e/skills.md#Investigation), [Nature](rules/5e/skills.md#Nature), [Perception](rules/5e/skills.md#Perception), [Stealth](rules/5e/skills.md#Stealth), and [Survival](rules/5e/skills.md#Survival)

You start with the following items, plus anything provided by your background.

- (a) [scale mail](compendium/5e/items/scale-mail-phb.md) or (b) [leather armor](compendium/5e/items/leather-armor-phb.md)
- (a) two [shortswords](compendium/5e/items/shortsword-phb.md) or (b) two simple melee weapons
- (a) a [dungeoneer's pack](compendium/5e/items/dungeoneers-pack.md) or (b) an [explorer's pack](compendium/5e/items/explorers-pack.md)
- A [longbow](compendium/5e/items/longbow-phb.md) and a [quiver](compendium/5e/items/quiver.md) of [20 arrows](compendium/5e/items/arrows-20-phb.md)
...
- **Armor**: [light armor](rules/5e/item-types.md#Light%20Armor), [medium armor](rules/5e/item-types.md#Medium%20Armor), [shields](compendium/5e/items/shield-phb.md)
- **Weapons**: simple weapons, martial weapons
- **Skills**: choose 1 from [Animal Handling](rules/5e/skills.md#Animal%20Handling), [Athletics](rules/5e/skills.md#Athletics), [Insight](rules/5e/skills.md#Insight), [Investigation](rules/5e/skills.md#Investigation), [Nature](rules/5e/skills.md#Nature), [Perception](rules/5e/skills.md#Perception), [Stealth](rules/5e/skills.md#Stealth), and [Survival](rules/5e/skills.md#Survival)
...
You can make a ranger quickly by following these suggestions. First, make Dexterity your highest ability score, followed by Wisdom. (Some rangers who focus on two-weapon fighting make Strength higher than Dexterity.) Second, choose the [outlander](compendium/5e/backgrounds/outlander.md) background.
...
`dice: [](ranger-phb.md#^view-of-the-world)`
...
`dice: [](ranger-phb.md#^sworn-enemies)`
...
Choose a type of favored enemy: aberrations, beasts, celestials, constructs, dragons, elementals, fey, fiends, giants, monstrosities, oozes, plants, or undead. Alternatively, you can select two races of humanoid (such as [gnolls](compendium/5e/bestiary/fiend/gnoll-warrior.md) and [orcs](compendium/5e/bestiary/humanoid/tough.md)) as favored enemies.

You have advantage on Wisdom ([Survival](rules/5e/skills.md#Survival)) checks to track your favored enemies, as well as on Intelligence checks to recall information about them.
...
*1st-level ranger [optional feature](rules/5e/variant-rules/optional-class-features-tce.md), which replaces the Favored Enemy feature and works with the Foe Slayer feature*

When you hit a creature with an attack roll, you can call on your mystical bond with nature to mark the target as your favored enemy for 1 minute or until you lose your [concentration](rules/5e/conditions.md#Concentration) (as if you were [concentrating](rules/5e/conditions.md#Concentration) on a spell).
...
*1st-level ranger [optional feature](rules/5e/variant-rules/optional-class-features-tce.md), which replaces the Natural Explorer feature*
...
- [Archery](compendium/5e/feats/archery.md)  
- [Defense](compendium/5e/feats/defense.md)  
- [Dueling](compendium/5e/feats/dueling.md)  
- [Two-Weapon Fighting](compendium/5e/feats/two-weapon-fighting.md)  
...
For example, if you know the 1st-level spell [animal friendship](compendium/5e/spells/animal-friendship.md) and have a 1st-level and a 2nd-level spell slot available, you can cast [animal friendship](compendium/5e/spells/animal-friendship.md) using either slot.
...
*2nd-level ranger [optional feature](rules/5e/variant-rules/optional-class-features-tce.md)*

You can use a [druidic focus](compendium/5e/items/druidic-focus.md) as a spellcasting focus for your ranger spells. A druidic focus might be a sprig of mistletoe or holly, a wand or rod made of yew or another special wood, a staff drawn whole from a living tree, or an object incorporating feathers, fur, bones, and teeth from sacred animals.
...
*3rd-level ranger [optional feature](rules/5e/variant-rules/optional-class-features-tce.md), which replaces the Primeval Awareness feature*
...
| Ranger Level | Spell |
|--------------|-------|
| 3rd | [speak with animals](compendium/5e/spells/speak-with-animals.md) |
| 5th | [beast sense](compendium/5e/spells/beast-sense.md) |
| 9th | [speak with plants](compendium/5e/spells/speak-with-plants.md) |
| 13th | [locate creature](compendium/5e/spells/locate-creature.md) |
| 17th | [commune with nature](compendium/5e/spells/commune-with-nature.md) |
^primal-awareness-spells
...
*4th-level ranger [optional feature](rules/5e/variant-rules/optional-class-features-tce.md)*

Whenever you reach a level in this class that grants the Ability Score Improvement feature, you can replace a fighting style you know with another fighting style available to rangers. This replacement represents a shift of focus in your martial practice.

### Extra Attack (Level 5)

Beginning at 5th level, you can attack twice, instead of once, whenever you take the [Attack](rules/5e/actions.md#Attack) action on your turn.
...
In addition, you have advantage on saving throws against plants that are magically created or manipulated to impede movement, such as those created by the [entangle](compendium/5e/spells/entangle.md) spell.

### Hide in Plain Sight (Level 10)

Starting at 10th level, you can spend 1 minute creating camouflage for yourself. You must have access to fresh mud, dirt, plants, soot, and other naturally occurring materials with which to create your camouflage.

Once you are camouflaged in this way, you can try to hide by pressing yourself up against a solid surface, such as a tree or wall, that is at least as tall and wide as you are. You gain a +10 bonus to Dexterity ([Stealth](rules/5e/skills.md#Stealth)) checks as long as you remain there without moving or taking actions. Once you move or take an action or a reaction, you must camouflage yourself again to gain this benefit.

### Nature's Veil (Level 10)
_Source: Tasha's Cauldron of Everything p. 56_

*10th-level ranger [optional feature](rules/5e/variant-rules/optional-class-features-tce.md), which replaces the Hide in Plain Sight feature*

You draw on the powers of nature to hide yourself from view briefly. As a bonus action, you can magically become [invisible](rules/5e/conditions.md#Invisible), along with any equipment you are wearing or carrying, until the start of your next turn.
...
In addition, whenever you finish a short rest, your [exhaustion](rules/5e/conditions.md#Exhaustion) level, if any, is decreased by 1.
...
Starting at 14th level, you can use the [Hide](rules/5e/actions.md#Hide) action as a bonus action on your turn. Also, you can't be tracked by nonmagical means, unless you choose to leave a trail.
...
At 18th level, you gain preternatural senses that help you fight creatures you can't see. When you attack a creature you can't see, your inability to see it doesn't impose disadvantage on your attack rolls against it. You are also aware of the location of any [invisible](rules/5e/conditions.md#Invisible) creature within 30 feet of you, provided that the creature isn't hidden from you and you aren't [blinded](rules/5e/conditions.md#Blinded) or [deafened](rules/5e/conditions.md#Deafened).
...
> ![Fighting Style, Ranger](compendium/5e/lists/list-optfeaturetype-fs-r.md#Fighting%20Style,%20Ranger)
