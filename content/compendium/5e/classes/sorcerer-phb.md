...
- **Armor**: none
- **Weapons**: [daggers](compendium/5e/items/dagger-phb.md), [darts](compendium/5e/items/dart-phb.md), [slings](compendium/5e/items/sling-phb.md), [quarterstaffs](compendium/5e/items/quarterstaff-phb.md), [light crossbows](compendium/5e/items/light-crossbow-phb.md)
- **Tools**: none
- **Skills**: choose 2 from [Arcana](rules/5e/skills.md#Arcana), [Deception](rules/5e/skills.md#Deception), [Insight](rules/5e/skills.md#Insight), [Intimidation](rules/5e/skills.md#Intimidation), [Persuasion](rules/5e/skills.md#Persuasion), and [Religion](rules/5e/skills.md#Religion)

You start with the following items, plus anything provided by your background.

- (a) a [light crossbow](compendium/5e/items/light-crossbow-phb.md) and [20 bolts](compendium/5e/items/crossbow-bolts-20-phb.md) or (b) any simple weapon
- (a) a [component pouch](compendium/5e/items/component-pouch.md) or (b) an [arcane focus](compendium/5e/items/arcane-focus.md)
...
- Two [daggers](compendium/5e/items/dagger-phb.md)
...
You can make a sorcerer quickly by following these suggestions. First, Charisma should be your highest ability score, followed by Constitution. Second, choose the hermit background. Third, choose the [light](compendium/5e/spells/light.md), [prestidigitation](compendium/5e/spells/prestidigitation.md), [ray of frost](compendium/5e/spells/ray-of-frost.md), and [shocking grasp](compendium/5e/spells/shocking-grasp.md) cantrips, along with the 1st-level spells [shield](compendium/5e/spells/shield.md) and [magic missile](compendium/5e/spells/magic-missile.md).
...
`dice: [](sorcerer-phb.md#^arcane-origins)`
...
`dice: [](sorcerer-phb.md#^reactions)`
...
`dice: [](sorcerer-phb.md#^supernatural-marks)`
...
`dice: [](sorcerer-phb.md#^signs-of-sorcery)`
...
For example, if you know the 1st-level spell [burning hands](compendium/5e/spells/burning-hands.md) and have a 1st-level and a 2nd-level spell slot available, you can cast [burning hands](compendium/5e/spells/burning-hands.md) using either slot.
...
You can use an [arcane focus](compendium/5e/items/arcane-focus.md) as a spellcasting focus for your sorcerer spells.
...
- [Careful Spell](compendium/5e/optional-features/careful-spell-xphb.md)  
- [Distant Spell](compendium/5e/optional-features/distant-spell-xphb.md)  
- [Empowered Spell](compendium/5e/optional-features/empowered-spell-xphb.md)  
- [Extended Spell](compendium/5e/optional-features/extended-spell-xphb.md)  
- [Heightened Spell](compendium/5e/optional-features/heightened-spell-xphb.md)  
- [Quickened Spell](compendium/5e/optional-features/quickened-spell-xphb.md)  
- [Subtle Spell](compendium/5e/optional-features/subtle-spell-xphb.md)  
- [Twinned Spell](compendium/5e/optional-features/twinned-spell-xphb.md)  

### Metamagic Options (Level 3)
_Source: Tasha's Cauldron of Everything p. 65_

*3rd-level sorcerer [optional feature](rules/5e/variant-rules/optional-class-features-tce.md)*
...
*4th-level sorcerer [optional feature](rules/5e/variant-rules/optional-class-features-tce.md)*
...
- Replace one of the options you chose for the Metamagic feature with a different [Metamagic option](compendium/5e/lists/list-optfeaturetype-mm.md) available to you.  
...
*5th-level sorcerer [optional feature](rules/5e/variant-rules/optional-class-features-tce.md)*
