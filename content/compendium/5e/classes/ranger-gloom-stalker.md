...
- 5e/subclass/ranger/gloom-stalker
aliases:
- Gloom Stalker
---
# Gloom Stalker
...
At the start of your first turn of each combat, your [Speed](rules/5e/variant-rules/speed-xphb.md) increases by 10 feet until the end of that turn.
...
When you roll [Initiative](rules/5e/variant-rules/initiative-xphb.md), you can add your Wisdom modifier to the roll.
...
| Ranger Level | Spells |
|--------------|--------|
| 3rd | [Disguise Self](compendium/5e/spells/disguise-self.md) |
| 5th | [Rope Trick](compendium/5e/spells/rope-trick.md) |
| 9th | [Fear](compendium/5e/spells/fear.md) |
| 13th | [Greater Invisibility](compendium/5e/spells/greater-invisibility.md) |
| 17th | [Seeming](compendium/5e/spells/seeming.md) |
^gloom-stalker-spells

### Umbral Sight (Level 3)

You gain [Darkvision](rules/5e/senses.md#Darkvision) with a range of 60 feet. If you already have [Darkvision](rules/5e/senses.md#Darkvision) when you gain this feature, its range increases by 60 feet.

You are also adept at evading creatures that rely on [Darkvision](rules/5e/senses.md#Darkvision). While entirely in [Darkness](rules/5e/variant-rules/darkness-xphb.md), you have the [Invisible](rules/5e/conditions.md#Invisible) condition to any creature that relies on [Darkvision](rules/5e/senses.md#Darkvision) to see you in that [Darkness](rules/5e/variant-rules/darkness-xphb.md).
...
The target and each creature within 10 feet of it must make a Wisdom saving throw against your spell save DC. On a failed save, a creature has the [Frightened](rules/5e/conditions.md#Frightened) condition until the start of your next turn.

### Shadowy Dodge (Level 15)

When a creature makes an attack roll against you, you can take a [Reaction](rules/5e/variant-rules/reaction-xphb.md) to impose [Disadvantage](rules/5e/variant-rules/disadvantage-xphb.md) on that roll. Whether the attack hits or misses, you can then teleport up to 30 feet to an unoccupied space you can see.