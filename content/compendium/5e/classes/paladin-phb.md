...
- **Armor**: [light armor](rules/5e/item-types.md#Light%20Armor), [medium armor](rules/5e/item-types.md#Medium%20Armor), [heavy armor](rules/5e/item-types.md#Heavy%20Armor), [shields](compendium/5e/items/shield-phb.md)
- **Weapons**: simple weapons, martial weapons
- **Tools**: none
- **Skills**: choose 2 from [Athletics](rules/5e/skills.md#Athletics), [Insight](rules/5e/skills.md#Insight), [Intimidation](rules/5e/skills.md#Intimidation), [Medicine](rules/5e/skills.md#Medicine), [Persuasion](rules/5e/skills.md#Persuasion), and [Religion](rules/5e/skills.md#Religion)

You start with the following items, plus anything provided by your background.

- (a) a martial weapon and a [shield](compendium/5e/items/shield-phb.md) or (b) two martial weapons
- (a) five [javelins](compendium/5e/items/javelin-phb.md) or (b) any simple melee weapon
- (a) a [priest's pack](compendium/5e/items/priests-pack.md) or (b) an [explorer's pack](compendium/5e/items/explorers-pack.md)
- [Chain mail](compendium/5e/items/chain-mail-phb.md) and a [holy symbol](compendium/5e/items/holy-symbol.md)
...
You can make a paladin quickly by following these suggestions. First, Strength should be your highest ability score, followed by Charisma. Second, choose the [noble](compendium/5e/backgrounds/noble.md) background.
...
`dice: [](paladin-phb.md#^personal-goal)`
...
`dice: [](paladin-phb.md#^temptation)`
...
The presence of strong evil registers on your senses like a noxious odor, and powerful good rings like heavenly music in your ears. As an action, you can open your awareness to detect such forces. Until the end of your next turn, you know the location of any celestial, fiend, or undead within 60 feet of you that is not behind total cover. You know the type (celestial, fiend, or undead) of any being whose presence you sense, but not its identity (the vampire Count Strahd von Zarovich, for instance). Within the same radius, you also detect the presence of any place or object that has been consecrated or desecrated, as with the [hallow](compendium/5e/spells/hallow.md) spell.
...
- [Great Weapon Fighting](compendium/5e/feats/great-weapon-fighting.md)  
- [Protection](compendium/5e/feats/protection.md)  
...
You can use a [holy symbol](compendium/5e/items/holy-symbol.md) as a spellcasting focus for your paladin spells.
...
*3rd-level paladin [optional feature](rules/5e/variant-rules/optional-class-features-tce.md)*
...
*4th-level paladin [optional feature](rules/5e/variant-rules/optional-class-features-tce.md)*

Whenever you reach a level in this class that grants the Ability Score Improvement feature, you can replace a [fighting style](compendium/5e/lists/list-optfeaturetype-fs-p.md) you know with another fighting style available to paladins. This replacement represents a shift of focus in your martial practice.
...
Starting at 10th level, you and friendly creatures within 10 feet of you can't be [frightened](rules/5e/conditions.md#Frightened) while you are conscious.
...
> ![Fighting Style, Paladin](compendium/5e/lists/list-optfeaturetype-fs-p.md#Fighting%20Style,%20Paladin)
