...
- **Tools**: none
- **Skills**: Two skills of your choice from the following list: [Arcana](rules/5e/skills.md#Arcana), [History](rules/5e/skills.md#History), [Insight](rules/5e/skills.md#Insight), [Investigation](rules/5e/skills.md#Investigation), [Medicine](rules/5e/skills.md#Medicine), [Performance](rules/5e/skills.md#Performance), [Persuasion](rules/5e/skills.md#Persuasion), and [Religion](rules/5e/skills.md#Religion).
...
> [!note]
> Note: this class is intended for NPC [sidekicks](rules/5e/variant-rules/sidekicks-tce.md).
...
- **Mage.** [mage hand](compendium/5e/spells/mage-hand.md), [ray of frost](compendium/5e/spells/ray-of-frost.md), [thunderwave](compendium/5e/spells/thunderwave.md)  
- **Healer.** [cure wounds](compendium/5e/spells/cure-wounds.md), [guidance](compendium/5e/spells/guidance.md), [sacred flame](compendium/5e/spells/sacred-flame.md)  
- **Prodigy.** [eldritch blast](compendium/5e/spells/eldritch-blast.md), [healing word](compendium/5e/spells/healing-word.md), [light](compendium/5e/spells/light.md)  
...
The sidekick can use a focus for its spells depending on the choice you made on the Spellcasting table. A Mage can use an arcane focus, a Healer can use a holy symbol, and a Prodigy can use an arcane focus or a [musical instrument](compendium/5e/items/musical-instrument.md).
...
Taking damage can't break the sidekick's [concentration](rules/5e/conditions.md#Concentration) on a spell.