...
You gain proficiency in the [Insight](rules/5e/skills.md#Insight) and [Medicine](rules/5e/skills.md#Medicine) skills, and you gain proficiency with the [herbalism kit](compendium/5e/items/herbalism-kit.md).

You also gain a special mask, which you often wear when using the features of this subclass. You determine its appearance, or generate it randomly by rolling on the Merciful Mask table.

**Merciful Mask**

`dice: [](monk-phb-way-of-mercy-tce.md#^merciful-mask)`
...
When you use Hand of Healing on a creature, you can also end one disease or one of the following conditions affecting the creature: [blinded](rules/5e/conditions.md#Blinded), [deafened](rules/5e/conditions.md#Deafened), [paralyzed](rules/5e/conditions.md#Paralyzed), [poisoned](rules/5e/conditions.md#Poisoned), or [stunned](rules/5e/conditions.md#Stunned).

When you use Hand of Harm on a creature, you can subject that creature to the [poisoned](rules/5e/conditions.md#Poisoned) condition until the end of your next turn.
