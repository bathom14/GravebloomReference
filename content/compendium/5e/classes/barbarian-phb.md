...
- **Tools**: none
- **Skills**: choose 2 from [Animal Handling](rules/5e/skills.md#Animal%20Handling), [Athletics](rules/5e/skills.md#Athletics), [Intimidation](rules/5e/skills.md#Intimidation), [Nature](rules/5e/skills.md#Nature), [Perception](rules/5e/skills.md#Perception), and [Survival](rules/5e/skills.md#Survival)

You start with the following items, plus anything provided by your background.

- (a) a [greataxe](compendium/5e/items/greataxe-phb.md) or (b) any martial melee weapon
- (a) two [handaxes](compendium/5e/items/handaxe-phb.md) or (b) any simple weapon
- An [explorer's pack](compendium/5e/items/explorers-pack.md), and four [javelins](compendium/5e/items/javelin-phb.md)
...
- **Armor**: [shields](compendium/5e/items/shield-phb.md)
- **Weapons**: simple weapons, martial weapons
...
You can make a barbarian quickly by following these suggestions. First, put your highest ability score in Strength, followed by Constitution. Second, choose the [outlander](compendium/5e/backgrounds/outlander.md) background.
...
`dice: [](barbarian-phb.md#^personal-totems)`
...
`dice: [](barbarian-phb.md#^superstition)`
...
Your rage lasts for 1 minute. It ends early if you are knocked [unconscious](rules/5e/conditions.md#Unconscious) or if your turn ends and you haven't attacked a hostile creature since your last turn or taken damage since then. You can also end your rage on your turn as a bonus action.
...
At 2nd level, you gain an uncanny sense of when things nearby aren't as they should be, giving you an edge when you dodge away from danger. You have advantage on Dexterity saving throws against effects that you can see, such as traps and spells. To gain this benefit, you can't be [blinded](rules/5e/conditions.md#Blinded), [deafened](rules/5e/conditions.md#Deafened), or [incapacitated](rules/5e/conditions.md#Incapacitated).
...
*3rd-level barbarian [optional feature](rules/5e/variant-rules/optional-class-features-tce.md)*
...
Additionally, if you are [surprised](rules/5e/conditions.md#Surprised) at the beginning of combat and aren't [incapacitated](rules/5e/conditions.md#Incapacitated), you can act normally on your first turn, but only if you enter your rage before doing anything else on that turn.

### Instinctive Pounce (Level 7)
_Source: Tasha's Cauldron of Everything p. 24_

*7th-level barbarian [optional feature](rules/5e/variant-rules/optional-class-features-tce.md)*
...
Beginning at 15th level, your rage is so fierce that it ends early only if you fall [unconscious](rules/5e/conditions.md#Unconscious) or if you choose to end it.
