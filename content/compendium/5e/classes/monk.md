...
- **Skill Proficiencies**: *Choose 2:* [Acrobatics](rules/5e/skills.md#Acrobatics), [Athletics](rules/5e/skills.md#Athletics), [History](rules/5e/skills.md#History), [Insight](rules/5e/skills.md#Insight), [Religion](rules/5e/skills.md#Religion), or [Stealth](rules/5e/skills.md#Stealth)
- **Weapon Proficiencies**: Simple weapons and Martial weapons that have the Light property
- **Tool Proficiencies**: Choose one type of [Artisan's Tools](compendium/5e/items/artisans-tools.md) or [Musical Instrument](compendium/5e/items/musical-instrument.md)

**Starting Equipment:** *Choose A or B:* (A) [Spear](compendium/5e/items/spear.md), 5 [Daggers](compendium/5e/items/dagger.md), [Artisan's Tools](compendium/5e/items/artisans-tools.md) or [Musical Instrument](compendium/5e/items/musical-instrument.md) chosen for the tool proficiency above, [Explorer's Pack](compendium/5e/items/explorers-pack.md), and 11 GP; or (B) 50 GP
...
Your practice of martial arts gives you mastery of combat styles that use your [Unarmed Strike](rules/5e/variant-rules/unarmed-strike-xphb.md) and Monk weapons, which are the following:

- Simple Melee Weapons  
- Martial Melee Weapons that have the Light property  

You gain the following benefits while you are unarmed or wielding only Monk weapons and you aren't wearing armor or wielding a [Shield](compendium/5e/items/shield.md).

### Bonus Unarmed Strike (Level 1)

You can make an [Unarmed Strike](rules/5e/variant-rules/unarmed-strike-xphb.md) as a [Bonus Action](rules/5e/variant-rules/bonus-action-xphb.md).

### Martial Arts Die (Level 1)

You can roll `dice:1d6|noform|noparens|avg` (`d6`) in place of the normal damage of your [Unarmed Strike](rules/5e/variant-rules/unarmed-strike-xphb.md) or Monk weapons. This die changes as you gain Monk levels, as shown in the Martial Arts column of the Monk Features table.

### Dexterous Attacks (Level 1)

You can use your Dexterity modifier instead of your Strength modifier for the attack and damage rolls of your Unarmed Strikes and Monk weapons. In addition, when you use the Grapple or Shove option of your [Unarmed Strike](rules/5e/variant-rules/unarmed-strike-xphb.md), you can use your Dexterity modifier instead of your Strength modifier to determine the save DC.

### Unarmored Defense (Level 1)

While you aren't wearing armor or wielding a [Shield](compendium/5e/items/shield.md), your base [Armor Class](rules/5e/variant-rules/armor-class-xphb.md) equals 10 plus your Dexterity and Wisdom modifiers.
...
When you expend a Focus Point, it is unavailable until you finish a [Short](rules/5e/variant-rules/short-rest-xphb.md) or [Long Rest](rules/5e/variant-rules/long-rest-xphb.md), at the end of which you regain all your expended points.

Some features that use Focus Points require your target to make a saving throw. The save DC equals 8 plus your Wisdom modifier and [Proficiency Bonus](rules/5e/variant-rules/proficiency-xphb.md).

### Flurry of Blows (Level 2)

You can expend 1 Focus Point to make two Unarmed Strikes as a [Bonus Action](rules/5e/variant-rules/bonus-action-xphb.md).

### Patient Defense (Level 2)

You can take the [Disengage](rules/5e/actions.md#Disengage) action as a [Bonus Action](rules/5e/variant-rules/bonus-action-xphb.md). Alternatively, you can expend 1 Focus Point to take both the [Disengage](rules/5e/actions.md#Disengage) and the [Dodge](rules/5e/actions.md#Dodge) actions as a [Bonus Action](rules/5e/variant-rules/bonus-action-xphb.md).

### Step of the Wind (Level 2)

You can take the [Dash](rules/5e/actions.md#Dash) action as a [Bonus Action](rules/5e/variant-rules/bonus-action-xphb.md). Alternatively, you can expend 1 Focus Point to take both the [Disengage](rules/5e/actions.md#Disengage) and [Dash](rules/5e/actions.md#Dash) actions as a [Bonus Action](rules/5e/variant-rules/bonus-action-xphb.md), and your jump distance is doubled for the turn.

### Unarmored Movement (Level 2)

Your speed increases by 10 feet while you aren't wearing armor or wielding a [Shield](compendium/5e/items/shield.md). This bonus increases when you reach certain Monk levels, as shown on the Monk Features table.

### Uncanny Metabolism (Level 2)

When you roll [Initiative](rules/5e/variant-rules/initiative-xphb.md), you can regain all expended Focus Points. When you do so, roll your Martial Arts die, and regain a number of [Hit Points](rules/5e/variant-rules/hit-points-xphb.md) equal to your Monk level plus the number rolled.

Once you use this feature, you can't use it again until you finish a [Long Rest](rules/5e/variant-rules/long-rest-xphb.md).

### Deflect Attacks (Level 3)

When an attack roll hits you and its damage includes Bludgeoning, Piercing, or Slashing damage, you can take a [Reaction](rules/5e/variant-rules/reaction-xphb.md) to reduce the attack's total damage against you. The reduction equals `dice:1d10|noform|noparens|avg` (`d10`) plus your Dexterity modifier and Monk level.

If you reduce the damage to 0, you can expend 1 Focus Point to redirect some of the attack's force. If you do so, choose a creature you can see within 5 feet of yourself if the attack was a melee attack or a creature you can see within 60 feet of yourself that isn't behind [Total Cover](rules/5e/variant-rules/cover-xphb.md) if the attack was a ranged attack. That creature must succeed on a Dexterity saving throw or take damage equal to two rolls of your Martial Arts die plus your Dexterity modifier. The damage is the same type dealt by the attack.
...
You gain the [Ability Score Improvement](compendium/5e/feats/ability-score-improvement.md) feat or another feat of your choice for which you qualify. You gain this feature again at Monk levels 8, 12, and 16.

### Slow Fall (Level 4)

You can take a [Reaction](rules/5e/variant-rules/reaction-xphb.md) when you fall to reduce any damage you take from the fall by an amount equal to five times your Monk level.

### Extra Attack (Level 5)

You can attack twice instead of once whenever you take the [Attack](rules/5e/actions.md#Attack) action on your turn.

### Stunning Strike (Level 5)

Once per turn when you hit a creature with a Monk weapon or an [Unarmed Strike](rules/5e/variant-rules/unarmed-strike-xphb.md), you can expend 1 Focus Point to attempt a stunning strike. The target must make a Constitution saving throw. On a failed save, the target has the [Stunned](rules/5e/conditions.md#Stunned) condition until the start of your next turn. On a successful save, the target's [Speed](rules/5e/variant-rules/speed-xphb.md) is halved until the start of your next turn, and the next attack roll made against the target before then has [Advantage](rules/5e/variant-rules/advantage-xphb.md).

### Empowered Strikes (Level 6)

Whenever you deal damage with your [Unarmed Strike](rules/5e/variant-rules/unarmed-strike-xphb.md), it can deal your choice of Force damage or its normal damage type.
...
You don't benefit from this feature if you have the [Incapacitated](rules/5e/conditions.md#Incapacitated) condition.

### Ability Score Improvement (Level 8)

You gain the [Ability Score Improvement](compendium/5e/feats/ability-score-improvement.md) feat or another feat of your choice for which you qualify.

### Acrobatic Movement (Level 9)

While you aren't wearing armor or wielding a [Shield](compendium/5e/items/shield.md), you gain the ability to move along vertical surfaces and across liquids on your turn without falling during the movement.
...
When you expend a Focus Point to use Patient Defense, you gain a number of [Temporary Hit Points](rules/5e/variant-rules/temporary-hit-points-xphb.md) equal to two rolls of your Martial Arts die.

#### Step of the Wind

When you expend a Focus Point to use Step of the Wind, you can choose a willing creature within 5 feet of yourself that is Large or smaller. You move the creature with you until the end of your turn. The creature's movement doesn't provoke [Opportunity Attacks](rules/5e/actions.md#Opportunity%20Attack).

### Self-Restoration (Level 10)

Through sheer force of will, you can remove one of the following conditions from yourself at the end of each of your turns: [Charmed](rules/5e/conditions.md#Charmed), [Frightened](rules/5e/conditions.md#Frightened), or [Poisoned](rules/5e/conditions.md#Poisoned).

In addition, forgoing food and drink doesn't give you levels of [Exhaustion](rules/5e/conditions.md#Exhaustion).
...
When you roll [Initiative](rules/5e/variant-rules/initiative-xphb.md) and don't use Uncanny Metabolism, you regain expended Focus Points until you have 4 if you have 3 or fewer.
...
At the start of your turn, you can expend 3 Focus Points to bolster yourself against harm for 1 minute or until you have the [Incapacitated](rules/5e/conditions.md#Incapacitated) condition. During that time, you have [Resistance](rules/5e/variant-rules/resistance-xphb.md) to all damage except Force damage.

### Epic Boon (Level 19)

You gain an Epic Boon feat or another feat of your choice for which you qualify. [Boon of Irresistible Offense](compendium/5e/feats/boon-of-irresistible-offense.md) is recommended.
