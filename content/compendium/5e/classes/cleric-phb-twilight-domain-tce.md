...
| [Yondalla](compendium/5e/deities/nonhuman-yondalla.md) | Halfling |
^twilight-deities
...
| Cleric Level | Spells |
|--------------|--------|
| 1st | [faerie fire](compendium/5e/spells/faerie-fire.md), [sleep](compendium/5e/spells/sleep.md) |
| 3rd | [moonbeam](compendium/5e/spells/moonbeam.md), [see invisibility](compendium/5e/spells/see-invisibility.md) |
| 5th | [aura of vitality](compendium/5e/spells/aura-of-vitality.md), [Leomund's tiny hut](compendium/5e/spells/leomunds-tiny-hut.md) |
| 7th | [aura of life](compendium/5e/spells/aura-of-life.md), [greater invisibility](compendium/5e/spells/greater-invisibility.md) |
| 9th | [circle of power](compendium/5e/spells/circle-of-power.md), [mislead](compendium/5e/spells/mislead.md) |
^twilight-domain-spells
...
You can see through the deepest gloom. You have [darkvision](rules/5e/senses.md#Darkvision) out to a range of 300 feet. In that radius, you can see in dim light as if it were bright light and in darkness as if it were dim light.

As an action, you can magically share the [darkvision](rules/5e/senses.md#Darkvision) of this feature with willing creatures you can see within 10 feet of you, up to a number of creatures equal to your Wisdom modifier (minimum of one creature). The shared [darkvision](rules/5e/senses.md#Darkvision) lasts for 1 hour. Once you share it, you can't do so again until you finish a long rest, unless you expend a spell slot of any level to share it again.
...
As an action, you present your holy symbol, and a sphere of twilight emanates from you. The sphere is centered on you, has a 30-foot radius, and is filled with dim light. The sphere moves with you, and it lasts for 1 minute or until you are [incapacitated](rules/5e/conditions.md#Incapacitated) or die. Whenever a creature (including you) ends its turn in the sphere, you can grant that creature one of these benefits:

- You grant it temporary hit points equal to `dice:1d6|noform|noparens|avg` (`d6`) plus your cleric level.  
- You end one effect on it causing it to be [charmed](rules/5e/conditions.md#Charmed) or [frightened](rules/5e/conditions.md#Frightened).  
...
*8th-level cleric [optional feature](rules/5e/variant-rules/optional-class-features-tce.md), which replaces the Divine Strike feature*
