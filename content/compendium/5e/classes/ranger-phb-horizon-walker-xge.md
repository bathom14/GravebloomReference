...
- 5e/subclass/ranger/horizon-walker
aliases:
- Horizon Walker
---
# Horizon Walker
...
| Ranger Level | Spells |
|--------------|--------|
| 3rd | [protection from evil and good](compendium/5e/spells/protection-from-evil-and-good.md) |
| 5th | [misty step](compendium/5e/spells/misty-step.md) |
| 9th | [haste](compendium/5e/spells/haste.md) |
| 13th | [banishment](compendium/5e/spells/banishment.md) |
| 17th | [teleportation circle](compendium/5e/spells/teleportation-circle.md) |
^horizon-walker-spells
...
At 7th level, you learn to step through the Ethereal Plane. As a bonus action, you can cast the [etherealness](compendium/5e/spells/etherealness.md) spell with this feature, without expending a spell slot, but the spell ends at the end of the current turn.

Once you use this feature, you can't use it again until you finish a short or long rest.

### Distant Strike (Level 11)

At 11th level, you gain the ability to pass between the planes in the blink of an eye. When you take the [Attack](rules/5e/actions.md#Attack) action, you can teleport up to 10 feet before each attack to an unoccupied space you can see.
