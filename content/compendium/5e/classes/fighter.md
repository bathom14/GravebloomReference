...
- **Skill Proficiencies**: *Choose 2:* [Acrobatics](rules/5e/skills.md#Acrobatics), [Animal Handling](rules/5e/skills.md#Animal%20Handling), [Athletics](rules/5e/skills.md#Athletics), [History](rules/5e/skills.md#History), [Insight](rules/5e/skills.md#Insight), [Intimidation](rules/5e/skills.md#Intimidation), [Perception](rules/5e/skills.md#Perception), [Persuasion](rules/5e/skills.md#Persuasion), or [Survival](rules/5e/skills.md#Survival)
...
**Starting Equipment:** *Choose A, B, or C:* (A) [Chain Mail](compendium/5e/items/chain-mail.md), [Greatsword](compendium/5e/items/greatsword.md), [Flail](compendium/5e/items/flail.md), 8 [Javelins](compendium/5e/items/javelin.md), [Dungeoneer's Pack](compendium/5e/items/dungeoneers-pack.md), and 4 GP; (B) [Studded Leather Armor](compendium/5e/items/studded-leather-armor.md), [Scimitar](compendium/5e/items/scimitar.md), [Shortsword](compendium/5e/items/shortsword.md), [Longbow](compendium/5e/items/longbow.md), [20 Arrows](compendium/5e/items/arrows-20.md), [Quiver](compendium/5e/items/quiver.md), [Dungeoneer's Pack](compendium/5e/items/dungeoneers-pack.md), and 11 GP; or (C) 155 GP
...
You have honed your martial prowess and gain a Fighting Style feat of your choice. [Defense](compendium/5e/feats/defense.md) is recommended.

Whenever you gain a Fighter level, you can replace the feat you chose with a different Fighting Style feat.

### Second Wind (Level 1)

You have a limited well of physical and mental stamina that you can draw on. As a [Bonus Action](rules/5e/variant-rules/bonus-action-xphb.md), you can use it to regain [Hit Points](rules/5e/variant-rules/hit-points-xphb.md) equal to `dice:1d10|noform|noparens|avg` (`d10`) plus your Fighter level.

You can use this feature twice. You regain one expended use when you finish a [Short Rest](rules/5e/variant-rules/short-rest-xphb.md), and you regain all expended uses when you finish a [Long Rest](rules/5e/variant-rules/long-rest-xphb.md).

When you reach certain Fighter levels, you gain more uses of this feature, as shown in the Second Wind column of the Fighter Features table.

### Weapon Mastery (Level 1)

Your training with weapons allows you to use the [mastery properties](rules/5e/variant-rules/weapon-mastery-properties-xphb.md) of three kinds of Simple or Martial weapons of your choice. Whenever you finish a [Long Rest](rules/5e/variant-rules/long-rest-xphb.md), you can practice weapon drills and change one of those weapon choices.

When you reach certain Fighter levels, you gain the ability to use the [mastery properties](rules/5e/variant-rules/weapon-mastery-properties-xphb.md) of more kinds of weapons, as shown in the [Weapon](rules/5e/variant-rules/weapon-xphb.md) Mastery column of the Fighter Features table.

### Action Surge (Level 2)

You can push yourself beyond your normal limits for a moment. On your turn, you can take one additional action, except the [Magic](rules/5e/actions.md#Magic) action.

Once you use this feature, you can't do so again until you finish a [Short](rules/5e/variant-rules/short-rest-xphb.md) or [Long Rest](rules/5e/variant-rules/long-rest-xphb.md). Starting at level 17, you can use it twice before a rest but only once on a turn.

### Tactical Mind (Level 2)

You have a mind for tactics on and off the battlefield. When you fail an ability check, you can expend a use of your Second Wind to push yourself toward success. Rather than regaining [Hit Points](rules/5e/variant-rules/hit-points-xphb.md), you roll `dice:1d10|noform|noparens|avg` (`d10`) and add the number rolled to the ability check, potentially turning it into a success. If the check still fails, this use of Second Wind isn't expended.
...
You gain the [Ability Score Improvement](compendium/5e/feats/ability-score-improvement.md) feat or another feat of your choice for which you qualify. You gain this feature again at Fighter levels 6, 8, 12, 14, and 16.
...
Whenever you activate your Second Wind with a [Bonus Action](rules/5e/variant-rules/bonus-action-xphb.md), you can move up to half your [Speed](rules/5e/variant-rules/speed-xphb.md) without provoking [Opportunity Attacks](rules/5e/actions.md#Opportunity%20Attack).
...
If you fail a saving throw, you can reroll it with a bonus equal to your Fighter level. You must use the new roll, and you can't use this feature again until you finish a [Long Rest](rules/5e/variant-rules/long-rest-xphb.md).

You can use this feature twice before a [Long Rest](rules/5e/variant-rules/long-rest-xphb.md) starting at level 13 and three times before a [Long Rest](rules/5e/variant-rules/long-rest-xphb.md) starting at level 17.

### Tactical Master (Level 9)

When you attack with a weapon whose mastery property you can use, you can replace that property with the [Push](rules/5e/item-mastery.md#Push), [Sap](rules/5e/item-mastery.md#Sap), or [Slow](rules/5e/item-mastery.md#Slow) property for that attack.
...
You can attack three times instead of once whenever you take the [Attack](rules/5e/actions.md#Attack) action on your turn.
...
You study your opponents and learn from each attack you make. If you make an attack roll against a creature and miss, you have [Advantage](rules/5e/variant-rules/advantage-xphb.md) on your next attack roll against that creature before the end of your next turn.
...
You gain an Epic Boon feat or another feat of your choice for which you qualify. [Boon of Combat Prowess](compendium/5e/feats/boon-of-combat-prowess.md) is recommended.

### Three Extra Attacks (Level 20)

You can attack four times instead of once whenever you take the [Attack](rules/5e/actions.md#Attack) action on your turn.