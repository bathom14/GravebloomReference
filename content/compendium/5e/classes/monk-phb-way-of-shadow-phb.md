...
You can use your ki to duplicate the effects of certain spells. As an action, you can spend 2 ki points to cast [darkness](compendium/5e/spells/darkness.md), [darkvision](compendium/5e/spells/darkvision.md), [pass without trace](compendium/5e/spells/pass-without-trace.md), or [silence](compendium/5e/spells/silence.md), without providing material components. Additionally, you gain the [minor illusion](compendium/5e/spells/minor-illusion.md) cantrip if you don't already know it.
...
By 11th level, you have learned to become one with the shadows. When you are in an area of dim light or darkness, you can use your action to become [invisible](rules/5e/conditions.md#Invisible). You remain [invisible](rules/5e/conditions.md#Invisible) until you make an attack, cast a spell, or are in an area of bright light.
