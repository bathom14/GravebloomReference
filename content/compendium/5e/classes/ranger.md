...
- **Skill Proficiencies**: *Choose 3:* [Animal Handling](rules/5e/skills.md#Animal%20Handling), [Athletics](rules/5e/skills.md#Athletics), [Insight](rules/5e/skills.md#Insight), [Investigation](rules/5e/skills.md#Investigation), [Nature](rules/5e/skills.md#Nature), [Perception](rules/5e/skills.md#Perception), [Stealth](rules/5e/skills.md#Stealth), or [Survival](rules/5e/skills.md#Survival)
...
**Starting Equipment:** *Choose A or B:* (A) [Studded Leather Armor](compendium/5e/items/studded-leather-armor.md), [Scimitar](compendium/5e/items/scimitar.md), [Shortsword](compendium/5e/items/shortsword.md), [Longbow](compendium/5e/items/longbow.md), [20 Arrows](compendium/5e/items/arrows-20.md), [Quiver](compendium/5e/items/quiver.md), [Druidic Focus](compendium/5e/items/druidic-focus.md) ([sprig of mistletoe](compendium/5e/items/sprig-of-mistletoe.md)), [Explorer's Pack](compendium/5e/items/explorers-pack.md), and 7 GP; or (B) 150 GP

## Multiclassing Ranger

- **Skill Proficiencies**: *Choose 1:* [Animal Handling](rules/5e/skills.md#Animal%20Handling), [Athletics](rules/5e/skills.md#Athletics), [Insight](rules/5e/skills.md#Insight), [Investigation](rules/5e/skills.md#Investigation), [Nature](rules/5e/skills.md#Nature), [Perception](rules/5e/skills.md#Perception), [Stealth](rules/5e/skills.md#Stealth), or [Survival](rules/5e/skills.md#Survival)
...
The Ranger Features table shows how many spell slots you have to cast your level 1+ spells. You regain all expended slots when you finish a [Long Rest](rules/5e/variant-rules/long-rest-xphb.md).

#### Prepared Spells of Level 1+

You prepare the list of level 1+ spells that are available for you to cast with this feature. To start, choose two level 1 Ranger spells. [Cure Wounds](compendium/5e/spells/cure-wounds.md) and [Ensnaring Strike](compendium/5e/spells/ensnaring-strike.md) are recommended.
...
Whenever you finish a [Long Rest](rules/5e/variant-rules/long-rest-xphb.md), you can replace one spell on your list with another Ranger spell for which you have spell slots.
...
You can use a [Druidic Focus](compendium/5e/items/druidic-focus.md) as a [Spellcasting Focus](rules/5e/variant-rules/spellcasting-focus-xphb.md) for your Ranger spells.

### Favored Enemy (Level 1)

You always have the [Hunter's Mark](compendium/5e/spells/hunters-mark.md) spell prepared. You can cast it twice without expending a spell slot, and you regain all expended uses of this ability when you finish a [Long Rest](rules/5e/variant-rules/long-rest-xphb.md).

The number of times you can cast the spell without a spell slot increases when you reach certain Ranger levels, as shown in the Favored Enemy column of the Ranger Features table.

### Weapon Mastery (Level 1)

Your training with weapons allows you to use the [mastery properties](rules/5e/variant-rules/weapon-mastery-properties-xphb.md) of two kinds of weapons of your choice with which you have proficiency, such as [Longbows](compendium/5e/items/longbow.md) and [Shortswords](compendium/5e/items/shortsword.md).

Whenever you finish a [Long Rest](rules/5e/variant-rules/long-rest-xphb.md), you can change the kinds of weapons you chose. For example, you could switch to using the [mastery properties](rules/5e/variant-rules/weapon-mastery-properties-xphb.md) of [Scimitars](compendium/5e/items/scimitar.md) and [Longswords](compendium/5e/items/longsword.md).
...
Choose one of your skill proficiencies with which you lack [Expertise](rules/5e/variant-rules/expertise-xphb.md). You gain [Expertise](rules/5e/variant-rules/expertise-xphb.md) in that skill.
...
You gain the [Ability Score Improvement](compendium/5e/feats/ability-score-improvement.md) feat or another feat of your choice for which you qualify. You gain this feature again at Ranger levels 8, 12, and 16.
...
Your [Speed](rules/5e/variant-rules/speed-xphb.md) increases by 10 feet while you aren't wearing Heavy armor. You also have a [Climb Speed](rules/5e/variant-rules/climb-speed-xphb.md) and a [Swim Speed](rules/5e/variant-rules/swim-speed-xphb.md) equal to your [Speed](rules/5e/variant-rules/speed-xphb.md).
...
Choose two of your skill proficiencies with which you lack [Expertise](rules/5e/variant-rules/expertise-xphb.md). You gain [Expertise](rules/5e/variant-rules/expertise-xphb.md) in those skills.
...
As a [Magic](rules/5e/actions.md#Magic) action, you can give yourself a number of [Temporary Hit Points](rules/5e/variant-rules/temporary-hit-points-xphb.md) equal to `dice:1d8|noform|noparens|avg` (`d8`) plus your Wisdom modifier (minimum of 1). You can use this action a number of times equal to your Wisdom modifier (minimum of once), and you regain all expended uses when you finish a [Long Rest](rules/5e/variant-rules/long-rest-xphb.md).

#### Decrease Exhaustion

Whenever you finish a [Short Rest](rules/5e/variant-rules/short-rest-xphb.md), your [Exhaustion](rules/5e/conditions.md#Exhaustion) level, if any, decreases by 1.
...
Taking damage can't break your [Concentration](rules/5e/conditions.md#Concentration) on Hunter's Mark.

### Nature's Veil (Level 14)

You invoke spirits of nature to magically hide yourself. As a [Bonus Action](rules/5e/variant-rules/bonus-action-xphb.md), you can give yourself the [Invisible](rules/5e/conditions.md#Invisible) condition until the end of your next turn.

You can use this feature a number of times equal to your Wisdom modifier (minimum of once), and you regain all expended uses when you finish a [Long Rest](rules/5e/variant-rules/long-rest-xphb.md).
...
You have [Advantage](rules/5e/variant-rules/advantage-xphb.md) on attack rolls against the creature currently marked by your Hunter's Mark.

### Feral Senses (Level 18)

Your connection to the forces of nature grants you [Blindsight](rules/5e/senses.md#Blindsight) with a range of 30 feet.
