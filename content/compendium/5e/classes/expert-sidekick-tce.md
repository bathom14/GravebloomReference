...
The sidekick is adept at giving well-timed assistance; the sidekick can take the [Help](rules/5e/actions.md#Help) action as a bonus action.

### Cunning Action (Level 2)

*2nd-level Expert feature*

The sidekick's agility or quick thinking allows it to act speedily. On its turn in combat, it can take the [Dash](rules/5e/actions.md#Dash), [Disengage](rules/5e/actions.md#Disengage), or [Hide](rules/5e/actions.md#Hide) action as a bonus action.
