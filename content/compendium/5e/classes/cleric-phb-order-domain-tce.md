...
The Order Domain represents discipline, as well as devotion to a society or an institution and strict obedience to the laws governing it. On Ravnica, the domain is favored by clerics of the Azorius Senate, who use it to maintain and enforce the law, and of the Orzhov Syndicate, who exploit law and order for their personal gain. On other worlds, gods who grant access to this domain include Bane, Tyr, Majere, [Erathis](compendium/5e/deities/dawn-war-erathis-dmg.md), Pholtus, Wee Jas, Aureon, [Maglubiyet](compendium/5e/deities/nonhuman-maglubiyet.md), [Nuada](compendium/5e/deities/celtic-nuada.md), [Athena](compendium/5e/deities/greek-athena.md), [Anubis](compendium/5e/deities/egyptian-anubis.md), [Forseti](compendium/5e/deities/norse-forseti.md), and [Asmodeus](compendium/5e/deities/dawn-war-asmodeus-dmg.md).
...
| Cleric Level | Spells |
|--------------|--------|
| 1st | [command](compendium/5e/spells/command.md), [heroism](compendium/5e/spells/heroism.md) |
| 3rd | [hold person](compendium/5e/spells/hold-person.md), [zone of truth](compendium/5e/spells/zone-of-truth.md) |
| 5th | [mass healing word](compendium/5e/spells/mass-healing-word.md), [slow](compendium/5e/spells/slow.md) |
| 7th | [compulsion](compendium/5e/spells/compulsion.md), [locate creature](compendium/5e/spells/locate-creature.md) |
| 9th | [commune](compendium/5e/spells/commune.md), [dominate person](compendium/5e/spells/dominate-person.md) |
^order-domain-spells

### Bonus Proficiencies (Level 1)

When you choose this domain at 1st level, you gain proficiency with heavy armor. You also gain proficiency in the [Intimidation](rules/5e/skills.md#Intimidation) or [Persuasion](rules/5e/skills.md#Persuasion) skill (your choice).
...
As an action, you present your holy symbol, and each creature of your choice that can see or hear you within 30 feet of you must succeed on a Wisdom saving throw or be [charmed](rules/5e/conditions.md#Charmed) by you until the end of your next turn or until the [charmed](rules/5e/conditions.md#Charmed) creature takes any damage. You can also cause any of the [charmed](rules/5e/conditions.md#Charmed) creatures to drop what they are holding when they fail the saving throw.
