...
*Use this column for [Cylinders](rules/5e/variant-rules/cylinder-area-of-effect-xphb.md), [Emanations](rules/5e/variant-rules/emanation-area-of-effect-xphb.md) (using the size of the Emanation rather than its radius), and [Spheres](rules/5e/variant-rules/sphere-area-of-effect-xphb.md).