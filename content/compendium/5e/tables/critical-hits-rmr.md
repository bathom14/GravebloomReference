...
| 6 | You take `dice:1d12\|noform\|noparens\|avg` (`d12`) force damage. Describe in excruciating detail what you did to earn this embarrassing injury. |
| 7 | You get a paper cut. If you fail a DC 16 Constitution saving throw, you lose `dice:1d6\|noform\|noparens\|avg` (`d6`) hit points from blood loss at the start of each of your turns for the next `dice:1d6\|noform\|noparens\|avg` (`d6`) rounds. |
| 8 | The weapon or item you were using when you made this crappy roll catches on fire. Throw it away or take `dice:2d10\|noform\|noparens\|avg` (`2d10`) fire damage while it smolders. |
| 9 | Whatever you were doing when this roll took place just became a comedic pratfall that hits you in the junk. Take `dice:2d6\|noform\|noparens\|avg` (`2d6`) bludgeoning damage, and if you had a point of Inspiration, it's now gone. |
