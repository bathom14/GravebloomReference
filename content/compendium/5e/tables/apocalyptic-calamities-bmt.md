...
| dice: d12 | Calamity |
|-----------|----------|
| 1 | The [tarrasque](compendium/5e/bestiary/monstrosity/tarrasque.md) awakens. (A [kraken](compendium/5e/bestiary/monstrosity/kraken.md), an [empyrean](compendium/5e/bestiary/miscellaneous/empyrean.md), or another titan might also serve as an agent of apocalyptic wrath.) |
...
| 10 | Magic goes awry, creating random zones of wild magic (where casting any spell of 1st level or higher causes a roll on the [Wild Magic Surge table](compendium/5e/tables/wild-magic-surge-phb.md) in the "Player's Handbook") and dead magic (like an [Antimagic Field](compendium/5e/spells/antimagic-field.md) spell on a larger scale). |
