...
|----------|----------------|
| 1 | A [medusa](compendium/5e/bestiary/monstrosity/medusa.md) sends authorities a broken stone finger bearing a distinctive signet ring, and invites emissaries to bring gold, a magic item, or some other ransom for the [petrified](rules/5e/conditions.md#Petrified) individual's release. |
...
| 6 | An [ogre](compendium/5e/bestiary/giant/ogre.md) warlord is accused of destroying a village just outside the borders of Droaam. The characters must bring the warlord to justice or work with the ogre to find the real culprit. |
^droaam-adventure-hooks