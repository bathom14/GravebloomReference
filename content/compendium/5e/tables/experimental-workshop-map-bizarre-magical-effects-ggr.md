...
| dice: d6 | Effect |
|----------|--------|
| 1 | Every spell cast in the area triggers a wild magic surge. (Roll on the [Wild Magic Surge](compendium/5e/tables/wild-magic-surge-phb.md) table in the "Sorcerer" section of the *Player's Handbook*.) |
...
| 3 | The area is affected by a [guards and wards](compendium/5e/spells/guards-and-wards.md)*spell*. |
...
| 6 | Random sections of the area are affected by an [antimagic field](compendium/5e/spells/antimagic-field.md) spell. |
^bizarre-magical-effects