...
| 7 | There is no sound here. This area is permanently under the effects of the [silence](compendium/5e/spells/silence.md) spell. |
| 8 | This place is supernaturally unlucky. Attack rolls, ability checks, and saving throws cannot be rerolled in this area. |
| 9 | Water turns to acid here. Water introduced to this area becomes acid in `dice:1d4\|noform\|noparens\|avg` (`d4`) days. |
