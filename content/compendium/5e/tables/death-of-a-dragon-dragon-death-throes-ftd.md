...
| 4 | Roll on the [Wild Magic Surge](compendium/5e/tables/wild-magic-surge-phb.md) table in the "[Sorcerer](compendium/5e/classes/sorcerer-phb.md)" section of the "Player's Handbook", rerolling any inappropriate result. |
