...
| 2 | **Light Sensitivity**. A creature of the night sky, the Nyxborn has disadvantage on attack rolls, as well as on Wisdom ([Perception](rules/5e/skills.md#Perception)) checks that rely on sight, while it is in bright light. |
...
| 5 | **Nyx Step**. The Nyxborn can move through other creatures and objects as if they were difficult terrain. It takes `dice:1d10\|noform\|noparens\|avg\|text(5)` (`d10`) force damage if it ends its turn inside an object. |
