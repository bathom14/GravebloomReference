...
| 4 | Cryptic Skin. The krasis can change color to match its surroundings. It has advantage on Dexterity ([Stealth](rules/5e/skills.md#Stealth)) checks made to hide. |
| 5 | Heightened Awareness. The krasis can't be [surprised](rules/5e/conditions.md#Surprised), as a result of having sensitive barbels like a catfish, stereoscopic vision like a chameleon, a tongue like a snake, eye stalks like a lobster, or an array of several eyes. |
...
| 8 | Stabilizing Legs. The krasis has several crablike legs. As a result, it has advantage on Strength and Dexterity saving throws made against effects that would knock it [prone](rules/5e/conditions.md#Prone). |
^minor-adaptations