...
| 2 | Multiple [category 3 krasis](compendium/5e/bestiary/monstrosity/category-3-krasis-ggr.md) under no one's control emerge from canals throughout the city. |
...
| 5 | A sage of the Gyre Clade accidentally creates an [antimagic field](compendium/5e/spells/antimagic-field.md) that slowly spreads over the neighborhood. |
