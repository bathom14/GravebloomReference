...
| [Raei](compendium/5e/deities/exandria-raei.md) | NG | Atonement, compassion | Life, Light | Humanoid, feminine phoenix |
...
* The [Order domain](compendium/5e/classes/cleric-phb-order-domain-tce.md) appears in "Guildmaster's Guide to Ravnica".

** The [Arcana domain](compendium/5e/classes/cleric-phb-arcana-domain-scag.md) appears in "Sword Coast Adventurer's Guide".

*** The [Forge](compendium/5e/classes/cleric-phb-forge-domain-xge.md) and [Grave](compendium/5e/classes/cleric-phb-grave-domain-xge.md) domains appear in "Xanathar's Guide to Everything".