...
- **Skills** [Perception](rules/5e/skills.md#Perception) +6, [Stealth](rules/5e/skills.md#Stealth) +13
...
***Burnished Blade.*** *Melee Weapon Attack:* `dice:1d20+9|noform|noparens|text(+9)` to hit, reach 5 ft., one target. *Hit:* `dice:1d6+5|noform|noparens|avg|text(8)` (`1d6 + 5`) piercing damage plus `dice:2d12|noform|noparens|avg|text(13)` (`2d12`) psychic damage.

***Bolt.*** *Ranged Weapon Attack:* `dice:1d20+9|noform|noparens|text(+9)` to hit, range 20/60 ft., one target. *Hit:* `dice:1d4+5|noform|noparens|avg|text(7)` (`1d4 + 5`) piercing damage plus `dice:2d12|noform|noparens|avg|text(13)` (`2d12`) psychic damage.
...
**1/day each:** [alter self](compendium/5e/spells/alter-self.md), [fog cloud](compendium/5e/spells/fog-cloud.md), [silence](compendium/5e/spells/silence.md)
