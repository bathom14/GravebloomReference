...
Death comes for all things in their time. It is the will of the [Matron of Ravens](compendium/5e/deities/exandria-the-matron-of-ravens-tdcsr.md) that no being, no matter how heroic or how powerful, shall escape their rightful place in the hereafter. Yet when his sister [Vex'ahlia](compendium/5e/bestiary/humanoid/vexahlia-tdcsr.md) died in a sunken "Issylran" tomb, Vax'ildan demanded that the goddess of death release her claim on [Vex'ahlia's](compendium/5e/bestiary/humanoid/vexahlia-tdcsr.md) soul—and claim his instead.

Inscrutably, the [Matron of Ravens](compendium/5e/deities/exandria-the-matron-of-ravens-tdcsr.md) acquiesced to Vax'ildan's demand. He donned the [Deathwalker's Ward](compendium/5e/items/deathwalkers-ward-tdcsr.md), a "Vestige of Divergence" imbued with the [Matron of Ravens'](compendium/5e/deities/exandria-the-matron-of-ravens-tdcsr.md) power, and the legendary armor of her previous mortal champion. In time, Vax'ildan too came to be called her champion, and returned to life from death more than once—even enduring utter annihilation by [The Whispered One](compendium/5e/deities/exandria-the-whispered-one-tdcsr.md) and strangulation by an Archfey. All these deaths were permissible for the [Matron of Ravens'](compendium/5e/deities/exandria-the-matron-of-ravens-tdcsr.md) champion, since the threads of fate that bound Vax'ildan to her service had not yet run their full course. But they inevitably did.

Vax'ildan bade farewell to all the people he held most dear in the wake of [The Whispered One's](compendium/5e/deities/exandria-the-whispered-one-tdcsr.md) defeat, and vanished into the eternal embrace of his god. In the years since, his returns to the world he once knew have been rare and fleeting. The Champion of Ravens is not Vax'ildan, though Vax resides within him. He is a loyal arbiter of the ineffable providence of death itself. He appears at times as a wrathful angel, masked and surrounded by a storm of raven feathers, bringing an end to those who would pervert the sanctity of oblivion out of greed or fear of the unknown.
...
- **Armor Class** 20 ([Deathwalker's ward](compendium/5e/items/deathwalkers-ward-exalted-tdcsr.md))
...
- **Skills** [Acrobatics](rules/5e/skills.md#Acrobatics) +19, [Intimidation](rules/5e/skills.md#Intimidation) +10, [Investigation](rules/5e/skills.md#Investigation) +10, [Perception](rules/5e/skills.md#Perception) +16, [Persuasion](rules/5e/skills.md#Persuasion) +10, [Sleight of Hand](rules/5e/skills.md#Sleight%20of%20Hand) +12, [Stealth](rules/5e/skills.md#Stealth) +19
...
- **Condition Immunities** [charmed](rules/5e/conditions.md#Charmed), [exhaustion](rules/5e/conditions.md#Exhaustion), [frightened](rules/5e/conditions.md#Frightened), [unconscious](rules/5e/conditions.md#Unconscious)
- **Languages** Abyssal, Celestial, Common, Druidic, Elvish, Thieves' cant
- **Challenge** 21

## Traits

***Innate Spellcasting.*** The Champion's innate spellcasting ability is Charisma (`dice:1d20+10|noform|noparens|text(+10)` to hit with spell attacks, save DC 18). He can innately cast the following spells, requiring no material components:

**At will:** [bane](compendium/5e/spells/bane.md), [bless](compendium/5e/spells/bless.md), [druidcraft](compendium/5e/spells/druidcraft.md)

**1/day:** [greater invisibility](compendium/5e/spells/greater-invisibility.md)
...
***Eternal Champion.*** When the Champion is reduced to 0 hit points or dies, his body is destroyed but his spirit returns to the [Raven Queen's](compendium/5e/deities/exandria-the-matron-of-ravens-tdcsr.md) side, and he gains a new body after `dice:1d4|noform|noparens|avg` (`d4`) days.
...
***Fate-Touched (4/Day).*** When the Champion makes an attack roll, ability check, or saving throw, he can reroll the `dice:d20|noform|noparens|avg` (`d20`) and use either roll. Alternatively, when a creature the Champion can see makes an attack roll against him, or a saving throw against one of his spells or features, he can force that creature to reroll the attack or save and use the new roll.

***Shadow Smite (1/Turn).*** The Champion deals an extra `dice:14d6|noform|noparens|avg|text(49)` (`14d6`) radiant or necrotic damage (his choice) when he hits a target with a weapon attack and he doesn't have disadvantage on the attack roll.

***Unerring Sight.*** The Champion's ranged weapon attacks ignore half cover and three-quarters cover and have no range penalty.

***Special Equipment.*** The Champion wears [boots of haste](compendium/5e/items/boots-of-haste-tdcsr.md) and the [Deathwalker's Ward](compendium/5e/items/deathwalkers-ward-exalted-tdcsr.md), and wields [Whisper](compendium/5e/items/whisper-exalted-tdcsr.md).

## Actions

***Multiattack.*** The Champion makes three attacks with [Whisper](compendium/5e/items/whisper-exalted-tdcsr.md).

***Whisper.*** *Melee  or Ranged Weapon Attack:* `dice:1d20+15|noform|noparens|text(+15)` to hit, reach 5 ft. or range 60 ft., one target. *Hit:* `dice:1d4+8|noform|noparens|avg|text(10)` (`1d4 + 8`) piercing damage plus `dice:1d8|noform|noparens|avg|text(4)` (`d8`) psychic damage. On a critical hit, the target must succeed on a DC 18 Wisdom saving throw or be [frightened](rules/5e/conditions.md#Frightened) of the Champion for 1 minute. On a ranged attack, the Champion can teleport with [Whisper](compendium/5e/items/whisper-exalted-tdcsr.md), appearing within 5 feet of the target on a hit, or in a random space within 30 feet of the target on a miss.

***Touch of Life and Death (Recharges after a Short or Long Rest).*** The Champion touches a creature within 5 feet of him, and chooses to either heal or harm that creature, restoring `dice:10d10|noform|noparens|avg|text(55)` (`10d10`) hit points or dealing `dice:10d10|noform|noparens|avg|text(55)` (`10d10`) necrotic damage. If the creature is an unwilling target, it can avoid either effect with a successful DC 20 Dexterity saving throw.

## Bonus Actions

***Cunning Action.*** The Champion takes the [Dash](rules/5e/actions.md#Dash), [Disengage](rules/5e/actions.md#Disengage), or [Hide](rules/5e/actions.md#Hide) action.

***Boots of Haste (1/Day).*** The Champion clicks his heels together, casting [haste](compendium/5e/spells/haste.md) on himself. He doesn't suffer from lethargy when the spell ends.
