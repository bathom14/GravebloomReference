...
***Hooves.*** *Melee Weapon Attack:* `dice:1d20+11|noform|noparens|text(+11)` to hit, reach 5 ft., one target. *Hit:* `dice:4d6+6|noform|noparens|avg|text(20)` (`4d6 + 6`) bludgeoning damage plus `dice:3d6|noform|noparens|avg|text(10)` (`3d6`) radiant damage. If the target is a Medium or smaller creature, it must succeed on a DC 19 Strength saving throw or have the [prone](rules/5e/conditions.md#Prone) condition.

***Radiant Lance.*** *Melee Weapon Attack:* `dice:1d20+11|noform|noparens|text(+11)` to hit, reach 10 ft., one target. *Hit:* `dice:1d12+6|noform|noparens|avg|text(12)` (`1d12 + 6`) piercing damage plus `dice:8d6|noform|noparens|avg|text(28)` (`8d6`) radiant damage, and the target is marked until the start of the archon's next turn. While it is marked, the target has disadvantage on attack rolls against creatures other than the archon.

***Spellcasting.*** The archon casts one of the following spells, using Charisma as the spellcasting ability:

**1/day each:** [daylight](compendium/5e/spells/daylight.md), [lesser restoration](compendium/5e/spells/lesser-restoration.md)
