...
- 5e/monster/type/celestial/unicorn
aliases:
- Forest Master
---
# Forest Master
...
- **Skills** [Insight](rules/5e/skills.md#Insight) +7, [Nature](rules/5e/skills.md#Nature) +4, [Perception](rules/5e/skills.md#Perception) +7
- **Senses** darkvision 60 ft., passive Perception 17
- **Damage Immunities** poison
- **Condition Immunities** [charmed](rules/5e/conditions.md#Charmed), [paralyzed](rules/5e/conditions.md#Paralyzed), [poisoned](rules/5e/conditions.md#Poisoned)
...
***Hooves.*** *Melee Weapon Attack:* `dice:1d20+7|noform|noparens|text(+7)` to hit, reach 5 ft., one target. *Hit:* `dice:2d6+4|noform|noparens|avg|text(11)` (`2d6 + 4`) bludgeoning damage.

***Moon Bolt.*** *Ranged Spell Attack:* `dice:1d20+7|noform|noparens|text(+7)` to hit, range 60 ft., one target. *Hit:* `dice:2d6+4|noform|noparens|avg|text(11)` (`2d6 + 4`) radiant damage.
