...
- **Skills** [Athletics](rules/5e/skills.md#Athletics) +9, [Perception](rules/5e/skills.md#Perception) +5, [Religion](rules/5e/skills.md#Religion) +5
...
***Headfirst Charge.*** If the equinal moves at least 30 feet in a straight line toward a creature and ends within 5 feet of it, that creature must succeed on a DC 17 Strength saving throw or take `dice:4d6|noform|noparens|avg|text(14)` (`4d6`) bludgeoning damage and have the [prone](rules/5e/conditions.md#Prone) condition.

## Actions

***Multiattack.*** The equinal makes two Fist attacks.

***Fist.*** *Melee Weapon Attack:* `dice:1d20+9|noform|noparens|text(+9)` to hit, reach 5 ft., one target. *Hit:* `dice:2d6+6|noform|noparens|avg|text(13)` (`2d6 + 6`) bludgeoning damage plus `dice:1d6|noform|noparens|avg|text(3)` (`d6`) radiant damage.

***Rock.*** *Ranged Weapon Attack:* `dice:1d20+9|noform|noparens|text(+9)` to hit, range 60/180 ft., one target. *Hit:* `dice:3d10+6|noform|noparens|avg|text(22)` (`3d10 + 6`) bludgeoning damage. If the target is a creature, it must succeed on a DC 17 Strength saving throw or have the [prone](rules/5e/conditions.md#Prone) condition.

***Shout (Recharge 6).*** The equinal lets out a booming shout. Each creature within 30 feet of the equinal must succeed on a DC 14 Constitution saving throw or have the [stunned](rules/5e/conditions.md#Stunned) condition until the end of the equinal's next turn.
```
^statblock