...
- **Armor Class** 13 ([mage armor](compendium/5e/spells/mage-armor.md))
...
- **Skills** [Insight](rules/5e/skills.md#Insight) +9, [Perception](rules/5e/skills.md#Perception) +6, [Persuasion](rules/5e/skills.md#Persuasion) +5
...
***Psi-Imbued Blade.*** *Melee Weapon Attack:* `dice:1d20+6|noform|noparens|text(+6)` to hit, reach 5 ft., one target. *Hit:* `dice:2d6+3|noform|noparens|avg|text(10)` (`2d6 + 3`) slashing damage, and if the target is a creature, it must succeed on a DC 15 Wisdom saving throw or be [frightened](rules/5e/conditions.md#Frightened) of the mercane until the end of the target's next turn.
...
**At will:** [detect magic](compendium/5e/spells/detect-magic.md), [light](compendium/5e/spells/light.md)

**1/day each:** [dimension door](compendium/5e/spells/dimension-door.md), [invisibility](compendium/5e/spells/invisibility.md), [mage armor](compendium/5e/spells/mage-armor.md) (self only)
```
^statblock