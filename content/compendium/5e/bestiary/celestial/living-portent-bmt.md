...
***Radiant Strike.*** *Melee  or Ranged Spell Attack:* `dice:1d20+5|noform|noparens|text(+5)` to hit, reach 5 ft. or range 120 ft., one target. *Hit:* `dice:1d12+3|noform|noparens|avg|text(9)` (`1d12 + 3`) radiant damage.
...
***Price of Defiance.*** When the living portent is damaged by a creature that it can see within 120 feet of itself, radiant power sears the creature. The creature must make a DC 13 Constitution saving throw, taking `dice:3d6|noform|noparens|avg|text(10)` (`3d6`) radiant damage on a failed save, or half as much damage on a successful one.
```
^statblock