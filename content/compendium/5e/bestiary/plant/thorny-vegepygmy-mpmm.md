...
If a Beast such as a dog or a bear dies from [russet mold](compendium/5e/traps-hazards/russet-mold-vgm.md), the result is a bestial moldy called a thorny, instead of a bipedal vegepygmy. Thornies are less intelligent than other vegepygmies, but they are larger and more ferocious and have thorn-covered bodies.
...
- **Proficiency Bonus** +2
- **Saving Throws** ⏤
- **Skills** [Perception](rules/5e/skills.md#Perception) +4, [Stealth](rules/5e/skills.md#Stealth) +3
...
***Plant Camouflage.*** The thorny has advantage on Dexterity ([Stealth](rules/5e/skills.md#Stealth)) checks it makes in any terrain with ample obscuring vegetation.
...
***Thorny Body.*** At the start of its turn, the thorny deals `dice:1d4|noform|noparens|avg|text(2)` (`d4`) piercing damage to any creature grappling it.

## Actions

***Bite.*** *Melee Weapon Attack:* `dice:1d20+3|noform|noparens|text(+3)` to hit, reach 5 ft., one target. *Hit:* `dice:2d8+1|noform|noparens|avg|text(10)` (`2d8 + 1`) piercing damage.
```
^statblock
