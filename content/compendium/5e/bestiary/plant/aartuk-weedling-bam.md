...
***Branch.*** *Melee Weapon Attack:* `dice:1d20+4|noform|noparens|text(+4)` to hit, reach 10 ft., one target. *Hit:* `dice:2d6+2|noform|noparens|avg|text(8)` (`2d6 + 2`) bludgeoning damage.

***Radiant Pellet.*** *Ranged Spell Attack:* `dice:1d20+3|noform|noparens|text(+3)` to hit, range 60 ft., one target. *Hit:* `dice:3d4+1|noform|noparens|avg|text(7)` (`3d4 + 1`) radiant damage.
