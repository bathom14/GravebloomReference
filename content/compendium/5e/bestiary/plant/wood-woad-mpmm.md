...
- **Armor Class** 18 (natural armor, [shield](compendium/5e/items/shield-phb.md))
...
- **Proficiency Bonus** +3
- **Saving Throws** ⏤
- **Skills** [Athletics](rules/5e/skills.md#Athletics) +7, [Perception](rules/5e/skills.md#Perception) +4, [Stealth](rules/5e/skills.md#Stealth) +4
...
***Plant Camouflage.*** The wood woad has advantage on Dexterity ([Stealth](rules/5e/skills.md#Stealth)) checks it makes in any terrain with ample obscuring vegetation.
...
***Club.*** *Melee Weapon Attack:* `dice:1d20+7|noform|noparens|text(+7)` to hit, reach 5 ft., one target. *Hit:* `dice:4d4+4|noform|noparens|avg|text(14)` (`4d4 + 4`) force damage.
```
^statblock
