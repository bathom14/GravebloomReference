...
***Branch.*** *Melee Weapon Attack:* `dice:1d20+6|noform|noparens|text(+6)` to hit, reach 10 ft., one target. *Hit:* `dice:2d6+4|noform|noparens|avg|text(11)` (`2d6 + 4`) bludgeoning damage.

***Radiant Pellet.*** *Ranged Spell Attack:* `dice:1d20+4|noform|noparens|text(+4)` to hit, range 60 ft., one target. *Hit:* `dice:4d4|noform|noparens|avg|text(10)` (`4d4`) radiant damage.
...
**1/day each:** [calm emotions](compendium/5e/spells/calm-emotions.md), [detect magic](compendium/5e/spells/detect-magic.md), [sending](compendium/5e/spells/sending.md)
