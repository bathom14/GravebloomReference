...
- **Condition Immunities** [blinded](rules/5e/conditions.md#Blinded), [deafened](rules/5e/conditions.md#Deafened), [frightened](rules/5e/conditions.md#Frightened)
- **Languages** —
- **Challenge** 1/4

## Traits

***False Appearance.*** If the violet fungus is motionless at the start of combat, it has advantage on its initiative roll. Moreover, if a creature hasn't observed the fungus move or act, that creature must succeed on a DC 18 Intelligence ([Investigation](rules/5e/skills.md#Investigation)) check to discern that the violet fungus isn't ordinary fungus.

## Actions

***Multiattack.*** The fungus makes `dice:1d4|noform|noparens|avg` (`d4`) Rotting Touch attacks.

***Rotting Touch.*** *Melee Weapon Attack:* `dice:1d20+2|noform|noparens|text(+2)` to hit, reach 10 ft., one creature. *Hit:* `dice:1d8|noform|noparens|avg|text(4)` (`d8`) necrotic damage.
```
^statblock