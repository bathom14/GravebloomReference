...
- **Stellar Incineration..** Any creature that enters the star or starts its turn inside it takes `dice:24d10|noform|noparens|avg|text(132)` (`24d10`) radiant damage.