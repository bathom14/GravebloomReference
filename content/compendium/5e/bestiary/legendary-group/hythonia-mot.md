...
- Hythonia briefly animates creatures that have been [petrified](rules/5e/conditions.md#Petrified) by her gaze. Each statue attacks one creature within 5 feet of it, with a +11 bonus to hit and dealing `dice:3d6|noform|noparens|avg|text(10)` (`3d6`) bludgeoning damage on a hit. If a Medium or smaller creature takes this damage, it is also [grappled](rules/5e/conditions.md#Grappled) (escape DC 15).  
- Hythonia causes spectral snakes to erupt from a point she can see within 150 feet of her. Each creature within 20 feet of that point must succeed on a DC 19 Constitution saving throw or take `dice:2d4|noform|noparens|avg|text(5)` (`2d4`) piercing damage and become [poisoned](rules/5e/conditions.md#Poisoned) until the end of its next turn. While [poisoned](rules/5e/conditions.md#Poisoned) in this way, the creature has disadvantage on Intelligence checks and Intelligence saving throws, and it behaves as if under the effect of the [confusion](compendium/5e/spells/confusion.md) spell.  
...
- Small bodies of water within 1 mile of the lair become poisonous. A creature that drinks the water must succeed on a DC 19 Constitution saving throw or become [poisoned](rules/5e/conditions.md#Poisoned) for 8 hours. An affected creature can repeat the saving throw at the end of each hour.  
