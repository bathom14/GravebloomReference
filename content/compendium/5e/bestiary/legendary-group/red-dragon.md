...
- **Smoldering Haze.** The area within 1 mile of the lair is [Lightly Obscured](rules/5e/variant-rules/lightly-obscured-xphb.md) with clouds of ash. Whenever a creature other than the dragon or one of its allies finishes a [Long Rest](rules/5e/variant-rules/long-rest-xphb.md) in that area, that creature must succeed on a DC 15 Constitution saving throw or have the [Poisoned](rules/5e/conditions.md#Poisoned) condition for 1 hour.  
