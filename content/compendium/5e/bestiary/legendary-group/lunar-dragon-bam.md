...
If the dragon dies, the moaning stops, the moon devils dissipate, and the black frost disappears over the course of `dice:1d10|noform|noparens|avg` (`d10`) days, allowing plant life in the area to recover.