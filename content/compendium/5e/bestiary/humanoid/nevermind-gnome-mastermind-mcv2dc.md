...
- **Skills** [Arcana](rules/5e/skills.md#Arcana) +8, [Investigation](rules/5e/skills.md#Investigation) +8, [Perception](rules/5e/skills.md#Perception) +3
...
***Clockwork Claw.*** *Melee Weapon Attack:* `dice:1d20+7|noform|noparens|text(+7)` to hit, reach 20 ft., one target. *Hit:* `dice:2d6+4|noform|noparens|avg|text(11)` (`2d6 + 4`) piercing damage, and if the target is a Medium or smaller creature, the target is [grappled](rules/5e/conditions.md#Grappled) (escape DC 15). Until this grapple ends, the target takes `dice:3d6|noform|noparens|avg|text(10)` (`3d6`) piercing damage at the start of each of the mastermind's turns. The mastermind has two claws, each of which can grapple only one target.
