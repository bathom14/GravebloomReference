...
```ad-statblock
title: Fraternity of Order Law Bender
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/MPP/Fraternity%20of%20Order%20Law%20Bender.webp#token)
...
***Arcane Burst.*** *Melee  or Ranged Spell Attack:* `dice:1d20+8|noform|noparens|text(+8)` to hit, reach 5 ft. or range 90 ft., one target. *Hit:* `dice:2d12+4|noform|noparens|avg|text(17)` (`2d12 + 4`) force damage.

***Power of Authority.*** The law bender targets a creature it can see within 60 feet of itself. The target must succeed on a DC 16 Intelligence saving throw or take `dice:3d6|noform|noparens|avg|text(10)` (`3d6`) psychic damage and have the [incapacitated](rules/5e/conditions.md#Incapacitated) condition for 1 minute. At the end of each of the target's turns, it can repeat the saving throw, ending the [incapacitated](rules/5e/conditions.md#Incapacitated) condition on itself on a success. A target that succeeds on the saving throw becomes immune to this law bender's Power of Authority for 24 hours.
...
**At will:** [dispel magic](compendium/5e/spells/dispel-magic.md), [fly](compendium/5e/spells/fly.md), [mage armor](compendium/5e/spells/mage-armor.md), [mage hand](compendium/5e/spells/mage-hand.md), [prestidigitation](compendium/5e/spells/prestidigitation.md)
