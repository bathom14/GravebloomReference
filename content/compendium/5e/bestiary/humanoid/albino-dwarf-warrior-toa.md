...
- **Proficiency Bonus** +2
- **Saving Throws** ⏤
- **Skills** [Perception](rules/5e/skills.md#Perception) +4, [Stealth](rules/5e/skills.md#Stealth) +3, [Survival](rules/5e/skills.md#Survival) +4
...
***Handaxe.*** *Melee  or Ranged Weapon Attack:* `dice:1d20+3|noform|noparens|text(+3)` to hit, reach 5 ft. or range 20/60 ft., one target. *Hit:* `dice:1d6+1|noform|noparens|avg|text(4)` (`1d6 + 1`) slashing damage.
```
^statblock