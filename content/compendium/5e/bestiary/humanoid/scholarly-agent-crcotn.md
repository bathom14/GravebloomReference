...
- **Skills** [Arcana](rules/5e/skills.md#Arcana) +5, [History](rules/5e/skills.md#History) +5, [Investigation](rules/5e/skills.md#Investigation) +5
...
***Arcane Shock.*** *Melee  or Ranged Spell Attack:* `dice:1d20+5|noform|noparens|text(+5)` to hit, reach 5 ft. or range 30 ft., one target. *Hit:* `dice:2d10+3|noform|noparens|avg|text(14)` (`2d10 + 3`) lightning damage. If the target is a creature, it can't take reactions until the start of its next turn.
...
**1/day each:** [comprehend languages](compendium/5e/spells/comprehend-languages.md), [identify](compendium/5e/spells/identify.md) (as an action), [mage armor](compendium/5e/spells/mage-armor.md)
