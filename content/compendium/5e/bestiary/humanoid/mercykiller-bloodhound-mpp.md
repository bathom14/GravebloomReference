...
***Clawed Gauntlet.*** *Melee Weapon Attack:* `dice:1d20+6|noform|noparens|text(+6)` to hit, reach 5 ft., one target. *Hit:* `dice:1d8+3|noform|noparens|avg|text(7)` (`1d8 + 3`) slashing damage plus `dice:3d6|noform|noparens|avg|text(10)` (`3d6`) necrotic damage.
