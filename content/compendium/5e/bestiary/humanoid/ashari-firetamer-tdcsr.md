...
Firetamers are almost always accompanied by a [salamander](compendium/5e/bestiary/elemental/salamander.md), a [fire elemental](compendium/5e/bestiary/elemental/fire-elemental.md), or a small herd of [magma](compendium/5e/bestiary/elemental/magma-mephit.md) or [smoke mephits](compendium/5e/bestiary/elemental/smoke-mephit.md). While home in Pyrah, Ashari firetamers use their power to control the Rift of Flame or to control the flames of the volcanic forest known as the Cindergrove. And on the outskirts of "Emon", a group of firetamers led by a half-orc Ashari named Lorkathar keeps watch over the volatile "Scar of the Cinder King".
...
- **Armor Class** 17 ([red dragon scale mail](compendium/5e/items/red-dragon-scale-mail.md))
...
- **Proficiency Bonus** +3
- **Saving Throws** ⏤
- **Skills** [Arcana](rules/5e/skills.md#Arcana) +4, [Nature](rules/5e/skills.md#Nature) +7
...
***Spellcasting.*** The firetamer is a 9th-level spellcaster. Its spellcasting ability is Wisdom (spell save DC 15, `dice:1d20+7|noform|noparens|text(+7)` to hit with spell attacks). It has the following druid spells prepared:

**Cantrips (at will):** [druidcraft](compendium/5e/spells/druidcraft.md), [mending](compendium/5e/spells/mending.md), [produce flame](compendium/5e/spells/produce-flame.md) (`dice:2d8|noform|noparens|avg` (`2d8`))

**1st level (4 slots):** [cure wounds](compendium/5e/spells/cure-wounds.md), [faerie fire](compendium/5e/spells/faerie-fire.md), [jump](compendium/5e/spells/jump.md)

**2nd level (3 slots):** [flame blade](compendium/5e/spells/flame-blade.md), [heat metal](compendium/5e/spells/heat-metal.md), [lesser restoration](compendium/5e/spells/lesser-restoration.md)

**3rd level (3 slots):** [daylight](compendium/5e/spells/daylight.md), [dispel magic](compendium/5e/spells/dispel-magic.md), [protection from energy](compendium/5e/spells/protection-from-energy.md)

**4th level (3 slots):** [freedom of movement](compendium/5e/spells/freedom-of-movement.md), [wall of fire](compendium/5e/spells/wall-of-fire.md)

**5th level (1 slots):** [conjure elemental](compendium/5e/spells/conjure-elemental.md)

## Actions

***Scimitar.*** *Melee Weapon Attack:* `dice:1d20+5|noform|noparens|text(+5)` to hit, reach 5 ft., one target. *Hit:* `dice:1d6+2|noform|noparens|avg|text(5)` (`1d6 + 2`) slashing damage plus `dice:4d6|noform|noparens|avg|text(14)` (`4d6`) fire damage.

***Flamecharm (Recharges after a Short or Long Rest).*** The firetamer can cast the [dominate monster](compendium/5e/spells/dominate-monster.md) spell (save DC 15) on a [fire elemental](compendium/5e/bestiary/elemental/fire-elemental.md) or other elemental fire creature. If the creature has 150 or more hit points, it has advantage on the saving throw.

## Bonus Actions

***Flameform (Recharges after a Short or Long Rest).*** The firetamer can transform into a [fire elemental](compendium/5e/bestiary/elemental/fire-elemental.md). Its game statistics are replaced by the statistics of the elemental, but the firetamer retains its alignment, personality, and Intelligence, Wisdom, and Charisma scores, and all of its skill and saving throw proficiencies. While in this form, the firetamer can't cast spells. When the firetamer is reduced to 0 hit points, falls [unconscious](rules/5e/conditions.md#Unconscious), or dies in this form, it reverts to its humanoid form. It can remain in flameform for up to 5 hours or until it reverts to its humanoid form as a bonus action.

***Druidic Recovery.*** If the firetamer is in [fire elemental](compendium/5e/bestiary/elemental/fire-elemental.md) form using Flameform, it can expend a spell slot to regain `dice:1d8|noform|noparens|avg` (`d8`) hit points per level of the spell slot expended.
```
^statblock