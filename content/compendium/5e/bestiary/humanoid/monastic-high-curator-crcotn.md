...
- **Skills** [Arcana](rules/5e/skills.md#Arcana) +8, [History](rules/5e/skills.md#History) +8, [Investigation](rules/5e/skills.md#Investigation) +8, [Perception](rules/5e/skills.md#Perception) +10
...
***Force Strike.*** *Melee  or Ranged Spell Attack:* `dice:1d20+10|noform|noparens|text(+10)` to hit, reach 5 ft. or range 10 ft., one target. *Hit:* `dice:2d10+6|noform|noparens|avg|text(17)` (`2d10 + 6`) force damage.

***Brain Burn (Recharge 4-6).*** The high curator targets up to two creatures it can see within 30 feet of itself. Each target must make a DC 18 Constitution saving throw. On a failed saving throw, the target takes `dice:8d6|noform|noparens|avg|text(28)` (`8d6`) psychic damage and can't take reactions until the start of its next turn. On a successful save, the target takes half as much damage and suffers no other effect.
...
**2/day each:** [detect thoughts](compendium/5e/spells/detect-thoughts.md), [identify](compendium/5e/spells/identify.md) (as an action), [scrying](compendium/5e/spells/scrying.md) (as an action)
```
^statblock