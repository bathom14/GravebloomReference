...
- **Armor Class** 17 ([leather armor](compendium/5e/items/leather-armor-phb.md), suave defense)
...
- **Proficiency Bonus** +2
- **Saving Throws** ⏤
- **Skills** [Acrobatics](rules/5e/skills.md#Acrobatics) +8, [Athletics](rules/5e/skills.md#Athletics) +5, [Persuasion](rules/5e/skills.md#Persuasion) +6
...
***Suave Defense.*** While the swashbuckler is wearing light or no armor and wielding no [shield](compendium/5e/items/shield-phb.md), its AC includes its Charisma modifier.
...
***Rapier.*** *Melee Weapon Attack:* `dice:1d20+6|noform|noparens|text(+6)` to hit, reach 5 ft., one target. *Hit:* `dice:1d8+4|noform|noparens|avg|text(8)` (`1d8 + 4`) piercing damage.

## Bonus Actions

***Lightfooted.*** The swashbuckler takes the [Dash](rules/5e/actions.md#Dash) or [Disengage](rules/5e/actions.md#Disengage) action.
```
^statblock
