...
- **Armor Class** 19 ([splint](compendium/5e/items/splint-armor-phb.md), [shield](compendium/5e/items/shield-phb.md))
...
- **Skills** [Athletics](rules/5e/skills.md#Athletics) +5, [Perception](rules/5e/skills.md#Perception) +4
...
***Vicious Lance.*** *Melee Weapon Attack:* `dice:1d20+5|noform|noparens|text(+5)` to hit, reach 10 ft., one target. *Hit:* `dice:1d10+3|noform|noparens|avg|text(8)` (`1d10 + 3`) piercing damage plus `dice:1d4|noform|noparens|avg|text(2)` (`d4`) fire damage.

***Heavy Crossbow.*** *Ranged Weapon Attack:* `dice:1d20+4|noform|noparens|text(+4)` to hit, range 100/400 ft., one target. *Hit:* `dice:1d10+2|noform|noparens|avg|text(7)` (`1d10 + 2`) piercing damage plus `dice:1d10|noform|noparens|avg|text(5)` (`d10`) fire damage.
