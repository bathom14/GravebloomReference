...
- **Skills** [Athletics](rules/5e/skills.md#Athletics) +5, [Deception](rules/5e/skills.md#Deception) +3, [Perception](rules/5e/skills.md#Perception) +3, [Survival](rules/5e/skills.md#Survival) +3
...
***Greatsword.*** *Melee Weapon Attack:* `dice:1d20+5|noform|noparens|text(+5)` to hit, reach 5 ft., one target. *Hit:* `dice:2d6+3|noform|noparens|avg|text(10)` (`2d6 + 3`) slashing damage plus `dice:1d6|noform|noparens|avg|text(3)` (`d6`) psychic damage.

***Telekinetic Bolt.*** *Ranged Spell Attack:* `dice:1d20+5|noform|noparens|text(+5)` to hit, range 60 ft., one target. *Hit:* `dice:3d6+3|noform|noparens|avg|text(13)` (`3d6 + 3`) force damage.
...
**At will:** [light](compendium/5e/spells/light.md), [mage hand](compendium/5e/spells/mage-hand.md) (the hand is invisible)
