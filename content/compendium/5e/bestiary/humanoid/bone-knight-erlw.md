...
- **Skills** [Athletics](rules/5e/skills.md#Athletics) +7, [Deception](rules/5e/skills.md#Deception) +6, [Intimidation](rules/5e/skills.md#Intimidation) +6
...
***Spellcasting.*** The knight is an 8th-level spellcaster. Its spellcasting ability is Charisma (spell save DC 14, `dice:1d20+6|noform|noparens|text(+6)` to hit with spell attacks). It has the following paladin spells prepared:

**1st level (4 slots):** [command](compendium/5e/spells/command.md), [compelled duel](compendium/5e/spells/compelled-duel.md), [hellish rebuke](compendium/5e/spells/hellish-rebuke.md), [wrathful smite](compendium/5e/spells/wrathful-smite.md)

**2nd level (3 slots):** [branding smite](compendium/5e/spells/shining-smite.md), [crown of madness](compendium/5e/spells/crown-of-madness.md), [darkness](compendium/5e/spells/darkness.md), [find steed](compendium/5e/spells/find-steed.md), [magic weapon](compendium/5e/spells/magic-weapon.md)
...
***Greatsword.*** *Melee Weapon Attack:* `dice:1d20+7|noform|noparens|text(+7)` to hit, reach 5 ft., one target. *Hit:* `dice:2d6+4|noform|noparens|avg|text(11)` (`2d6 + 4`) slashing damage.

***Longbow.*** *Ranged Weapon Attack:* `dice:1d20+4|noform|noparens|text(+4)` to hit, range 150/600 ft., one target. *Hit:* `dice:1d8+1|noform|noparens|avg|text(5)` (`1d8 + 1`) piercing damage.
```
^statblock