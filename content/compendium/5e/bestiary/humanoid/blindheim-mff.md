...
- 5e/monster/type/humanoid/blindheim
aliases:
- Blindheim
---
# Blindheim
...
- **Proficiency Bonus** +2
- **Saving Throws** ⏤
- **Skills** [Athletics](rules/5e/skills.md#Athletics) +3, [Perception](rules/5e/skills.md#Perception) +2
...
***Bite.*** *Melee Weapon Attack:* `dice:1d20+4|noform|noparens|text(+4)` to hit, reach 5 ft., one target. Hit: `dice:1d6+2|noform|noparens|avg|text(5)` (`1d6 + 2`) piercing damage.

***Radiant Blast.*** Radiant energy erupts from the blindheim's eyes in a 15-foot cone. Each creature in that area must succeed on a DC 12 Constitution saving throw or take `dice:2d6|noform|noparens|avg|text(7)` (`2d6`) radiant damage and be [blinded](rules/5e/conditions.md#Blinded) until the end of the blindheim's next turn. Creatures with the Sunlight Sensitivity trait have disadvantage on this saving throw.
```
^statblock