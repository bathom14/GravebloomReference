...
- **Skills** [Arcana](rules/5e/skills.md#Arcana) +9, [Insight](rules/5e/skills.md#Insight) +10, [Perception](rules/5e/skills.md#Perception) +10
...
***Unarmed Strike.*** *Melee Weapon Attack:* `dice:1d20+10|noform|noparens|text(+10)` to hit, reach 5 ft., one target. *Hit:* `dice:1d8+5|noform|noparens|avg|text(9)` (`1d8 + 5`) bludgeoning damage plus `dice:4d8|noform|noparens|avg|text(18)` (`4d8`) psychic damage.
...
**3/day each:** [see invisibility](compendium/5e/spells/see-invisibility.md), [telekinesis](compendium/5e/spells/telekinesis.md)

**1/day each:** [globe of invulnerability](compendium/5e/spells/globe-of-invulnerability.md), [plane shift](compendium/5e/spells/plane-shift.md), [wall of force](compendium/5e/spells/wall-of-force.md)
...
***Change Gravity (Costs 3 Actions).*** The githzerai casts the [reverse gravity](compendium/5e/spells/reverse-gravity.md) spell, using Wisdom as the spellcasting ability. The spell has the normal effect, except that the githzerai can orient the area in any direction and creatures and objects fall toward the end of the area.

![Githzerai Anarch](compendium/5e/bestiary/legendary-group/githzerai-anarch-mpmm.md)
```
^statblock