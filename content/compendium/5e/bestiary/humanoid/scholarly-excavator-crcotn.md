...
- **Skills** [Arcana](rules/5e/skills.md#Arcana) +4, [Athletics](rules/5e/skills.md#Athletics) +4, [History](rules/5e/skills.md#History) +4
...
***Thunderous Warhammer.*** *Melee Weapon Attack:* `dice:1d20+4|noform|noparens|text(+4)` to hit, reach 5 ft., one target. *Hit:* `dice:1d10+2|noform|noparens|avg|text(7)` (`1d10 + 2`) thunder damage.
