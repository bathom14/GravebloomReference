...
- **Skills** [Insight](rules/5e/skills.md#Insight) +3, [Intimidation](rules/5e/skills.md#Intimidation) +4, [Perception](rules/5e/skills.md#Perception) +3
...
***Longsword.*** *Melee Weapon Attack:* `dice:1d20+5|noform|noparens|text(+5)` to hit, reach 5 ft., one target. *Hit:* `dice:2d8+3|noform|noparens|avg|text(12)` (`2d8 + 3`) slashing damage, or `dice:2d10+3|noform|noparens|avg|text(14)` (`2d10 + 3`) slashing damage when used with two hands.
