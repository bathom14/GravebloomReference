...
- **Armor Class** 15 ([leather](compendium/5e/items/leather-armor-phb.md))
- **Hit Points** 44 (`8d8 + 8`)
- **Speed** 30 ft.
...
- **Skills** [Deception](rules/5e/skills.md#Deception) +3, [Stealth](rules/5e/skills.md#Stealth) +8
...
***Sneak Attack (1/Turn).*** The cutthroat deals an extra `dice:4d6|noform|noparens|avg|text(14)` (`4d6`) damage when it hits a target with a weapon attack and has advantage on the attack roll, or when the target is within 5 feet of an ally of the cutthroat that isn't [incapacitated](rules/5e/conditions.md#Incapacitated) and the cutthroat doesn't have disadvantage on the attack roll.

## Actions

***Multiattack.*** The cutthroat makes two shortsword or dagger attacks.

***Shortsword.*** *Melee Weapon Attack:* `dice:1d20+6|noform|noparens|text(+6)` to hit, reach 5 ft., one target. *Hit:* `dice:1d6+4|noform|noparens|avg|text(7)` (`1d6 + 4`) piercing damage.

***Dagger.*** *Melee  or Ranged Weapon Attack:* `dice:1d20+6|noform|noparens|text(+6)` to hit, reach 5 ft., range 20/60 ft., one target. *Hit:* `dice:1d4+4|noform|noparens|avg|text(6)` (`1d4 + 4`) piercing damage.

## Bonus Actions

***Cunning Action.*** The cutthroat can take the [Dash](rules/5e/actions.md#Dash), [Disengage](rules/5e/actions.md#Disengage), or [Hide](rules/5e/actions.md#Hide) action.
