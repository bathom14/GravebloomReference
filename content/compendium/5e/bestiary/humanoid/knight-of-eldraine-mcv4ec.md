...
***Lance.*** *Melee Weapon Attack:* `dice:1d20+5|noform|noparens|text(+5)` to hit, reach 10 ft., one target. *Hit:* `dice:1d12+3|noform|noparens|avg|text(9)` (`1d12 + 3`) piercing damage plus `dice:2d8|noform|noparens|avg|text(9)` (`2d8`) radiant damage.

***Longsword.*** *Melee Weapon Attack:* `dice:1d20+5|noform|noparens|text(+5)` to hit, reach 5 ft., one target. *Hit:* `dice:1d8+3|noform|noparens|avg|text(7)` (`1d8 + 3`) slashing damage, or `dice:1d10+3|noform|noparens|avg|text(8)` (`1d10 + 3`) slashing damage if used with two hands, plus `dice:2d8|noform|noparens|avg|text(9)` (`2d8`) radiant damage.

***Heavy Crossbow.*** *Ranged Weapon Attack:* `dice:1d20+3|noform|noparens|text(+3)` to hit, range 100/400 ft., one target. *Hit:* `dice:1d10+1|noform|noparens|avg|text(6)` (`1d10 + 1`) piercing damage plus `dice:2d8|noform|noparens|avg|text(9)` (`2d8`) radiant damage.
```
^statblock