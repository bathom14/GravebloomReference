...
***Handaxe.*** *Melee  or Ranged Weapon Attack:* `dice:1d20+6|noform|noparens|text(+6)` to hit, reach 5 ft. or range 20/60 ft., one target. *Hit:* `dice:1d6+4|noform|noparens|avg|text(7)` (`1d6 + 4`) slashing damage. *Hit or Miss:* The handaxe magically returns to the chosen's hand immediately after a ranged attack.
