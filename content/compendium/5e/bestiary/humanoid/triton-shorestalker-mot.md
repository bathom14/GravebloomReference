...
- **Proficiency Bonus** +2
- **Saving Throws** ⏤
- **Skills** [Nature](rules/5e/skills.md#Nature) +4, [Perception](rules/5e/skills.md#Perception) +4, [Stealth](rules/5e/skills.md#Stealth) +5
...
**1/day each:** [fog cloud](compendium/5e/spells/fog-cloud.md), [gust of wind](compendium/5e/spells/gust-of-wind.md)
...
***Urchin-Spine Shortsword.*** *Melee Weapon Attack:* `dice:1d20+5|noform|noparens|text(+5)` to hit, reach 5 ft., one target. *Hit:* `dice:1d6+3|noform|noparens|avg|text(6)` (`1d6 + 3`) piercing damage plus `dice:3d6|noform|noparens|avg|text(10)` (`3d6`) poison damage. If the damage reduces a creature to 0 hit points, that creature is stable but [poisoned](rules/5e/conditions.md#Poisoned) for 1 hour, even after regaining hit points, and is [paralyzed](rules/5e/conditions.md#Paralyzed) while [poisoned](rules/5e/conditions.md#Poisoned) in this way.

***Poisoned Spine.*** *Ranged Weapon Attack:* `dice:1d20+5|noform|noparens|text(+5)` to hit, range 30/60 ft., one target. *Hit:* `dice:1d4+3|noform|noparens|avg|text(5)` (`1d4 + 3`) piercing damage plus `dice:3d6|noform|noparens|avg|text(10)` (`3d6`) poison damage.
```
^statblock