...
***Fey Ancestry.*** The elf has advantage on saving throws it makes to avoid or end the [charmed](rules/5e/conditions.md#Charmed) condition on itself, and magic can't put it to sleep.

***Special Equipment.*** The elf wears a suit of [elven chain](compendium/5e/items/elven-chain.md).
...
***Radiant Beam (3/Day).*** A magical beam of radiance flashes out from the elf's hand in a 5-foot-wide, 60-foot-long line. Each creature in the line must make a DC 16 Constitution saving throw, taking `dice:4d8|noform|noparens|avg|text(18)` (`4d8`) radiant damage on a failed save, or half as much damage on a successful one.
