...
- **Skills** [Acrobatics](rules/5e/skills.md#Acrobatics) +7, [Insight](rules/5e/skills.md#Insight) +6, [Investigation](rules/5e/skills.md#Investigation) +8, [Stealth](rules/5e/skills.md#Stealth) +7
...
***Unarmed Strike.*** *Melee Weapon Attack:* `dice:1d20+7|noform|noparens|text(+7)` to hit, reach 5 ft., one target. *Hit:* `dice:1d10+4|noform|noparens|avg|text(9)` (`1d10 + 4`) bludgeoning damage.

***Cobalt Dart.*** *Ranged Weapon Attack:* `dice:1d20+7|noform|noparens|text(+7)` to hit, range 20/60 ft., one target. *Hit:* `dice:1d4+4|noform|noparens|avg|text(6)` (`1d4 + 4`) piercing damage plus `dice:1d6|noform|noparens|avg|text(3)` (`d6`) force damage.
