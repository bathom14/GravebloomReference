...
- **Skills** [Persuasion](rules/5e/skills.md#Persuasion) +5, [Religion](rules/5e/skills.md#Religion) +3
...
***Thunder Bolt.*** *Melee  or Ranged Spell Attack:* `dice:1d20+5|noform|noparens|text(+5)` to hit, reach 5 ft. or range 60 ft., one target. *Hit:* `dice:3d8|noform|noparens|avg|text(13)` (`3d8`) thunder damage, and the target is pushed horizontally up to 10 feet away from the speaker.
...
**1/day each:** [calm emotions](compendium/5e/spells/calm-emotions.md), [charm person](compendium/5e/spells/charm-person.md), [command](compendium/5e/spells/command.md), [comprehend languages](compendium/5e/spells/comprehend-languages.md)

## Reactions

***Disarming Words (3/Day).*** When a creature the speaker can see within 60 feet of it makes a damage roll, the speaker can roll a `dice:d6|noform|noparens|avg` (`d6`) and subtract the number rolled from that damage roll.
```
^statblock