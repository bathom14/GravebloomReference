...
- **Proficiency Bonus** +2
- **Saving Throws** ⏤
- **Skills** [Perception](rules/5e/skills.md#Perception) +3, [Performance](rules/5e/skills.md#Performance) +7, [Persuasion](rules/5e/skills.md#Persuasion) +5, [Stealth](rules/5e/skills.md#Stealth) +4
...
***Dart.*** *Ranged Weapon Attack:* `dice:1d20+4|noform|noparens|text(+4)` to hit, range 20/60 ft., one target. *Hit:* `dice:1d4+2|noform|noparens|avg|text(4)` (`1d4 + 2`) piercing damage.
```
^statblock