...
***Greatsword.*** *Melee Weapon Attack:* `dice:1d20+9|noform|noparens|text(+9)` to hit, reach 5 ft., one target. *Hit:* `dice:2d6+5|noform|noparens|avg|text(12)` (`2d6 + 5`) slashing damage, plus `dice:2d6|noform|noparens|avg|text(7)` (`2d6`) slashing damage if the champion has more than half of its total hit points remaining.

***Shortbow.*** *Ranged Weapon Attack:* `dice:1d20+6|noform|noparens|text(+6)` to hit, range 80/320 ft., one target. *Hit:* `dice:1d6+2|noform|noparens|avg|text(5)` (`1d6 + 2`) piercing damage, plus `dice:2d6|noform|noparens|avg|text(7)` (`2d6`) piercing damage if the champion has more than half of its total hit points remaining.
