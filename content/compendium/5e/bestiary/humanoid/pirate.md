...
---
# Pirate
*Source: Monster Manual (2024) p. 241, Dragon Delves. Available in the <span title='Systems Reference Document (5.2)'>SRD</span> and the Free Rules (2024)*  
...
***Dagger.*** *Melee  or Ranged Attack Roll:* `dice:1d20+5|noform|noparens|text(+5)`, reach 5 ft. or range 20/60 ft. *Hit:* `dice:1d4+3|noform|noparens|avg|text(5)` (`1d4 + 3`) Piercing damage.

***Enthralling Panache.*** *Wisdom Saving Throw:* DC 12, one creature the pirate can see within 30 feet. *Failure:* The target has the [Charmed](rules/5e/conditions.md#Charmed) condition until the start of the pirate's next turn.
```
^statblock
