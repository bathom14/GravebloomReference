...
- **Skills** [Intimidation](rules/5e/skills.md#Intimidation) +6, [Perception](rules/5e/skills.md#Perception) +6, [Survival](rules/5e/skills.md#Survival) +6
...
***Longsword.*** *Melee Weapon Attack:* `dice:1d20+5|noform|noparens|text(+5)` to hit, reach 5 ft., one target. *Hit:* `dice:2d8+2|noform|noparens|avg|text(11)` (`2d8 + 2`) slashing damage, or `dice:2d10+2|noform|noparens|avg|text(13)` (`2d10 + 2`) slashing damage when used with two hands, plus `dice:3d6|noform|noparens|avg|text(10)` (`3d6`) radiant damage.

***Radiant Ray.*** *Ranged Spell Attack:* `dice:1d20+6|noform|noparens|text(+6)` to hit, range 120 ft., one target. *Hit:* `dice:4d10|noform|noparens|avg|text(22)` (`4d10`) radiant damage.
```
^statblock