...
Supreme commanders lead armies, each one commanding ten kith'raks, who in turn lead the rest of their forces. Most supreme commanders ride [red dragons](compendium/5e/bestiary/dragon/adult-red-dragon.md) into battle.
...
- **Skills** [Intimidation](rules/5e/skills.md#Intimidation) +9, [Perception](rules/5e/skills.md#Perception) +8
...
***Silver Greatsword.*** *Melee Weapon Attack:* `dice:1d20+12|noform|noparens|text(+12)` to hit, reach 5 ft., one target. *Hit:* `dice:2d6+7|noform|noparens|avg|text(14)` (`2d6 + 7`) slashing damage plus `dice:5d6|noform|noparens|avg|text(17)` (`5d6`) psychic damage. On a critical hit against a target in an astral body (as with the [astral projection](compendium/5e/spells/astral-projection.md) spell), the githyanki can cut the silvery cord that tethers the target to its material body, instead of dealing damage.
...
**3/day each:** [levitate](compendium/5e/spells/levitate.md) (self only), [nondetection](compendium/5e/spells/nondetection.md) (self only)

**1/day each:** [Bigby's hand](compendium/5e/spells/bigbys-hand.md), [mass suggestion](compendium/5e/spells/mass-suggestion.md), [plane shift](compendium/5e/spells/plane-shift.md), [telekinesis](compendium/5e/spells/telekinesis.md)
