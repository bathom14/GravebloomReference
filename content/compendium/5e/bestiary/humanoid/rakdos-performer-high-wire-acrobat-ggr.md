...
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/GGR/Rakdos%20Performer%2C%20High-Wire%20Acrobat.webp#token)
...
***Barbed Pole.*** *Melee Weapon Attack:* `dice:1d20+5|noform|noparens|text(+5)` to hit, reach 5 ft., one target. *Hit:* `dice:1d8+3|noform|noparens|avg|text(7)` (`1d8 + 3`) piercing damage, and the acrobat can jump up to 20 feet. This movement doesn't provoke opportunity attacks.
```
^statblock