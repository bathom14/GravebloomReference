...
Percival Fredrickstein von Musel Klossowski de Rolo III has endured much in his life. He was a young man plagued by personal demons when Vox Machina rescued him from a dismal cell in the "Umbra Hills". In those days, Percival de Rolo was a man driven by vengeance, with only his guns as allies, but he took no joy in that life. He has since expressed that the thing he's most grateful for is that he didn't die as the person he was, but lived long enough to grow into someone better, together with his beloved [Vex'ahlia](compendium/5e/bestiary/humanoid/vexahlia-tdcsr.md) and their five children.
...
- **Armor Class** 18 ([studded leather](compendium/5e/items/studded-leather-armor-phb.md))
...
- **Skills** [Acrobatics](rules/5e/skills.md#Acrobatics) +12, [History](rules/5e/skills.md#History) +11, [Perception](rules/5e/skills.md#Perception) +9, [Persuasion](rules/5e/skills.md#Persuasion) +8
...
***Cabal's Ruin.*** [Cabal's Ruin](compendium/5e/items/cabals-ruin-exalted-tdcsr.md) grants Percy advantage on saving throws against spells or magical effects. Additionally, [Cabal's Ruin](compendium/5e/items/cabals-ruin-exalted-tdcsr.md) has 10 charges. When Percy hits with a weapon attack, he can expend up to 10 charges to have the attack deal `dice:1d6|noform|noparens|avg` (`d6`) extra lightning damage per charge spent.

***Indomitable (3/Long Rest).*** Percy can reroll a failed saving throw.

***Misfire.*** When Percy rolls a 2 or lower on the `dice:d20|noform|noparens|avg` (`d20`) when making an attack with Animus or Bad News, the attack misses and he can't use the weapon again until he spends an action to repair it. On a misfire with Animus, he takes `dice:2d6|noform|noparens|avg|text(7)` (`2d6`) psychic damage.
...
***Special Equipment.*** Percy wears a [ring of lightning resistance](compendium/5e/items/ring-of-lightning-resistance.md) and [Cabal's Ruin](compendium/5e/items/cabals-ruin-exalted-tdcsr.md). He wields Animus and Bad News, which are both +1 weapons.
...
***Animus.*** *Ranged Weapon Attack:* `dice:1d20+15|noform|noparens|text(+15)` to hit, range 320 ft., one target. *Hit:* `dice:1d10+6|noform|noparens|avg|text(11)` (`1d10 + 6`) piercing damage and `dice:1d6|noform|noparens|avg|text(3)` (`d6`) psychic damage.

***Bad News.*** *Ranged Weapon Attack:* `dice:1d20+15|noform|noparens|text(+15)` to hit, range 800 ft., one target. *Hit:* `dice:2d12+6|noform|noparens|avg|text(19)` (`2d12 + 6`) piercing damage.

## Reactions

***Absorb Magic (Recharges after a Short or Long Rest).*** When Percy is targeted by an enemy's spell, he can absorb a portion of the spell's energy into [Cabal's Ruin](compendium/5e/items/cabals-ruin-exalted-tdcsr.md). The spell affects him normally, but the cloak gains a number of charges equal to the level of the spell. When he does so, he also gains resistance to one type of damage dealt by the spell until the end of his next turn.
```
^statblock