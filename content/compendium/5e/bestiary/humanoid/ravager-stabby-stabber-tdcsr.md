...
***Shortsword.*** *Melee Weapon Attack:* `dice:1d20+5|noform|noparens|text(+5)` to hit, reach 5 ft., one target. *Hit:* `dice:1d6+3|noform|noparens|avg|text(6)` (`1d6 + 3`) piercing damage.

***Dagger.*** *Melee  or Ranged Weapon Attack:* `dice:1d20+5|noform|noparens|text(+5)` to hit, reach 5 ft., range 20/60 ft., one target. *Hit:* `dice:1d4+3|noform|noparens|avg|text(5)` (`1d4 + 3`) piercing damage.

## Bonus Actions

***Nimble Escape.*** The stabby-stabber can use the [Disengage](rules/5e/actions.md#Disengage) or [Hide](rules/5e/actions.md#Hide) action.
```
^statblock
