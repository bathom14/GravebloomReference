...
- 5e/monster/type/humanoid/jermlaine
aliases:
- Jermlaine
---
# Jermlaine
...
The jermlaine's skin is rough, leathery, and textured like stone. Whether by the design of some sympathetic god or through sheer luck, their hide makes them appear [invisible](rules/5e/conditions.md#Invisible) to [darkvision](rules/5e/senses.md#Darkvision). Part of the jermlaine's anger comes from attempts to hunt them down and fashion cloaks and other material from their skin. Such experiments have yet to yield a functional magic item, and the jermlaine's hatred of outsiders is driven in part by their assumption that any who meet them seek to harvest them for such experiments.
...
***Lurkers in Shadow.*** Jermlaine are [invisible](rules/5e/conditions.md#Invisible) to darkvision.
...
***Swarming Rush.*** A jermlaine adds `dice:1d4|noform|noparens|avg` (`d4`) to its weapon damage rolls while within 5 feet of another, conscious jermlaine.

## Actions

***Club.*** *Melee Weapon Attack:* `dice:1d20-1|noform|noparens|text(-1)` to hit, reach 5 ft., one target. *Hit:* `dice:1d4-3|noform|noparens|avg|text(1)` (`1d4 - 3`) bludgeoning damage.

***Dart.*** *Ranged Weapon Attack:* `dice:1d20+3|noform|noparens|text(+3)` to hit, range 20/60 ft., one target. *Hit:* `dice:1d4+1|noform|noparens|avg|text(3)` (`1d4 + 1`) piercing damage.
```
^statblock