...
- **Skills** [Acrobatics](rules/5e/skills.md#Acrobatics) +7, [Performance](rules/5e/skills.md#Performance) +4
...
***Bladed Chain.*** *Melee Weapon Attack:* `dice:1d20+5|noform|noparens|text(+5)` to hit, reach 10 ft., one target. *Hit:* `dice:1d6+3|noform|noparens|avg|text(6)` (`1d6 + 3`) slashing damage.

***Spew Flame (Recharge 4-6).*** The fire eater exhales flames. Each creature in a 15-foot cone must make a DC 13 Dexterity saving throw, taking `dice:2d8|noform|noparens|avg|text(9)` (`2d8`) fire damage on a failed save, or half as much damage on a successful one.
```
^statblock