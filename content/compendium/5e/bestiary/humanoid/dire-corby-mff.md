...
- 5e/monster/type/humanoid/dire-corby
aliases:
- Dire Corby
---
# Dire Corby
...
- **Proficiency Bonus** +2
- **Saving Throws** ⏤
- **Skills** [Acrobatics](rules/5e/skills.md#Acrobatics) +4, [Perception](rules/5e/skills.md#Perception) +3
...
***Keen Hearing.*** The dire corby has advantage on Wisdom ([Perception](rules/5e/skills.md#Perception)) checks that rely on hearing.
