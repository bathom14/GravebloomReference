...
- 5e/monster/type/humanoid/xvart
aliases:
- Xvart Speaker
---
# Xvart Speaker
...
***Overbearing Pack.*** The xvart has advantage on Strength ([Athletics](rules/5e/skills.md#Athletics)) checks to shove a creature if at least one of the xvart's allies is within 5 feet of the target and the ally isn't [incapacitated](rules/5e/conditions.md#Incapacitated).
