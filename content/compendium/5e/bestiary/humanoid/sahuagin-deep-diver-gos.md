...
- **Skills** [Perception](rules/5e/skills.md#Perception) +5, [Stealth](rules/5e/skills.md#Stealth) +5
...
***Brine Lurker.*** The deep diver has advantage on Dexterity ([Stealth](rules/5e/skills.md#Stealth)) checks made while submerged in water.
...
***Glaive.*** *Melee Weapon Attack:* `dice:1d20+4|noform|noparens|text(+4)` to hit, reach 10 ft., one target. *Hit:* `dice:2d10+2|noform|noparens|avg|text(13)` (`2d10 + 2`) slashing damage.

***Bite.*** *Melee Weapon Attack:* `dice:1d20+4|noform|noparens|text(+4)` to hit, reach 5 ft., one target. *Hit:* `dice:1d10+2|noform|noparens|avg|text(7)` (`1d10 + 2`) piercing damage.

***Claws.*** *Melee Weapon Attack:* `dice:1d20+4|noform|noparens|text(+4)` to hit, reach 5 ft., one target. *Hit:* `dice:1d8+2|noform|noparens|avg|text(6)` (`1d8 + 2`) slashing damage.

***Light of Sekolah.*** The deep diver pulses magical light from its lure. Any creature within 30 feet of the deep diver that can see the light must succeed on a DC 11 Wisdom saving throw or be [charmed](rules/5e/conditions.md#Charmed) until the end of its next turn. A creature [charmed](rules/5e/conditions.md#Charmed) in this way is [incapacitated](rules/5e/conditions.md#Incapacitated) as it stares at the light.
```
^statblock