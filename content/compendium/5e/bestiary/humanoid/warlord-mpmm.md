...
- **Skills** [Athletics](rules/5e/skills.md#Athletics) +9, [Intimidation](rules/5e/skills.md#Intimidation) +8, [Perception](rules/5e/skills.md#Perception) +5, [Persuasion](rules/5e/skills.md#Persuasion) +8
...
***Greatsword.*** *Melee Weapon Attack:* `dice:1d20+9|noform|noparens|text(+9)` to hit, reach 5 ft., one target. *Hit:* `dice:2d6+5|noform|noparens|avg|text(12)` (`2d6 + 5`) slashing damage.

***Shortbow.*** *Ranged Weapon Attack:* `dice:1d20+7|noform|noparens|text(+7)` to hit, range 80/320 ft., one target. *Hit:* `dice:1d6+3|noform|noparens|avg|text(6)` (`1d6 + 3`) piercing damage.
...
***Frighten Foe (Costs 2 Actions).*** The warlord targets one creature it can see within 30 feet of it. If the target can see and hear it, the target must succeed on a DC 16 Wisdom saving throw or be [frightened](rules/5e/conditions.md#Frightened) until the end of warlord's next turn.
```
^statblock
