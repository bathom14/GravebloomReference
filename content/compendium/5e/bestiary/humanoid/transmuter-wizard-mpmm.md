...
- **Darkvision.** The transmuter has [darkvision](rules/5e/senses.md#Darkvision) out to a range of 60 feet.  
...
***Arcane Burst.*** *Melee  or Ranged Spell Attack:* `dice:1d20+6|noform|noparens|text(+6)` to hit, reach 5 ft. or range 120 ft., one target. *Hit:* `dice:3d10+3|noform|noparens|avg|text(19)` (`3d10 + 3`) acid damage.
...
**At will:** [light](compendium/5e/spells/light.md), [message](compendium/5e/spells/message.md), [prestidigitation](compendium/5e/spells/prestidigitation.md)

**2/day each:** [fireball](compendium/5e/spells/fireball.md), [hold person](compendium/5e/spells/hold-person.md), [knock](compendium/5e/spells/knock.md), [mage armor](compendium/5e/spells/mage-armor.md), [polymorph](compendium/5e/spells/polymorph.md), [slow](compendium/5e/spells/slow.md)

**1/day each:** [telekinesis](compendium/5e/spells/telekinesis.md)

## Bonus Actions

***Transmute (Recharge 4-6).*** The transmuter casts [alter self](compendium/5e/spells/alter-self.md) or changes the benefit of Transmuter's Stone if bearing the stone.
```
^statblock
