...
- **Proficiency Bonus** +2
- **Saving Throws** ⏤
- **Skills** [Athletics](rules/5e/skills.md#Athletics) +2, [Perception](rules/5e/skills.md#Perception) +4, [Stealth](rules/5e/skills.md#Stealth) +4
...
***Ruin Dweller.*** The stalker has advantage on Dexterity ([Stealth](rules/5e/skills.md#Stealth)) checks made to hide in ruins, and its speed is not reduced in difficult terrain composed of rubble.
...
***Shortsword.*** *Melee Attack Roll:* `dice:1d20+4|noform|noparens|text(+4)` to hit, reach 5 ft., one target. *Hit:* `dice:1d6+2|noform|noparens|avg|text(5)` (`1d6 + 2`) piercing damage.
```
^statblock