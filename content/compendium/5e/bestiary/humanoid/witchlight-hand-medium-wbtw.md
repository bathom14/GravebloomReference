...
- **Proficiency Bonus** +2
- **Saving Throws** ⏤
- **Skills** [Sleight of Hand](rules/5e/skills.md#Sleight%20of%20Hand) +6
...
***Secret Expertise.*** The hand has one of these additional skills: [Acrobatics](rules/5e/skills.md#Acrobatics) [Acrobatics](rules/5e/skills.md#Acrobatics) (`dice:1d20+6|noform|noparens|text(+6)`), [Animal Handling](rules/5e/skills.md#Animal%20Handling) [Animal Handling](rules/5e/skills.md#Animal%20Handling) (`dice:1d20+5|noform|noparens|text(+5)`), [Arcana](rules/5e/skills.md#Arcana) [Arcana](rules/5e/skills.md#Arcana) (`dice:1d20+5|noform|noparens|text(+5)`), [Athletics](rules/5e/skills.md#Athletics) [Athletics](rules/5e/skills.md#Athletics) (`dice:1d20+4|noform|noparens|text(+4)`), [Medicine](rules/5e/skills.md#Medicine) [Medicine](rules/5e/skills.md#Medicine) (`dice:1d20+5|noform|noparens|text(+5)`), or [Performance](rules/5e/skills.md#Performance) [Performance](rules/5e/skills.md#Performance) (`dice:1d20+5|noform|noparens|text(+5)`).
...
**At will:** [dancing lights](compendium/5e/spells/dancing-lights.md), [message](compendium/5e/spells/message.md), [prestidigitation](compendium/5e/spells/prestidigitation.md)
```
^statblock