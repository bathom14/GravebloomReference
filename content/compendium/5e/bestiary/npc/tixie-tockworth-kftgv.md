...
- **Armor Class** 17 (natural armor, [shield](compendium/5e/items/shield-phb.md))
...
- **Skills** [Arcana](rules/5e/skills.md#Arcana) +9, [Perception](rules/5e/skills.md#Perception) +2
...
**At will:** [nondetection](compendium/5e/spells/nondetection.md) (self only)

**2/day:** [dimension door](compendium/5e/spells/dimension-door.md)

**1/day each:** [blindness/deafness](compendium/5e/spells/blindness-deafness.md), [blur](compendium/5e/spells/blur.md)

## Bonus Actions

***Scalding Steam (Recharge 5-6).*** Tockworth emits a jet of piping-hot steam in a 15-foot cone. Each creature in that cone must make a DC 15 Dexterity saving throw, taking `dice:3d6|noform|noparens|avg|text(10)` (`3d6`) fire damage on a failed save, or half as much damage on a successful one.
```
^statblock