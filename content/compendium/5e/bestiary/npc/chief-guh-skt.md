...
***Greatclub.*** *Melee Weapon Attack:* `dice:1d20+8|noform|noparens|text(+8)` to hit, reach 10 ft., one target. *Hit:* `dice:3d8+5|noform|noparens|avg|text(18)` (`3d8 + 5`) bludgeoning damage.

***Unarmed Attack.*** *Melee Weapon Attack:* `dice:1d20+8|noform|noparens|text(+8)` to hit, reach 10 ft., one target. *Hit:* `dice:3d4+5|noform|noparens|avg|text(12)` (`3d4 + 5`) bludgeoning damage.

***Rock.*** *Ranged Weapon Attack:* `dice:1d20+8|noform|noparens|text(+8)` to hit, range 60/240 ft., one target. *Hit:* `dice:3d10+5|noform|noparens|avg|text(21)` (`3d10 + 5`) bludgeoning damage.
```
^statblock