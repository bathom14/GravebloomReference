...
- **Skills** [Athletics](rules/5e/skills.md#Athletics) +8, [Perception](rules/5e/skills.md#Perception) +5
...
***Bite.*** *Melee Weapon Attack:* `dice:1d20+8|noform|noparens|text(+8)` to hit, reach 10 ft., one target. *Hit:* `dice:2d10+5|noform|noparens|avg|text(16)` (`2d10 + 5`) piercing damage.

***Tail Smash.*** *Melee Weapon Attack:* `dice:1d20+8|noform|noparens|text(+8)` to hit, reach 10 ft., one target. *Hit:* `dice:1d8+5|noform|noparens|avg|text(9)` (`1d8 + 5`) bludgeoning damage.

## Legendary Actions

***Detect.*** The maw of Sekolah makes a Wisdom ([Perception](rules/5e/skills.md#Perception)) check.

***Speed of Sekolah.*** The maw of Sekolah moves up to its speed.

***Feed (Costs 2 Actions).*** The ferocious spirit of Sekolah flashes through the water, tearing through the foes of the maw of Sekolah. Each creature of the maw's choosing within 60 feet of it must make a DC 16 Dexterity saving throw, taking `dice:2d6|noform|noparens|avg|text(7)` (`2d6`) slashing damage on a failed save, or half as much damage on a successful one.
```
^statblock