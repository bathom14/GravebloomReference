...
- **Armor Class** 19 (splint mail, [shield](compendium/5e/items/shield-phb.md))
...
- **Skills** [Medicine](rules/5e/skills.md#Medicine) +7, [Religion](rules/5e/skills.md#Religion) +3, [Survival](rules/5e/skills.md#Survival) +7
...
***Warhammer.*** *Melee Weapon Attack:* `dice:1d20+7|noform|noparens|text(+7)` to hit, reach 5 ft., one target. *Hit:* `dice:1d8+4|noform|noparens|avg|text(8)` (`1d8 + 4`) bludgeoning damage, or `dice:1d10+4|noform|noparens|avg|text(9)` (`1d10 + 4`) bludgeoning damage when used with two hands.

***Searing Wrath.*** *Ranged Spell Attack:* `dice:1d20+7|noform|noparens|text(+7)` to hit, range 60 ft., one creature. *Hit:* `dice:4d8|noform|noparens|avg|text(18)` (`4d8`) radiant damage, and the target is [blinded](rules/5e/conditions.md#Blinded) until the end of its next turn.
...
**2/day each:** [bless](compendium/5e/spells/bless.md) (at 2nd level), [cure wounds](compendium/5e/spells/cure-wounds.md) (at 3rd level)
