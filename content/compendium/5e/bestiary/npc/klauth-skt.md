...
- **Skills** [Perception](rules/5e/skills.md#Perception) +16, [Stealth](rules/5e/skills.md#Stealth) +8
...
***Special Equipment.*** Klauth carries a [wand of fireballs](compendium/5e/items/wand-of-fireballs.md) and a [wand of lightning bolts](compendium/5e/items/wand-of-lightning-bolts.md), and he wears a [ring of cold resistance](compendium/5e/items/ring-of-cold-resistance.md).

## Actions

***Multiattack.*** Klauth can use his Frightful Presence. He then makes three attacks: one with his bite and two with his claws.

***Bite.*** *Melee Weapon Attack:* `dice:1d20+17|noform|noparens|text(+17)` to hit, reach 15 ft., one target. *Hit:* `dice:2d10+10|noform|noparens|avg|text(21)` (`2d10 + 10`) piercing damage plus `dice:4d6|noform|noparens|avg|text(14)` (`4d6`) fire damage.

***Claw.*** *Melee Weapon Attack:* `dice:1d20+17|noform|noparens|text(+17)` to hit, reach 10 ft., one target. *Hit:* `dice:2d6+10|noform|noparens|avg|text(17)` (`2d6 + 10`) slashing damage.

***Tail.*** *Melee Weapon Attack:* `dice:1d20+17|noform|noparens|text(+17)` to hit, reach 20 ft., one target. *Hit:* `dice:2d8+10|noform|noparens|avg|text(19)` (`2d8 + 10`) bludgeoning damage.

***Frightful Presence.*** Each creature of Klauth's choice that is within 120 feet of Klauth and aware of him must succeed on a DC 21 Wisdom saving throw or become [frightened](rules/5e/conditions.md#Frightened) for 1 minute. A creature can repeat the saving throw at the end of each of its turns, ending the effect on itself on a success. If a creature's saving throw is successful or the effect ends for it, the creature is immune to Klauth's Frightful Presence for the next 24 hours.

***Fire Breath (Recharge 5-6).*** Klauth exhales fire in a 90-foot cone. Each creature in that area must make a DC 24 Dexterity saving throw, taking `dice:26d6|noform|noparens|avg|text(91)` (`26d6`) fire damage on a failed save, or half as much damage on a successful one.
...
**At will:** [comprehend languages](compendium/5e/spells/comprehend-languages.md), [detect magic](compendium/5e/spells/detect-magic.md), [mage hand](compendium/5e/spells/mage-hand.md), [minor illusion](compendium/5e/spells/minor-illusion.md), [prestidigitation](compendium/5e/spells/prestidigitation.md)

**2/day each:** [darkness](compendium/5e/spells/darkness.md), [detect thoughts](compendium/5e/spells/detect-thoughts.md), [ice storm](compendium/5e/spells/ice-storm.md)

**1/day each:** [banishment](compendium/5e/spells/banishment.md), [cloudkill](compendium/5e/spells/cloudkill.md), [disintegrate](compendium/5e/spells/disintegrate.md), [etherealness](compendium/5e/spells/etherealness.md), [find the path](compendium/5e/spells/find-the-path.md) (cast as 1 action), [greater invisibility](compendium/5e/spells/greater-invisibility.md), [haste](compendium/5e/spells/haste.md), [locate object](compendium/5e/spells/locate-object.md), [mass suggestion](compendium/5e/spells/mass-suggestion.md), [mirage arcane](compendium/5e/spells/mirage-arcane.md) (cast as 1 action), [prismatic spray](compendium/5e/spells/prismatic-spray.md)

## Legendary Actions

***Detect.*** Klauth makes a Wisdom ([Perception](rules/5e/skills.md#Perception)) check.

***Tail Attack.*** Klauth makes a tail attack.

***Wing Attack (Costs 2 Actions).*** Klauth beats his wings. Each creature within 15 feet of Klauth must succeed on a DC 25 Dexterity saving throw or take `dice:2d6+10|noform|noparens|avg|text(17)` (`2d6 + 10`) bludgeoning damage and be knocked [prone](rules/5e/conditions.md#Prone). Klauth can then fly up to half his flying speed.

![Red Dragon](compendium/5e/bestiary/legendary-group/red-dragon-mm.md)
```
^statblock