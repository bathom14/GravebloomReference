...
- 5e/monster/type/humanoid/strongheart-halfling
aliases:
- Bepis Honeymaker
---
# Bepis Honeymaker
...
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/WDH/Bepis%20Honeymaker.webp#token)
...
***Brave.*** Bepis has advantage on saving throws against being [frightened](rules/5e/conditions.md#Frightened).
```
^statblock