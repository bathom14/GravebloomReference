...
- **Skills** [Deception](rules/5e/skills.md#Deception) +15, [Perception](rules/5e/skills.md#Perception) +12, [Persuasion](rules/5e/skills.md#Persuasion) +15
...
***Wave of Sorrow (Greatsword).*** *Melee Weapon Attack:* `dice:1d20+13|noform|noparens|text(+13)` to hit, reach 10 ft., one target. *Hit:* `dice:4d6+6|noform|noparens|avg|text(20)` (`4d6 + 6`) force damage plus `dice:4d6|noform|noparens|avg|text(14)` (`4d6`) acid damage.
...
**At will:** [charm person](compendium/5e/spells/charm-person.md), [detect magic](compendium/5e/spells/detect-magic.md), [dispel magic](compendium/5e/spells/dispel-magic.md)

**3/day each:** [darkness](compendium/5e/spells/darkness.md), [dominate person](compendium/5e/spells/dominate-person.md), [telekinesis](compendium/5e/spells/telekinesis.md), [teleport](compendium/5e/spells/teleport.md)

**1/day each:** [dominate monster](compendium/5e/spells/dominate-monster.md), [greater invisibility](compendium/5e/spells/greater-invisibility.md)
...
***Dance, My Puppet!.*** One creature [charmed](rules/5e/conditions.md#Charmed) by Graz'zt that Graz'zt can see must use its reaction to move up to its speed as Graz'zt directs.

![Graz'zt](compendium/5e/bestiary/legendary-group/grazzt-mpmm.md)
```
^statblock