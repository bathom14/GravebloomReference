...
- 5e/monster/type/humanoid/goblin
...
- **Armor Class** 20 ([plate](compendium/5e/items/plate-armor-phb.md), [shield](compendium/5e/items/shield-phb.md))
...
- **Skills** [Medicine](rules/5e/skills.md#Medicine) +8, [Religion](rules/5e/skills.md#Religion) +3, [Survival](rules/5e/skills.md#Survival) +8
...
***Special Equipment.*** Dermot wears [mariner's armor](compendium/5e/items/mariners-armor-dmg.md) and wields a ruidium warhammer (see appendix B). If Dermot rolls a 1 on an attack roll made with the warhammer, he must succeed on a DC 20 Charisma saving throw or gain 1 level of [exhaustion](rules/5e/conditions.md#Exhaustion).

## Actions

***Multiattack.*** Dermot makes one Ruidium Warhammer attack and one Searing Wrath attack.

***Ruidium Warhammer.*** *Melee Weapon Attack:* `dice:1d20+7|noform|noparens|text(+7)` to hit, reach 5 ft., one target. *Hit:* `dice:1d8+4|noform|noparens|avg|text(8)` (`1d8 + 4`) bludgeoning damage, or `dice:1d10+4|noform|noparens|avg|text(9)` (`1d10 + 4`) bludgeoning damage when used with two hands, plus `dice:2d6|noform|noparens|avg|text(7)` (`2d6`) psychic damage.

***Searing Wrath.*** *Ranged Spell Attack:* `dice:1d20+8|noform|noparens|text(+8)` to hit, range 60 ft., one creature. *Hit:* `dice:5d8|noform|noparens|avg|text(22)` (`5d8`) radiant damage, and the target is [blinded](rules/5e/conditions.md#Blinded) until the end of its next turn.

***Spellcasting.*** Dermot casts one of the following spells, using Wisdom as the spellcasting ability (spell save DC 16):

**At will:** [guidance](compendium/5e/spells/guidance.md), [light](compendium/5e/spells/light.md), [spare the dying](compendium/5e/spells/spare-the-dying.md)

**2/day each:** [bless](compendium/5e/spells/bless.md) (at 3rd level), [cure wounds](compendium/5e/spells/cure-wounds.md) (at 3rd level)

**1/day:** [revivify](compendium/5e/spells/revivify.md)
```
^statblock