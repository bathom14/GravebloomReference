...
- 5e/monster/type/monstrosity/yuan-ti
aliases:
- Ras Nsi
---
# Ras Nsi
...
- **Armor Class** 15 ([bracers of defense](compendium/5e/items/bracers-of-defense.md))
- **Speed** 30 ft.
...
- **Skills** [Deception](rules/5e/skills.md#Deception) +8, [Persuasion](rules/5e/skills.md#Persuasion) +8, [Religion](rules/5e/skills.md#Religion) +7, [Stealth](rules/5e/skills.md#Stealth) +6
...
***Spellcasting.*** Ras Nsi is an 11th-level spellcaster. His spellcasting ability is Intelligence (spell save DC 15, `dice:1d20+7|noform|noparens|text(+7)` to hit with spell attacks).

Ras Nsi has the following wizard spells prepared:

**Cantrips (at will):** [chill touch](compendium/5e/spells/chill-touch.md), [fire bolt](compendium/5e/spells/fire-bolt.md), [mage hand](compendium/5e/spells/mage-hand.md), [mending](compendium/5e/spells/mending.md), [poison spray](compendium/5e/spells/poison-spray.md)

**1st level (4 slots):** [expeditious retreat](compendium/5e/spells/expeditious-retreat.md), [false life](compendium/5e/spells/false-life.md), [magic missile](compendium/5e/spells/magic-missile.md), [shield](compendium/5e/spells/shield.md)

**2nd level (3 slots):** [blindness/deafness](compendium/5e/spells/blindness-deafness.md), [hold person](compendium/5e/spells/hold-person.md), [misty step](compendium/5e/spells/misty-step.md)

**3rd level (3 slots):** [animate dead](compendium/5e/spells/animate-dead.md), [counterspell](compendium/5e/spells/counterspell.md), [fireball](compendium/5e/spells/fireball.md)

**4th level (3 slots):** [blight](compendium/5e/spells/blight.md), [polymorph](compendium/5e/spells/polymorph.md)

**5th level (2 slots):** [contact other plane](compendium/5e/spells/contact-other-plane.md), [geas](compendium/5e/spells/geas.md)

**6th level (1 slots):** [create undead](compendium/5e/spells/create-undead.md)
...
***Special Equipment.*** Ras Nsi wears [bracers of defense](compendium/5e/items/bracers-of-defense.md), wields a [flame tongue longsword](compendium/5e/items/flame-tongue-dmg.md), and carries a [sending stone](compendium/5e/items/sending-stones.md) matched to the one carried by the guide Salida (see chapter 1).
...
***Bite (Snake Form Only).*** *Melee Weapon Attack:* `dice:1d20+6|noform|noparens|text(+6)` to hit, reach 5 ft., one target. *Hit:* `dice:1d4+3|noform|noparens|avg|text(5)` (`1d4 + 3`) piercing damage plus `dice:2d6|noform|noparens|avg|text(7)` (`2d6`) poison damage.

***Constrict.*** *Melee Weapon Attack:* `dice:1d20+6|noform|noparens|text(+6)` to hit, reach 5 ft., one creature. *Hit:* `dice:2d6+3|noform|noparens|avg|text(10)` (`2d6 + 3`) bludgeoning damage, and the target is [grappled](rules/5e/conditions.md#Grappled) (escape DC 14). Until this grapple ends, the target is [restrained](rules/5e/conditions.md#Restrained), and Ras Nsi can't constrict another target.

***Flame Tongue Longsword (Yuan-ti Form Only).*** *Melee Weapon Attack:* `dice:1d20+6|noform|noparens|text(+6)` to hit, reach 5 ft., one target. *Hit:* `dice:1d8+3|noform|noparens|avg|text(7)` (`1d8 + 3`) slashing damage, or `dice:1d10+3|noform|noparens|avg|text(8)` (`1d10 + 3`) slashing damage when used with two hands, plus `dice:2d6|noform|noparens|avg|text(7)` (`2d6`) fire damage.
```
^statblock