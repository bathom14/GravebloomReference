...
- **Skills** [Acrobatics](rules/5e/skills.md#Acrobatics) +6, [Deception](rules/5e/skills.md#Deception) +5, [Stealth](rules/5e/skills.md#Stealth) +9, [Survival](rules/5e/skills.md#Survival) +5
...
***Dagger.*** *Melee  or Ranged Weapon Attack:* `dice:1d20+6|noform|noparens|text(+6)` to hit, reach 5 ft. or range 20/60 ft., one target. *Hit:* `dice:1d4+3|noform|noparens|avg|text(5)` (`1d4 + 3`) piercing damage plus `dice:4d6|noform|noparens|avg|text(14)` (`4d6`) poison damage.
```
^statblock