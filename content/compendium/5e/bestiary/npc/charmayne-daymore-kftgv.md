...
- 5e/monster/type/elemental/wizard
aliases:
- Charmayne Daymore
---
# Charmayne Daymore
...
- **Skills** [Arcana](rules/5e/skills.md#Arcana) +9, [Deception](rules/5e/skills.md#Deception) +7, [Perception](rules/5e/skills.md#Perception) +6
...
***Ashen Burst.*** *Melee  or Ranged Spell Attack:* `dice:1d20+9|noform|noparens|text(+9)` to hit, reach 5 ft. or range 60 ft., one target. *Hit:* `dice:5d6|noform|noparens|avg|text(17)` (`5d6`) fire damage.

***Cinder Spite (Recharge 5-6).*** Charmayne creates a magical explosion of fire centered on a point she can see within 120 feet of herself. Each creature in a 20-foot-radius sphere centered on that point must make a DC 17 Dexterity saving throw, taking `dice:10d6|noform|noparens|avg|text(35)` (`10d6`) fire damage on a failed save, or half as much damage on a successful one. A Humanoid reduced to 0 hit points by this damage dies and is transformed into a Tiny charcoal figurine.
