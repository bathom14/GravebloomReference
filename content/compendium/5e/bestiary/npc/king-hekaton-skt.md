...
- **Skills** [Arcana](rules/5e/skills.md#Arcana) +8, [Athletics](rules/5e/skills.md#Athletics) +14, [History](rules/5e/skills.md#History) +8, [Perception](rules/5e/skills.md#Perception) +9
...
**At will:** [detect magic](compendium/5e/spells/detect-magic.md), [feather fall](compendium/5e/spells/feather-fall.md), [levitate](compendium/5e/spells/levitate.md), [light](compendium/5e/spells/light.md)

**3/day each:** [control weather](compendium/5e/spells/control-weather.md), [water breathing](compendium/5e/spells/water-breathing.md)
...
***Broken Chain.*** *Melee Weapon Attack:* `dice:1d20+14|noform|noparens|text(+14)` to hit, reach 10 ft., one target. *Hit:* `dice:3d6+9|noform|noparens|avg|text(18)` (`3d6 + 9`) bludgeoning damage.

***Ballista.*** *Ranged Weapon Attack:* `dice:1d20+6|noform|noparens|text(+6)` to hit, range 120/480 ft., one target. *Hit:* `dice:3d10+2|noform|noparens|avg|text(18)` (`3d10 + 2`) piercing damage.

***Lightning Strike (Recharge 5-6).*** Hekaton hurls a magical lightning bolt at a point he can see within 500 feet of it. Each creature within 10 feet of that point must make a DC 17 Dexterity saving throw, taking `dice:12d8|noform|noparens|avg|text(54)` (`12d8`) lightning damage on a failed save, or half as much damage on a successful one.

***Thunderous Stomp (Recharge 6).*** Hekaton stomps the ground, triggering a thunderclap. All other creatures within 15 feet of him must succeed on a DC 17 Constitution saving throw or take `dice:6d10|noform|noparens|avg|text(33)` (`6d10`) thunder damage and be [deafened](rules/5e/conditions.md#Deafened) until the start of Hekaton's next turn. On a successful save, a creature takes half as much damage and isn't [deafened](rules/5e/conditions.md#Deafened). The thunderclap can be heard out to a range of 1,200 feet.
```
^statblock