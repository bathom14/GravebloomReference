...
- **Skills** [Arcana](rules/5e/skills.md#Arcana) +15, [History](rules/5e/skills.md#History) +15, [Insight](rules/5e/skills.md#Insight) +13, [Perception](rules/5e/skills.md#Perception) +13
...
***Alien Mind.*** If a creature tries to read Dyrrn's thoughts or deals psychic damage to it, that creature must succeed on a DC 23 Intelligence saving throw or be [stunned](rules/5e/conditions.md#Stunned) for 1 minute. The [stunned](rules/5e/conditions.md#Stunned) creature can repeat the saving throw at the end of each of its turns, ending the effect on itself on a success.
...
***Multiattack.*** Dyrrn makes one Tentacle Whip attack and uses its Corruption once. Dyrrn can replace its Tentacle Whip attack with Extract Brain if it has a creature [grappled](rules/5e/conditions.md#Grappled).

***Tentacle Whip.*** *Melee Weapon Attack:* `dice:1d20+15|noform|noparens|text(+15)` to hit, reach 10 ft., one target. *Hit:* `dice:3d10+8|noform|noparens|avg|text(24)` (`3d10 + 8`) slashing damage. If the target is a Medium or smaller creature, it is [grappled](rules/5e/conditions.md#Grappled) (escape DC 23), pulled into an unoccupied space within 5 feet of Dyrrn, and must succeed on a DC 23 Intelligence saving throw or be [stunned](rules/5e/conditions.md#Stunned) until this grapple ends. Dyrrn can't use the same tentacle whip on another target until this grapple ends. Dyrrn has two tentacle whips.

***Corruption.*** Dyrrn targets one creature it can see within 60 feet of it. The target must succeed on a DC 23 Constitution saving throw or take `dice:4d6+8|noform|noparens|avg|text(22)` (`4d6 + 8`) necrotic damage and become corrupted for 1 minute.
...
***Extract Brain.*** *Melee Weapon Attack:* `dice:1d20+15|noform|noparens|text(+15)` to hit, reach 5 ft., one [incapacitated](rules/5e/conditions.md#Incapacitated) creature [grappled](rules/5e/conditions.md#Grappled) by Dyrrn. *Hit:* `dice:10d10|noform|noparens|avg|text(55)` (`10d10`) piercing damage. If this damage reduces the target to 0 hit points, Dyrrn kills the target by extracting and devouring its brain.
...
***Mind Blast (Costs 3 Actions).*** Dyrrn magically emits psychic energy in a 60-foot cone. Each creature in that area must succeed on a DC 23 Intelligence saving throw or take `dice:5d8+8|noform|noparens|avg|text(30)` (`5d8 + 8`) psychic damage and be [stunned](rules/5e/conditions.md#Stunned) for 1 minute. A creature can repeat the saving throw at the end of each of its turns, ending the effect on itself on a success.

![Dyrrn](compendium/5e/bestiary/legendary-group/dyrrn-erlw.md)
```
^statblock