...
- **Skills** [Deception](rules/5e/skills.md#Deception) +6, [Insight](rules/5e/skills.md#Insight) +6, [Perception](rules/5e/skills.md#Perception) +6, [Stealth](rules/5e/skills.md#Stealth) +7
...
***Sunlight Sensitivity.*** While in sunlight, Kyrilla has disadvantage on attack rolls and on Wisdom ([Perception](rules/5e/skills.md#Perception)) checks that rely on sight.
...
***Claw.*** *Melee Weapon Attack:* `dice:1d20+7|noform|noparens|text(+7)` to hit, reach 5 ft., one target. *Hit:* `dice:3d6+3|noform|noparens|avg|text(13)` (`3d6 + 3`) slashing damage.

***Constrict.*** *Melee Weapon Attack:* `dice:1d20+4|noform|noparens|text(+4)` to hit, reach 10 ft., one target. *Hit:* `dice:3d6|noform|noparens|avg|text(10)` (`3d6`) bludgeoning damage, and the target is [grappled](rules/5e/conditions.md#Grappled) (escape DC 13) if it is a Large or smaller creature. Until this grapple ends, the target is [restrained](rules/5e/conditions.md#Restrained), and Kyrilla can't constrict another target.

***Longbow.*** *Ranged Weapon Attack:* `dice:1d20+7|noform|noparens|text(+7)` to hit, range 150/600 ft., one target. *Hit:* `dice:3d8+3|noform|noparens|avg|text(16)` (`3d8 + 3`) piercing damage.
...
***Detect.*** Kyrilla makes a Wisdom ([Perception](rules/5e/skills.md#Perception)) check.

***Slither.*** Kyrilla moves up to her speed without provoking opportunity attacks.

![Kyrilla, Accursed Gorgon](compendium/5e/bestiary/legendary-group/kyrilla-accursed-gorgon-aitfr-dn.md)
```
^statblock