...
***Freedom of Movement.*** Slarkrethel ignores difficult terrain, and magical effects can't reduce its speed or cause it to be [restrained](rules/5e/conditions.md#Restrained). It can spend 5 feet of movement to escape from nonmagical restraints or being [grappled](rules/5e/conditions.md#Grappled).
...
***Bite.*** *Melee Weapon Attack:* `dice:1d20+17|noform|noparens|text(+17)` to hit, reach 5 ft., one target. *Hit:* `dice:3d8+10|noform|noparens|avg|text(23)` (`3d8 + 10`) piercing damage. If the target is a Large or smaller creature [grappled](rules/5e/conditions.md#Grappled) by Slarkrethel, that creature is swallowed, and the grapple ends. While swallowed, the creature is [blinded](rules/5e/conditions.md#Blinded) and [restrained](rules/5e/conditions.md#Restrained), it has total cover against attacks and other effects outside Slarkrethel, and it takes `dice:12d6|noform|noparens|avg|text(42)` (`12d6`) acid damage at the start of each of Slarkrethel's turns. If Slarkrethel takes 50 damage or more on a single turn from a creature inside it, Slarkrethel must succeed on a DC 25 Constitution saving throw at the end of that turn or regurgitate all swallowed creatures, which fall [prone](rules/5e/conditions.md#Prone) in a space within 10 feet of Slarkrethel. If Slarkrethel dies, a swallowed creature is no longer [restrained](rules/5e/conditions.md#Restrained) by it and can escape from the corpse using 15 feet of movement, exiting [prone](rules/5e/conditions.md#Prone).

***Tentacle.*** *Melee Weapon Attack:* `dice:1d20+17|noform|noparens|text(+17)` to hit, reach 30 ft., one target. *Hit:* `dice:3d6+10|noform|noparens|avg|text(20)` (`3d6 + 10`) bludgeoning damage, and the target is [grappled](rules/5e/conditions.md#Grappled) (escape DC 18). Until this grapple ends, the target is [restrained](rules/5e/conditions.md#Restrained). Slarkrethel has ten tentacles, each of which can grapple one target.
...
**At will:** [detect magic](compendium/5e/spells/detect-magic.md), [detect thoughts](compendium/5e/spells/detect-thoughts.md), [sending](compendium/5e/spells/sending.md)

**2/day each:** [control weather](compendium/5e/spells/control-weather.md) (cast as 1 action), [fly](compendium/5e/spells/fly.md), [ice storm](compendium/5e/spells/ice-storm.md)

**1/day each:** [arcane eye](compendium/5e/spells/arcane-eye.md), [chain lightning](compendium/5e/spells/chain-lightning.md), [feeblemind](compendium/5e/spells/befuddlement.md), [foresight](compendium/5e/spells/foresight.md), [locate creature](compendium/5e/spells/locate-creature.md), [mass suggestion](compendium/5e/spells/mass-suggestion.md), [nondetection](compendium/5e/spells/nondetection.md), [power word kill](compendium/5e/spells/power-word-kill.md), [scrying](compendium/5e/spells/scrying.md) (cast as 1 action), [sequester](compendium/5e/spells/sequester.md), [telekinesis](compendium/5e/spells/telekinesis.md), [teleport](compendium/5e/spells/teleport.md)
...
***Ink Cloud (Costs 3 Actions).*** While underwater, Slarkrethel expels an ink cloud in a 60-foot radius. The cloud spreads around corners, and that area is heavily obscured to creatures other than Slarkrethel. Each creature other than Slarkrethel that ends its turn there must succeed on a DC 23 Constitution saving throw, taking `dice:3d10|noform|noparens|avg|text(16)` (`3d10`) poison damage on a failed save, or half as much damage on a successful one. A strong current disperses the cloud, which otherwise disappears at the end of Slarkrethel's next turn.

![Kraken](compendium/5e/bestiary/legendary-group/kraken-mm.md)
```
^statblock