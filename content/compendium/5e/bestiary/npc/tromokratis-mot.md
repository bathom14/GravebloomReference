...
- **Condition Immunities** [charmed](rules/5e/conditions.md#Charmed), [frightened](rules/5e/conditions.md#Frightened), [paralyzed](rules/5e/conditions.md#Paralyzed), [restrained](rules/5e/conditions.md#Restrained)
- **Languages** —
- **Challenge** 26
...
***Pincer.*** *Melee Weapon Attack:* `dice:1d20+18|noform|noparens|text(+18)` to hit, reach 20 ft., one target. *Hit:* `dice:3d6+10|noform|noparens|avg|text(20)` (`3d6 + 10`) bludgeoning damage, and if the target is a creature, it is [grappled](rules/5e/conditions.md#Grappled) (escape DC 26). Until the grapple ends, the target is [restrained](rules/5e/conditions.md#Restrained), and Tromokratis can't use this attack on anyone else.

***Tail.*** *Melee Weapon Attack:* `dice:1d20+18|noform|noparens|text(+18)` to hit, reach 20 ft., one target. *Hit:* `dice:3d8+10|noform|noparens|avg|text(23)` (`3d8 + 10`) bludgeoning damage, and if the target is a creature, it is knocked [prone](rules/5e/conditions.md#Prone).

***Tentacle Grasp.*** *Melee Weapon Attack:* `dice:1d20+18|noform|noparens|text(+18)` to hit, reach 20 ft., one creature. *Hit:* `dice:3d6+10|noform|noparens|avg|text(20)` (`3d6 + 10`) bludgeoning damage, and the target is [grappled](rules/5e/conditions.md#Grappled) (escape DC 26). If the target doesn't escape by the end of its next turn, Tromokratis throws the target up to 60 feet in a straight line. The target lands [prone](rules/5e/conditions.md#Prone) and takes `dice:6d6|noform|noparens|avg|text(21)` (`6d6`) bludgeoning damage.

***Bite.*** *Melee Weapon Attack:* `dice:1d20+18|noform|noparens|text(+18)` to hit, reach 5 ft., one target. *Hit:* `dice:3d12+10|noform|noparens|avg|text(29)` (`3d12 + 10`) piercing damage. If the target is a Large or smaller creature [grappled](rules/5e/conditions.md#Grappled) by Tromokratis, that creature is swallowed, and the grapple ends. While swallowed, the creature is [blinded](rules/5e/conditions.md#Blinded) and [restrained](rules/5e/conditions.md#Restrained), it has total cover against attacks and other effects outside Tromokratis, and it takes `dice:12d6|noform|noparens|avg|text(42)` (`12d6`) acid damage at the start of each of Tromokratis's turns. If Tromokratis takes 50 damage or more on a single turn from a creature inside it, Tromokratis must succeed on a DC 20 Constitution saving throw at the end of that turn or regurgitate all swallowed creatures, which fall [prone](rules/5e/conditions.md#Prone) in a space within 10 feet of Tromokratis. If Tromokratis dies, a swallowed creature is no longer [restrained](rules/5e/conditions.md#Restrained) by it and can escape from the corpse by using 15 feet of movement, exiting [prone](rules/5e/conditions.md#Prone).
...
![Tromokratis](compendium/5e/bestiary/legendary-group/tromokratis-mot.md)
```
^statblock