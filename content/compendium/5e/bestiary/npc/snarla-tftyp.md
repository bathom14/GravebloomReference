...
- 5e/monster/type/humanoid/shapechanger
aliases:
- Snarla
---
# Snarla
...
A humanoid creature can be afflicted with the curse of lycanthropy after being wounded by a lycanthrope, or if one or both of its parents are lycanthropes. A [remove curse](compendium/5e/spells/remove-curse.md) spell can rid an afflicted lycanthrope of the curse, but a natural born lycanthrope can be freed of the curse only with a wish.
...
**Cantrips (at will):** [fire bolt](compendium/5e/spells/fire-bolt.md), [light](compendium/5e/spells/light.md), [mage hand](compendium/5e/spells/mage-hand.md), [shocking grasp](compendium/5e/spells/shocking-grasp.md)

**1st level (4 slots):** [magic missile](compendium/5e/spells/magic-missile.md), [shield](compendium/5e/spells/shield.md), [thunderwave](compendium/5e/spells/thunderwave.md)

**2nd level (3 slots):** [mirror image](compendium/5e/spells/mirror-image.md), [web](compendium/5e/spells/web.md)

**3rd level (3 slots):** [dispel magic](compendium/5e/spells/dispel-magic.md), [fear](compendium/5e/spells/fear.md), [haste](compendium/5e/spells/haste.md), [stinking cloud](compendium/5e/spells/stinking-cloud.md)

***Shapechanger.*** The werewolf can use its action to polymorph into a wolf-humanoid hybrid or into a wolf, or back into its true form, which is humanoid. Its statistics, other than its AC, are the same in each form. Any equipment it is wearing or carrying isn't transformed. It reverts to its true form if it dies.

***Keen Hearing and Smell.*** The werewolf has advantage on Wisdom ([Perception](rules/5e/skills.md#Perception)) checks that rely on hearing or smell.
...
***Bite (Wolf or Hybrid Form Only).*** *Melee Weapon Attack:* `dice:1d20+4|noform|noparens|text(+4)` to hit, reach 5 ft., one target. *Hit:* `dice:1d8+2|noform|noparens|avg|text(6)` (`1d8 + 2`) piercing damage. If the target is a humanoid, it must succeed on a DC 12 Constitution saving throw or be cursed with werewolf lycanthropy.

***Claws (Hybrid Form Only).*** *Melee Weapon Attack:* `dice:1d20+4|noform|noparens|text(+4)` to hit, reach 5 ft., one creature. *Hit:* `dice:2d4+2|noform|noparens|avg|text(7)` (`2d4 + 2`) slashing damage.

***Spear (Humanoid Form Only).*** *Melee  or Ranged Weapon Attack:* `dice:1d20+4|noform|noparens|text(+4)` to hit, reach 5 ft. or range 20/60 ft., one creature. *Hit:* `dice:1d6+2|noform|noparens|avg|text(5)` (`1d6 + 2`) piercing damage, or `dice:1d8+2|noform|noparens|avg|text(6)` (`1d8 + 2`) piercing damage if used with two hands to make a melee attack.
```
^statblock