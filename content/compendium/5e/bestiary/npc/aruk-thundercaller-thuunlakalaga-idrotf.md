...
- 5e/monster/type/humanoid/goliath
aliases:
...
***Greataxe.*** *Melee Weapon Attack:* `dice:1d20+6|noform|noparens|text(+6)` to hit, reach 5 ft., one target. *Hit:* `dice:1d12+4|noform|noparens|avg|text(10)` (`1d12 + 4`) slashing damage.

***Javelin.*** *Melee  or Ranged Weapon Attack:* `dice:1d20+6|noform|noparens|text(+6)` to hit, reach 5 ft. or range 30/120 ft., one target. *Hit:* `dice:1d6+4|noform|noparens|avg|text(7)` (`1d6 + 4`) piercing damage.

## Reactions

***Stone's Endurance (Recharges after a Short or Long Rest).*** When Aruk takes damage, it reduces the damage taken by `dice:1d12+3|noform|noparens|avg|text(9)` (`1d12 + 3`).
```
^statblock