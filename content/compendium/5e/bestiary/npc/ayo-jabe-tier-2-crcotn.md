...
- **Skills** [Athletics](rules/5e/skills.md#Athletics) +5, [Perception](rules/5e/skills.md#Perception) +5, [Survival](rules/5e/skills.md#Survival) +5
...
***Harpoon.*** *Melee Weapon Attack:* `dice:1d20+5|noform|noparens|text(+5)` to hit, reach 5 ft., one target. *Hit:* `dice:2d8+2|noform|noparens|avg|text(11)` (`2d8 + 2`) piercing damage.

***Longbow.*** *Ranged Weapon Attack:* `dice:1d20+6|noform|noparens|text(+6)` to hit, range 150/600 ft., one target. *Hit:* `dice:2d8+3|noform|noparens|avg|text(12)` (`2d8 + 3`) piercing damage.

***Spellcasting.*** Ayo casts one of the following spells, using Wisdom as the spellcasting ability (spell save DC 13):

**1/day each:** [animal friendship](compendium/5e/spells/animal-friendship.md), [goodberry](compendium/5e/spells/goodberry.md), [pass without trace](compendium/5e/spells/pass-without-trace.md)
