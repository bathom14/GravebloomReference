...
- **Armor Class** 16 ([chain mail](compendium/5e/items/chain-mail-phb.md))
...
- **Skills** [Arcana](rules/5e/skills.md#Arcana) +4, [Deception](rules/5e/skills.md#Deception) +7, [Intimidation](rules/5e/skills.md#Intimidation) +7
...
***Innate Spellcasting.*** Xardorok's innate spellcasting ability is Charisma (spell save DC 15, `dice:1d20+7|noform|noparens|text(+7)` to hit with spell attacks). He can innately cast the following spells, requiring no material components:

**At will:** [eldritch blast](compendium/5e/spells/eldritch-blast.md) (see "Actions" below), [mage hand](compendium/5e/spells/mage-hand.md)

**1/day each:** [hold person](compendium/5e/spells/hold-person.md), [suggestion](compendium/5e/spells/suggestion.md)

***Duergar Resilience.*** Xardorok has advantage on saving throws against poison, spells, and illusions, as well as to resist being [charmed](rules/5e/conditions.md#Charmed) or [paralyzed](rules/5e/conditions.md#Paralyzed).

***Sunlight Sensitivity.*** While in sunlight, Xardorok has disadvantage on attack rolls, as well as on Wisdom ([Perception](rules/5e/skills.md#Perception)) checks that rely on sight.

## Actions

***Multiattack.*** Xardorok attacks twice with a weapon or casts [eldritch blast](compendium/5e/spells/eldritch-blast.md) twice.

***Spiked Gauntlet.*** *Melee Weapon Attack:* `dice:1d20+6|noform|noparens|text(+6)` to hit, reach 5 ft., one target. *Hit:* `dice:1d4+3|noform|noparens|avg|text(5)` (`1d4 + 3`) piercing damage, or `dice:2d4+3|noform|noparens|avg|text(8)` (`2d4 + 3`) piercing damage while Xardorok is enlarged.

***Eldritch Blast (Cantrip).*** *Ranged Spell Attack:* `dice:1d20+7|noform|noparens|text(+7)` to hit, range 120 ft., one creature. *Hit:* `dice:1d10+4|noform|noparens|avg|text(9)` (`1d10 + 4`) force damage.
...
***Invisibility (Recharge 4-6).*** Xardorok magically turns [invisible](rules/5e/conditions.md#Invisible) until he attacks, he casts a spell, he uses his Enlarge, or his [concentration](rules/5e/conditions.md#Concentration) is broken (as if [concentrating](rules/5e/conditions.md#Concentration) on a spell). Any equipment Xardorok wears or carries is [invisible](rules/5e/conditions.md#Invisible) with him.

## Reactions

***Hellish Rebuke (2/Day).*** When Xardorok is damaged by a creature within 60 feet of him that he can see, the creature that damaged him is engulfed in hellish flames and must make a DC 15 Dexterity saving throw, taking `dice:3d10|noform|noparens|avg|text(16)` (`3d10`) fire damage on a failed save, or half as much damage on a successful one.
```
^statblock