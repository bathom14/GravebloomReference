...
- **Skills** [Athletics](rules/5e/skills.md#Athletics) +9, [History](rules/5e/skills.md#History) +3, [Insight](rules/5e/skills.md#Insight) +5, [Perception](rules/5e/skills.md#Perception) +5
...
***Axe.*** *Melee Weapon Attack:* `dice:1d20+9|noform|noparens|text(+9)` to hit, reach 5 ft., one target. *Hit:* `dice:2d10+6|noform|noparens|avg|text(17)` (`2d10 + 6`) slashing damage.

***Rock.*** *Ranged Weapon Attack:* `dice:1d20+9|noform|noparens|text(+9)` to hit, range 60/240 ft., one target. *Hit:* `dice:2d10+6|noform|noparens|avg|text(17)` (`2d10 + 6`) bludgeoning damage.
