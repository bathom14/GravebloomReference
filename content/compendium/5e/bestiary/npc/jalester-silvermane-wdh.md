...
- **Armor Class** 18 ([chain mail](compendium/5e/items/chain-mail-phb.md), [Badge of the Watch](compendium/5e/items/badge-of-the-watch-wdh.md))
...
- **Skills** [Athletics](rules/5e/skills.md#Athletics) +4, [Survival](rules/5e/skills.md#Survival) +4
...
***Special Equipment.*** Jalester carries a [badge of the Watch](compendium/5e/items/badge-of-the-watch-wdh.md).

***Second Wind (Recharges after a Short or Long Rest).*** As a bonus action, Jalester can regain `dice:1d10+11|noform|noparens|avg|text(16)` (`1d10 + 11`) hit points.

## Actions

***Multiattack.*** Jalester makes two weapon attacks.

***Longsword.*** *Melee Weapon Attack:* `dice:1d20+4|noform|noparens|text(+4)` to hit, reach 5 ft., one target. *Hit:* `dice:1d8+2|noform|noparens|avg|text(6)` (`1d8 + 2`) slashing damage, or `dice:1d10+2|noform|noparens|avg|text(7)` (`1d10 + 2`) slashing damage when used with two hands.
