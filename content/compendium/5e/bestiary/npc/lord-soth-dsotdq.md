...
- 5e/monster/type/undead/paladin
aliases:
- Lord Soth
---
# Lord Soth
...
***Marshal Undead.*** Unless Soth is [incapacitated](rules/5e/conditions.md#Incapacitated), he and Undead creatures of his choice within 60 feet of him are immune to features that turn Undead.
...
***Forsaken Brand.*** *Melee Weapon Attack:* `dice:1d20+12|noform|noparens|text(+12)` to hit, reach 5 ft., one target. *Hit:* `dice:1d8+6|noform|noparens|avg|text(10)` (`1d8 + 6`) bludgeoning damage plus `dice:4d8|noform|noparens|avg|text(18)` (`4d8`) necrotic damage, and if the target is a creature, it can't regain hit points until the start of Soth's next turn.
