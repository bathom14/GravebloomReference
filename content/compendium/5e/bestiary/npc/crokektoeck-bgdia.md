...
***Bite.*** *Melee Weapon Attack:* `dice:1d20+14|noform|noparens|text(+14)` to hit, reach 15 ft., one target. *Hit:* `dice:10d6+9|noform|noparens|avg|text(44)` (`10d6 + 9`) piercing damage.

***Disgorge Allies (Recharge 6).*** Crokek'toeck opens its mouth and disgorges `dice:1d4|noform|noparens|avg` (`d4`) [barlguras](compendium/5e/bestiary/fiend/barlgura.md), `dice:3d6|noform|noparens|avg` (`3d6`) [gnolls](compendium/5e/bestiary/fiend/gnoll-warrior.md) led by 1 [gnoll fang of Yeenoghu](compendium/5e/bestiary/fiend/gnoll-fang-of-yeenoghu.md), `dice:6d6|noform|noparens|avg` (`6d6`) [dretches](compendium/5e/bestiary/fiend/dretch.md), or `dice:1d3|noform|noparens|avg` (`d3`) [vrocks](compendium/5e/bestiary/fiend/vrock.md). Each creature it disgorges appears in an unoccupied space within 30 feet of Crokek'toeck's mouth, or the next closest unoccupied space.
```
^statblock