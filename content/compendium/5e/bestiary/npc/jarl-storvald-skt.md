...
- **Skills** [Athletics](rules/5e/skills.md#Athletics) +9, [Perception](rules/5e/skills.md#Perception) +6
...
***Weighted Net.*** *Ranged Weapon Attack:* `dice:1d20+5|noform|noparens|text(+5)` to hit, ranged 20/60 ft., one Small, Medium, or Large creature. *Hit:* The target is [restrained](rules/5e/conditions.md#Restrained) until it escapes the net. Any creature can use its action to make a DC 17 Strength check to free itself or another creature in the net, ending the effect on a success. Dealing 15 slashing damage to the net (AC 12) destroys the net and frees the target.

***Multiattack.*** The giant makes two greataxe attacks.

***Greataxe.*** *Melee Weapon Attack:* `dice:1d20+9|noform|noparens|text(+9)` to hit, reach 10 ft., one target. *Hit:* `dice:3d12+6|noform|noparens|avg|text(25)` (`3d12 + 6`) slashing damage.

***Rock.*** *Ranged Weapon Attack:* `dice:1d20+9|noform|noparens|text(+9)` to hit, range 60/240 ft., one target. *Hit:* `dice:4d10+6|noform|noparens|avg|text(28)` (`4d10 + 6`) bludgeoning damage.
...
**1/day each:** [jump](compendium/5e/spells/jump.md), [locate animals or plants](compendium/5e/spells/locate-animals-or-plants.md), [locate object](compendium/5e/spells/locate-object.md), [water breathing](compendium/5e/spells/water-breathing.md), [water walk](compendium/5e/spells/water-walk.md)
```
^statblock