...
- **Armor Class** 13 ([hide armor](compendium/5e/items/hide-armor-phb.md), [shield](compendium/5e/items/shield-phb.md))
...
- **Proficiency Bonus** +3
- **Saving Throws** ⏤
- **Skills** [Athletics](rules/5e/skills.md#Athletics) +8, [Intimidation](rules/5e/skills.md#Intimidation) +6, [Survival](rules/5e/skills.md#Survival) +3
...
***Menacing Blows (1/Turn).*** Gunvald deals an extra `dice:1d12|noform|noparens|avg|text(6)` (`d12`) damage when he hits a target with a weapon attack. If the target is a creature, it must succeed on a DC 14 Wisdom saving throw or be [frightened](rules/5e/conditions.md#Frightened) until the start of Gunvald's next turn.
...
***Battleaxe.*** *Melee Weapon Attack:* `dice:1d20+8|noform|noparens|text(+8)` to hit, reach 5 ft., one target. *Hit:* `dice:1d8+5|noform|noparens|avg|text(9)` (`1d8 + 5`) slashing damage, or `dice:1d10+5|noform|noparens|avg|text(10)` (`1d10 + 5`) slashing damage when used with two hands, plus `dice:1d12|noform|noparens|avg|text(6)` (`d12`) slashing damage if Gunvald uses Menacing Blows.

***Javelin.*** *Melee  or Ranged Weapon Attack:* `dice:1d20+8|noform|noparens|text(+8)` to hit, range 30/120 ft., one target. *Hit:* `dice:1d6+5|noform|noparens|avg|text(8)` (`1d6 + 5`) piercing damage, plus `dice:1d12|noform|noparens|avg|text(6)` (`d12`) piercing damage if Gunvald uses Menacing Blows.
```
^statblock