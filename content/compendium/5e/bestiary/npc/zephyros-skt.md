...
**At will:** [detect magic](compendium/5e/spells/detect-magic.md), [fog cloud](compendium/5e/spells/fog-cloud.md), [light](compendium/5e/spells/light.md)

**3/day each:** [feather fall](compendium/5e/spells/feather-fall.md), [fly](compendium/5e/spells/fly.md), [misty step](compendium/5e/spells/misty-step.md), [telekinesis](compendium/5e/spells/telekinesis.md)

**1/day each:** [control weather](compendium/5e/spells/control-weather.md), [gaseous form](compendium/5e/spells/gaseous-form.md)

***Keen Smell.*** Zephyros has advantage on Wisdom ([Perception](rules/5e/skills.md#Perception)) checks that rely on smell.

## Actions

***Fling.*** Zephyros tries to throw a Small or Medium creature within 10 feet of it. The target must succeed on a DC 20 Dexterity saving throw or be hurled up to 60 feet horizontally in a direction of Zephyros's choice and land [prone](rules/5e/conditions.md#Prone), taking `dice:1d8|noform|noparens|avg` (`d8`) bludgeoning damage for every 10 feet it was thrown.

***Wind Aura.*** A magical aura of wind surrounds Zephyros. The aura is a 10-foot-radius sphere that lasts as long as he maintains [concentration](rules/5e/conditions.md#Concentration) on it (as if [concentrating](rules/5e/conditions.md#Concentration) on a spell). While the aura is in effect, Zephyros gains a +2 bonus to his AC against ranged weapon attacks, and all open flames within the aura are extinguished unless they are magical.

***Multiattack.*** Zephyros makes two staff attacks.

***Staff of the Magi.*** *Melee Weapon Attack:* `dice:1d20+15|noform|noparens|text(+15)` to hit, reach 10 ft., one target. *Hit:* `dice:3d6+10|noform|noparens|avg|text(20)` (`3d6 + 10`) bludgeoning damage, or `dice:3d8+10|noform|noparens|avg|text(23)` (`3d8 + 10`) bludgeoning damage if used with two hands. This damage is considered magical..

***Rock.*** *Ranged Weapon Attack:* `dice:1d20+12|noform|noparens|text(+12)` to hit, range 60/240 ft., one target. *Hit:* `dice:4d10+8|noform|noparens|avg|text(30)` (`4d10 + 8`) bludgeoning damage.

***Spellcasting.*** Zephyros casts one of the following spells, requiring no material components and using Intelligence as the spellcasting ability (spell save DC 17, `dice:1d20+11|noform|noparens|text(+11)` to hit with spell attacks):

**At will:** [message](compendium/5e/spells/message.md), [prestidigitation](compendium/5e/spells/prestidigitation.md), [ray of frost](compendium/5e/spells/ray-of-frost.md)

**2/day each:** [gust of wind](compendium/5e/spells/gust-of-wind.md), [levitate](compendium/5e/spells/levitate.md), [magic missile](compendium/5e/spells/magic-missile.md)

**1/day each:** [cone of cold](compendium/5e/spells/cone-of-cold.md), [contact other plane](compendium/5e/spells/contact-other-plane.md) (cast as 1 action), [greater invisibility](compendium/5e/spells/greater-invisibility.md), [mass suggestion](compendium/5e/spells/mass-suggestion.md), [nondetection](compendium/5e/spells/nondetection.md), [Otiluke's resilient sphere](compendium/5e/spells/otilukes-resilient-sphere.md), [protection from energy](compendium/5e/spells/protection-from-energy.md), [tongues](compendium/5e/spells/tongues.md)
```
^statblock