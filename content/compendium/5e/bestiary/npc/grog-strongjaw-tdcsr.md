...
- 5e/monster/type/humanoid/half-giant
aliases:
- Grog Strongjaw
---
# Grog Strongjaw
...
- **Skills** [Animal Handling](rules/5e/skills.md#Animal%20Handling) +6, [Athletics](rules/5e/skills.md#Athletics) +14, [Intimidation](rules/5e/skills.md#Intimidation) +7, [Survival](rules/5e/skills.md#Survival) +6
- **Senses** darkvision 60 ft., passive Perception 10
- **Damage Resistances** cold, fire, lightning, thunder while enlarged
- **Condition Immunities** [charmed](rules/5e/conditions.md#Charmed), [frightened](rules/5e/conditions.md#Frightened) while raging
...
***Special Equipment.*** Grog wears a [belt of dwarvenkind](compendium/5e/items/belt-of-dwarvenkind.md). He wields the [Bloodaxe](compendium/5e/items/bloodaxe-egw.md) (a +2 magic weapon), a [dwarven thrower](compendium/5e/items/dwarven-thrower.md), and the [Titanstone Knuckles](compendium/5e/items/titanstone-knuckles-exalted-tdcsr.md).

***Spellbreaker.*** When Grog damages a creature that is concentrating on a spell, that creature has disadvantage on the saving throw to maintain its [concentration](rules/5e/conditions.md#Concentration). In addition, Grog has advantage on saving throws against spells cast by creatures within 5 feet of him.

***Toughness.*** Grog has an additional 40 hit points.

## Actions

***Multiattack.*** Grog makes two attacks (three when raging) with his [Bloodaxe](compendium/5e/items/bloodaxe-egw.md), [dwarven thrower](compendium/5e/items/dwarven-thrower.md), or [Titanstone Knuckles](compendium/5e/items/titanstone-knuckles-exalted-tdcsr.md).

***[Bloodaxe](compendium/5e/items/bloodaxe-egw.md).*** *Melee Weapon Attack:* `dice:1d20+16|noform|noparens|text(+16)` to hit, reach 5 ft., one target. *Hit:* `dice:1d12+14|noform|noparens|avg|text(20)` (`1d12 + 14`) slashing damage and `dice:1d6|noform|noparens|avg|text(3)` (`d6`) necrotic damage. If the target is reduced to 0 hit points, Grog gains 10 temporary hit points.

***[Dwarven Thrower](compendium/5e/items/dwarven-thrower.md).*** *Melee  or Ranged Weapon Attack:* `dice:1d20+17|noform|noparens|text(+17)` to hit, reach 5 ft. or range 20/60, one target. *Hit:* `dice:2d8+15|noform|noparens|avg|text(24)` (`2d8 + 15`) bludgeoning damage.

***Titanstone Knuckles.*** *Melee Weapon Attack:* `dice:1d20+14|noform|noparens|text(+14)` to hit, reach 5 ft., one target. *Hit:* `dice:1d4+12|noform|noparens|avg|text(14)` (`1d4 + 12`) bludgeoning damage.

***Enlarge (Recharges after a Long Rest).*** Grog casts [enlarge/reduce](compendium/5e/spells/enlarge-reduce.md) on himself to grow in size for 10 minutes. While enlarged in this way, he has resistance to cold, fire, lightning, and thunder damage.

## Bonus Actions

***Rage (Recharges after a Short or Long Rest).*** Grog enters a rage that lasts until he falls [unconscious](rules/5e/conditions.md#Unconscious) or chooses to end it (no action required). While raging, Grog gains the following benefits:
...
- He can't be [charmed](rules/5e/conditions.md#Charmed) or [frightened](rules/5e/conditions.md#Frightened)  
- He can make an additional melee weapon attack (included in the Multiattack action)  

When Grog's rage ends, he gains one level of [exhaustion](rules/5e/conditions.md#Exhaustion).
