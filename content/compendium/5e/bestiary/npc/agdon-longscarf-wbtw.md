...
- **Armor Class** 19 ([studded leather](compendium/5e/items/studded-leather-armor-phb.md), [shield](compendium/5e/items/shield-phb.md))
- **Hit Points** 36 (`8d8`)
...
- **Skills** [Acrobatics](rules/5e/skills.md#Acrobatics) +7, [Perception](rules/5e/skills.md#Perception) +6, [Sleight of Hand](rules/5e/skills.md#Sleight%20of%20Hand) +7, [Stealth](rules/5e/skills.md#Stealth) +7
...
***Evasion.*** If Agdon is subjected to an effect that allows him to make a Dexterity saving throw to take only half damage, he instead takes no damage if he succeeds on the saving throw and only half damage if he fails, provided he isn't [incapacitated](rules/5e/conditions.md#Incapacitated).
...
***Branding Iron.*** *Melee Weapon Attack:* `dice:1d20+7|noform|noparens|text(+7)` to hit, reach 5 ft., one target. *Hit:* `dice:3d6|noform|noparens|avg|text(10)` (`3d6`) fire damage, and the target is magically branded. Agdon is [invisible](rules/5e/conditions.md#Invisible) to creatures branded in this way. The brand disappears after 24 hours, or it can be removed from a creature or object by any spell that ends a curse.
...
***Quick Fingers.*** Agdon targets one creature within 5 feet of him that he can see and makes a Dexterity ([Sleight of Hand](rules/5e/skills.md#Sleight%20of%20Hand)) check, with a DC equal to 1 + the target's passive Wisdom ([Perception](rules/5e/skills.md#Perception)) score. On a successful check, Agdon pilfers one object weighing 1 pound or less that the target has in its possession but not in its grasp, without the target noticing the theft.
