...
- **Armor Class** 21 ([+3 plate armor](compendium/5e/items/3-armor-dmg.md))
...
***Gurt's Greataxe.*** *Melee Weapon Attack:* `dice:1d20+11|noform|noparens|text(+11)` to hit, reach 10 ft., one target. *Hit:* `dice:3d12+7|noform|noparens|avg|text(26)` (`3d12 + 7`) slashing damage, or `dice:5d12+7|noform|noparens|avg|text(39)` (`5d12 + 7`) slashing damage if the target is human.
