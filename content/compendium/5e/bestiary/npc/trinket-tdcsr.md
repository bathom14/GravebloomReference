...
- 5e/monster/type/beast/brown-bear
aliases:
- Trinket
---
# Trinket
...
- **Armor Class** 18 ([plate barding](compendium/5e/items/barding-phb.md))
...
***Chosen Companion.*** Trinket has an additional 10 hit points, and has a +6 bonus to attack and damage rolls and to Wisdom ([Perception](rules/5e/skills.md#Perception)) checks.
...
***Keen Smell.*** Trinket has advantage on Wisdom ([Perception](rules/5e/skills.md#Perception)) checks that rely on smell.

***Raven's Slumber.*** If Trinket is reduced to 0 hit points and is within 100 feet of Vex, he is immediately drawn into the demiplane within [Vex's](compendium/5e/bestiary/humanoid/vexahlia-tdcsr.md) [raven's slumber](compendium/5e/items/ravens-slumber-tdcsr.md) and stabilized.

## Actions

***Multiattack.*** Trinket makes two attacks: one with his bite and one with his claws.

***Bite.*** *Melee Weapon Attack:* `dice:1d20+13|noform|noparens|text(+13)` to hit, reach 5 ft., one target. *Hit:* `dice:1d8+10|noform|noparens|avg|text(14)` (`1d8 + 10`) piercing damage.

***Claws.*** *Melee Weapon Attack:* `dice:1d20+13|noform|noparens|text(+13)` to hit, reach 5 ft., one target. *Hit:* `dice:2d6+10|noform|noparens|avg|text(17)` (`2d6 + 10`) slashing damage.
```
^statblock