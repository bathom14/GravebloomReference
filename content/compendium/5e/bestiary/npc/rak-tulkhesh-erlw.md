...
- **Skills** [Athletics](rules/5e/skills.md#Athletics) +17, [Intimidation](rules/5e/skills.md#Intimidation) +16, [Perception](rules/5e/skills.md#Perception) +14
...
**At will:** [detect thoughts](compendium/5e/spells/detect-thoughts.md), [dispel magic](compendium/5e/spells/dispel-magic.md), [spirit guardians](compendium/5e/spells/spirit-guardians.md)

**1/day each:** [banishing smite](compendium/5e/spells/banishing-smite.md), [blinding smite](compendium/5e/spells/blinding-smite.md), [staggering smite](compendium/5e/spells/staggering-smite.md)
...
***Whirlwind of Weapons.*** A magical aura of weapons surrounds Rak Tulkhesh in a 10 foot radius. At the start of each of his turns, any other creature in the aura takes `dice:4d6|noform|noparens|avg|text(14)` (`4d6`) force damage.

## Actions

***Multiattack.*** Rak Tulkhesh makes four weapon attacks.

***Spawned Melee Weapon.*** *Melee Weapon Attack:* `dice:1d20+17|noform|noparens|text(+17)` to hit, reach 10 ft., one target. *Hit:* `dice:3d12+9|noform|noparens|avg|text(28)` (`3d12 + 9`) force damage.

***Spawned Ranged Weapon.*** *Ranged Weapon Attack:* `dice:1d20+12|noform|noparens|text(+12)` to hit, range 150/600 ft., one target. *Hit:* `dice:3d8+4|noform|noparens|avg|text(17)` (`3d8 + 4`) force damage.
...
***End Magic (Costs 2 Actions).*** Rak Tulkhesh casts [dispel magic](compendium/5e/spells/dispel-magic.md).
