...
```ad-statblock
title: Xilonen
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/TftYP/Xilonen.webp#token)
...
- **Proficiency Bonus** +3
- **Saving Throws** ⏤
- **Skills** [Perception](rules/5e/skills.md#Perception) +6, [Stealth](rules/5e/skills.md#Stealth) +5
...
***Bite.*** *Melee Weapon Attack:* `dice:1d20+7|noform|noparens|text(+7)` to hit, reach 5 ft., one target. *Hit:* `dice:4d8+4|noform|noparens|avg|text(22)` (`4d8 + 4`) piercing damage.

***Tendril.*** *Melee Weapon Attack:* `dice:1d20+7|noform|noparens|text(+7)` to hit, reach 50 ft., one creature. *Hit:* The target is [grappled](rules/5e/conditions.md#Grappled) (escape DC 15). Until the grapple ends, the target is [restrained](rules/5e/conditions.md#Restrained) and has disadvantage on Strength checks and Strength saving throws, and Xilonen can't use the same tendril on another target.

***Reel.*** Xilonen pulls each creature [grappled](rules/5e/conditions.md#Grappled) by it up to 25 feet straight toward it.
```
^statblock