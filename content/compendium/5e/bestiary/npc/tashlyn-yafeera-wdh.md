...
- **Skills** [Athletics](rules/5e/skills.md#Athletics) +8, [Intimidation](rules/5e/skills.md#Intimidation) +5, [Perception](rules/5e/skills.md#Perception) +6
...
***Extra Damage.*** Tashlyn deals an extra `dice:2d6|noform|noparens|avg|text(7)` (`2d6`) damage to every hit if she has more than half her hit points remaining.
...
***Shortbow.*** *Ranged Weapon Attack:* `dice:1d20+6|noform|noparens|text(+6)` to hit, range 80/320 ft., one target. *Hit:* `dice:1d6+2|noform|noparens|avg|text(5)` (`1d6 + 2`) piercing damage.
```
^statblock