...
tags:
- 5e/compendium/src/5e/aitfr-isf
- 5e/monster/cr/11
...
***Innate Spellcasting.*** Exul's innate spellcasting ability is Charisma (spell save DC 15, `dice:1d20+7|noform|noparens|text(+7)` to hit with spell attacks). He can innately cast the following spells, requiring no material components:

**At will:** [detect magic](compendium/5e/spells/detect-magic.md)

**3/day each:** [comprehend languages](compendium/5e/spells/comprehend-languages.md), [tongues](compendium/5e/spells/tongues.md)

**1/day each:** [conjure elemental](compendium/5e/spells/conjure-elemental.md) (earth or fire elemental only), [invisibility](compendium/5e/spells/invisibility.md), [major image](compendium/5e/spells/major-image.md), [plane shift](compendium/5e/spells/plane-shift.md), [wall of fire](compendium/5e/spells/wall-of-fire.md)
...
***Handaxe.*** *Melee Weapon Attack:* `dice:1d20+10|noform|noparens|text(+10)` to hit, reach 5 ft., one target. *Hit:* 13 (2d6 + 6) slashing damage plus 3 (1d6) fire damage.

***Hurl Flame.*** *Ranged Spell Attack:* `dice:1d20+7|noform|noparens|text(+7)` to hit, range 120 ft., one target. *Hit:* 17 (5d6) fire damage.
```
^statblock