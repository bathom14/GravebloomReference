...
- **Skills** [Arcana](rules/5e/skills.md#Arcana) +7, [Deception](rules/5e/skills.md#Deception) +10, [Insight](rules/5e/skills.md#Insight) +9, [Perception](rules/5e/skills.md#Perception) +9
...
***Innate Spellcasting.*** Mahadi's innate spellcasting ability is Charisma (spell save DC 18, `dice:1d20+9|noform|noparens|text(+9)` to hit with spell attacks). He can innately cast the following spells, requiring no material components:

**At will:** [detect thoughts](compendium/5e/spells/detect-thoughts.md), [disguise self](compendium/5e/spells/disguise-self.md), [mage hand](compendium/5e/spells/mage-hand.md), [minor illusion](compendium/5e/spells/minor-illusion.md)

**3/day each:** [charm person](compendium/5e/spells/charm-person.md), [detect magic](compendium/5e/spells/detect-magic.md), [dispel magic](compendium/5e/spells/dispel-magic.md), [hellish rebuke](compendium/5e/spells/hellish-rebuke.md), [invisibility](compendium/5e/spells/invisibility.md), [major image](compendium/5e/spells/major-image.md), [speak with dead](compendium/5e/spells/speak-with-dead.md), [suggestion](compendium/5e/spells/suggestion.md)

**1/day each:** [banishment](compendium/5e/spells/banishment.md), [demiplane](compendium/5e/spells/demiplane.md), [dominate person](compendium/5e/spells/dominate-person.md), [fly](compendium/5e/spells/fly.md), [forcecage](compendium/5e/spells/forcecage.md), [geas](compendium/5e/spells/geas.md), [plane shift](compendium/5e/spells/plane-shift.md), [true seeing](compendium/5e/spells/true-seeing.md)
...
***Claw.*** *Melee Weapon Attack:* `dice:1d20+7|noform|noparens|text(+7)` to hit, reach 5 ft., one target. *Hit:* `dice:2d6+2|noform|noparens|avg|text(9)` (`2d6 + 2`) slashing damage, and the target is cursed if it's a creature. The curse takes effect whenever the target takes a short or long rest, filling the target's thoughts with horrible images and dreams. The cursed target gains no benefit from finishing a short or long rest. The curse lasts until it is lifted by a [remove curse](compendium/5e/spells/remove-curse.md) spell or similar magic.
