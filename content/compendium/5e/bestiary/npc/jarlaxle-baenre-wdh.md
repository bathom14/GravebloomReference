...
- **Armor Class** 24 ([+3 leather armor](compendium/5e/items/3-armor-dmg.md), Suave Defense)
...
- **Skills** [Acrobatics](rules/5e/skills.md#Acrobatics) +11, [Athletics](rules/5e/skills.md#Athletics) +6, [Deception](rules/5e/skills.md#Deception) +14, [Perception](rules/5e/skills.md#Perception) +8, [Sleight of Hand](rules/5e/skills.md#Sleight%20of%20Hand) +11, [Stealth](rules/5e/skills.md#Stealth) +16
...
***Innate Spellcasting.*** Jarlaxle's innate spellcasting ability is Charisma (spell save DC 17, `dice:1d20+9|noform|noparens|text(+9)` to hit with spell attacks) He can innately cast the following spells, requiring no material components:

**At will:** [dancing lights](compendium/5e/spells/dancing-lights.md)

**1/day each:** [darkness](compendium/5e/spells/darkness.md), [faerie fire](compendium/5e/spells/faerie-fire.md), [levitate](compendium/5e/spells/levitate.md) (self only)

***Special Equipment.*** Jarlaxle wears [+3 leather armor](compendium/5e/items/3-armor-dmg.md), a [hat of disguise](compendium/5e/items/hat-of-disguise.md), a [bracer of flying daggers](compendium/5e/items/bracer-of-flying-daggers-wdh.md), a [cloak of invisibility](compendium/5e/items/cloak-of-invisibility.md), a [knave's eye patch](compendium/5e/items/knaves-eye-patch-wdh.md), and a [ring of truth telling](compendium/5e/items/ring-of-truth-telling-wdh.md). He wields a [+3 rapier](compendium/5e/items/3-weapon-dmg.md) and carries a [portable hole](compendium/5e/items/portable-hole.md) and a [wand of web](compendium/5e/items/wand-of-web.md). His hat is adorned with a [feather of diatryma summoning](compendium/5e/items/feather-of-diatryma-summoning-wdh.md).

***Evasion.*** If he is subjected to an effect that allows him to make a Dexterity saving throw to take only half damage, Jarlaxle instead takes no damage if he succeeds on the saving throw, and only half damage if he fails. He can't use this trait if he's [incapacitated](rules/5e/conditions.md#Incapacitated).

***Fey Ancestry.*** Jarlaxle has advantage on saving throws against being [charmed](rules/5e/conditions.md#Charmed), and magic can't put him to sleep.
...
***Sneak Attack (1/Turn).*** Jarlaxle deals an extra `dice:7d6|noform|noparens|avg|text(24)` (`7d6`) damage when he hits a target with a weapon attack and has advantage on the attack roll, or when the target is within 5 feet of an ally of Jarlaxle's that isn't [incapacitated](rules/5e/conditions.md#Incapacitated) and Jarlaxle doesn't have disadvantage on the attack roll.

***Suave Defense.*** While Jarlaxle is wearing light or no armor and wielding no shield, his AC includes his Charisma modifier.

***Sunlight Sensitivity.*** When not wearing his knave's eye patch, Jarlaxle has disadvantage on attack rolls, as well as on Wisdom ([Perception](rules/5e/skills.md#Perception)) checks that rely on sight.
...
***+3 Rapier.*** *Melee Weapon Attack:* `dice:1d20+14|noform|noparens|text(+14)` to hit, reach 5 ft., one target. *Hit:* `dice:1d8+9|noform|noparens|avg|text(13)` (`1d8 + 9`) piercing damage.

***Flying Dagger.*** *Ranged Weapon Attack:* `dice:1d20+11|noform|noparens|text(+11)` to hit, range 20/60 ft., one target. *Hit:* `dice:1d4+6|noform|noparens|avg|text(8)` (`1d4 + 6`) piercing damage.
