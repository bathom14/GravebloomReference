...
- **Skills** [Perception](rules/5e/skills.md#Perception) +3, [Persuasion](rules/5e/skills.md#Persuasion) +5, [Stealth](rules/5e/skills.md#Stealth) +4
...
***Rapier.*** *Melee Weapon Attack:* `dice:1d20+4|noform|noparens|text(+4)` to hit, reach 5 ft., one target. *Hit:* `dice:1d8+2|noform|noparens|avg|text(6)` (`1d8 + 2`) piercing damage.

***Seed Sling.*** *Ranged Weapon Attack:* `dice:1d20+4|noform|noparens|text(+4)` to hit, range 30/120 ft., one target. *Hit:* `dice:1d4+2|noform|noparens|avg|text(4)` (`1d4 + 2`) bludgeoning damage.
