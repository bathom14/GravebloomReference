...
***Misty Escape.*** When it drops to 0 hit points outside its resting place, Sandesyl transforms into a cloud of mist (as in the Shapechanger trait) instead of falling [unconscious](rules/5e/conditions.md#Unconscious), provided that it isn't in sunlight or running water. If it can't transform, it is destroyed.
...
- **Stake to the Heart.** If a piercing weapon made of wood is driven into Sandesyl's heart while Sandesyl is [incapacitated](rules/5e/conditions.md#Incapacitated) in its resting place, Sandesyl is [paralyzed](rules/5e/conditions.md#Paralyzed) until the stake is removed.  
...
***Unarmed Strike (Vampire Form Only).*** *Melee Weapon Attack:* `dice:1d20+9|noform|noparens|text(+9)` to hit, reach 5 ft., one creature. *Hit:* `dice:1d8+4|noform|noparens|avg|text(8)` (`1d8 + 4`) bludgeoning damage. Instead of dealing damage, Sandesyl can grapple the target (escape DC 18).

***Bite (Bat or Vampire Form Only).*** *Melee Weapon Attack:* `dice:1d20+9|noform|noparens|text(+9)` to hit, reach 5 ft., one willing creature, or a creature that is [grappled](rules/5e/conditions.md#Grappled) by Sandesyl, [incapacitated](rules/5e/conditions.md#Incapacitated), or [restrained](rules/5e/conditions.md#Restrained). *Hit:* `dice:1d6+4|noform|noparens|avg|text(7)` (`1d6 + 4`) piercing damage plus `dice:3d6|noform|noparens|avg|text(10)` (`3d6`) necrotic damage. The target's hit point maximum is reduced by an amount equal to the necrotic damage taken, and Sandesyl regains hit points equal to that amount. The reduction lasts until the target finishes a long rest. The target dies if this effect reduces its hit point maximum to 0. A humanoid slain in this way and then buried in the ground rises the following night as a [vampire spawn](compendium/5e/bestiary/undead/vampire-spawn.md) under Sandesyl's control.

***Charm.*** Sandesyl targets one humanoid it can see within 30 feet of it. If the target can see Sandesyl, the target must succeed on a DC 17 Wisdom saving throw against this magic or be [charmed](rules/5e/conditions.md#Charmed) by Sandesyl. The [charmed](rules/5e/conditions.md#Charmed) target regards Sandesyl as a trusted friend to be heeded and protected. Although the target isn't under Sandesyl's control, it takes Sandesyl's requests or actions in the most favorable way it can, and it is a willing target for Sandesyl's bite attack.
...
***Children of the Night (1/Day).*** Sandesyl magically calls `dice:2d4|noform|noparens|avg` (`2d4`) swarms of [bats](compendium/5e/bestiary/beast/swarm-of-bats.md) or [rats](compendium/5e/bestiary/beast/swarm-of-rats.md), provided that the sun isn't up. While outdoors, Sandesyl can call `dice:3d6|noform|noparens|avg` (`3d6`) [wolves](compendium/5e/bestiary/beast/wolf.md) instead. The called creatures arrive in `dice:1d4|noform|noparens|avg` (`d4`) rounds, acting as allies of Sandesyl and obeying its spoken commands. The beasts remain for 1 hour, until Sandesyl dies, or until Sandesyl dismisses them as a bonus action.
