...
- **Skills** [Arcana](rules/5e/skills.md#Arcana) +18, [History](rules/5e/skills.md#History) +18, [Insight](rules/5e/skills.md#Insight) +14, [Religion](rules/5e/skills.md#Religion) +18
...
***Innate Spellcasting.*** Sul Khatesh's spellcasting ability is Intelligence (spell save DC 26, `dice:1d20+18|noform|noparens|text(+18)` to hit with spell attacks). She can innately cast the following spells, requiring no material components:

**At will:** [counterspell](compendium/5e/spells/counterspell.md), [detect magic](compendium/5e/spells/detect-magic.md), [detect thoughts](compendium/5e/spells/detect-thoughts.md), [dispel magic](compendium/5e/spells/dispel-magic.md), [eyebite](compendium/5e/spells/eyebite.md), [fireball](compendium/5e/spells/fireball.md), [lightning bolt](compendium/5e/spells/lightning-bolt.md), [shield](compendium/5e/spells/shield.md)

**3/day each:** [chain lightning](compendium/5e/spells/chain-lightning.md), [create undead](compendium/5e/spells/create-undead.md), [dream](compendium/5e/spells/dream.md), [hold monster](compendium/5e/spells/hold-monster.md), [mass suggestion](compendium/5e/spells/mass-suggestion.md), [scrying](compendium/5e/spells/scrying.md)

**1/day each:** [foresight](compendium/5e/spells/foresight.md), [gate](compendium/5e/spells/gate.md), [power word kill](compendium/5e/spells/power-word-kill.md), [teleport](compendium/5e/spells/teleport.md)
...
***Master of Magic.*** Sul Khatesh has advantage on Constitution saving throws to maintain [concentration](rules/5e/conditions.md#Concentration).

## Actions

***Multiattack.*** Sul Khatesh makes four attacks with Arcane Blast.

***Arcane Blast.*** *Ranged Spell Attack:* `dice:1d20+18|noform|noparens|text(+18)` to hit, range 120 ft., one target. *Hit:* `dice:1d10+10|noform|noparens|avg|text(15)` (`1d10 + 10`) force damage.

***Magic Staff.*** *Melee Weapon Attack:* `dice:1d20+12|noform|noparens|text(+12)` to hit, reach 5 ft., one target. *Hit:* `dice:5d12+4|noform|noparens|avg|text(36)` (`5d12 + 4`) force damage.

***Arcane Cataclysm (Recharges after a Long Rest).*** Sul Khatesh conjures orbs of magical energy that plummet to the ground at three different points she can see within 1 mile of her. Each creature in a 40-foot-radius sphere centered on each point must make a DC 26 Dexterity saving throw, taking `dice:11d12|noform|noparens|avg|text(71)` (`11d12`) force damage on a failed save or half as much damage on a successful one. A creature in the area of more than one arcane burst is affected only once. The area of each arcane burst then acts as an [antimagic field](compendium/5e/spells/antimagic-field.md) for 1 hour. Sul Khatesh and spells she casts are unaffected by these fields.
...
***Consume Magic (Costs 2 Actions).*** Sul Khatesh targets a creature within 120 feet of her who is [concentrating](rules/5e/conditions.md#Concentration) on a spell. The target must succeed on a DC 26 Constitution saving throw or its [concentration](rules/5e/conditions.md#Concentration) is broken on the spell, and Sul Khatesh gains 5 temporary hit points per level of that spell.

***Maddening Secrets (Costs 3 Actions).*** Sul Khatesh whispers an arcane secret into the mind of a creature she can see within 60 feet of her. The target must succeed on a DC 26 Wisdom saving throw or expend one of its spell slots of 3rd level or lower and deal `dice:4d12|noform|noparens|avg|text(26)` (`4d12`) force damage to each creature within 30 feet of it. A creature that fails the saving throw but can't expend a spell slot is instead [stunned](rules/5e/conditions.md#Stunned) until the end of its next turn.
```
^statblock