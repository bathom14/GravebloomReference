...
- 5e/monster/type/humanoid/ranger
...
- **Armor Class** 17 ([studded leather](compendium/5e/items/studded-leather-armor-phb.md))
...
- **Skills** [Athletics](rules/5e/skills.md#Athletics) +6, [Perception](rules/5e/skills.md#Perception) +6, [Survival](rules/5e/skills.md#Survival) +6
...
***Special Equipment.*** Ayo wields a ruidium harpoon (see appendix B). If Ayo rolls a 1 on an attack roll made with the harpoon, she must succeed on a DC 20 Charisma saving throw or gain 1 level of [exhaustion](rules/5e/conditions.md#Exhaustion).

## Actions

***Multiattack.*** Ayo makes three Harpoon or Longbow attacks.

***Ruidium Harpoon.*** *Melee Weapon Attack:* `dice:1d20+6|noform|noparens|text(+6)` to hit, reach 5 ft., one target. *Hit:* `dice:2d8+3|noform|noparens|avg|text(12)` (`2d8 + 3`) piercing damage plus `dice:2d6|noform|noparens|avg|text(7)` (`2d6`) psychic damage.

***Longbow.*** *Ranged Weapon Attack:* `dice:1d20+8|noform|noparens|text(+8)` to hit, range 150/600 ft., one target. *Hit:* `dice:3d8+5|noform|noparens|avg|text(18)` (`3d8 + 5`) piercing damage.

***Spellcasting.*** Ayo casts one of the following spells, using Wisdom as the spellcasting ability (spell save DC 14):

**1/day each:** [animal friendship](compendium/5e/spells/animal-friendship.md), [freedom of movement](compendium/5e/spells/freedom-of-movement.md), [goodberry](compendium/5e/spells/goodberry.md), [pass without trace](compendium/5e/spells/pass-without-trace.md), [protection from energy](compendium/5e/spells/protection-from-energy.md)
