...
- **Skills** [Acrobatics](rules/5e/skills.md#Acrobatics) +4, [Deception](rules/5e/skills.md#Deception) +3, [Stealth](rules/5e/skills.md#Stealth) +6, [Survival](rules/5e/skills.md#Survival) +3
...
***Dagger.*** *Melee  or Ranged Weapon Attack:* `dice:1d20+4|noform|noparens|text(+4)` to hit, reach 5 ft. or range 20/60 ft., one target. *Hit:* `dice:1d4+2|noform|noparens|avg|text(4)` (`1d4 + 2`) piercing damage plus `dice:2d6|noform|noparens|avg|text(7)` (`2d6`) poison damage.
```
^statblock