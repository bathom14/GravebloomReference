...
***Keen Smell.*** Sansuri has advantage on Wisdom ([Perception](rules/5e/skills.md#Perception)) checks that rely on smell.

## Actions

***Fling.*** Sansuri tries to throw a Small or Medium creature within 10 feet of her. The target must succeed on a DC 20 Dexterity saving throw or be hurled up to 60 feet horizontally in a direction of Sansuri's choice and land [prone](rules/5e/conditions.md#Prone), taking `dice:1d8|noform|noparens|avg` (`d8`) bludgeoning damage for every 10 feet it was thrown.

***Wind Aura.*** A magical aura of wind surrounds Sansuri. The aura is a 10-foot-radius sphere that lasts as long as Sansuri maintains [concentration](rules/5e/conditions.md#Concentration) on it (as if [concentrating](rules/5e/conditions.md#Concentration) on a spell). While the aura is in effect, Sansuri gains a +2 bonus to its AC against ranged weapon attacks, and all open flames within the aura are extinguished unless they are magical.

***Multiattack.*** Sansuri makes two spear attacks.

***Morningstar.*** *Melee Weapon Attack:* `dice:1d20+12|noform|noparens|text(+12)` to hit, reach 10 ft., one target. *Hit:* `dice:3d8+8|noform|noparens|avg|text(21)` (`3d8 + 8`) piercing damage.
...
***Spellcasting.*** Sansuri casts one of the following spells, requiring no material components and using Intelligence as the spellcasting ability (spell save DC 15; `dice:1d20+7|noform|noparens|text(+7)` to hit with spell attacks):

**At will:** [mage hand](compendium/5e/spells/mage-hand.md), [message](compendium/5e/spells/message.md), [prestidigitation](compendium/5e/spells/prestidigitation.md), [ray of frost](compendium/5e/spells/ray-of-frost.md)

**2/day each:** [arcane lock](compendium/5e/spells/arcane-lock.md), [gust of wind](compendium/5e/spells/gust-of-wind.md), [invisibility](compendium/5e/spells/invisibility.md), [magic missile](compendium/5e/spells/magic-missile.md), [unseen servant](compendium/5e/spells/unseen-servant.md)

**1/day each:** [globe of invulnerability](compendium/5e/spells/globe-of-invulnerability.md), [haste](compendium/5e/spells/haste.md), [hypnotic pattern](compendium/5e/spells/hypnotic-pattern.md), [ice storm](compendium/5e/spells/ice-storm.md), [lightning bolt](compendium/5e/spells/lightning-bolt.md), [Mordenkainen's sword](compendium/5e/spells/mordenkainens-sword.md), [wall of force](compendium/5e/spells/wall-of-force.md)
```
^statblock