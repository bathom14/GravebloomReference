...
tags:
- 5e/compendium/src/5e/aitfr-fcd
- 5e/monster/cr/13
...
- **Skills** [Arcana](rules/5e/skills.md#Arcana) +12, [Deception](rules/5e/skills.md#Deception) +8, [History](rules/5e/skills.md#History) +10, [Perception](rules/5e/skills.md#Perception) +7
...
***Spellcasting.*** Tyreus is a 16th-level spellcaster. His spellcasting ability is Intelligence (spell save DC 18, `dice:1d20+10|noform|noparens|text(+10)` to hit with spell attacks). He has the following wizard spells prepared.

**Cantrips (at will):** [fire bolt](compendium/5e/spells/fire-bolt.md), [light](compendium/5e/spells/light.md), [mage hand](compendium/5e/spells/mage-hand.md), [minor illusion](compendium/5e/spells/minor-illusion.md), [shocking grasp](compendium/5e/spells/shocking-grasp.md)

**1st level (4 slots):** [mage armor](compendium/5e/spells/mage-armor.md), [magic missile](compendium/5e/spells/magic-missile.md), [shield](compendium/5e/spells/shield.md), [thunderwave](compendium/5e/spells/thunderwave.md)

**2nd level (3 slots):** [invisibility](compendium/5e/spells/invisibility.md)*, [mirror image](compendium/5e/spells/mirror-image.md)*, [phantasmal force](compendium/5e/spells/phantasmal-force.md)*

**3rd level (3 slots):** [counterspell](compendium/5e/spells/counterspell.md), [fly](compendium/5e/spells/fly.md), [lightning bolt](compendium/5e/spells/lightning-bolt.md), [major image](compendium/5e/spells/major-image.md)*

**4th level (3 slots):** [banishment](compendium/5e/spells/banishment.md), [hallucinatory terrain](compendium/5e/spells/hallucinatory-terrain.md)*, [phantasmal killer](compendium/5e/spells/phantasmal-killer.md)*, [stoneskin](compendium/5e/spells/stoneskin.md)

**5th level (2 slots):** [conjure elemental](compendium/5e/spells/conjure-elemental.md), [mislead](compendium/5e/spells/mislead.md)*, [telekinesis](compendium/5e/spells/telekinesis.md)

**6th level (1 slots):** [disintegrate](compendium/5e/spells/disintegrate.md)

**7th level (1 slots):** [plane shift](compendium/5e/spells/plane-shift.md)

**8th level (1 slots):** [maze](compendium/5e/spells/maze.md)
...
***Displacement (Recharges after Tyreus Casts an Illusion Spell of 1st Level or Higher).*** As a bonus action, Tyreus projects an illusion that makes him appear to be standing a few inches from his actual location, causing any creature to have disadvantage on attack rolls against Tyreus. The effect ends if Tyreus takes damage, he is [incapacitated](rules/5e/conditions.md#Incapacitated), or his speed becomes 0.

## Actions

***Dagger.*** *Melee  or Ranged Weapon Attack:* `dice:1d20+8|noform|noparens|text(+8)` to hit, reach 5 ft. or range 20/60 ft., one target. *Hit:* `dice:1d4+3|noform|noparens|avg|text(5)` (`1d4 + 3`) piercing damage.
...
***Scrutinize.*** Tyreus makes an Intelligence ([Investigation](rules/5e/skills.md#Investigation)) or Wisdom ([Perception](rules/5e/skills.md#Perception)) check.
