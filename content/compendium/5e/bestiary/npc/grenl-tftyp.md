...
***Spellcasting.*** Grenl is a 1st-level spellcaster. Her spellcasting ability is Wisdom (spell save DC 11, `dice:1d20+3|noform|noparens|text(+3)` to hit with spell attacks). She has the following cleric spells prepared:

**Cantrips (at will):** [poison spray](compendium/5e/spells/poison-spray.md), [thaumaturgy](compendium/5e/spells/thaumaturgy.md)

**1st level (2 slots):** [bane](compendium/5e/spells/bane.md), [inflict wounds](compendium/5e/spells/inflict-wounds.md)

***Nimble Escape.*** The goblin can take the Disengage or Hide action as a bonus action on each of its turns.

## Actions

***Scimitar.*** *Melee Weapon Attack:* `dice:1d20+4|noform|noparens|text(+4)`, reach 5 ft., one target. *Hit:* `dice:1d6+2|noform|noparens|avg|text(5)` (`1d6 + 2`) piercing damage.

***Shortbow.*** *Ranged Weapon Attack:* `dice:1d20+4|noform|noparens|text(+4)`, range 80/320 ft., one target. *Hit:* `dice:1d6+2|noform|noparens|avg|text(5)` (`1d6 + 2`) piercing damage.
```
^statblock