...
- **Skills** [Athletics](rules/5e/skills.md#Athletics) +4, [Perception](rules/5e/skills.md#Perception) +3, [Survival](rules/5e/skills.md#Survival) +3
...
***Harpoon.*** *Melee Weapon Attack:* `dice:1d20+4|noform|noparens|text(+4)` to hit, reach 5 ft., one target. *Hit:* `dice:2d8+2|noform|noparens|avg|text(11)` (`2d8 + 2`) piercing damage.

***Longbow.*** *Ranged Weapon Attack:* `dice:1d20+4|noform|noparens|text(+4)` to hit, range 150/600 ft., one target. *Hit:* `dice:2d8+2|noform|noparens|avg|text(11)` (`2d8 + 2`) piercing damage.

***Spellcasting.*** Ayo casts one of the following spells, using Wisdom as the spellcasting ability (spell save DC 11):

**1/day each:** [animal friendship](compendium/5e/spells/animal-friendship.md), [goodberry](compendium/5e/spells/goodberry.md)
```
^statblock