...
- **Skills** [Deception](rules/5e/skills.md#Deception) +9, [Insight](rules/5e/skills.md#Insight) +8, [Perception](rules/5e/skills.md#Perception) +8
...
***Special Equipment.*** Shemeshka carries a magic crown called the Razorvine Tiara. In the hands of anyone other than Shemeshka, the Razorvine Tiara functions as a [tentacle rod](compendium/5e/items/tentacle-rod.md) that deals slashing damage instead of bludgeoning damage.
...
***Arcane Flux.*** Shemeshka causes a surge of arcane energy to burst around one creature she can see within 120 feet of herself. The target must make a DC 18 Dexterity saving throw. On a failed save, the target takes `dice:7d12|noform|noparens|avg|text(45)` (`7d12`) force damage and has the [incapacitated](rules/5e/conditions.md#Incapacitated) condition until the end of its next turn. On a successful save, the target takes half as much damage only.

***Claw.*** *Melee Weapon Attack:* `dice:1d20+10|noform|noparens|text(+10)` to hit, reach 5 ft., one target. *Hit:* `dice:2d4+5|noform|noparens|avg|text(10)` (`2d4 + 5`) slashing damage plus `dice:4d6|noform|noparens|avg|text(14)` (`4d6`) poison damage.

***Razorvine Tiara.*** *Melee Weapon Attack:* `dice:1d20+10|noform|noparens|text(+10)` to hit, reach 15 ft., one target. *Hit:* `dice:3d6|noform|noparens|avg|text(10)` (`3d6`) slashing damage plus `dice:2d8|noform|noparens|avg|text(9)` (`2d8`) necrotic damage. If the target is a creature, it must succeed on a DC 15 Constitution saving throw, or its speed is halved and it has disadvantage on attack rolls and saving throws until the end of its next turn.
...
**At will:** [alter self](compendium/5e/spells/alter-self.md), [darkness](compendium/5e/spells/darkness.md), [invisibility](compendium/5e/spells/invisibility.md) (self only), [mage hand](compendium/5e/spells/mage-hand.md), [prestidigitation](compendium/5e/spells/prestidigitation.md)

**2/day each:** [detect thoughts](compendium/5e/spells/detect-thoughts.md), [dimension door](compendium/5e/spells/dimension-door.md), [suggestion](compendium/5e/spells/suggestion.md)

**1/day each:** [banishment](compendium/5e/spells/banishment.md), [contact other plane](compendium/5e/spells/contact-other-plane.md) (as an action), [mind blank](compendium/5e/spells/mind-blank.md)
