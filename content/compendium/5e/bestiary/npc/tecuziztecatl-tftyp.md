...
- **Proficiency Bonus** +2
- **Saving Throws** ⏤
- **Skills** [Deception](rules/5e/skills.md#Deception) +3, [Stealth](rules/5e/skills.md#Stealth) +2
...
***Pseudopod.*** *Melee Weapon Attack:* `dice:1d20+5|noform|noparens|text(+5)` to hit, reach 10 ft., one target. *Hit:* `dice:2d8+3|noform|noparens|avg|text(12)` (`2d8 + 3`) bludgeoning damage.

***Spit Acid (Recharge 4-6).*** Tecuziztecatl exhales acid in a 30-foot line that is 5 feet wide. Each creature in that line must make a DC 13 Dexterity saving throw, taking `dice:4d8|noform|noparens|avg|text(18)` (`4d8`) acid damage on a failed save, or half as much damage on a successful one.
```
^statblock