...
- **Armor Class** 17 ([leather armor](compendium/5e/items/leather-armor-phb.md))
...
***Dagger.*** *Melee Weapon Attack:* `dice:1d20+6|noform|noparens|text(+6)` to hit, reach 5 ft., one target. *Hit:* `dice:1d4+4|noform|noparens|avg|text(6)` (`1d4 + 4`) piercing damage. Or Ranged Weapon Attack: `dice:1d20+6|noform|noparens|text(+6)` to hit, range 20/60 ft., one target. *Hit:* `dice:1d4+4|noform|noparens|avg|text(6)` (`1d4 + 4`) piercing damage.
