...
- **Skills** [Arcana](rules/5e/skills.md#Arcana) +10, [History](rules/5e/skills.md#History) +10, [Insight](rules/5e/skills.md#Insight) +7
...
***Necrotic Strike.*** *Melee  or Ranged Spell Attack:* `dice:1d20+10|noform|noparens|text(+10)` to hit, reach 5 ft. or range 120 ft., one target. *Hit:* `dice:5d10+5|noform|noparens|avg|text(32)` (`5d10 + 5`) necrotic damage.

***Swarm of Meteors (1/Day).*** Sofina magically calls down a meteor swarm that detonates in four 40-foot-radius spheres, each one centered on a point she can see within 1 mile of herself. These spheres can overlap. Each creature in one or more of these spheres must make a DC 18 Dexterity saving throw, taking `dice:10d6|noform|noparens|avg|text(35)` (`10d6`) fire damage and `dice:10d6|noform|noparens|avg|text(35)` (`10d6`) bludgeoning damage on a failed saving throw, or half as much damage on a successful one. A creature in multiple spheres takes this damage only once.

***Spellcasting.*** Sofina casts one of the following spells, using Intelligence as the spellcasting ability (spell save DC 18):

**At will:** [mage hand](compendium/5e/spells/mage-hand.md), [message](compendium/5e/spells/message.md), [prestidigitation](compendium/5e/spells/prestidigitation.md)

**2/day each:** [bestow curse](compendium/5e/spells/bestow-curse.md), [Bigby's hand](compendium/5e/spells/bigbys-hand.md), [dimension door](compendium/5e/spells/dimension-door.md), [mage armor](compendium/5e/spells/mage-armor.md), [Otiluke's resilient sphere](compendium/5e/spells/otilukes-resilient-sphere.md), [thunderwave](compendium/5e/spells/thunderwave.md)

**1/day each:** [Evard's black tentacles](compendium/5e/spells/evards-black-tentacles.md), [finger of death](compendium/5e/spells/finger-of-death.md), [time stop](compendium/5e/spells/time-stop.md)
