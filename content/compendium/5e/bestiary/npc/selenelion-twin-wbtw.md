...
- **Skills** [Acrobatics](rules/5e/skills.md#Acrobatics) +8, [Sleight of Hand](rules/5e/skills.md#Sleight%20of%20Hand) +6, [Stealth](rules/5e/skills.md#Stealth) +6
...
***Fey Ancestry.*** The Selenelion twins, Gleam and Glister, have advantage on saving throws against being [charmed](rules/5e/conditions.md#Charmed), and magic can't put them to sleep.
...
***Dagger.*** *Melee  or Ranged Weapon Attack:* `dice:1d20+6|noform|noparens|text(+6)` to hit, reach 5 ft. or range 20/60 ft., one target. *Hit:* `dice:1d4+4|noform|noparens|avg|text(6)` (`1d4 + 4`) piercing damage.

***Moon Ray (Gleam Only; 3/Day).*** *Ranged Spell Attack:* `dice:1d20+5|noform|noparens|text(+5)` to hit, range 60 ft., one creature. *Hit:* `dice:2d8+3|noform|noparens|avg|text(12)` (`2d8 + 3`) radiant damage, and the target must succeed on a DC 13 Wisdom saving throw or be transformed into a bat for 1 minute, as though affected by a [polymorph](compendium/5e/spells/polymorph.md) spell. The target can repeat the saving throw at the end of each of its turns, ending the effect on itself on a success.

***Sun Ray (Glister Only; 3/Day).*** *Ranged Spell Attack:* `dice:1d20+5|noform|noparens|text(+5)` to hit, range 60 ft., one creature. *Hit:* `dice:2d8+3|noform|noparens|avg|text(12)` (`2d8 + 3`) radiant damage, and the target must succeed on a DC 13 Wisdom saving throw or be [blinded](rules/5e/conditions.md#Blinded) for 1 minute. The target can repeat the saving throw at the end of each of its turns, ending the effect on itself on a success.

***Twin Sight (Recharges after a Short or Long Rest).*** In her mind's eye, a Selenelion twin can see what the other twin sees for up to 1 minute, provided both twins are alive and on the same plane of existence. Maintaining this effect requires [concentration](rules/5e/conditions.md#Concentration) (as if [concentrating](rules/5e/conditions.md#Concentration) on a spell).
```
^statblock