...
- **Skills** [Athletics](rules/5e/skills.md#Athletics) +7, [Intimidation](rules/5e/skills.md#Intimidation) +4, [Nature](rules/5e/skills.md#Nature) +3, [Survival](rules/5e/skills.md#Survival) +6
...
***Darksteel Greataxe.*** *Melee Weapon Attack:* `dice:1d20+7|noform|noparens|text(+7)` to hit, reach 5 ft., one target. *Hit:* `dice:1d12+4|noform|noparens|avg|text(10)` (`1d12 + 4`) slashing damage.

***Improvised Weapon.*** *Melee  or Ranged Weapon Attack:* `dice:1d20+7|noform|noparens|text(+7)` to hit, reach 5 ft., or range 20/60 ft., one target. *Hit:* `dice:1d6+4|noform|noparens|avg|text(7)` (`1d6 + 4`) bludgeoning damage.
