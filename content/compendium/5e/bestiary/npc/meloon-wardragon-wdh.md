...
- **Skills** [Athletics](rules/5e/skills.md#Athletics) +9, [Survival](rules/5e/skills.md#Survival) +6
...
***Special Equipment.*** Meloon wields [Azuredge](compendium/5e/items/azuredge-wdh.md) but can't attune to it, and thus gains none of its benefits.
...
***Azuredge.*** *Melee Attack Roll:* `dice:1d20+9|noform|noparens|text(+9)` to hit, reach 5 ft., one target. *Hit:* `dice:1d12+5|noform|noparens|avg|text(11)` (`1d12 + 5`) slashing damage.
```
^statblock