...
- **Skills** [Athletics](rules/5e/skills.md#Athletics) +6, [Insight](rules/5e/skills.md#Insight) +4, [Perception](rules/5e/skills.md#Perception) +4, [Persuasion](rules/5e/skills.md#Persuasion) +3
...
***Giant Maul.*** *Melee Weapon Attack:* `dice:1d20+6|noform|noparens|text(+6)` to hit, reach 10 ft., one target. *Hit:* `dice:2d8+4|noform|noparens|avg|text(13)` (`2d8 + 4`) bludgeoning damage, and if the target is a creature, Maggie can force it to make a DC 14 Strength saving throw; on a failed save, the target is pushed 5 feet away from Maggie and knocked [prone](rules/5e/conditions.md#Prone).

***Hammer Toss.*** *Ranged Weapon Attack:* `dice:1d20+6|noform|noparens|text(+6)` to hit, range 20/60 ft., one target. *Hit:* `dice:2d4+4|noform|noparens|avg|text(9)` (`2d4 + 4`) bludgeoning damage, and if the target is a creature, Maggie can force it to make a DC 14 Strength saving throw; on a failed save, the target is pushed 5 feet away from Maggie and knocked [prone](rules/5e/conditions.md#Prone).
```
^statblock