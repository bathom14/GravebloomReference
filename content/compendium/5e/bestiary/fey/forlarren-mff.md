...
A forlarren in its fey aspect demonstrates self-destructive urges that reflect the inherent tension in its nature. That aspect might drive it to drink itself nearly to death, or to throw itself into caring for others with such relentless energy that it eventually collapses from [exhaustion](rules/5e/conditions.md#Exhaustion). Unfortunately, when it reaches that breaking point, its diabolical nature asserts itself, and it remains in this scheming, dominating mindset until its plans are foiled and it faces defeat. Then, overwhelmed with fear and shame, the forlarren's diabolical nature fades and its fey aspect emerges once again.
...
- **Proficiency Bonus** +2
- **Saving Throws** ⏤
- **Skills** [Acrobatics](rules/5e/skills.md#Acrobatics) +5, [Deception](rules/5e/skills.md#Deception) +8, [Stealth](rules/5e/skills.md#Stealth) +5
...
**At will:** [expeditious retreat](compendium/5e/spells/expeditious-retreat.md), [false life](compendium/5e/spells/false-life.md), [minor illusion](compendium/5e/spells/minor-illusion.md), [prestidigitation](compendium/5e/spells/prestidigitation.md)

**3/day each:** [aid](compendium/5e/spells/aid.md), [misty step](compendium/5e/spells/misty-step.md), [Tasha's hideous laughter](compendium/5e/spells/tashas-hideous-laughter.md)

**1/day each:** [heal](compendium/5e/spells/heal.md), [heat metal](compendium/5e/spells/heat-metal.md), [mirror image](compendium/5e/spells/mirror-image.md)
...
***Claw.*** *Melee Weapon Attack:* `dice:1d20+5|noform|noparens|text(+5)` to hit, reach 5 ft., one target. *Hit:* `dice:1d6+3|noform|noparens|avg|text(6)` (`1d6 + 3`) slashing damage.

***Gore.*** *Melee Weapon Attack:* `dice:1d20+5|noform|noparens|text(+5)` to hit, reach 5 ft., one target. *Hit:* `dice:1d8+3|noform|noparens|avg|text(7)` (`1d8 + 3`) piercing damage.

***Chromatic Ray.*** *Ranged Spell Attack:* `dice:1d20+6|noform|noparens|text(+6)` to hit, range 60 ft., one target. *Hit:* `dice:1d6|noform|noparens|avg|text(3)` (`d6`) lightning damage plus `dice:1d6|noform|noparens|avg|text(3)` (`d6`) fire damage plus `dice:1d6|noform|noparens|avg|text(3)` (`d6`) cold damage.
```
^statblock