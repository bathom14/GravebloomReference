...
Korreds prefer to keep their own company but occasionally consort with creatures of elemental earth such as [galeb duhr](compendium/5e/bestiary/elemental/galeb-duhr.md). They often gather with other korreds to perform ceremonial dances, beating out rhythms on stone with their hooves and clubs. In the depths of the Material Plane, korreds typically flee from other creatures, but they become aggressive when they feel insulted or are annoyed by the sounds of mining.
...
- **Proficiency Bonus** +3
- **Saving Throws** ⏤
- **Skills** [Athletics](rules/5e/skills.md#Athletics) +9, [Perception](rules/5e/skills.md#Perception) +5, [Stealth](rules/5e/skills.md#Stealth) +5
...
***Stone Camouflage.*** The korred has advantage on Dexterity ([Stealth](rules/5e/skills.md#Stealth)) checks made to hide in rocky terrain.

## Actions

***Multiattack.*** The korred makes two Greatclub or Rock attacks.

***Greatclub.*** *Melee Weapon Attack:* `dice:1d20+9|noform|noparens|text(+9)` to hit, reach 5 ft., one target. *Hit:* `dice:1d8+6|noform|noparens|avg|text(10)` (`1d8 + 6`) bludgeoning damage, or `dice:3d8+6|noform|noparens|avg|text(19)` (`3d8 + 6`) bludgeoning damage if the korred is on the ground.

***Rock.*** *Ranged Weapon Attack:* `dice:1d20+9|noform|noparens|text(+9)` to hit, range 60/120 ft., one target. *Hit:* `dice:1d8+6|noform|noparens|avg|text(10)` (`1d8 + 6`) bludgeoning damage, or `dice:3d8+6|noform|noparens|avg|text(19)` (`3d8 + 6`) bludgeoning damage if the korred is on the ground.
...
**At will:** [commune with nature](compendium/5e/spells/commune-with-nature.md) (as an action), [meld into stone](compendium/5e/spells/meld-into-stone.md), [stone shape](compendium/5e/spells/stone-shape.md)

**1/day:** [Otto's irresistible dance](compendium/5e/spells/ottos-irresistible-dance.md)

## Bonus Actions

***Command Hair.*** The korred has at least one 50-foot-long rope woven out of its hair. The korred commands one such rope within 30 feet of it to move up to 20 feet and entangle a Large or smaller creature that the korred can see. The target must succeed on a DC 13 Dexterity saving throw or become [grappled](rules/5e/conditions.md#Grappled) by the rope (escape DC 13). Until this grapple ends, the target is [restrained](rules/5e/conditions.md#Restrained). The korred can use a bonus action to release the target, which is also freed if the korred dies or becomes [incapacitated](rules/5e/conditions.md#Incapacitated).
