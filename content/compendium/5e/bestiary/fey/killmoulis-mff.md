...
- **Proficiency Bonus** +2
- **Saving Throws** ⏤
- **Skills** [History](rules/5e/skills.md#History) +3, [Perception](rules/5e/skills.md#Perception) +4, [Stealth](rules/5e/skills.md#Stealth) +8
...
***Slam.*** *Melee Weapon Attack:* `dice:1d20-1|noform|noparens|text(-1)` to hit, reach 5 ft., one target. *Hit:* 1 bludgeoning damage.
