...
- **Proficiency Bonus** +2
- **Saving Throws** ⏤
- **Skills** [Sleight of Hand](rules/5e/skills.md#Sleight%20of%20Hand) +7, [Stealth](rules/5e/skills.md#Stealth) +7
...
***Needle Blade.*** *Melee Weapon Attack:* `dice:1d20+7|noform|noparens|text(+7)` to hit, reach 5 ft., one target. *Hit:* `dice:1d4+5|noform|noparens|avg|text(7)` (`1d4 + 5`) piercing damage.

***Magic Mockery.*** The faerie hurls magical taunts at one creature it can see within 60 feet of itself. The creature must succeed on a DC 13 Wisdom saving throw or take `dice:1d6|noform|noparens|avg|text(3)` (`d6`) psychic damage and have disadvantage on attack rolls and ability checks until the start of the faerie's next turn.
...
**At will:** [prestidigitation](compendium/5e/spells/prestidigitation.md)

**1/day:** [silent image](compendium/5e/spells/silent-image.md)

## Reactions

***Tricksy Parry.*** Immediately after taking damage, the faerie reduces the damage taken by `dice:1d4|noform|noparens|avg|text(2)` (`d4`).
```
^statblock