...
- **Proficiency Bonus** +2
- **Saving Throws** ⏤
- **Skills** [Acrobatics](rules/5e/skills.md#Acrobatics) +5, [Athletics](rules/5e/skills.md#Athletics) +4, [Stealth](rules/5e/skills.md#Stealth) +5
...
***Unarmed Strike.*** *Melee Weapon Attack:* `dice:1d20+5|noform|noparens|text(+5)` to hit, reach 5 ft., one target. *Hit:* `dice:1d4+3|noform|noparens|avg|text(5)` (`1d4 + 3`) bludgeoning damage.
...
**At will:** [minor illusion](compendium/5e/spells/minor-illusion.md), [prestidigitation](compendium/5e/spells/prestidigitation.md)

**1/day each:** [charm person](compendium/5e/spells/charm-person.md), [disguise self](compendium/5e/spells/disguise-self.md), [silent image](compendium/5e/spells/silent-image.md)
```
^statblock
