...
- **Skills** [Deception](rules/5e/skills.md#Deception) +14, [Performance](rules/5e/skills.md#Performance) +10, [Stealth](rules/5e/skills.md#Stealth) +13
...
***Fae Blade.*** *Melee Weapon Attack:* `dice:1d20+9|noform|noparens|text(+9)` to hit, reach 5 ft., one target. *Hit:* `dice:3d8+5|noform|noparens|avg|text(18)` (`3d8 + 5`) force damage.

***Vexing Prank.*** The high fae targets one creature it can see within 60 feet of itself with a magical trick. The target must make a DC 18 Wisdom saving throw. On a failed save, the target takes `dice:6d6|noform|noparens|avg|text(21)` (`6d6`) psychic damage and has the [frightened](rules/5e/conditions.md#Frightened) condition until the start of the high fae's next turn. On a successful save, the target takes half as much damage only.
...
**At will:** [friends](compendium/5e/spells/friends.md), [minor illusion](compendium/5e/spells/minor-illusion.md)

**1/day each:** [enthrall](compendium/5e/spells/enthrall.md), [Nystul's magic aura](compendium/5e/spells/nystuls-magic-aura.md)
