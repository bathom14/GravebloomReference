...
***Fey Ancestry.*** The brigganock has advantage on saving throws against being [charmed](rules/5e/conditions.md#Charmed), and magic can't put it to sleep.
...
***Pickaxe.*** *Melee Weapon Attack:* `dice:1d20+4|noform|noparens|text(+4)` to hit, reach 5 ft., one target. *Hit:* `dice:1d4+2|noform|noparens|avg|text(4)` (`1d4 + 2`) piercing damage.
...
**At will:** [minor illusion](compendium/5e/spells/minor-illusion.md), [spare the dying](compendium/5e/spells/spare-the-dying.md)

**1/day each:** [animal friendship](compendium/5e/spells/animal-friendship.md), [faerie fire](compendium/5e/spells/faerie-fire.md), [meld into stone](compendium/5e/spells/meld-into-stone.md), [silence](compendium/5e/spells/silence.md)
