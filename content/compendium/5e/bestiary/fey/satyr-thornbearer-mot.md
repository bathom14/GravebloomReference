...
- **Proficiency Bonus** +2
- **Saving Throws** ⏤
- **Skills** [Perception](rules/5e/skills.md#Perception) +5, [Performance](rules/5e/skills.md#Performance) +6, [Stealth](rules/5e/skills.md#Stealth) +6
...
***Ram.*** *Melee Weapon Attack:* `dice:1d20+3|noform|noparens|text(+3)` to hit, reach 5 ft., one target. *Hit:* `dice:2d4+1|noform|noparens|avg|text(6)` (`2d4 + 1`) bludgeoning damage.

***Shortbow.*** *Ranged Weapon Attack:* `dice:1d20+6|noform|noparens|text(+6)` to hit, range 80/320 ft., one target. *Hit:* `dice:1d6+4|noform|noparens|avg|text(7)` (`1d6 + 4`) piercing damage.
