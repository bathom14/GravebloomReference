...
- **Skills** [Arcana](rules/5e/skills.md#Arcana) +11, [Investigation](rules/5e/skills.md#Investigation) +7, [Nature](rules/5e/skills.md#Nature) +7
...
***Elemental Strike.*** *Melee  or Ranged Spell Attack:* `dice:1d20+11|noform|noparens|text(+11)` to hit, reach 5 ft. or range 60 ft., one target. *Hit:* `dice:2d10+7|noform|noparens|avg|text(18)` (`2d10 + 7`) acid, cold, fire, force, lightning, or thunder damage (the high fae's choice).

***Negotiate Life (Recharge 5-6).*** The high fae enacts a magical bargain, siphoning energy from its opponents to heal its wounds. The high fae targets up to three creatures it can see within 60 feet of itself. Each target must make a DC 19 Constitution saving throw, taking `dice:4d12|noform|noparens|avg|text(26)` (`4d12`) necrotic damage on a failed save, or half as much damage on a successful one. The high fae then regains 30 hit points.
...
**At will:** [dancing lights](compendium/5e/spells/dancing-lights.md), [detect magic](compendium/5e/spells/detect-magic.md), [druidcraft](compendium/5e/spells/druidcraft.md), [mage armor](compendium/5e/spells/mage-armor.md) (self only)

**2/day each:** [faerie fire](compendium/5e/spells/faerie-fire.md), [gust of wind](compendium/5e/spells/gust-of-wind.md), [mirror image](compendium/5e/spells/mirror-image.md)

## Reactions

***Fae Counterspell.*** The high fae interrupts a creature it can see that is casting a spell with verbal, somatic, or material components. The caster takes `dice:3d6|noform|noparens|avg|text(10)` (`3d6`) psychic damage and must make a DC 19 Charisma saving throw. On a failed save, the spell fails and has no effect, but the spell slot used to cast it is not expended.
```
^statblock