...
| 2 | Burst of Speed (Recharge 6). The animal can take the [Dash](rules/5e/actions.md#Dash) action as a bonus action. |
| 3 | Camouflage. The animal has advantage on Dexterity ([Stealth](rules/5e/skills.md#Stealth)) checks it makes while outdoors. |
| 4 | Lie Detector. The animal knows when a creature within 15 feet of it tells a lie. |
| 5 | Fey Ancestry. The animal has advantage on saving throws against being [charmed](rules/5e/conditions.md#Charmed) or [frightened](rules/5e/conditions.md#Frightened), and magic can't put it to sleep. |
...
| 7 | Quickness (Recharge 6). The animal can take the [Dodge](rules/5e/actions.md#Dodge) action as a bonus action. |
...
***Keen Hearing and Smell.*** The hound has advantage on Wisdom ([Perception](rules/5e/skills.md#Perception)) checks that rely on hearing or smell.

## Actions

***Bite.*** *Melee Weapon Attack:* `dice:1d20+5|noform|noparens|text(+5)` to hit, reach 5 ft., one target. *Hit:* `dice:1d6+3|noform|noparens|avg|text(6)` (`1d6 + 3`) piercing damage. If the target is a creature, it must succeed on a DC 13 Strength saving throw or be knocked [prone](rules/5e/conditions.md#Prone).
```
^statblock