...
- **Skills** [Deception](rules/5e/skills.md#Deception) +7, [Insight](rules/5e/skills.md#Insight) +6, [Perception](rules/5e/skills.md#Perception) +6
- **Senses** blindsight 60 ft., passive Perception 16
- **Condition Immunities** [blinded](rules/5e/conditions.md#Blinded), [charmed](rules/5e/conditions.md#Charmed), [frightened](rules/5e/conditions.md#Frightened)
...
**At will:** [detect magic](compendium/5e/spells/detect-magic.md), [disguise self](compendium/5e/spells/disguise-self.md)

**3/day each:** [dream](compendium/5e/spells/dream.md), [hypnotic pattern](compendium/5e/spells/hypnotic-pattern.md), [sleep](compendium/5e/spells/sleep.md) (`dice:9d8|noform|noparens|avg` (`9d8`))

**1/day each:** [legend lore](compendium/5e/spells/legend-lore.md), [scrying](compendium/5e/spells/scrying.md)
...
***Claws.*** *Melee Weapon Attack:* `dice:1d20+5|noform|noparens|text(+5)` to hit, reach 5 ft., one target. *Hit:* `dice:1d6+2|noform|noparens|avg|text(5)` (`1d6 + 2`) slashing damage.

***Nightmare Touch.*** *Melee Spell Attack:* `dice:1d20+7|noform|noparens|text(+7)` to hit, reach 5 ft., one creature. *Hit:* `dice:4d6+4|noform|noparens|avg|text(18)` (`4d6 + 4`) psychic damage. If the target is [unconscious](rules/5e/conditions.md#Unconscious), it takes an extra `dice:3d6|noform|noparens|avg|text(10)` (`3d6`) psychic damage and is cursed until the hag dies or the curse is removed. The cursed creature's hit point maximum decreases by `dice:1d10|noform|noparens|avg|text(5)` (`d10`) whenever it finishes a long rest.

## Reactions

***Dream Eater.*** When an [unconscious](rules/5e/conditions.md#Unconscious) creature the hag can see within 30 feet of her regains consciousness, the hag can force the creature to make a DC 15 Wisdom saving throw. Unless the save succeeds, the creature takes `dice:2d10|noform|noparens|avg|text(11)` (`2d10`) psychic damage, and the hag regains hit points equal to the amount of damage taken.
```
^statblock