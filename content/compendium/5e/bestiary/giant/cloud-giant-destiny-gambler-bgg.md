...
- **Skills** [Deception](rules/5e/skills.md#Deception) +18, [Insight](rules/5e/skills.md#Insight) +9, [Perception](rules/5e/skills.md#Perception) +9
...
***Flying Staff.*** *Melee  or Ranged Weapon Attack:* `dice:1d20+14|noform|noparens|text(+14)` to hit, reach 10 ft. or range 30/90 ft., one target. *Hit:* `dice:3d6+8|noform|noparens|avg|text(18)` (`3d6 + 8`) bludgeoning damage plus `dice:3d10|noform|noparens|avg|text(16)` (`3d10`) thunder damage. *Hit or Miss:* The staff magically returns to the giant's hand immediately after a ranged attack.

***Thunderous Clap (Requires Cloud Rune).*** The giant magically summons a thundercloud that fills a 30-foot-radius sphere centered on a point the giant can see within 60 feet of itself. The cloud spreads around corners. Each creature in that area must make a DC 20 Constitution saving throw as the cloud emits a thunderous boom. On a failed save, a creature takes `dice:8d12|noform|noparens|avg|text(52)` (`8d12`) thunder damage and has the [prone](rules/5e/conditions.md#Prone) condition. On a successful save, a creature takes half as much damage only. The thunderclap is audible within 300 feet of the cloud's center point.
...
**1/day each:** [dream](compendium/5e/spells/dream.md) (as an action), [gaseous form](compendium/5e/spells/gaseous-form.md), [major image](compendium/5e/spells/major-image.md)
