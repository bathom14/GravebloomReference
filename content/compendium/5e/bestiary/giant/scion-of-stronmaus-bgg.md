...
- **Skills** [Arcana](rules/5e/skills.md#Arcana) +16, [History](rules/5e/skills.md#History) +16, [Perception](rules/5e/skills.md#Perception) +17
- **Senses** truesight 120 ft., passive Perception 27
- **Damage Resistances** cold; fire; bludgeoning, piercing, slashing from nonmagical attacks
- **Damage Immunities** lightning, thunder
- **Condition Immunities** [charmed](rules/5e/conditions.md#Charmed), [exhaustion](rules/5e/conditions.md#Exhaustion), [frightened](rules/5e/conditions.md#Frightened), [paralyzed](rules/5e/conditions.md#Paralyzed), [petrified](rules/5e/conditions.md#Petrified), [prone](rules/5e/conditions.md#Prone)
...
***Lightning Sword.*** *Melee Weapon Attack:* `dice:1d20+18|noform|noparens|text(+18)` to hit, reach 30 ft., one target. *Hit:* `dice:4d12+10|noform|noparens|avg|text(36)` (`4d12 + 10`) force damage plus `dice:4d10|noform|noparens|avg|text(22)` (`4d10`) lightning damage.

***Hailstone.*** *Ranged Weapon Attack:* `dice:1d20+18|noform|noparens|text(+18)` to hit, range 120/480 ft., one target. *Hit:* `dice:4d10+10|noform|noparens|avg|text(32)` (`4d10 + 10`) bludgeoning damage plus `dice:4d8|noform|noparens|avg|text(18)` (`4d8`) cold damage, and the target must succeed on a DC 26 Strength saving throw or have the [prone](rules/5e/conditions.md#Prone) condition.

***Slam.*** *Melee Weapon Attack:* `dice:1d20+18|noform|noparens|text(+18)` to hit, reach 20 ft., one target. *Hit:* `dice:4d12+10|noform|noparens|avg|text(36)` (`4d12 + 10`) force damage.
...
***Acid Rain.*** The cloud rains acid. Each creature in the cylinder must succeed on a DC 25 Constitution saving throw or be covered in acid for 1 minute or until a creature uses its action to remove the acid from itself or another creature. A creature covered in the acid takes `dice:4d12|noform|noparens|avg|text(26)` (`4d12`) acid damage at the start of each of its turns.

***Freezing Storm.*** Shards of ice pelt down, and freezing wind fills the area. Each creature in the cylinder must succeed on a DC 25 Dexterity saving throw or take `dice:8d6|noform|noparens|avg|text(28)` (`8d6`) cold damage and be hindered by ice formations for 1 minute or until it or another creature within reach of it uses an action to break away the ice. A creature hindered by ice has its speed reduced to 0.

***Lightning Bolts.*** Bolts of lightning strike down. Each creature in the cylinder must succeed on DC 25 Dexterity saving throw or take `dice:4d8|noform|noparens|avg|text(18)` (`4d8`) lightning damage and have the [stunned](rules/5e/conditions.md#Stunned) condition until the end of its next turn.

![Scion of Stronmaus](compendium/5e/bestiary/legendary-group/scion-of-stronmaus-bgg.md)
```
^statblock