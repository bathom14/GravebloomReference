...
- **Skills** [Athletics](rules/5e/skills.md#Athletics) +9, [Perception](rules/5e/skills.md#Perception) +2
...
***Chain.*** *Melee Weapon Attack:* `dice:1d20+9|noform|noparens|text(+9)` to hit, reach 20 ft., one target. *Hit:* `dice:3d6+6|noform|noparens|avg|text(16)` (`3d6 + 6`) bludgeoning damage. If the target is a creature, it is [grappled](rules/5e/conditions.md#Grappled) (escape DC 17). Until the grapple ends, the target is [restrained](rules/5e/conditions.md#Restrained), and the giant can't use this attack on anyone else.

***Rock.*** *Ranged Weapon Attack:* `dice:1d20+9|noform|noparens|text(+9)` to hit, range 60/240 ft., one target. *Hit:* `dice:3d6+6|noform|noparens|avg|text(16)` (`3d6 + 6`) bludgeoning damage.
