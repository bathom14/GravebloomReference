...
***Incorporeal Movement.*** The troll can move through other creatures and objects as if they were difficult terrain. It takes `dice:1d10|noform|noparens|avg|text(5)` (`d10`) force damage if it ends its turn inside an object.
...
***Bite.*** *Melee Weapon Attack:* `dice:1d20+7|noform|noparens|text(+7)` to hit, reach 5 ft., one creature. *Hit:* `dice:3d10+3|noform|noparens|avg|text(19)` (`3d10 + 3`) psychic damage, and the target must succeed on a DC 15 Wisdom saving throw or be [stunned](rules/5e/conditions.md#Stunned) for 1 minute. The [stunned](rules/5e/conditions.md#Stunned) target can repeat the saving throw at the end of each of its turns, ending the effect on itself on a success.

***Claws.*** *Melee Weapon Attack:* `dice:1d20+7|noform|noparens|text(+7)` to hit, reach 5 ft., one creature. *Hit:* `dice:3d10+3|noform|noparens|avg|text(19)` (`3d10 + 3`) psychic damage.
```
^statblock
