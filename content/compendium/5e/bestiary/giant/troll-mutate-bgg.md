...
***Rend.*** *Melee Weapon Attack:* `dice:1d20+7|noform|noparens|text(+7)` to hit, reach 5 ft. (or 15 ft. if the mutate has the Elastic Body mutation), one target. *Hit:* `dice:2d10+4|noform|noparens|avg|text(15)` (`2d10 + 4`) slashing damage plus `dice:2d8|noform|noparens|avg|text(9)` (`2d8`) force damage.

***Psychic Burst (Recharge 5-6).*** The mutate unleashes a wave of psychic energy. Each creature within 30 feet of the mutate must make a DC 14 Intelligence saving throw, taking `dice:8d6|noform|noparens|avg|text(28)` (`8d6`) psychic damage on a failed save, or half as much damage on a successful one.
```
^statblock