...
***Fist.*** *Melee Weapon Attack:* `dice:1d20+6|noform|noparens|text(+6)` to hit, reach 5 ft., one target. *Hit:* `dice:2d4+4|noform|noparens|avg|text(9)` (`2d4 + 4`) bludgeoning damage.

***Bolt Launcher.*** *Ranged Weapon Attack:* `dice:1d20+3|noform|noparens|text(+3)` to hit, range 120/480 ft., one target. *Hit:* `dice:3d10+1|noform|noparens|avg|text(17)` (`3d10 + 1`) piercing damage.
```
^statblock
