...
- **Armor Class** 15 ([breastplate](compendium/5e/items/breastplate-phb.md), [shield](compendium/5e/items/shield-phb.md))
...
***Mace.*** *Melee Weapon Attack:* `dice:1d20+6|noform|noparens|text(+6)` to hit, reach 5 ft., one target. *Hit:* `dice:2d6+4|noform|noparens|avg|text(11)` (`2d6 + 4`) bludgeoning damage.
```
^statblock
