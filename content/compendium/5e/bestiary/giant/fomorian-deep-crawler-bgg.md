...
***Crawling Stance.*** While the fomorian has the [prone](rules/5e/conditions.md#Prone) condition, crawling does not cost it extra movement. In addition, the [prone](rules/5e/conditions.md#Prone) condition does not grant advantage on attack rolls against the fomorian.
...
***Crawling Hex (Recharge 4-6).*** The fomorian targets one creature it can see within 60 feet of itself. The target must succeed on a DC 15 Wisdom saving throw or take `dice:7d8|noform|noparens|avg|text(31)` (`7d8`) psychic damage, have the [prone](rules/5e/conditions.md#Prone) condition, and become cursed for 1 hour. While cursed this way, the target can't stand up and end the [prone](rules/5e/conditions.md#Prone) condition on itself.
```
^statblock