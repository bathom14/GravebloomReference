...
- **Skills** [Deception](rules/5e/skills.md#Deception) +11, [Insight](rules/5e/skills.md#Insight) +7, [Perception](rules/5e/skills.md#Perception) +11, [Sleight of Hand](rules/5e/skills.md#Sleight%20of%20Hand) +9
...
***Control Weather (8th-level Spell).*** The giant can cast the [control weather](compendium/5e/spells/control-weather.md) spell, requiring no material components and using Charisma as the spellcasting ability.

## Actions

***Multiattack.*** The giant makes two Slam attacks or two Telekinetic Strike attacks.

***Slam.*** *Melee Weapon Attack:* `dice:1d20+12|noform|noparens|text(+12)` to hit, reach 10 ft., one target. *Hit:* `dice:3d8+8|noform|noparens|avg|text(21)` (`3d8 + 8`) bludgeoning damage plus `dice:1d10|noform|noparens|avg|text(5)` (`d10`) psychic damage.

***Telekinetic Strike.*** *Ranged Spell Attack:* `dice:1d20+7|noform|noparens|text(+7)` to hit, range 240 ft., one target. *Hit:* `dice:4d10+3|noform|noparens|avg|text(25)` (`4d10 + 3`) force damage.
...
**At will:** [detect magic](compendium/5e/spells/detect-magic.md), [fog cloud](compendium/5e/spells/fog-cloud.md), [light](compendium/5e/spells/light.md), [minor illusion](compendium/5e/spells/minor-illusion.md)

**3/day each:** [invisibility](compendium/5e/spells/invisibility.md), [silent image](compendium/5e/spells/silent-image.md), [suggestion](compendium/5e/spells/suggestion.md), [tongues](compendium/5e/spells/tongues.md)
