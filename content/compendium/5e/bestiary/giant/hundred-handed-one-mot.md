...
- **Skills** [Intimidation](rules/5e/skills.md#Intimidation) +8, [Perception](rules/5e/skills.md#Perception) +8
...
***Longsword.*** *Melee Weapon Attack:* `dice:1d20+13|noform|noparens|text(+13)` to hit, reach 15 ft., one target. *Hit:* `dice:3d8+8|noform|noparens|avg|text(21)` (`3d8 + 8`) slashing damage.

***Rock.*** *Ranged Weapon Attack:* `dice:1d20+13|noform|noparens|text(+13)` to hit, range 60/240 ft., one target. *Hit:* `dice:4d10+8|noform|noparens|avg|text(30)` (`4d10 + 8`) bludgeoning damage. If the target is a creature, it must succeed on a DC 21 Strength saving throw or be knocked [prone](rules/5e/conditions.md#Prone).
