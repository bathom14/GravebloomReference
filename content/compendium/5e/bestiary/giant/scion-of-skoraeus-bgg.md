...
- **Skills** [Acrobatics](rules/5e/skills.md#Acrobatics) +12, [Perception](rules/5e/skills.md#Perception) +14
- **Senses** truesight 120 ft., passive Perception 24
- **Damage Resistances** cold; fire; lightning; bludgeoning, piercing, slashing from nonmagical attacks
- **Damage Immunities** acid
- **Condition Immunities** [charmed](rules/5e/conditions.md#Charmed), [frightened](rules/5e/conditions.md#Frightened), [paralyzed](rules/5e/conditions.md#Paralyzed), [petrified](rules/5e/conditions.md#Petrified)
...
***Crystal Club.*** *Melee Weapon Attack:* `dice:1d20+16|noform|noparens|text(+16)` to hit, reach 30 ft., one target. *Hit:* `dice:4d12+9|noform|noparens|avg|text(35)` (`4d12 + 9`) bludgeoning damage. *Hit or Miss:* The scion can cause the club to flare with bright light, and the target must succeed on a DC 22 Constitution saving throw or take `dice:4d8|noform|noparens|avg|text(18)` (`4d8`) radiant damage and have the [blinded](rules/5e/conditions.md#Blinded) condition until the start of the scion's next turn.

***Slam.*** *Melee Weapon Attack:* `dice:1d20+16|noform|noparens|text(+16)` to hit, reach 20 ft., one target. *Hit:* `dice:4d10+9|noform|noparens|avg|text(31)` (`4d10 + 9`) force damage.

***Runic Boulder.*** *Ranged Weapon Attack:* `dice:1d20+16|noform|noparens|text(+16)` to hit, range 120/480 ft., one target. *Hit:* `dice:4d8+9|noform|noparens|avg|text(27)` (`4d8 + 9`) bludgeoning damage. *Hit or Miss:* The boulder explodes. The target and each creature within 30 feet of it must make a DC 22 Dexterity saving throw. On a failed save, a creature takes `dice:3d12|noform|noparens|avg|text(19)` (`3d12`) force damage and has the [prone](rules/5e/conditions.md#Prone) condition. On a successful save, a creature takes half as much damage only.

***Entombing Grasp (Recharge 6).*** The scion wreathes its hand in petrifying magic and touches one Huge or smaller creature it can see within 20 feet of itself. The target must succeed on a DC 24 Dexterity saving throw or take `dice:8d6|noform|noparens|avg|text(28)` (`8d6`) force damage and have the [grappled](rules/5e/conditions.md#Grappled) condition (escape DC 19). At the start of the scion's next turn, if the target is still [grappled](rules/5e/conditions.md#Grappled), the target has the [petrified](rules/5e/conditions.md#Petrified) condition.

## Bonus Actions

***Earth-Shaking Movement.*** The scion moves up to its speed and then sends a shock wave through the ground in a 60-foot radius circle centered on itself. Each creature on the ground in that area that is [concentrating](rules/5e/conditions.md#Concentration) must succeed on a DC 24 Constitution saving throw or lose [concentration](rules/5e/conditions.md#Concentration).
