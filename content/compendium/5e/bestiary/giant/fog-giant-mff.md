...
- **Skills** [Insight](rules/5e/skills.md#Insight) +7, [Perception](rules/5e/skills.md#Perception) +7, [Persuasion](rules/5e/skills.md#Persuasion) +7
...
**3/day each:** [feather fall](compendium/5e/spells/feather-fall.md), [misty step](compendium/5e/spells/misty-step.md)

***Denizen of the Mist.*** During its turn, the fog giant ignores the effects of [fog cloud](compendium/5e/spells/fog-cloud.md) spells cast by it or other allied fog giants.

***Keen Smell.*** The giant has advantage on Wisdom ([Perception](rules/5e/skills.md#Perception)) checks that rely on smell.

## Actions

***Multiattack.*** The giant makes two greatsword attacks and casts [fog cloud](compendium/5e/spells/fog-cloud.md).

***Greatsword.*** *Melee Weapon Attack:* `dice:1d20+12|noform|noparens|text(+12)` to hit, reach 10 ft., one target. *Hit:* `dice:6d6+8|noform|noparens|avg|text(29)` (`6d6 + 8`) slashing damage.
