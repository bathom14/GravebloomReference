...
- **Skills** [Arcana](rules/5e/skills.md#Arcana) +15, [Perception](rules/5e/skills.md#Perception) +14
...
***Cloud Morningstar.*** *Melee Weapon Attack:* `dice:1d20+18|noform|noparens|text(+18)` to hit, reach 30 ft., one target. *Hit:* `dice:4d10+10|noform|noparens|avg|text(32)` (`4d10 + 10`) force damage plus `dice:4d10|noform|noparens|avg|text(22)` (`4d10`) thunder damage.

***Wind Javelin.*** *Ranged Weapon Attack:* `dice:1d20+18|noform|noparens|text(+18)` to hit, range 120/480 ft., one target. *Hit:* `dice:5d12+10|noform|noparens|avg|text(42)` (`5d12 + 10`) thunder damage, and the target must succeed on a DC 26 Strength saving throw or have the [prone](rules/5e/conditions.md#Prone) condition.
