...
- **Skills** [Arcana](rules/5e/skills.md#Arcana) +4, [Insight](rules/5e/skills.md#Insight) +7, [Perception](rules/5e/skills.md#Perception) +7
...
***Mirage Flare.*** *Melee  or Ranged Spell Attack:* `dice:1d20+6|noform|noparens|text(+6)` to hit, reach 5 ft. or range 60 ft., one target. *Hit:* `dice:2d6+4|noform|noparens|avg|text(11)` (`2d6 + 4`) radiant damage, and the target must succeed on a DC 14 Wisdom saving throw or be [charmed](rules/5e/conditions.md#Charmed) by the veil keeper until the start of the veil keeper's next turn. While [charmed](rules/5e/conditions.md#Charmed) in this way, a creature is [incapacitated](rules/5e/conditions.md#Incapacitated) as it is beset by hypnotic, illusory visions.

***Augment Physicality (1/Day).*** For 1 minute, the veil keeper magically obscures it location, heightens its physical ability, and increases in size, along with anything it is wearing or carrying. While the veil keeper is augmented, attack rolls against it have disadvantage, it is Large, and it makes Strength and Dexterity saving throws with advantage. If the veil keeper lacks the room to become Large, it attains the maximum size possible in the space available. These augmentations end if the veil keeper is [incapacitated](rules/5e/conditions.md#Incapacitated).
...
**At will:** [dancing lights](compendium/5e/spells/dancing-lights.md), [minor illusion](compendium/5e/spells/minor-illusion.md)

**2/day each:** [invisibility](compendium/5e/spells/invisibility.md), [major image](compendium/5e/spells/major-image.md), [phantasmal force](compendium/5e/spells/phantasmal-force.md)

**1/day:** [hallucinatory terrain](compendium/5e/spells/hallucinatory-terrain.md) (as an action)
