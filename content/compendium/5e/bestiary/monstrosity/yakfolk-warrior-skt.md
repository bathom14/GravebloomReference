...
- **Armor Class** 11 ([leather armor](compendium/5e/items/leather-armor-phb.md))
...
- **Proficiency Bonus** +2
- **Saving Throws** ⏤
- **Skills** [Deception](rules/5e/skills.md#Deception) +4, [Survival](rules/5e/skills.md#Survival) +4
...
***Greatsword.*** *Melee Weapon Attack:* `dice:1d20+6|noform|noparens|text(+6)` to hit, reach 5 ft., one target. *Hit:* `dice:4d6+4|noform|noparens|avg|text(18)` (`4d6 + 4`) slashing damage.

***Longbow.*** *Ranged Weapon Attack:* `dice:1d20+2|noform|noparens|text(+2)` to hit, range 150/600 ft., one target. *Hit:* `dice:2d8|noform|noparens|avg|text(9)` (`2d8`) piercing damage.
```
^statblock