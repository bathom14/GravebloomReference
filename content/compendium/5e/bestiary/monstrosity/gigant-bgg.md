...
***Mandibles.*** *Melee Weapon Attack:* `dice:1d20+13|noform|noparens|text(+13)` to hit, reach 10 ft., one creature. *Hit:* `dice:4d6+7|noform|noparens|avg|text(21)` (`4d6 + 7`) slashing damage, and the target has the [grappled](rules/5e/conditions.md#Grappled) condition (escape DC 17). Until the grapple ends, the target takes `dice:4d6+7|noform|noparens|avg|text(21)` (`4d6 + 7`) slashing damage at the start of each of the gigant's turns. While the gigant is grappling a target, it can't use Mandibles against other targets.

***Talons.*** *Melee Weapon Attack:* `dice:1d20+13|noform|noparens|text(+13)` to hit, reach 20 ft., one target. *Hit:* `dice:3d6+7|noform|noparens|avg|text(17)` (`3d6 + 7`) slashing damage, and the target is pulled 10 feet straight toward the gigant.

***Scale Dust (Recharge 5-6).*** The gigant releases magical dust from its wings in a 30-foot cube. Each creature in that area must make a DC 19 Constitution saving throw, taking `dice:10d8|noform|noparens|avg|text(45)` (`10d8`) poison damage on a failed save, or half as much damage on a successful one. On a success or failure, the creature has the [poisoned](rules/5e/conditions.md#Poisoned) condition for 1 hour. While [poisoned](rules/5e/conditions.md#Poisoned) this way, the creature can't regain hit points.

## Bonus Actions

***Drone.*** The gigant produces a horrid droning sound by rapidly beating its wings. Each creature within 10 feet of the gigant must succeed on a DC 19 Constitution saving throw or take `dice:3d6|noform|noparens|avg|text(10)` (`3d6`) thunder damage and have the [incapacitated](rules/5e/conditions.md#Incapacitated) condition until the end of its next turn. The gigant can then fly up to half its flying speed.
```
^statblock