...
- **Proficiency Bonus** +3
- **Saving Throws** ⏤
- **Skills** [Perception](rules/5e/skills.md#Perception) +6, [Stealth](rules/5e/skills.md#Stealth) +8
...
***Bite.*** *Melee Weapon Attack:* `dice:1d20+8|noform|noparens|text(+8)` to hit (with advantage if the target is a creature that is missing any hit points), reach 10 ft., one target. *Hit:* `dice:4d10+5|noform|noparens|avg|text(27)` (`4d10 + 5`) piercing damage.
```
^statblock