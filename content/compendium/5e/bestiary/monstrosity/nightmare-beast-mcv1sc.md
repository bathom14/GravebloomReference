...
***Claw.*** *Melee Weapon Attack:* `dice:1d20+13|noform|noparens|text(+13)` to hit, reach 15 ft., one target. *Hit:* `dice:1d12+8|noform|noparens|avg|text(14)` (`1d12 + 8`) slashing damage, and if the target is a creature, it must succeed on a DC 21 Strength saving throw or be knocked [prone](rules/5e/conditions.md#Prone).

***Tusk.*** *Melee Weapon Attack:* `dice:1d20+13|noform|noparens|text(+13)` to hit, reach 15 ft., one target. *Hit:* `dice:2d8+8|noform|noparens|avg|text(17)` (`2d8 + 8`) slashing damage.

***Disintegration Gaze (Recharge 5-6).*** The beast targets one creature it can see within 60 feet of itself. The target must make a DC 18 Constitution saving throw, taking `dice:10d6+40|noform|noparens|avg|text(70)` (`10d6 + 40`) force damage on a failed save, or half as much damage on a successful one. If this magical effect reduces the target to 0 hit points, the target is disintegrated and leaves nothing behind, except a pile of ashes plus whatever equipment it was wearing or carrying.
...
***Frightful Howl (Costs 2 Actions).*** The beast howls as it exhales a cloud of magical fear gas in a 120-foot cone. Any creature in that area must succeed on a DC 18 Wisdom saving throw or be [frightened](rules/5e/conditions.md#Frightened) of the beast for 1 minute. A creature can repeat the saving throw at the end of each of its turns, ending the effect on itself on a success.
```
^statblock