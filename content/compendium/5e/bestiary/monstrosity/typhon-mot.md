...
***Keen Smell.*** The typhon has advantage on Wisdom ([Perception](rules/5e/skills.md#Perception)) checks that rely on smell.
...
***Flurry of Bites.*** *Melee Weapon Attack:* `dice:1d20+12|noform|noparens|text(+12)` to hit, reach 10 ft., one target. *Hit:* `dice:8d6+7|noform|noparens|avg|text(35)` (`8d6 + 7`) piercing damage.

***Constrict.*** *Melee Weapon Attack:* `dice:1d20+12|noform|noparens|text(+12)` to hit, reach 15 ft., one Large or smaller creature. *Hit:* `dice:3d6+7|noform|noparens|avg|text(17)` (`3d6 + 7`) bludgeoning damage, and the target is [grappled](rules/5e/conditions.md#Grappled) (escape DC 19). Until this grapple ends, the target is [restrained](rules/5e/conditions.md#Restrained) and takes `dice:3d6+7|noform|noparens|avg|text(17)` (`3d6 + 7`) bludgeoning damage at the start of each of its turns. The typhon can have up to two creatures constricted.

***Maw.*** *Melee Weapon Attack:* `dice:1d20+12|noform|noparens|text(+12)` to hit, reach 10 ft., one target. *Hit:* `dice:3d12+7|noform|noparens|avg|text(26)` (`3d12 + 7`) piercing damage plus `dice:3d12|noform|noparens|avg|text(19)` (`3d12`) acid damage.
```
^statblock