...
- **Proficiency Bonus** +2
- **Saving Throws** ⏤
- **Skills** [Athletics](rules/5e/skills.md#Athletics) +4, [Stealth](rules/5e/skills.md#Stealth) +4
...
***Fey Ancestry.*** The chitine has advantage on saving throws against being [charmed](rules/5e/conditions.md#Charmed), and magic can't put the chitine to sleep.

***Sunlight Sensitivity.*** While in sunlight, the chitine has disadvantage on attack rolls, as well as on Wisdom ([Perception](rules/5e/skills.md#Perception)) checks that rely on sight.
