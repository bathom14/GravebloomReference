...
- **Skills** [Perception](rules/5e/skills.md#Perception) +6, [Survival](rules/5e/skills.md#Survival) +6
...
**At will:** [counterspell](compendium/5e/spells/counterspell.md) (see "Reactions" below), [detect magic](compendium/5e/spells/detect-magic.md), [dispel magic](compendium/5e/spells/dispel-magic.md), [see invisibility](compendium/5e/spells/see-invisibility.md)

**1/day:** [antimagic field](compendium/5e/spells/antimagic-field.md)

***Horrid Gnashing.*** The nullifier's mouths gnash incoherently while it can see any enemies. Each creature that starts its turn within 20 feet of the nullifier and can hear it must make a DC 16 Wisdom saving throw. Unless the save succeeds, the creature rolls a `dice:d8|noform|noparens|avg` (`d8`) to determine what it does during the current turn:

- **1-4.** The creature is [stunned](rules/5e/conditions.md#Stunned) until the end of the turn.  
- **5-6.** The creature is [frightened](rules/5e/conditions.md#Frightened) until the end of the turn and uses its movement to get as far as possible from the nullifier.  
...
***Bites.*** *Melee Weapon Attack:* `dice:1d20+8|noform|noparens|text(+8)` to hit, reach 5 ft., one creature. *Hit:* `dice:2d12+4|noform|noparens|avg|text(17)` (`2d12 + 4`) piercing damage plus `dice:2d10|noform|noparens|avg|text(11)` (`2d10`) force damage.

***Claws.*** *Melee Weapon Attack:* `dice:1d20+8|noform|noparens|text(+8)` to hit, reach 10 ft., one target. *Hit:* `dice:2d6+4|noform|noparens|avg|text(11)` (`2d6 + 4`) slashing damage plus `dice:2d10|noform|noparens|avg|text(11)` (`2d10`) force damage, and the target is [grappled](rules/5e/conditions.md#Grappled) (escape DC 16) if it's a creature. The nullifier has two claws, each of which can grapple one creature.
