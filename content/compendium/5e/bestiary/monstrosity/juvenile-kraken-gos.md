...
***Freedom of Movement.*** The kraken ignores difficult terrain, and magical effects can't reduce its speed or cause it to be [restrained](rules/5e/conditions.md#Restrained). It can spend 5 feet of movement to escape from nonmagical restraints or being [grappled](rules/5e/conditions.md#Grappled).

## Actions

***Multiattack.*** The kraken makes two tentacle attacks, each of which it can replace with a use of Fling.

***Bite.*** *Melee Weapon Attack:* `dice:1d20+12|noform|noparens|text(+12)` to hit, reach 5 ft., one target. *Hit:* `dice:3d8+7|noform|noparens|avg|text(20)` (`3d8 + 7`) piercing damage. If the target is a Medium or smaller creature [grappled](rules/5e/conditions.md#Grappled) by the kraken, that creature is swallowed and the grapple ends. While swallowed, the creature is [blinded](rules/5e/conditions.md#Blinded) and [restrained](rules/5e/conditions.md#Restrained), it has total cover against attacks and other effects outside the kraken, and it takes `dice:6d6|noform|noparens|avg|text(21)` (`6d6`) acid damage at the start of each of the kraken's turns. One Medium or two smaller creatures can be swallowed at the same time.

If the kraken takes 35 damage or more on a single turn from a creature inside it, the kraken must succeed on a DC 23 Constitution saving throw at the end of that turn or regurgitate all swallowed creatures, which fall [prone](rules/5e/conditions.md#Prone) in spaces within 10 feet of the kraken. If the kraken dies, a swallowed creature is no longer [restrained](rules/5e/conditions.md#Restrained) by it and can escape from the corpse using 10 feet of movement, exiting [prone](rules/5e/conditions.md#Prone).

***Tentacle.*** *Melee Weapon Attack:* `dice:1d20+12|noform|noparens|text(+12)` to hit, reach 20 ft., one target. *Hit:* `dice:3d6+7|noform|noparens|avg|text(17)` (`3d6 + 7`) bludgeoning damage, and the target is [grappled](rules/5e/conditions.md#Grappled) (escape DC 20). Until the grapple ends, the target is [restrained](rules/5e/conditions.md#Restrained). The kraken has ten tentacles, each of which can grapple one target.
