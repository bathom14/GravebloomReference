...
***False Appearance.*** If the spider is motionless, has its eyes and mouth closed, and has its legs wrapped around its body at the start of combat, it has advantage on its initiative roll. Moreover, if a creature hasn't observed the spider move or act, that creature must succeed on a DC 18 Intelligence ([Investigation](rules/5e/skills.md#Investigation)) check to discern that the spider is anything other than an asteroid.
...
***Bite.*** *Melee Weapon Attack:* `dice:1d20+13|noform|noparens|text(+13)` to hit, reach 10 ft., one target. *Hit:* `dice:3d8+8|noform|noparens|avg|text(21)` (`3d8 + 8`) piercing damage plus `dice:3d6|noform|noparens|avg|text(10)` (`3d6`) acid damage.

***Web Strand.*** *Ranged Weapon Attack:* `dice:1d20+13|noform|noparens|text(+13)` to hit, reach 120 ft., one creature. *Hit:* The target is [grappled](rules/5e/conditions.md#Grappled) (escape DC 18). The web strand can be attacked and destroyed (AC 12; 20 hit points; vulnerability to fire damage; immunity to bludgeoning, poison, and psychic damage). The spider can grapple up to six creatures at a time using its web strands.

***Reel.*** The spider pulls each creature [grappled](rules/5e/conditions.md#Grappled) by it up to 60 feet straight toward itself.

## Bonus Actions

***Snare Ship (1/Day).*** The spider weaves a magical web around a spelljamming ship it can see within 120 feet of itself. The web lasts for 1 minute and suppresses the magic of any spelljamming helm aboard the ship. Decks and other surfaces of the ship that aren't enclosed become difficult terrain until the effect ends. The web is impervious to damage but is destroyed by a successful casting of [dispel magic](compendium/5e/spells/dispel-magic.md) (DC 18).
```
^statblock