...
---
# Yuan-ti Malison (Type 3)
*Source: Monster Manual (2024) p. 344, Dragon Delves*  
...
`dice: [](yuan-ti-malison-type-3.md#^yuan-ti-transformations)`
...
***Multiattack.*** The yuan-ti makes two Poison Burst attacks, and it can use Spellcasting to cast [Suggestion](compendium/5e/spells/suggestion.md) if available.
...
***Constrict.*** *Strength Saving Throw:* DC 13, one Medium or smaller creature within 5 feet. *Failure:* `dice:4d8+3|noform|noparens|avg|text(21)` (`4d8 + 3`) Bludgeoning damage. The target has the [Grappled](rules/5e/conditions.md#Grappled) condition (escape DC 13), and it has the [Restrained](rules/5e/conditions.md#Restrained) condition until the grapple ends.
