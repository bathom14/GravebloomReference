...
![Major Adaptations](compendium/5e/tables/major-adaptations-ggr.md)

![Minor Adaptations](compendium/5e/tables/minor-adaptations-ggr.md)
...
***Bite.*** *Melee Weapon Attack:* `dice:1d20+11|noform|noparens|text(+11)` to hit, reach 10 ft., one creature. *Hit:* `dice:6d6+6|noform|noparens|avg|text(27)` (`6d6 + 6`) piercing damage.

***Claws.*** *Melee Weapon Attack:* `dice:1d20+11|noform|noparens|text(+11)` to hit, reach 10 ft., one target. *Hit:* `dice:3d10+6|noform|noparens|avg|text(22)` (`3d10 + 6`) slashing damage.

***Tail.*** *Melee Weapon Attack:* `dice:1d20+11|noform|noparens|text(+11)` to hit, reach 15 ft., one target. *Hit:* `dice:6d8+6|noform|noparens|avg|text(33)` (`6d8 + 6`) bludgeoning damage. If the target is a creature, it must succeed on a DC 19 Strength saving throw or be knocked [prone](rules/5e/conditions.md#Prone).
```
^statblock