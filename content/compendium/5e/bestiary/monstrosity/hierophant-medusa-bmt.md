...
- **Skills** [Insight](rules/5e/skills.md#Insight) +12, [Perception](rules/5e/skills.md#Perception) +12, [Persuasion](rules/5e/skills.md#Persuasion) +12, [Religion](rules/5e/skills.md#Religion) +8, [Stealth](rules/5e/skills.md#Stealth) +11
- **Senses** passive Perception 22
- **Damage Immunities** poison
- **Condition Immunities** [charmed](rules/5e/conditions.md#Charmed), [frightened](rules/5e/conditions.md#Frightened), [petrified](rules/5e/conditions.md#Petrified), [poisoned](rules/5e/conditions.md#Poisoned)
- **Languages** Common plus any three languages (Abyssal, Celestial, Druidic, or Infernal recommended)
- **Challenge** 17

## Traits

***Devotion's Call (1/Day).*** The medusa can cast the [Resurrection](compendium/5e/spells/resurrection.md) spell, requiring no material components and using Wisdom as the spellcasting ability.
...
***Constrict.*** *Melee Weapon Attack:* `dice:1d20+12|noform|noparens|text(+12)` to hit, reach 10 ft., one target. *Hit:* `dice:3d6+6|noform|noparens|avg|text(16)` (`3d6 + 6`) bludgeoning damage, and if the target is a Medium or smaller creature, it has the [grappled](rules/5e/conditions.md#Grappled) condition (escape DC 20). Until this grapple ends, the target has the [restrained](rules/5e/conditions.md#Restrained) condition, and the medusa can't constrict another creature.

***Final Blade.*** *Melee Weapon Attack:* `dice:1d20+12|noform|noparens|text(+12)` to hit, reach 5 ft., one target. *Hit:* `dice:2d6+6|noform|noparens|avg|text(13)` (`2d6 + 6`) slashing damage plus `dice:6d6|noform|noparens|avg|text(21)` (`6d6`) force damage. If the target has at least one head and the medusa rolled a 20 on the attack roll, the target is decapitated and dies if it fails a DC 20 Constitution saving throw and can't survive without that head. A target is immune to this effect if it takes none of the damage, has legendary actions, or is Huge or larger. Such a creature takes an extra `dice:8d6|noform|noparens|avg|text(28)` (`8d6`) force damage from the hit.

***Snake Hair.*** *Melee Weapon Attack:* `dice:1d20+12|noform|noparens|text(+12)` to hit, reach 5 ft., one target. *Hit:* `dice:1d10+6|noform|noparens|avg|text(11)` (`1d10 + 6`) piercing damage plus `dice:1d10|noform|noparens|avg|text(5)` (`d10`) poison damage.

***Wrathful Strike.*** *Ranged Spell Attack:* `dice:1d20+12|noform|noparens|text(+12)` to hit, range 120 ft., one creature. *Hit:* `dice:3d10+6|noform|noparens|avg|text(22)` (`3d10 + 6`) radiant damage, and the target has the [blinded](rules/5e/conditions.md#Blinded) condition until the end of its next turn.
...
**At will:** [Light](compendium/5e/spells/light.md), [Spare the Dying](compendium/5e/spells/spare-the-dying.md), [Thaumaturgy](compendium/5e/spells/thaumaturgy.md)

**2/day:** [Mass Cure Wounds](compendium/5e/spells/mass-cure-wounds.md) (cast at 8th level)

**1/day each:** [Blade Barrier](compendium/5e/spells/blade-barrier.md), [Divination](compendium/5e/spells/divination.md), [Greater Restoration](compendium/5e/spells/greater-restoration.md)

## Bonus Actions

***Petrifying Gaze (Recharge 4-6).*** The medusa unleashes petrifying magic from its eyes in a 30-foot cone. Each creature in that area must make a DC 18 Constitution saving throw if it doesn't have the [blinded](rules/5e/conditions.md#Blinded) condition. If the saving throw fails by 5 or more, the creature has the [petrified](rules/5e/conditions.md#Petrified) condition. Otherwise, on a failed save, the creature takes `dice:3d6|noform|noparens|avg|text(10)` (`3d6`) force damage, begins to turn to stone, and has the [restrained](rules/5e/conditions.md#Restrained) condition. The [restrained](rules/5e/conditions.md#Restrained) creature must repeat the saving throw at the end of its next turn. On a failed save, it has the [petrified](rules/5e/conditions.md#Petrified) condition, and on a successful save, the effect ends on it. The petrification lasts until the creature is freed by the [Greater Restoration](compendium/5e/spells/greater-restoration.md) spell or other magic.

A creature can use its reaction, if available, to shut its eyes to avoid the saving throw. If the creature does so, it has the [blinded](rules/5e/conditions.md#Blinded) condition until the end of its next turn.
...
![Hierophant Medusa](compendium/5e/bestiary/legendary-group/hierophant-medusa-bmt.md)
```
^statblock