...
***Raxivort's Tongue.*** The xvart can communicate with ordinary [bats](compendium/5e/bestiary/beast/bat.md) and [rats](compendium/5e/bestiary/beast/rat.md), as well as [giant bats](compendium/5e/bestiary/beast/giant-bat.md) and [giant rats](compendium/5e/bestiary/beast/giant-rat.md).

## Actions

***Multiattack.*** The xvart makes two Scimitar or Raxivort's Bite attacks.

***Scimitar.*** *Melee Weapon Attack:* `dice:1d20+4|noform|noparens|text(+4)` to hit, reach 5 ft., one target. *Hit:* `dice:1d6+2|noform|noparens|avg|text(5)` (`1d6 + 2`) slashing damage.

***Raxivort's Bite.*** *Ranged Spell Attack:* `dice:1d20+3|noform|noparens|text(+3)` to hit, range 30 ft., one creature. *Hit:* `dice:1d10+2|noform|noparens|avg|text(7)` (`1d10 + 2`) poison damage.
...
**At will:** [detect magic](compendium/5e/spells/detect-magic.md), [mage armor](compendium/5e/spells/mage-armor.md) (self only), [mage hand](compendium/5e/spells/mage-hand.md), [minor illusion](compendium/5e/spells/minor-illusion.md), [prestidigitation](compendium/5e/spells/prestidigitation.md)

**1/day each:** [burning hands](compendium/5e/spells/burning-hands.md), [invisibility](compendium/5e/spells/invisibility.md)

## Bonus Actions

***Low Cunning.*** The xvart takes the [Disengage](rules/5e/actions.md#Disengage) action.
```
^statblock
