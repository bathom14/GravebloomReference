...
***Greataxe.*** *Melee Weapon Attack:* `dice:1d20+6|noform|noparens|text(+6)` to hit, reach 5 ft., one target. *Hit:* `dice:2d12+4|noform|noparens|avg|text(17)` (`2d12 + 4`) slashing damage.

***Gore.*** *Melee Weapon Attack:* `dice:1d20+6|noform|noparens|text(+6)` to hit, reach 5 ft., one target. *Hit:* `dice:2d8+4|noform|noparens|avg|text(13)` (`2d8 + 4`) piercing damage.

***Amphora.*** *Melee Weapon Attack:* `dice:1d20+6|noform|noparens|text(+6)` to hit, reach 5 ft., one Medium or smaller creature. *Hit:* `dice:1d8+4|noform|noparens|avg|text(8)` (`1d8 + 4`) bludgeoning damage. If there is not already a creature inside the amphora, the target is [restrained](rules/5e/conditions.md#Restrained) inside. As an action, the [restrained](rules/5e/conditions.md#Restrained) creature can make a DC 14 Dexterity ([Acrobatics](rules/5e/skills.md#Acrobatics)) check, escaping from the amphora on a success. The effect also ends if the amphora is destroyed. The amphora has AC 8, 20 hit points, and immunity to poison and psychic damage.
```
^statblock