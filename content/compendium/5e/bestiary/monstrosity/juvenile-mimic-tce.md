...
***Bite.*** *Melee Weapon Attack:* `dice:1d20+3|noform|noparens|text(+3)` to hit, reach 5 ft., one target. *Hit:* 1 piercing damage plus `dice:1d4|noform|noparens|avg|text(2)` (`d4`) acid damage.
