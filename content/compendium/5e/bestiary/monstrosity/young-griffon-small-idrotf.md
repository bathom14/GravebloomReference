...
***Keen Sight.*** The griffon has advantage on Wisdom ([Perception](rules/5e/skills.md#Perception)) checks that rely on sight.

## Actions

***Multiattack.*** The griffon makes two attacks: one with its beak and one with its claws.

***Beak.*** *Melee Weapon Attack:* `dice:1d20+1|noform|noparens|text(+1)` to hit, reach 5 ft., one target. *Hit:* `dice:1d4|noform|noparens|avg|text(2)` (`d4`) piercing damage.

***Claws.*** *Melee Weapon Attack:* `dice:1d20+1|noform|noparens|text(+1)` to hit, reach 5 ft., one target. *Hit:* `dice:1d4|noform|noparens|avg|text(2)` (`d4`) slashing damage.
```
^statblock