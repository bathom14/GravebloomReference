...
***Tunneler.*** The umber hulk can burrow through solid rock at half its [Burrow Speed](rules/5e/variant-rules/burrow-speed-xphb.md) and leaves a 10-foot-diameter tunnel in its wake.

## Actions

***Multiattack.*** The umber hulk makes three Rend attacks.

***Rend.*** *Melee Attack Roll:* `dice:1d20+8|noform|noparens|text(+8)`, reach 10 ft. *Hit:* `dice:2d6+5|noform|noparens|avg|text(12)` (`2d6 + 5`) Slashing damage.

## Bonus Actions

***Confusing Gaze (Recharge 5-6).*** *Wisdom Saving Throw:* DC 14, each creature in a 30-foot [Cone](rules/5e/variant-rules/cone-area-of-effect-xphb.md). *Failure:* The target can't take Reactions until the start of the umber hulk's next turn, and the target rolls `dice:1d8|noform|noparens|avg` (`d8`) to determine what it does on its next turn:
