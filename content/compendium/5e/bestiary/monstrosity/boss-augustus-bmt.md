...
- **Skills** [Perception](rules/5e/skills.md#Perception) +10, [Sleight of Hand](rules/5e/skills.md#Sleight%20of%20Hand) +7, [Stealth](rules/5e/skills.md#Stealth) +7
...
***Special Equipment.*** Augustus wields a [+2 Longsword](compendium/5e/items/2-weapon-dmg.md).

## Actions

***Multiattack.*** Augustus makes any combination of two Bite, Claw, or Magic Longsword attacks.

***Bite (Wolf or Hybrid Form Only).*** *Melee Weapon Attack:* `dice:1d20+8|noform|noparens|text(+8)` to hit, reach 5 ft., one target. *Hit:* `dice:5d8+4|noform|noparens|avg|text(26)` (`5d8 + 4`) piercing damage. If the target is a Humanoid, it must succeed on a DC 15 Constitution saving throw or be cursed with lycanthropy. While cursed in this way, the target retains its alignment, languages, and equipment but otherwise uses the werewolf stat block, excluding actions that require equipment the target doesn't have. During any night when there's a full moon in the sky, the target becomes an NPC under the DM's control and remains so until the night ends. A [Remove Curse](compendium/5e/spells/remove-curse.md) spell or similar magic ends this curse.

***Claw (Wolf or Hybrid Form Only).*** *Melee Weapon Attack:* `dice:1d20+8|noform|noparens|text(+8)` to hit, reach 5 ft., one target. *Hit:* `dice:5d6+4|noform|noparens|avg|text(21)` (`5d6 + 4`) piercing damage. If the target is a creature, it must succeed on a DC 16 Strength saving throw or have the [prone](rules/5e/conditions.md#Prone) condition.

***Magic Longsword (Humanoid or Hybrid Form Only).*** *Melee Weapon Attack:* `dice:1d20+10|noform|noparens|text(+10)` to hit, reach 5 ft., one target. *Hit:* `dice:4d10+6|noform|noparens|avg|text(28)` (`4d10 + 6`) slashing damage.
