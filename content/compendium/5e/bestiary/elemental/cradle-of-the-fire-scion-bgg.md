...
- **Condition Immunities** [exhaustion](rules/5e/conditions.md#Exhaustion), [petrified](rules/5e/conditions.md#Petrified), [poisoned](rules/5e/conditions.md#Poisoned)
- **Languages** Giant, Primordial
- **Challenge** 25

## Traits

***Awakening of the Scion.*** The cradle is a container for the [scion of Surtur](compendium/5e/bestiary/giant/scion-of-surtur-bgg.md). When the cradle drops to 0 hit points, its body hardens and crumbles to ash. The scion instantly appears in the space the cradle occupied and uses the cradle's initiative count.
...
***Slam.*** *Melee Weapon Attack:* `dice:1d20+17|noform|noparens|text(+17)` to hit, reach 20 ft., one target. *Hit:* `dice:4d10+9|noform|noparens|avg|text(31)` (`4d10 + 9`) bludgeoning damage plus `dice:4d6|noform|noparens|avg|text(14)` (`4d6`) fire damage.

***Hurl Lava.*** *Ranged Weapon Attack:* `dice:1d20+17|noform|noparens|text(+17)` to hit, range 120 ft., one target. *Hit:* `dice:4d8+9|noform|noparens|avg|text(27)` (`4d8 + 9`) fire damage. If the target is a creature or a flammable object, it ignites. Until a creature within 5 feet of the fire takes an action to douse the fire, the target takes `dice:3d6|noform|noparens|avg|text(10)` (`3d6`) fire damage at the start of each of its turns.

***Erupting Breath (Recharge 5-6).*** The cradle exhales flames and volcanic gases in a 90-foot cone. Each creature in that area must make a DC 24 Dexterity saving throw. On a failed save, a creature takes `dice:10d10|noform|noparens|avg|text(55)` (`10d10`) fire damage and has the [poisoned](rules/5e/conditions.md#Poisoned) condition for 1 minute. On a successful save, a creature takes half as much damage only.

A creature [poisoned](rules/5e/conditions.md#Poisoned) in this way can make a DC 24 Constitution saving throw at the end of each of its turns, ending the effect on itself on a success.

## Bonus Actions

***Lava Geyser.*** The cradle causes lava to erupt from a point on the ground it can see within 120 feet of itself. Each creature in a 20-foot-radius, 50-foot-high cylinder centered on that point must succeed on a DC 21 Dexterity saving throw or take `dice:4d6|noform|noparens|avg|text(14)` (`4d6`) fire damage.
