...
***Awakening of the Scion.*** The cradle is a container for the [scion of Thrym](compendium/5e/bestiary/giant/scion-of-thrym-bgg.md). When the cradle drops to 0 hit points, its body shatters into shards of ice. The scion instantly appears in the space the cradle occupied and uses the cradle's initiative count.
...
***Slam.*** *Melee Weapon Attack:* `dice:1d20+15|noform|noparens|text(+15)` to hit, reach 20 ft., one target. *Hit:* `dice:4d10+8|noform|noparens|avg|text(30)` (`4d10 + 8`) bludgeoning damage plus `dice:2d10|noform|noparens|avg|text(11)` (`2d10`) cold damage.

***Hurl Icicle.*** *Ranged Weapon Attack:* `dice:1d20+15|noform|noparens|text(+15)` to hit, range 120 ft., one target. *Hit:* `dice:4d8+8|noform|noparens|avg|text(26)` (`4d8 + 8`) piercing damage plus `dice:2d8|noform|noparens|avg|text(9)` (`2d8`) cold damage, and the target must succeed on a DC 23 Strength saving throw or have the [prone](rules/5e/conditions.md#Prone) condition.

***Freezing Breath (Recharge 5-6).*** The cradle exhales a blast of frost in a 90-foot cone. Each creature in that area must make a DC 23 Constitution saving throw. On a failed save, a creature takes `dice:8d12|noform|noparens|avg|text(52)` (`8d12`) cold damage, and its speed is reduced to 0 until the end of its next turn. On a successful save, a creature takes half as much damage only. If this damage would reduce the target to 0 hit points, the target drops to 1 hit point instead and has the [petrified](rules/5e/conditions.md#Petrified) condition, turning into a frozen statue.
