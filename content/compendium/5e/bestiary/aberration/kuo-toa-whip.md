...
`dice: [](kuo-toa-whip.md#^kuo-toa-deity-features)`
...
`dice: [](kuo-toa-whip.md#^kuo-toa-ritual-sites)`
...
- **Proficiency Bonus** +2
- **Saving Throws** ⏤
- **Skills** [Perception](rules/5e/skills.md#Perception) +6, [Religion](rules/5e/skills.md#Religion) +3
...
***Pincer Staff.*** *Melee Attack Roll:* `dice:1d20+4|noform|noparens|text(+4)`, reach 10 ft. *Hit:* `dice:2d6+2|noform|noparens|avg|text(9)` (`2d6 + 2`) Piercing damage. If the target is a Medium or smaller creature, it has the [Grappled](rules/5e/conditions.md#Grappled) condition (escape DC 12). Until the grapple ends, the kuo-toa can't make Pincer Staff attacks.
...
***Shield of Faith (2/Day).*** The kuo-toa casts [Shield of Faith](compendium/5e/spells/shield-of-faith.md), using Wisdom as the spellcasting ability.
