...
3rd Level (2 slots): [dispel magic](compendium/5e/spells/dispel-magic.md), tongues
...
***Spellcasting.*** The ixitxachitl is a 5th-level spellcaster that uses Wisdom as its spellcasting ability (Spell save DC 11, `dice:1d20+3|noform|noparens|text(+3)` to hit with spell attacks). The ixitxachitl has the following cleric spells prepared:

**Cantrips (at will):** [guidance](compendium/5e/spells/guidance.md), [thaumaturgy](compendium/5e/spells/thaumaturgy.md)

**1st level (4 slots):** [charm person](compendium/5e/spells/charm-person.md), [create or destroy water](compendium/5e/spells/create-or-destroy-water.md)

**2nd level (3 slots):** [hold person](compendium/5e/spells/hold-person.md), [silence](compendium/5e/spells/silence.md)

**3rd level (2 slots):** [dispel magic](compendium/5e/spells/dispel-magic.md), [tongues](compendium/5e/spells/tongues.md)

## Actions

***Vampiric Bite.*** *Melee Weapon Attack:* `dice:1d20+4|noform|noparens|text(+4)` to hit, reach 5 ft., one target. *Hit:* `dice:1d8+2|noform|noparens|avg|text(6)` (`1d8 + 2`) piercing damage. The target must succeed on a DC 11 Constitution saving throw or its hit point maximum is reduced by an amount equal to the damage taken, and the ixitxachitl regains hit points equal to that amount. The reduction lasts until the target finishes a long rest. The target dies if its hit point maximum is reduced to 0.
...
*Melee Weapon Attack:* `dice:1d20+6|noform|noparens|text(+6)` to hit, reach 5 ft., one target. *Hit:* `dice:1d10+4|noform|noparens|avg|text(9)` (`1d10 + 4`) piercing damage.
```
^statblock