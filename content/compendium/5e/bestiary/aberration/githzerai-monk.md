...
`dice: [](githzerai-monk.md#^gith-conflicts)`
...
**1/day:** [See Invisibility](compendium/5e/spells/see-invisibility.md)

## Bonus Actions

***Psi-Powered Leap (2/Day).*** The githzerai casts [Jump](compendium/5e/spells/jump.md), requiring no spell components and using the same spellcasting ability as Spellcasting.


## Reactions

***Psionic Defense (2/Day).*** The githzerai casts [Feather Fall](compendium/5e/spells/feather-fall.md) or [Shield](compendium/5e/spells/shield.md) in response to the spell's trigger, requiring no spell components and using the same spellcasting ability as Spellcasting.
