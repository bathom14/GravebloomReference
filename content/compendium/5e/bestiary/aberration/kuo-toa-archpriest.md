...
`dice: [](kuo-toa-archpriest.md#^kuo-toa-deity-features)`
...
`dice: [](kuo-toa-archpriest.md#^kuo-toa-ritual-sites)`
...
- **Proficiency Bonus** +3
- **Saving Throws** ⏤
- **Skills** [Perception](rules/5e/skills.md#Perception) +9, [Religion](rules/5e/skills.md#Religion) +4
...
***Strange Scepter.*** *Melee  or Ranged Attack Roll:* `dice:1d20+6|noform|noparens|text(+6)`, reach 5 ft. or range 120 ft. *Hit:* `dice:5d6+3|noform|noparens|avg|text(20)` (`5d6 + 3`) Lightning damage.
...
**At will:** [Detect Magic](compendium/5e/spells/detect-magic.md), [Thaumaturgy](compendium/5e/spells/thaumaturgy.md)

**1/day each:** [Destructive Wave](compendium/5e/spells/destructive-wave.md), [Divination](compendium/5e/spells/divination.md), [Hold Monster](compendium/5e/spells/hold-monster.md) (level 6 version), [Scrying](compendium/5e/spells/scrying.md), [Tongues](compendium/5e/spells/tongues.md)

## Bonus Actions

***Shield of Faith (2/Day).*** The kuo-toa casts [Shield of Faith](compendium/5e/spells/shield-of-faith.md), using the same spellcasting ability as Spellcasting.
