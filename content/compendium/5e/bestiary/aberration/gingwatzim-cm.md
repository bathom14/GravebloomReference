...
- 5e/monster/type/aberration/shapechanger
aliases:
- Gingwatzim
---
# Gingwatzim
...
***Energy Drain (True Form Only).*** *Melee Weapon Attack:* `dice:1d20+4|noform|noparens|text(+4)` to hit, reach 5 ft., one creature. *Hit:* `dice:4d6+2|noform|noparens|avg|text(16)` (`4d6 + 2`) necrotic damage, and the target must succeed on a DC 12 Constitution saving throw or gain 1 level of [exhaustion](rules/5e/conditions.md#Exhaustion). When the target finishes a short or long rest, the target loses every level of [exhaustion](rules/5e/conditions.md#Exhaustion) gained from this attack.
