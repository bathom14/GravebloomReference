...
- 5e/monster/type/aberration/sorcerer
aliases:
- Derro Savant
---
# Derro Savant
...
***Quarterstaff.*** *Melee Weapon Attack:* `dice:1d20+1|noform|noparens|text(+1)` to hit, reach 5 ft., one target. *Hit:* `dice:1d6-1|noform|noparens|avg|text(2)` (`1d6 - 1`) bludgeoning damage.

***Chromatic Beam.*** The derro launches a brilliant beam of magical energy in a 5-foot-wide line that is 60 feet long. Each creature in the line must make a DC 12 Dexterity saving throw, taking `dice:6d6|noform|noparens|avg|text(21)` (`6d6`) radiant damage on a failed save, or half as much damage on a successful one.
...
**1/day each:** [invisibility](compendium/5e/spells/invisibility.md), [sleep](compendium/5e/spells/sleep.md), [spider climb](compendium/5e/spells/spider-climb.md)
```
^statblock
