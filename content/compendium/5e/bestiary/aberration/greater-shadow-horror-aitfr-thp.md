...
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/AitFR-THP/Greater%20Shadow%20Horror.webp#token)
...
***Claw.*** *Melee Weapon Attack:* `dice:1d20+7|noform|noparens|text(+7)` to hit, reach 5 ft., one target. *Hit:* `dice:4d6+3|noform|noparens|avg|text(17)` (`4d6 + 3`) slashing damage, and the target must succeed on a DC 16 Wisdom saving throw or be [frightened](rules/5e/conditions.md#Frightened) of the horror until the end of the target's next turn.

***Lashing Shadows (Recharge 5-6).*** Each creature within 60 feet of the horror, except other horrors, must succeed on a DC 16 Dexterity saving throw or take `dice:8d8|noform|noparens|avg|text(36)` (`8d8`) necrotic damage.
...
***Frighten Foe (Costs 2 Actions).*** The horror targets one enemy it can see within 30 feet of it. If the target can see and hear it, the target must succeed on a DC 16 Wisdom saving throw or be [frightened](rules/5e/conditions.md#Frightened) until the end of horror's next turn.
```
^statblock