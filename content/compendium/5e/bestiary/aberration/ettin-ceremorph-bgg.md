...
- **Condition Immunities** [charmed](rules/5e/conditions.md#Charmed), [frightened](rules/5e/conditions.md#Frightened), [stunned](rules/5e/conditions.md#Stunned), [unconscious](rules/5e/conditions.md#Unconscious)
...
***Slam.*** *Melee Weapon Attack:* `dice:1d20+7|noform|noparens|text(+7)` to hit, reach 10 ft., one target. *Hit:* `dice:4d8+4|noform|noparens|avg|text(22)` (`4d8 + 4`) bludgeoning damage.

***Tentacles.*** *Melee Weapon Attack:* `dice:1d20+7|noform|noparens|text(+7)` to hit, reach 10 ft., one creature. *Hit:* `dice:2d10+4|noform|noparens|avg|text(15)` (`2d10 + 4`) psychic damage. If the target is Large or smaller, it has the [grappled](rules/5e/conditions.md#Grappled) condition (escape DC 14) and must succeed on a DC 15 Intelligence saving throw or have the [stunned](rules/5e/conditions.md#Stunned) condition until this grapple ends.
...
***Mind Bolt (3/Day).*** *Ranged Spell Attack:* `dice:1d20+7|noform|noparens|text(+7)` to hit, range 120 ft., one creature. *Hit:* `dice:2d12+4|noform|noparens|avg|text(17)` (`2d12 + 4`) psychic damage, and the target must succeed on a DC 15 Intelligence saving throw or have the [stunned](rules/5e/conditions.md#Stunned) condition until the end of its next turn.
```
^statblock