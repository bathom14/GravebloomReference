...
- **Skills** [Investigation](rules/5e/skills.md#Investigation) +6, [Perception](rules/5e/skills.md#Perception) +10
...
***Dreadful Contact.*** *Melee Weapon Attack:* `dice:1d20+5|noform|noparens|text(+5)` to hit, reach 5 ft., one creature. *Hit:* `dice:3d6+4|noform|noparens|avg|text(14)` (`3d6 + 4`) psychic damage, or `dice:6d6+4|noform|noparens|avg|text(25)` (`6d6 + 4`) psychic damage if the target has the [frightened](rules/5e/conditions.md#Frightened) condition.
...
***Weeping Eyes.*** The oculorb weeps, releasing a wave of crushing despair. Each creature within 30 feet of the oculorb must make a DC 16 Constitution saving throw. On a failed save, a creature's speed is reduced to 0 feet until the end of the oculorb's next turn, and if the creature was [concentrating](rules/5e/conditions.md#Concentration), its [concentration](rules/5e/conditions.md#Concentration) is broken.

***Withering Glare.*** The oculorb's eyes unleash furious scarlet energy in a 60-foot cone. Each creature in that area must make a DC 16 Wisdom saving throw. On a failed save, a creature takes `dice:6d10|noform|noparens|avg|text(33)` (`6d10`) necrotic damage and has the [frightened](rules/5e/conditions.md#Frightened) condition for 1 minute. On a successful save, a creature takes half as much damage and isn't [frightened](rules/5e/conditions.md#Frightened). A [frightened](rules/5e/conditions.md#Frightened) creature can repeat the saving throw at the end of each of its turns, ending the effect on itself on a successful save.
