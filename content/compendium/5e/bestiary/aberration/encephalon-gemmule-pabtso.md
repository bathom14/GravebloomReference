...
***Encephalon Progeny.*** The gemmule matures into an encephalon cluster if not killed within `dice:4d12+4|noform|noparens|avg|text(30)` (`4d12 + 4`) days of its creation.
