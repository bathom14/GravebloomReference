...
***Bite.*** *Melee Weapon Attack:* `dice:1d20+4|noform|noparens|text(+4)` to hit, reach 5 ft., one target. *Hit:* `dice:2d8+2|noform|noparens|avg|text(11)` (`2d8 + 2`) piercing damage.
...
***Extract Brain.*** *Melee Weapon Attack:* `dice:1d20+4|noform|noparens|text(+4)` to hit, reach 5 ft., one [incapacitated](rules/5e/conditions.md#Incapacitated) Humanoid. *Hit:* `dice:10d6|noform|noparens|avg|text(35)` (`10d6`) piercing damage. If this damage reduces the target to 0 hit points, the neh-thalggu kills the target by extracting and consuming its brain.

***Mind Blast (Recharge 5-6).*** The neh-thalggu magically emits psychic energy at one Humanoid it can see within 10 feet of itself. The target must make a DC 14 Wisdom saving throw. On a failed save, the target takes `dice:2d8|noform|noparens|avg|text(9)` (`2d8`) psychic damage and is [incapacitated](rules/5e/conditions.md#Incapacitated) until the end of its next turn. On a successful save, the target takes half as much damage and isn't [incapacitated](rules/5e/conditions.md#Incapacitated).
...
**1/day each:** [arms of Hadar](compendium/5e/spells/arms-of-hadar.md) (1 brain), [detect magic](compendium/5e/spells/detect-magic.md) (2 brains), [magic missile](compendium/5e/spells/magic-missile.md) (3 brains), [Tenser's floating disk](compendium/5e/spells/tensers-floating-disk.md) (4 brains), [darkness](compendium/5e/spells/darkness.md) (5 brains), [hold person](compendium/5e/spells/hold-person.md) (6 brains), [invisibility](compendium/5e/spells/invisibility.md) (7 brains), [spider climb](compendium/5e/spells/spider-climb.md) (8 brains), [fear](compendium/5e/spells/fear.md) (9 brains), [hypnotic pattern](compendium/5e/spells/hypnotic-pattern.md) (10 brains), [major image](compendium/5e/spells/major-image.md) (11 brains), [stinking cloud](compendium/5e/spells/stinking-cloud.md) (12 brains)
```
^statblock