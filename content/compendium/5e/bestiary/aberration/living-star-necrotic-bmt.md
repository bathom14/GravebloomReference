...
- **Skills** [Arcana](rules/5e/skills.md#Arcana) +6, [History](rules/5e/skills.md#History) +6, [Insight](rules/5e/skills.md#Insight) +5, [Perception](rules/5e/skills.md#Perception) +5
- **Senses** darkvision 120 ft., passive Perception 15
- **Damage Immunities** radiant
- **Condition Immunities** [exhaustion](rules/5e/conditions.md#Exhaustion)
- **Languages** all
- **Challenge** 3
...
**2/day:** [Cure Wounds](compendium/5e/spells/cure-wounds.md)

**1/day each:** [Divination](compendium/5e/spells/divination.md), [Greater Restoration](compendium/5e/spells/greater-restoration.md)
...
***Price of Defiance.*** When the living portent is damaged by a creature that it can see within 120 feet of itself, necrotic power sears the creature. The creature must make a DC 13 Constitution saving throw, taking `dice:3d6|noform|noparens|avg|text(10)` (`3d6`) necrotic damage on a failed save, or half as much damage on a successful one.
```
^statblock