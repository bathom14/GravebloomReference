...
***Mind Blast (Recharge 5-6).*** The zealot magically emits psychic energy in a 60-foot cone. Each creature in that area must succeed on a DC 15 Intelligence saving throw or take `dice:4d8+4|noform|noparens|avg|text(22)` (`4d8 + 4`) psychic damage and have the [stunned](rules/5e/conditions.md#Stunned) condition for 1 minute. A target can repeat the saving throw at the end of each of its turns, ending the [stunned](rules/5e/conditions.md#Stunned) condition on itself on a success.
