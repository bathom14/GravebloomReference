...
***Pack Tactics.*** The hound has advantage on attack rolls against a creature if at least one of the hound's allies is within 5 feet of the target and the ally doesn't have the [incapacitated](rules/5e/conditions.md#Incapacitated) condition.
...
***Bite.*** *Melee Weapon Attack:* `dice:1d20+5|noform|noparens|text(+5)` to hit, reach 5 ft., one target. *Hit:* `dice:2d6+3|noform|noparens|avg|text(10)` (`2d6 + 3`) piercing damage plus `dice:1d6|noform|noparens|avg|text(3)` (`d6`) necrotic damage. If the target is a creature, it must succeed on a DC 13 Strength saving throw or have the [prone](rules/5e/conditions.md#Prone) condition.
