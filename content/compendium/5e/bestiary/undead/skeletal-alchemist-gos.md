...
***Claws.*** *Melee Weapon Attack:* `dice:1d20+3|noform|noparens|text(+3)` to hit, reach 5 ft. one target. *Hit:* `dice:1d6+1|noform|noparens|avg|text(4)` (`1d6 + 1`) slashing damage.

***Lob Acid.*** *Ranged Weapon Attack:* `dice:1d20+3|noform|noparens|text(+3)` to hit, range 30/120 ft., one target. *Hit:* `dice:1d8+1|noform|noparens|avg|text(5)` (`1d8 + 1`) acid damage.
```
^statblock