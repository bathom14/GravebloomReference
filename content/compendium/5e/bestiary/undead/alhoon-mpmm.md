...
- 5e/monster/type/undead/mind-flayer
...
- **Skills** [Arcana](rules/5e/skills.md#Arcana) +8, [Deception](rules/5e/skills.md#Deception) +7, [History](rules/5e/skills.md#History) +8, [Insight](rules/5e/skills.md#Insight) +7, [Perception](rules/5e/skills.md#Perception) +7, [Stealth](rules/5e/skills.md#Stealth) +5
...
***Chilling Grasp.*** *Melee Spell Attack:* `dice:1d20+8|noform|noparens|text(+8)` to hit, reach 5 ft., one target. *Hit:* `dice:4d6|noform|noparens|avg|text(14)` (`4d6`) cold damage, and the alhoon regains 14 hit points.

***Arcane Bolt.*** *Ranged Spell Attack:* `dice:1d20+8|noform|noparens|text(+8)` to hit, range 120 ft., one target. *Hit:* `dice:8d6|noform|noparens|avg|text(28)` (`8d6`) force damage.

***Mind Blast (Recharge 5-6).*** The alhoon magically emits psychic energy in a 60-foot cone. Each creature in that area must succeed on a DC 16 Intelligence saving throw or take `dice:4d8+4|noform|noparens|avg|text(22)` (`4d8 + 4`) psychic damage and be [stunned](rules/5e/conditions.md#Stunned) for 1 minute. A target can repeat the saving throw at the end of each of its turns, ending the effect on itself on a success.
...
**At will:** [dancing lights](compendium/5e/spells/dancing-lights.md), [detect magic](compendium/5e/spells/detect-magic.md), [detect thoughts](compendium/5e/spells/detect-thoughts.md), [disguise self](compendium/5e/spells/disguise-self.md), [mage hand](compendium/5e/spells/mage-hand.md), [prestidigitation](compendium/5e/spells/prestidigitation.md)

**1/day each:** [dominate monster](compendium/5e/spells/dominate-monster.md), [globe of invulnerability](compendium/5e/spells/globe-of-invulnerability.md), [invisibility](compendium/5e/spells/invisibility.md), [modify memory](compendium/5e/spells/modify-memory.md), [plane shift](compendium/5e/spells/plane-shift.md) (self only), [wall of force](compendium/5e/spells/wall-of-force.md)
