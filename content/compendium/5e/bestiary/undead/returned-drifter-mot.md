...
***Scimitar.*** *Melee Weapon Attack:* `dice:1d20+4|noform|noparens|text(+4)` to hit, reach 5 ft., one target. *Hit:* `dice:1d6+2|noform|noparens|avg|text(5)` (`1d6 + 2`) slashing damage plus `dice:1d6|noform|noparens|avg|text(3)` (`d6`) poison damage.
