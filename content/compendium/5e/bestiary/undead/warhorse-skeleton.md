...
`dice: [](warhorse-skeleton.md#^skeleton-pantomimes)`
...
***Hooves.*** *Melee Attack Roll:* `dice:1d20+6|noform|noparens|text(+6)`, reach 5 ft. *Hit:* `dice:1d6+4|noform|noparens|avg|text(7)` (`1d6 + 4`) Bludgeoning damage. If the target is a Large or smaller creature and the skeleton moved 20+ feet straight toward it immediately before the hit, the target has the [Prone](rules/5e/conditions.md#Prone) condition.
```
^statblock
