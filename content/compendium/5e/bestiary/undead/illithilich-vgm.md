...
Melee Weapon Attack: +12 to hit, reach 5 ft., one creature. Hit: `dice:3d10+5|noform|noparens|avg|text(21)` (`3d10 + 5`) psychic damage. If the target is Large or smaller, it is [grappled](rules/5e/conditions.md#Grappled) (escape DC 15) and must succeed on a DC 20 Intelligence saving throw or be [stunned](rules/5e/conditions.md#Stunned) until this grapple ends.
...
The lich magically emits psychic energy in a 60-foot cone. Each creature in that area must succeed on a DC 18 Intelligence saving throw or take `dice:5d8+5|noform|noparens|avg|text(27)` (`5d8 + 5`) psychic damage and be [stunned](rules/5e/conditions.md#Stunned) for 1 minute. A creature can repeat the saving throw at the end of each of its turns, ending the effect on itself on a success.
...
***Spellcasting.*** The illithilich is an 18th-level spellcaster. Its spellcasting ability is Intelligence (spell save DC 20, `dice:1d20+12|noform|noparens|text(+12)` to hit with spell attacks). The lich has the following wizard spells prepared:

**Cantrips (at will):** [mage hand](compendium/5e/spells/mage-hand.md), [prestidigitation](compendium/5e/spells/prestidigitation.md), [ray of frost](compendium/5e/spells/ray-of-frost.md)

**1st level (4 slots):** [detect magic](compendium/5e/spells/detect-magic.md), [magic missile](compendium/5e/spells/magic-missile.md), [shield](compendium/5e/spells/shield.md), [thunderwave](compendium/5e/spells/thunderwave.md)

**2nd level (3 slots):** [detect thoughts](compendium/5e/spells/detect-thoughts.md), [invisibility](compendium/5e/spells/invisibility.md), [Melf's acid arrow](compendium/5e/spells/melfs-acid-arrow.md), [mirror image](compendium/5e/spells/mirror-image.md)

**3rd level (3 slots):** [animate dead](compendium/5e/spells/animate-dead.md), [counterspell](compendium/5e/spells/counterspell.md), [dispel magic](compendium/5e/spells/dispel-magic.md), [fireball](compendium/5e/spells/fireball.md)

**4th level (3 slots):** [blight](compendium/5e/spells/blight.md), [dimension door](compendium/5e/spells/dimension-door.md)

**5th level (3 slots):** [cloudkill](compendium/5e/spells/cloudkill.md), [scrying](compendium/5e/spells/scrying.md)

**6th level (1 slots):** [disintegrate](compendium/5e/spells/disintegrate.md), [globe of invulnerability](compendium/5e/spells/globe-of-invulnerability.md)

**7th level (1 slots):** [finger of death](compendium/5e/spells/finger-of-death.md), [plane shift](compendium/5e/spells/plane-shift.md)

**8th level (1 slots):** [dominate monster](compendium/5e/spells/dominate-monster.md), [power word stun](compendium/5e/spells/power-word-stun.md)

**9th level (1 slots):** [power word kill](compendium/5e/spells/power-word-kill.md)
...
***Rejuvenation.*** If it has a phylactery, a destroyed illithilich gains a new body in `dice:1d10|noform|noparens|avg` (`d10`) days, regaining all its hit points and becoming active again. The new body appears within 5 feet of the phylactery.
...
***Paralyzing Touch.*** *Melee Spell Attack:* `dice:1d20+12|noform|noparens|text(+12)` to hit, reach 5 ft., one creature. *Hit:* `dice:3d6|noform|noparens|avg|text(10)` (`3d6`) cold damage. The target must succeed on a DC 18 Constitution saving throw or be [paralyzed](rules/5e/conditions.md#Paralyzed) for 1 minute. The target can repeat the saving throw at the end of each of its turns, ending the effect on itself on a success.

***Tentacles.*** *Melee Weapon Attack:* `dice:1d20+12|noform|noparens|text(+12)` to hit, reach 5 ft., one creature. *Hit:* `dice:3d10+5|noform|noparens|avg|text(21)` (`3d10 + 5`) psychic damage. If the target is Large or smaller, it is [grappled](rules/5e/conditions.md#Grappled) (escape DC 15) and must succeed on a DC 20 Intelligence saving throw or be [stunned](rules/5e/conditions.md#Stunned) until this grapple ends.

***Extract Brain.*** *Melee Weapon Attack:* `dice:1d20+12|noform|noparens|text(+12)` to hit, reach 5 ft., one [incapacitated](rules/5e/conditions.md#Incapacitated) humanoid [grappled](rules/5e/conditions.md#Grappled) by the lich. *Hit:* `dice:10d10|noform|noparens|avg|text(55)` (`10d10`) piercing damage. If this damage reduces the target to 0 hit points, the lich kills the target by extracting and devouring its brain.
...
![Illithilich](compendium/5e/bestiary/legendary-group/illithilich-vgm.md)
```
^statblock
