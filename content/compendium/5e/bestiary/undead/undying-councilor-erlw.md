...
- **Skills** [Arcana](rules/5e/skills.md#Arcana) +7, [History](rules/5e/skills.md#History) +11, [Insight](rules/5e/skills.md#Insight) +9, [Perception](rules/5e/skills.md#Perception) +9, [Religion](rules/5e/skills.md#Religion) +7
...
***Spellcasting.*** The councilor is a 13th-level spellcaster. Its spellcasting ability is Wisdom (spell save DC 17, `dice:1d20+9|noform|noparens|text(+9)` to hit with spell attacks). It has the following cleric spells prepared:

**Cantrips (at will):** [guidance](compendium/5e/spells/guidance.md), [mending](compendium/5e/spells/mending.md), [sacred flame](compendium/5e/spells/sacred-flame.md), [spare the dying](compendium/5e/spells/spare-the-dying.md), [thaumaturgy](compendium/5e/spells/thaumaturgy.md)

**1st level (4 slots):** [bless](compendium/5e/spells/bless.md), [command](compendium/5e/spells/command.md), [create or destroy water](compendium/5e/spells/create-or-destroy-water.md)

**2nd level (3 slots):** [augury](compendium/5e/spells/augury.md), [calm emotions](compendium/5e/spells/calm-emotions.md), [hold person](compendium/5e/spells/hold-person.md)

**3rd level (3 slots):** [daylight](compendium/5e/spells/daylight.md), [dispel magic](compendium/5e/spells/dispel-magic.md), [spirit guardians](compendium/5e/spells/spirit-guardians.md)

**4th level (3 slots):** [banishment](compendium/5e/spells/banishment.md), [divination](compendium/5e/spells/divination.md), [guardian of faith](compendium/5e/spells/guardian-of-faith.md)

**5th level (2 slots):** [dispel evil and good](compendium/5e/spells/dispel-evil-and-good.md), [flame strike](compendium/5e/spells/flame-strike.md) (see "Actions" below), [scrying](compendium/5e/spells/scrying.md)

**6th level (1 slots):** [forbiddance](compendium/5e/spells/forbiddance.md), [planar ally](compendium/5e/spells/planar-ally.md)

**7th level (1 slots):** [plane shift](compendium/5e/spells/plane-shift.md)
...
***Radiant Touch.*** *Melee Spell Attack:* `dice:1d20+9|noform|noparens|text(+9)` to hit, reach 5 ft., one target. *Hit:* `dice:3d6+5|noform|noparens|avg|text(15)` (`3d6 + 5`) radiant damage.

***Healing Touch (3/Day).*** The councilor touches another creature. The target magically regains `dice:3d8+5|noform|noparens|avg|text(18)` (`3d8 + 5`) hit points and is freed from one curse afflicting it (councilor's choice).

***Flame Strike (5th-Level Spell; Requires a Spell Slot).*** The councilor chooses a point it can see within 60 feet of it. Each creature in a 10-foot-radius, 40-foot-high cylinder centered on that point must make a DC 17 Dexterity saving throw. A creature takes `dice:4d6|noform|noparens|avg|text(14)` (`4d6`) fire damage and `dice:4d6|noform|noparens|avg|text(14)` (`4d6`) radiant damage on a failed save, or half as much damage on a successful one. If the councilor casts this spell using a spell slot of 6th level or higher, the fire damage or the radiant damage (its choice) increases by `dice:1d6|noform|noparens|avg` (`d6`) for each slot level above 5th.

## Legendary Actions

***Touch.*** The councilor makes one attack with its Radiant Touch.

***Shimmering Aura (Costs 2 Actions).*** The councilor channels positive energy into its Aura of Radiance. Until the end of the councilor's next turn, it sheds bright light in a 30-foot radius and dim light for an additional 30 feet. Any creature that starts its turn in the bright light must succeed on a DC 17 Constitution saving throw or be [blinded](rules/5e/conditions.md#Blinded) until the end of the councilor's next turn.
```
^statblock