...
- **Skills** [Arcana](rules/5e/skills.md#Arcana) +8, [Perception](rules/5e/skills.md#Perception) +7, [Stealth](rules/5e/skills.md#Stealth) +9
...
***Blight Staff.*** *Melee Weapon Attack:* `dice:1d20+9|noform|noparens|text(+9)` to hit, reach 5 ft., one target. *Hit:* `dice:1d8+4|noform|noparens|avg|text(8)` (`1d8 + 4`) bludgeoning damage plus `dice:6d6|noform|noparens|avg|text(21)` (`6d6`) necrotic damage.

***Plague Bolt.*** *Ranged Spell Attack:* `dice:1d20+10|noform|noparens|text(+10)` to hit, range 120 ft., one target. *Hit:* `dice:4d8+5|noform|noparens|avg|text(23)` (`4d8 + 5`) poison damage, and the target has the [poisoned](rules/5e/conditions.md#Poisoned) condition until the start of the champion's next turn.
...
**At will:** [Detect Magic](compendium/5e/spells/detect-magic.md), [Mage Armor](compendium/5e/spells/mage-armor.md) (self only)

**2/day each:** [Blight](compendium/5e/spells/blight.md), [Blindness/Deafness](compendium/5e/spells/blindness-deafness.md)

**1/day each:** [Cloudkill](compendium/5e/spells/cloudkill.md), [Contagion](compendium/5e/spells/contagion.md)
