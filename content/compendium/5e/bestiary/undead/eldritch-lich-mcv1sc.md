...
- **Skills** [Arcana](rules/5e/skills.md#Arcana) +14, [Perception](rules/5e/skills.md#Perception) +7
...
***Far Realm Parasite.*** Inside the lich's torso dwells a wormlike parasite that contains the lich's soul. When the lich dies, it implodes into the parasite, which then vanishes into the Far Realm. In `dice:2d4|noform|noparens|avg` (`2d4`) days, the parasite causes the lich to reappear within `dice:1d4|noform|noparens|avg` (`d4`) miles of where it died. If the lich died inside a magic circle cast to contain Undead, the lich instead reappears as an [otyugh](compendium/5e/bestiary/aberration/otyugh.md) with all the lich's memories.
...
***Parasitic Tentacle.*** *Melee Weapon Attack:* `dice:1d20+9|noform|noparens|text(+9)` to hit, reach 10 ft., one creature. *Hit:* `dice:6d6+4|noform|noparens|avg|text(25)` (`6d6 + 4`) piercing damage plus `dice:6d6+4|noform|noparens|avg|text(25)` (`6d6 + 4`) necrotic damage. The target must succeed on a DC 17 Constitution saving throw or be [poisoned](rules/5e/conditions.md#Poisoned). The [poisoned](rules/5e/conditions.md#Poisoned) target can repeat the save at the end of each of its turns, ending the effect on itself on a success. The third time the target fails the save, the target dies and dissolves into a [gibbering mouther](compendium/5e/bestiary/aberration/gibbering-mouther.md) that obeys the lich and uses the target's initiative.

***Psychic Whisper.*** The lich targets one creature it can see within 120 feet of itself. The target must succeed on a DC 17 Wisdom saving throw or take `dice:6d6+4|noform|noparens|avg|text(25)` (`6d6 + 4`) psychic damage and be [stunned](rules/5e/conditions.md#Stunned) until the end of the lich's next turn as incomprehensible whispers fill the target's mind.

***Spellcasting.*** The lich casts one of the following spells, using Intelligence as the spellcasting ability (spell save DC 17):

**At will:** [detect magic](compendium/5e/spells/detect-magic.md), [mage hand](compendium/5e/spells/mage-hand.md), [prestidigitation](compendium/5e/spells/prestidigitation.md)

**2/day each:** [dispel magic](compendium/5e/spells/dispel-magic.md), [hunger of Hadar](compendium/5e/spells/hunger-of-hadar.md), [lightning bolt](compendium/5e/spells/lightning-bolt.md)

**1/day each:** [arcane eye](compendium/5e/spells/arcane-eye.md), [dimension door](compendium/5e/spells/dimension-door.md), [plane shift](compendium/5e/spells/plane-shift.md) (self only)
