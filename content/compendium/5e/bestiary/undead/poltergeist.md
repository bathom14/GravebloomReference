...
`dice: [](poltergeist.md#^poltergeist-activities)`
...
***Incorporeal Movement.*** The poltergeist can move through other creatures and objects as if they were [Difficult Terrain](rules/5e/variant-rules/difficult-terrain-xphb.md). It takes `dice:1d10|noform|noparens|avg|text(5)` (`d10`) Force damage if it ends its turn inside an object.
...
***Vanish.*** The poltergeist gives itself the [Invisible](rules/5e/conditions.md#Invisible) condition or ends that condition on itself.
```
^statblock
