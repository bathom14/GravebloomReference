...
***Charge.*** If the centaur moves at least 30 feet straight toward a target and then hits it with a pike attack on the same turn, the target takes an extra `dice:3d6|noform|noparens|avg|text(10)` (`3d6`) piercing damage.

## Actions

***Multiattack.*** The centaur skeleton makes two attacks: one with its pike and one with its hooves, or two with its longbow.

***Pike.*** *Melee Weapon Attack:* `dice:1d20+5|noform|noparens|text(+5)` to hit, reach 10 ft., one target. *Hit:* `dice:1d10+3|noform|noparens|avg|text(8)` (`1d10 + 3`) piercing damage.

***Hooves.*** *Melee Weapon Attack:* `dice:1d20+5|noform|noparens|text(+5)` to hit, reach 5 ft., one target. *Hit:* `dice:2d6+3|noform|noparens|avg|text(10)` (`2d6 + 3`) bludgeoning damage.
