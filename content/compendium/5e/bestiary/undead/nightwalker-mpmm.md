...
***Annihilating Aura.*** Any creature that starts its turn within 30 feet of the nightwalker must succeed on a DC 21 Constitution saving throw or take `dice:6d6|noform|noparens|avg|text(21)` (`6d6`) necrotic damage. Undead are immune to this aura.

***Life Eater.*** A creature dies if reduced to 0 hit points by the nightwalker and can't be revived except by a [wish](compendium/5e/spells/wish.md) spell.
...
***Enervating Focus.*** *Melee Weapon Attack:* `dice:1d20+12|noform|noparens|text(+12)` to hit, reach 15 ft., one target. *Hit:* `dice:5d8+6|noform|noparens|avg|text(28)` (`5d8 + 6`) necrotic damage. The target must succeed on a DC 21 Constitution saving throw or its hit point maximum is reduced by an amount equal to the necrotic damage taken. This reduction lasts until the target finishes a long rest. The target dies if its hit point maximum is reduced to 0.

***Finger of Doom (Recharge 6).*** The nightwalker points at one creature it can see within 300 feet of it. The target must succeed on a DC 21 Wisdom saving throw or take `dice:6d12|noform|noparens|avg|text(39)` (`6d12`) necrotic damage and become [frightened](rules/5e/conditions.md#Frightened) until the end of the nightwalker's next turn. While [frightened](rules/5e/conditions.md#Frightened) in this way, the creature is also [paralyzed](rules/5e/conditions.md#Paralyzed). If a target's saving throw is successful, the target is immune to the nightwalker's Finger of Doom for the next 24 hours.
```
^statblock
