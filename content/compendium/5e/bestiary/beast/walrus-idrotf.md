...
***Tusks.*** *Melee Weapon Attack:* `dice:1d20+4|noform|noparens|text(+4)` to hit, reach 5 ft., one target. *Hit:* `dice:2d4+2|noform|noparens|avg|text(7)` (`2d4 + 2`) piercing damage.
```
^statblock