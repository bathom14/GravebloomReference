...
***Bladed Hide.*** At the start of each of its turns, the moorbounder deals `dice:2d4|noform|noparens|avg|text(5)` (`2d4`) piercing damage to any creature grappling it.
...
***Blades.*** *Melee Weapon Attack:* `dice:1d20+6|noform|noparens|text(+6)` to hit, reach 5 ft., one target. *Hit:* `dice:2d6+4|noform|noparens|avg|text(11)` (`2d6 + 4`) slashing damage.

***Claws.*** *Melee Weapon Attack:* `dice:1d20+6|noform|noparens|text(+6)` to hit, reach 5 ft., one target. *Hit:* `dice:4d4+4|noform|noparens|avg|text(14)` (`4d4 + 4`) slashing damage.
```
^statblock