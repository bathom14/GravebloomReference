...
***Bite.*** *Melee Weapon Attack:* `dice:1d20+2|noform|noparens|text(+2)` to hit, reach 5 ft., one target. *Hit:* `dice:1d6+1|noform|noparens|avg|text(4)` (`1d6 + 1`) piercing damage. Target is [grappled](rules/5e/conditions.md#Grappled) (escape DC 11). Until this grapple ends, the target is [restrained](rules/5e/conditions.md#Restrained), and spiderfrog can't bite another target.
```
^statblock