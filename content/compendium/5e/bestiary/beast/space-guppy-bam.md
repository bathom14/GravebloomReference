...
```ad-statblock
title: Space Guppy
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/BAM/Space%20Guppy.webp#token)
...
***Tail Slap.*** *Melee Weapon Attack:* `dice:1d20+5|noform|noparens|text(+5)` to hit, reach 5 ft., one target. *Hit:* 1 bludgeoning damage.
```
^statblock