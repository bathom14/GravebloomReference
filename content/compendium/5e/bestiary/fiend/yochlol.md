...
- **Skills** [Deception](rules/5e/skills.md#Deception) +11, [Insight](rules/5e/skills.md#Insight) +6
...
***Demonic Restoration.*** If the yochlol dies outside the Abyss, its body dissolves, and it gains a new body instantly, reviving with all its [Hit Points](rules/5e/variant-rules/hit-points-xphb.md) in the Abyss.

***Magic Resistance.*** The yochlol has [Advantage](rules/5e/variant-rules/advantage-xphb.md) on saving throws against spells and other magical effects.
...
***Multiattack.*** The yochlol makes two Caustic Lash attacks, and it can use Spellcasting to cast [Web](compendium/5e/spells/web.md) or [Dominate Person](compendium/5e/spells/dominate-person.md) if available.

***Caustic Lash.*** *Melee  or Ranged Attack Roll:* `dice:1d20+8|noform|noparens|text(+8)`, reach 10 ft. or range 120 ft. *Hit:* `dice:6d6+4|noform|noparens|avg|text(25)` (`6d6 + 4`) Acid damage.
...
**At will:** [Detect Thoughts](compendium/5e/spells/detect-thoughts.md), [Gaseous Form](compendium/5e/spells/gaseous-form.md) (self only), [Web](compendium/5e/spells/web.md)
