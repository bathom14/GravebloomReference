...
`dice: [](nightmare.md#^nightmare-riders)`
...
***Confer Fire Resistance.*** The nightmare can grant [Resistance](rules/5e/variant-rules/resistance-xphb.md) to Fire damage to a rider while it is on the nightmare.

***Illumination.*** The nightmare sheds [Bright Light](rules/5e/variant-rules/bright-light-xphb.md) in a 10-foot radius and [Dim Light](rules/5e/variant-rules/dim-light-xphb.md) for an additional 10 feet.
