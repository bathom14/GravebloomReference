...
- **Skills** [Arcana](rules/5e/skills.md#Arcana) +13, [History](rules/5e/skills.md#History) +13, [Perception](rules/5e/skills.md#Perception) +13
...
***Contamination.*** The sibriex emits an aura of corruption 30 feet in every direction. Vegetation withers in the aura, and the ground in the aura is difficult terrain for other creatures. Any creature that starts its turn in the aura must succeed on a DC 20 Constitution saving throw or take `dice:4d6|noform|noparens|avg|text(14)` (`4d6`) poison damage. A creature that succeeds on the save is immune to this sibriex's Contamination for 24 hours.
...
***Chain.*** *Melee Weapon Attack:* `dice:1d20+13|noform|noparens|text(+13)` to hit, reach 15 ft., one target. *Hit:* `dice:2d12+7|noform|noparens|avg|text(20)` (`2d12 + 7`) force damage.

***Squirt Bile.*** The sibriex targets one creature it can see within 120 feet of it. The target must succeed on a DC 20 Dexterity saving throw or take `dice:9d6|noform|noparens|avg|text(31)` (`9d6`) acid damage.

***Warp Creature.*** The sibriex targets up to three creatures it can see within 120 feet of it. Each target must make a DC 20 Constitution saving throw. On a successful save, a creature becomes immune to this sibriex's Warp Creature. On a failed save, the target is [poisoned](rules/5e/conditions.md#Poisoned), which causes it to also gain 1 level of [exhaustion](rules/5e/conditions.md#Exhaustion). While [poisoned](rules/5e/conditions.md#Poisoned) in this way, the target must repeat the saving throw at the start of each of its turns. Three successful saves against the poison end it, and ending the poison removes any levels of [exhaustion](rules/5e/conditions.md#Exhaustion) caused by it. Each failed save causes the target to gain another level of [exhaustion](rules/5e/conditions.md#Exhaustion). Once the target reaches 6 levels of [exhaustion](rules/5e/conditions.md#Exhaustion), it dies and instantly transforms into a living [manes](compendium/5e/bestiary/fiend/manes.md) under the sibriex's control. The transformation of the body can be undone only by a [wish](compendium/5e/spells/wish.md) spell.
...
**At will:** [command](compendium/5e/spells/command.md), [dispel magic](compendium/5e/spells/dispel-magic.md), [hold monster](compendium/5e/spells/hold-monster.md)
