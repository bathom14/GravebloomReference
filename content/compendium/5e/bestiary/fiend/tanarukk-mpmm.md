...
- **Proficiency Bonus** +3
- **Saving Throws** ⏤
- **Skills** [Intimidation](rules/5e/skills.md#Intimidation) +2, [Perception](rules/5e/skills.md#Perception) +2
...
***Bite.*** *Melee Weapon Attack:* `dice:1d20+7|noform|noparens|text(+7)` to hit, reach 5 ft., one target. *Hit:* `dice:1d8+4|noform|noparens|avg|text(8)` (`1d8 + 4`) piercing damage.
