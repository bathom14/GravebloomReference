...
- **Proficiency Bonus** +2
- **Saving Throws** ⏤
- **Skills** [Deception](rules/5e/skills.md#Deception) +4, [Intimidation](rules/5e/skills.md#Intimidation) +4, [Perception](rules/5e/skills.md#Perception) +5, [Stealth](rules/5e/skills.md#Stealth) +4
...
***Bite.*** *Melee Weapon Attack:* `dice:1d20+6|noform|noparens|text(+6)` to hit, reach 5 ft., one target. *Hit:* `dice:2d8+4|noform|noparens|avg|text(13)` (`2d8 + 4`) piercing damage.

***Claw.*** *Melee Weapon Attack:* `dice:1d20+6|noform|noparens|text(+6)` to hit, reach 5 ft., one target. *Hit:* `dice:1d8+4|noform|noparens|avg|text(8)` (`1d8 + 4`) slashing damage.
...
**At will:** [levitate](compendium/5e/spells/levitate.md), [minor illusion](compendium/5e/spells/minor-illusion.md), [pass without trace](compendium/5e/spells/pass-without-trace.md)

**1/day each:** [charm person](compendium/5e/spells/charm-person.md), [dimension door](compendium/5e/spells/dimension-door.md), [suggestion](compendium/5e/spells/suggestion.md)
