...
***Devil's Sight.*** Magical darkness doesn't impede the merregon's [darkvision](rules/5e/senses.md#Darkvision).
...
***Halberd.*** *Melee Weapon Attack:* `dice:1d20+6|noform|noparens|text(+6)` to hit, reach 10 ft., one target. *Hit:* `dice:1d10+4|noform|noparens|avg|text(9)` (`1d10 + 4`) slashing damage.

***Heavy Crossbow.*** *Ranged Weapon Attack:* `dice:1d20+4|noform|noparens|text(+4)` to hit, range 100/400 ft., one target. *Hit:* `dice:1d10+2|noform|noparens|avg|text(7)` (`1d10 + 2`) piercing damage.
