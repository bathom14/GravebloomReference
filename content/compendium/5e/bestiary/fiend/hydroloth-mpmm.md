...
- **Proficiency Bonus** +4
- **Saving Throws** ⏤
- **Skills** [Insight](rules/5e/skills.md#Insight) +4, [Perception](rules/5e/skills.md#Perception) +4
...
***Bite.*** *Melee Weapon Attack:* `dice:1d20+9|noform|noparens|text(+9)` to hit, reach 5 ft., one target. *Hit:* `dice:2d10+5|noform|noparens|avg|text(16)` (`2d10 + 5`) force damage plus `dice:2d10|noform|noparens|avg|text(9)` (`2d10`) psychic damage.

***Claw.*** *Melee Weapon Attack:* `dice:1d20+9|noform|noparens|text(+9)` to hit, reach 5 ft., one target.  *Hit:* `dice:2d8+5|noform|noparens|avg|text(14)` (`2d8 + 5`) force damage plus `dice:2d10|noform|noparens|avg|text(9)` (`2d10`) psychic damage.

***Steal Memory (1/Day).*** The hydroloth targets one creature it can see within 60 feet of it. The target takes `dice:4d6|noform|noparens|avg|text(14)` (`4d6`) psychic damage, and it must make a DC 16 Intelligence saving throw. On a successful save, the target becomes immune to this hydroloth's Steal Memory for 24 hours. On a failed save, the target loses all proficiencies; it can't cast spells; it can't understand language; and if its Intelligence and Charisma scores are higher than 5, they become 5. Each time the target finishes a long rest, it can repeat the saving throw, ending the effect on itself on a success. A [greater restoration](compendium/5e/spells/greater-restoration.md) or [remove curse](compendium/5e/spells/remove-curse.md) spell cast on the target ends this effect early.
...
**At will:** [darkness](compendium/5e/spells/darkness.md), [detect magic](compendium/5e/spells/detect-magic.md), [dispel magic](compendium/5e/spells/dispel-magic.md), [invisibility](compendium/5e/spells/invisibility.md) (self only)

**3/day each:** [control water](compendium/5e/spells/control-water.md), [crown of madness](compendium/5e/spells/crown-of-madness.md), [fear](compendium/5e/spells/fear.md), [suggestion](compendium/5e/spells/suggestion.md)
```
^statblock