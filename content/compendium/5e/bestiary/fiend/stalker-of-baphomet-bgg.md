...
- **Skills** [Athletics](rules/5e/skills.md#Athletics) +15, [Perception](rules/5e/skills.md#Perception) +7, [Stealth](rules/5e/skills.md#Stealth) +11
...
***Glaive.*** *Melee Weapon Attack:* `dice:1d20+11|noform|noparens|text(+11)` to hit, reach 15 ft., one target. *Hit:* `dice:2d10+7|noform|noparens|avg|text(18)` (`2d10 + 7`) slashing damage plus `dice:2d8|noform|noparens|avg|text(9)` (`2d8`) force damage.

***Rock.*** *Ranged Weapon Attack:* `dice:1d20+11|noform|noparens|text(+11)` to hit, range 60/240 ft., one target. *Hit:* `dice:3d10+7|noform|noparens|avg|text(23)` (`3d10 + 7`) bludgeoning damage. If the target is a Large or smaller creature, it must succeed on a DC 19 Strength saving throw or have the [prone](rules/5e/conditions.md#Prone) condition. After the stalker throws the rock, roll a `dice:d6|noform|noparens|avg` (`d6`); on a roll of 3 or lower, the stalker has no more rocks to throw.
...
Each creature in that area must make a DC 15 Dexterity saving throw. On a failed save, a creature takes `dice:6d10|noform|noparens|avg|text(33)` (`6d10`) piercing damage and is pushed up to 30 feet upward and then falls. On a successful save, a creature takes half as much damage only.
...
**1/day each:** [meld into stone](compendium/5e/spells/meld-into-stone.md), [stone shape](compendium/5e/spells/stone-shape.md), [wall of stone](compendium/5e/spells/wall-of-stone.md)
```
^statblock