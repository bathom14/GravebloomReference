...
***Blood Frenzy.*** The sahuagin has [Advantage](rules/5e/variant-rules/advantage-xphb.md) on attack rolls against any creature that doesn't have all its [Hit Points](rules/5e/variant-rules/hit-points-xphb.md).
...
***Aquatic Charge.*** The sahuagin swims up to its [Swim Speed](rules/5e/variant-rules/swim-speed-xphb.md) straight toward an enemy it can see.
```
^statblock
