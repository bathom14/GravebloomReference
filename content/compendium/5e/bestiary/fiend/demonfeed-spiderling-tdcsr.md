...
- **Skills** [Stealth](rules/5e/skills.md#Stealth) +5, [Perception](rules/5e/skills.md#Perception) +0
...
***Bite.*** *Melee Weapon Attack:* `dice:1d20+3|noform|noparens|text(+3)` to hit, reach 5 ft., one target. *Hit:* `dice:1d8+1|noform|noparens|avg|text(5)` (`1d8 + 1`) piercing damage, and the target must make a DC 13 Constitution saving throw, taking `dice:3d6|noform|noparens|avg|text(10)` (`3d6`) poison damage on a failed save, or half as much damage on a successful one.
```
^statblock
