...
***Talon.*** *Melee Weapon Attack:* `dice:1d20+6|noform|noparens|text(+6)` to hit, reach 5 ft., one target. *Hit:* `dice:1d8+3|noform|noparens|avg|text(8)` (`1d8 + 3`) piercing damage plus `dice:3d8|noform|noparens|avg|text(14)` (`3d8`) poison damage.
...
***Plague Winds (Fiend Form Only; Recharge 5-6).*** The tlacatecolo emits a chilling, disease-ridden wind in a 60-foot line that is 10 feet wide. Each creature in that area must succeed on a DC 13 Constitution saving throw or take `dice:4d12|noform|noparens|avg|text(26)` (`4d12`) cold damage and become [poisoned](rules/5e/conditions.md#Poisoned).

While [poisoned](rules/5e/conditions.md#Poisoned) in this way, the creature can't regain hit points. At the end of every hour, the creature must succeed on a DC 13 Constitution saving throw or gain 1 level of [exhaustion](rules/5e/conditions.md#Exhaustion). If the creature is in direct sunlight when it makes this saving throw, it automatically succeeds on the save.
