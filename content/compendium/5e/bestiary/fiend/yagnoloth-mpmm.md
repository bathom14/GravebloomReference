...
- **Skills** [Deception](rules/5e/skills.md#Deception) +8, [Insight](rules/5e/skills.md#Insight) +6, [Perception](rules/5e/skills.md#Perception) +6, [Persuasion](rules/5e/skills.md#Persuasion) +8
...
***Electrified Touch.*** *Melee Weapon Attack:* `dice:1d20+8|noform|noparens|text(+8)` to hit, reach 5 ft., one target. *Hit:* `dice:6d8|noform|noparens|avg|text(27)` (`6d8`) lightning damage.

***Massive Arm.*** *Melee Weapon Attack:* `dice:1d20+8|noform|noparens|text(+8)` to hit, reach 15 ft., one target. *Hit:* `dice:3d12+4|noform|noparens|avg|text(23)` (`3d12 + 4`) force damage. If the target is a creature, it must succeed on a DC 16 Constitution saving throw or become [stunned](rules/5e/conditions.md#Stunned) until the end of the yagnoloth's next turn.
...
**At will:** [darkness](compendium/5e/spells/darkness.md), [detect magic](compendium/5e/spells/detect-magic.md), [dispel magic](compendium/5e/spells/dispel-magic.md), [invisibility](compendium/5e/spells/invisibility.md) (self only), [suggestion](compendium/5e/spells/suggestion.md)

**3/day:** [lightning bolt](compendium/5e/spells/lightning-bolt.md)
```
^statblock
