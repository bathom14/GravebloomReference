...
- **Armor Class** 15 ([leather](compendium/5e/items/leather-armor-phb.md), [shield](compendium/5e/items/shield-phb.md))
...
***Dragon's Resistance.*** The kobold has resistance to a type of damage based on the color of dragon that invested it with power (choose or roll a `dice:d10|noform|noparens|avg` (`d10`)): 1–2, acid (black or copper); 3–4, cold (silver or white); 5–6, fire (brass, gold, or red); 7–8, lightning (blue or bronze); 9–10, poison (green).

***Heart of the Dragon.*** If the kobold is [frightened](rules/5e/conditions.md#Frightened) or [paralyzed](rules/5e/conditions.md#Paralyzed) by an effect that allows a saving throw, it can repeat the save at the start of its turn to end the effect on itself and all kobolds within 30 feet of it. Any kobold that benefits from this trait (including the dragonshield) has advantage on its next attack roll.
