...
- **Skills** [Arcana](rules/5e/skills.md#Arcana) +12, [Perception](rules/5e/skills.md#Perception) +10, [Persuasion](rules/5e/skills.md#Persuasion) +8, [Stealth](rules/5e/skills.md#Stealth) +5
...
***Bite.*** *Melee Weapon Attack:* `dice:1d20+9|noform|noparens|text(+9)` to hit, reach 10 ft., one target. *Hit:* `dice:2d10+5|noform|noparens|avg|text(16)` (`2d10 + 5`) piercing damage plus `dice:1d8|noform|noparens|avg|text(4)` (`d8`) force damage.
...
**1/day each:** [blink](compendium/5e/spells/blink.md), [dispel magic](compendium/5e/spells/dispel-magic.md), [protection from evil and good](compendium/5e/spells/protection-from-evil-and-good.md), [sending](compendium/5e/spells/sending.md)
```
^statblock