...
- **Skills** [Intimidation](rules/5e/skills.md#Intimidation) +9, [Perception](rules/5e/skills.md#Perception) +8, [Stealth](rules/5e/skills.md#Stealth) +4
...
***Bite.*** *Melee Weapon Attack:* `dice:1d20+6|noform|noparens|text(+6)` to hit, reach 10 ft., one target. *Hit:* `dice:2d10+3|noform|noparens|avg|text(14)` (`2d10 + 3`) piercing damage plus `dice:1d6|noform|noparens|avg|text(3)` (`d6`) necrotic damage.
...
**1/day each:** [bane](compendium/5e/spells/bane.md), [create or destroy water](compendium/5e/spells/create-or-destroy-water.md)
```
^statblock