...
- **Skills** [History](rules/5e/skills.md#History) +9, [Perception](rules/5e/skills.md#Perception) +13, [Persuasion](rules/5e/skills.md#Persuasion) +14, [Stealth](rules/5e/skills.md#Stealth) +7
...
***Bite.*** *Melee Weapon Attack:* `dice:1d20+11|noform|noparens|text(+11)` to hit, reach 10 ft., one target. *Hit:* `dice:2d10+6|noform|noparens|avg|text(17)` (`2d10 + 6`) piercing damage plus `dice:1d10|noform|noparens|avg|text(5)` (`d10`) thunder damage.
...
**1/day each:** [dissonant whispers](compendium/5e/spells/dissonant-whispers.md), [hold monster](compendium/5e/spells/hold-monster.md), [meld into stone](compendium/5e/spells/meld-into-stone.md), [telekinesis](compendium/5e/spells/telekinesis.md)
