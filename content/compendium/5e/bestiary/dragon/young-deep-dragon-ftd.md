...
- **Skills** [Perception](rules/5e/skills.md#Perception) +5, [Persuasion](rules/5e/skills.md#Persuasion) +6, [Stealth](rules/5e/skills.md#Stealth) +7
...
***Bite.*** *Melee Weapon Attack:* `dice:1d20+7|noform|noparens|text(+7)` to hit, reach 10 ft., one target. *Hit:* `dice:1d10+4|noform|noparens|avg|text(9)` (`1d10 + 4`) piercing damage plus `dice:1d6|noform|noparens|avg|text(3)` (`d6`) poison damage.
