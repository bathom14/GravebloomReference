...
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/DSotDQ/Wasteland%20Dragonnel.webp#token)
...
***Acid Spit.*** *Ranged Weapon Attack:* `dice:1d20+5|noform|noparens|text(+5)` to hit, range 60 ft., one target. *Hit:* `dice:5d6+3|noform|noparens|avg|text(20)` (`5d6 + 3`) acid damage.
```
^statblock