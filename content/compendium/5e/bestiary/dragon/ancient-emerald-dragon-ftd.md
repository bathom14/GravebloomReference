...
- **Skills** [Arcana](rules/5e/skills.md#Arcana) +12, [Deception](rules/5e/skills.md#Deception) +12, [Perception](rules/5e/skills.md#Perception) +18, [Stealth](rules/5e/skills.md#Stealth) +8
...
***Warp Perception (1/Day).*** The dragon can cast [mirage arcane](compendium/5e/spells/mirage-arcane.md), requiring no spell components and using Intelligence as the spellcasting ability.

## Actions

***Multiattack.*** The dragon makes one Bite attack and two Claw attacks.

***Bite.*** *Melee Weapon Attack:* `dice:1d20+14|noform|noparens|text(+14)` to hit, reach 15 ft., one target. *Hit:* `dice:2d10+7|noform|noparens|avg|text(18)` (`2d10 + 7`) piercing damage plus `dice:3d6|noform|noparens|avg|text(10)` (`3d6`) psychic damage.

***Claw.*** *Melee Weapon Attack:* `dice:1d20+14|noform|noparens|text(+14)` to hit, reach 10 ft., one target. *Hit:* `dice:2d6+7|noform|noparens|avg|text(14)` (`2d6 + 7`) slashing damage.

***Disorienting Breath (Recharge 5-6).*** The dragon exhales a wave of psychic dissonance in a 90-foot cone. Each creature in that area must make a DC 22 Intelligence saving throw. On a failed save, the creature takes `dice:16d6|noform|noparens|avg|text(56)` (`16d6`) psychic damage, and until the end of its next turn, when the creature makes an attack roll or an ability check, it must roll a `dice:d8|noform|noparens|avg` (`d8`) and reduce the total by the number rolled. On a successful save, the creature takes half as much damage with no additional effects.
...
**At will:** [mage hand](compendium/5e/spells/mage-hand.md) (the hand is invisible), [minor illusion](compendium/5e/spells/minor-illusion.md)

**1/day each:** [detect thoughts](compendium/5e/spells/detect-thoughts.md), [dispel magic](compendium/5e/spells/dispel-magic.md), [etherealness](compendium/5e/spells/etherealness.md), [major image](compendium/5e/spells/major-image.md), [mislead](compendium/5e/spells/mislead.md)
...
***Emerald Embers (Costs 3 Actions).*** The dragon creates a dancing mote of green flame around a creature it can see within 60 feet of it. The target must succeed on a DC 20 Dexterity saving throw or take `dice:12d6|noform|noparens|avg|text(42)` (`12d6`) fire damage.

![Emerald Dragon](compendium/5e/bestiary/legendary-group/emerald-dragon-ftd.md)
```
^statblock