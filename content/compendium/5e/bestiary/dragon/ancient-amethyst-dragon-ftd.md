...
- **Skills** [Arcana](rules/5e/skills.md#Arcana) +22, [Perception](rules/5e/skills.md#Perception) +18, [Persuasion](rules/5e/skills.md#Persuasion) +13, [Stealth](rules/5e/skills.md#Stealth) +9
- **Senses** blindsight 60 ft., darkvision 120 ft., passive Perception 28
- **Damage Resistances** force, psychic
- **Condition Immunities** [frightened](rules/5e/conditions.md#Frightened), [prone](rules/5e/conditions.md#Prone)
...
***Bite.*** *Melee Weapon Attack:* `dice:1d20+15|noform|noparens|text(+15)` to hit, reach 15 ft., one target. *Hit:* `dice:2d10+8|noform|noparens|avg|text(19)` (`2d10 + 8`) piercing damage plus `dice:3d8|noform|noparens|avg|text(13)` (`3d8`) force damage.

***Claw.*** *Melee Weapon Attack:* `dice:1d20+15|noform|noparens|text(+15)` to hit, reach 10 ft., one target. *Hit:* `dice:2d6+8|noform|noparens|avg|text(15)` (`2d6 + 8`) slashing damage.

***Singularity Breath (Recharge 5-6).*** The dragon creates a shining bead of gravitational force in its mouth, then releases the energy in a 90-foot cone. Each creature in that area must make a DC 23 Strength saving throw. On a failed save, the creature takes `dice:14d8|noform|noparens|avg|text(63)` (`14d8`) force damage, and its speed becomes 0 until the start of the dragon's next turn. On a successful save, the creature takes half as much damage, and its speed isn't reduced.

***Spellcasting (Psionics).*** The dragon casts one of the following spells, requiring no spell components and using Intelligence as the spellcasting ability (spell save DC 23, `dice:1d20+15|noform|noparens|text(+15)` to hit with spell attacks):

**1/day each:** [blink](compendium/5e/spells/blink.md), [control water](compendium/5e/spells/control-water.md), [dispel magic](compendium/5e/spells/dispel-magic.md), [freedom of movement](compendium/5e/spells/freedom-of-movement.md), [globe of invulnerability](compendium/5e/spells/globe-of-invulnerability.md), [plane shift](compendium/5e/spells/plane-shift.md), [protection from evil and good](compendium/5e/spells/protection-from-evil-and-good.md), [sending](compendium/5e/spells/sending.md)
