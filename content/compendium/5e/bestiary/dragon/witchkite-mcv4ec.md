...
- 5e/monster/type/dragon/warlock
aliases:
- Witchkite
---
# Witchkite
...
- **Skills** [Arcana](rules/5e/skills.md#Arcana) +7, [Perception](rules/5e/skills.md#Perception) +8, [Stealth](rules/5e/skills.md#Stealth) +5
...
***Rend.*** *Melee Weapon Attack:* `dice:1d20+11|noform|noparens|text(+11)` to hit, reach 10 ft., one target. *Hit:* `dice:3d6+6|noform|noparens|avg|text(16)` (`3d6 + 6`) slashing damage.

***Malevolent Flare.*** The witchkite spits magical, green-tinged flame at one creature it can see within 60 feet of itself. The target must make a DC 17 Dexterity saving throw. On a failed save, the target takes `dice:5d8|noform|noparens|avg|text(22)` (`5d8`) fire damage and suffers one of the following effects of the witchkite's choice:
...
- The target takes `dice:2d12|noform|noparens|avg|text(13)` (`2d12`) psychic damage.  
...
**At will:** [detect magic](compendium/5e/spells/detect-magic.md), [minor illusion](compendium/5e/spells/minor-illusion.md), [speak with dead](compendium/5e/spells/speak-with-dead.md)

**1/day each:** [detect thoughts](compendium/5e/spells/detect-thoughts.md), [dimension door](compendium/5e/spells/dimension-door.md), [hold monster](compendium/5e/spells/hold-monster.md)

## Reactions

The witchkite can take up to two reactions per round but only one per turn.

***Enchanting Gaze.*** When a creature the witchkite can see moves within 10 feet of it, the witchkite emits an enchanting gaze at the creature. The creature must succeed on a DC 17 Wisdom saving throw or take `dice:3d6|noform|noparens|avg|text(10)` (`3d6`) psychic damage and have the [charmed](rules/5e/conditions.md#Charmed) condition until the end of its next turn.
