...
- **Skills** [Perception](rules/5e/skills.md#Perception) +14, [Stealth](rules/5e/skills.md#Stealth) +13
...
***Bite.*** *Melee Weapon Attack:* `dice:1d20+14|noform|noparens|text(+14)` to hit, reach 15 ft., one target. *Hit:* `dice:2d6+8|noform|noparens|avg|text(15)` (`2d6 + 8`) piercing damage plus `dice:2d6|noform|noparens|avg|text(7)` (`2d6`) cold damage.
...
***Tail.*** *Melee Weapon Attack:* `dice:1d20+14|noform|noparens|text(+14)` to hit, reach 20 ft., one target. *Hit:* `dice:2d6+8|noform|noparens|avg|text(15)` (`2d6 + 8`) bludgeoning damage.

***Cold Breath (Recharge 5-6).*** The dragon exhales a blast of frost in a 90-foot cone. Each creature in the cone must make a DC 21 Constitution saving throw. On a failed save, the creature takes `dice:8d8|noform|noparens|avg|text(36)` (`8d8`) cold damage, and its speed is reduced to 0 until the end of its next turn. On a successful save, the creature takes half as much damage, and its speed isn't reduced.

## Bonus Actions

***Phase (3/Day).*** The dragon becomes partially incorporeal for as long as it maintains [concentration](rules/5e/conditions.md#Concentration) on the effect (as if [concentrating](rules/5e/conditions.md#Concentration) on a spell). While partially incorporeal, the dragon has resistance to bludgeoning, piercing, and slashing damage.
