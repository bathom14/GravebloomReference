...
- **Skills** [History](rules/5e/skills.md#History) +7, [Perception](rules/5e/skills.md#Perception) +10, [Persuasion](rules/5e/skills.md#Persuasion) +11, [Stealth](rules/5e/skills.md#Stealth) +6
...
***Bite.*** *Melee Weapon Attack:* `dice:1d20+9|noform|noparens|text(+9)` to hit, reach 10 ft., one target. *Hit:* `dice:2d10+5|noform|noparens|avg|text(16)` (`2d10 + 5`) piercing damage plus `dice:1d8|noform|noparens|avg|text(4)` (`d8`) thunder damage.
...
**1/day each:** [dissonant whispers](compendium/5e/spells/dissonant-whispers.md), [hold person](compendium/5e/spells/hold-person.md), [meld into stone](compendium/5e/spells/meld-into-stone.md)
```
^statblock