...
- **Skills** [Perception](rules/5e/skills.md#Perception) +15, [Stealth](rules/5e/skills.md#Stealth) +13, [Survival](rules/5e/skills.md#Survival) +9
...
***Bite.*** *Melee Weapon Attack:* `dice:1d20+13|noform|noparens|text(+13)` to hit, reach 15 ft., one target. *Hit:* `dice:2d10+7|noform|noparens|avg|text(18)` (`2d10 + 7`) piercing damage plus `dice:2d8|noform|noparens|avg|text(9)` (`2d8`) radiant damage.

***Claw.*** *Melee Weapon Attack:* `dice:1d20+13|noform|noparens|text(+13)` to hit, reach 10 ft., one target. *Hit:* `dice:2d6+7|noform|noparens|avg|text(14)` (`2d6 + 7`) slashing damage.

***Scintillating Breath (Recharge 5-6).*** The dragon exhales a burst of brilliant radiance in a 90-foot cone. Each creature in that area must make a DC 22 Constitution saving throw, taking `dice:11d8|noform|noparens|avg|text(49)` (`11d8`) radiant damage on a failed save, or half as much damage on a successful one. The dragon then gains 25 temporary hit points by absorbing a portion of the radiant energy.
...
**At will:** [dancing lights](compendium/5e/spells/dancing-lights.md), [guidance](compendium/5e/spells/guidance.md)

**1/day each:** [command](compendium/5e/spells/command.md), [divination](compendium/5e/spells/divination.md), [greater restoration](compendium/5e/spells/greater-restoration.md), [hypnotic pattern](compendium/5e/spells/hypnotic-pattern.md), [invisibility](compendium/5e/spells/invisibility.md)
...
***Starlight Strike (Costs 3 Actions).*** The dragon releases a searing beam of starlight at a creature that it can see within 60 feet of it. The target must succeed on a DC 19 Dexterity saving throw or take `dice:11d6|noform|noparens|avg|text(38)` (`11d6`) radiant damage.

![Crystal Dragon](compendium/5e/bestiary/legendary-group/crystal-dragon-ftd.md)
```
^statblock