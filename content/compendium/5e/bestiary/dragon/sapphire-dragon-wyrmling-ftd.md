...
- **Skills** [History](rules/5e/skills.md#History) +4, [Perception](rules/5e/skills.md#Perception) +5, [Persuasion](rules/5e/skills.md#Persuasion) +6, [Stealth](rules/5e/skills.md#Stealth) +4
...
***Bite.*** *Melee Weapon Attack:* `dice:1d20+5|noform|noparens|text(+5)` to hit, reach 5 ft., one target. *Hit:* `dice:1d10+3|noform|noparens|avg|text(8)` (`1d10 + 3`) piercing damage plus `dice:1d6|noform|noparens|avg|text(3)` (`d6`) thunder damage.

***Debilitating Breath (Recharge 5-6).*** The dragon exhales a pulse of high-pitched, nearly inaudible sound in a 15-foot cone. Each creature in that area must make a DC 13 Constitution saving throw. On a failed save, the creature takes `dice:4d10|noform|noparens|avg|text(22)` (`4d10`) thunder damage and is [incapacitated](rules/5e/conditions.md#Incapacitated) until the end of its next turn. On a successful save, the creature takes half as much damage and isn't [incapacitated](rules/5e/conditions.md#Incapacitated).
...
**1/day each:** [alarm](compendium/5e/spells/alarm.md), [Tenser's floating disk](compendium/5e/spells/tensers-floating-disk.md)
```
^statblock