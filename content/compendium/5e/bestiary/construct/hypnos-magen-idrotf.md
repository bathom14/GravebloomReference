...
Magen are magical, humanlike beings created by a wizard spell (see the [create magen](compendium/5e/spells/create-magen-idrotf.md) spell in appendix D) or by other arcane methods.
...
***Psychic Lash.*** The magen's eyes glow silver as it targets one creature that it can see within 60 feet of it. The target must succeed on a DC 12 Wisdom saving throw or take `dice:2d10|noform|noparens|avg|text(11)` (`2d10`) psychic damage.

***Suggestion.*** The magen casts the [suggestion](compendium/5e/spells/suggestion.md) spell (save DC 12), requiring no material components. The target must be a creature that the magen can communicate with telepathically. If it succeeds on its saving throw, the target is immune to this magen's [suggestion](compendium/5e/spells/suggestion.md) spell for the next 24 hours. The magen's spellcasting ability is Intelligence.
```
^statblock