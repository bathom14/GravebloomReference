...
`dice: [](brazen-gorgon.md#^gorgon-command-keys)`
...
***Flame Aura.*** At the end of each of the gorgon's turns, each creature in a 5-foot [Emanation](rules/5e/variant-rules/emanation-area-of-effect-xphb.md) originating from the gorgon takes `dice:3d8|noform|noparens|avg|text(13)` (`3d8`) Fire damage.

***Illumination.*** The gorgon sheds [Bright Light](rules/5e/variant-rules/bright-light-xphb.md) in a 10-foot radius and [Dim Light](rules/5e/variant-rules/dim-light-xphb.md) for an additional 10 feet.
