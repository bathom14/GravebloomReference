...
- **Skills** [History](rules/5e/skills.md#History) +13, [Insight](rules/5e/skills.md#Insight) +12, [Perception](rules/5e/skills.md#Perception) +12
- **Senses** darkvision 60 ft., passive Perception 22
- **Damage Resistances** thunder; bludgeoning, piercing, slashing from nonmagical attacks
- **Damage Immunities** poison
- **Condition Immunities** [charmed](rules/5e/conditions.md#Charmed), [exhaustion](rules/5e/conditions.md#Exhaustion), [frightened](rules/5e/conditions.md#Frightened), [paralyzed](rules/5e/conditions.md#Paralyzed), [poisoned](rules/5e/conditions.md#Poisoned), [unconscious](rules/5e/conditions.md#Unconscious)
- **Languages** all
- **Challenge** 20
...
***Unerring Blade.*** *Melee Weapon Attack:* automatic hit, reach 5 ft., one target. *Hit:* 24 force damage plus one of the following effects (choose one or roll a `dice:d6|noform|noparens|avg` (`d6`)):
