...
***Slam.*** *Melee Weapon Attack:* `dice:1d20+16|noform|noparens|text(+16)` to hit, reach 5 ft., one target. *Hit:* `dice:3d12+10|noform|noparens|avg|text(29)` (`3d12 + 10`) bludgeoning damage.

***Hurled Stone.*** *Ranged Weapon Attack:* `dice:1d20+16|noform|noparens|text(+16)` to hit, range 200/800 ft., one target. *Hit:* `dice:6d10+10|noform|noparens|avg|text(43)` (`6d10 + 10`) bludgeoning damage.
```
^statblock