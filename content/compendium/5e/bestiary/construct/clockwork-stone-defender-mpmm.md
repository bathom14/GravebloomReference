...
The thick plates of stone riveted onto a stone [defender](compendium/5e/items/defender-dmg.md) give it substantial protection. Its chief role is as a bodyguard.
...
***Slam.*** *Melee Weapon Attack:* `dice:1d20+6|noform|noparens|text(+6)` to hit, reach 5 ft., one target. *Hit:* `dice:2d6+4|noform|noparens|avg|text(11)` (`2d6 + 4`) bludgeoning damage, and if the target is Large or smaller, it is knocked [prone](rules/5e/conditions.md#Prone).
