...
```ad-statblock
title: Replica Tridrone
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/OoW/Replica%20Tridrone.webp#token)
...
***Javelin.*** *Melee  or Ranged Weapon Attack:* `dice:1d20+3|noform|noparens|text(+3)` to hit, reach 5 ft. or range 30/120 ft., one target. *Hit:* `dice:1d6+1|noform|noparens|avg|text(4)` (`1d6 + 1`) piercing damage.
```
^statblock