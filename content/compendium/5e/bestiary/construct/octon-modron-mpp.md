...
***Tentacle.*** *Melee Weapon Attack:* `dice:1d20+8|noform|noparens|text(+8)` to hit, reach 10 ft., one target. *Hit:* `dice:3d6+4|noform|noparens|avg|text(14)` (`3d6 + 4`) bludgeoning damage plus `dice:2d8|noform|noparens|avg|text(9)` (`2d8`) lightning damage.
