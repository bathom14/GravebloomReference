...
```ad-statblock
title: Mad Golem
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/WDMM/Mad%20Golem.webp#token)
...
***Slam.*** *Melee Weapon Attack:* `dice:1d20+10|noform|noparens|text(+10)` to hit, reach 5 ft., one target. *Hit:* `dice:4d8+6|noform|noparens|avg|text(24)` (`4d8 + 6`) bludgeoning damage.
