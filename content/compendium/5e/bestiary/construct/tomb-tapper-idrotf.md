...
***Bite.*** *Melee Weapon Attack:* `dice:1d20+10|noform|noparens|text(+10)` to hit, reach 5 ft., one target. *Hit:* `dice:3d10+6|noform|noparens|avg|text(22)` (`3d10 + 6`) slashing damage.

***Claw.*** *Melee Weapon Attack:* `dice:1d20+10|noform|noparens|text(+10)` to hit, reach 10 ft., one target. *Hit:* `dice:3d6+6|noform|noparens|avg|text(16)` (`3d6 + 6`) slashing damage.

***Sledgehammer.*** *Melee  or Ranged Weapon Attack:* `dice:1d20+10|noform|noparens|text(+10)` to hit, reach 15 ft. or range 30/120 ft., one target. *Hit:* `dice:6d6+6|noform|noparens|avg|text(27)` (`6d6 + 6`) bludgeoning or force damage (tomb tapper's choice). If thrown, the hammer returns to the tomb tapper at the end of its turn, landing at the tomb tapper's feet if it doesn't have a hand free to catch the weapon.
```
^statblock