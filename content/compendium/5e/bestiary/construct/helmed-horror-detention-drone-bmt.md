...
```ad-statblock
title: Helmed Horror Detention Drone
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/BMT/Helmed%20Horror%20Detention%20Drone.webp#token)
...
***Spell Immunity.*** The drone is immune to three spells chosen by its creator. Typical immunities include [fireball](compendium/5e/spells/fireball.md), [heat metal](compendium/5e/spells/heat-metal.md), and [lightning bolt](compendium/5e/spells/lightning-bolt.md).

## Actions

***Multiattack.*** The drone makes two longsword attacks.
