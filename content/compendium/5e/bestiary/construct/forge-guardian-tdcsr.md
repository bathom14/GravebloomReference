...
Just as "dwarves" created the earliest golems, the [All-Hammer](compendium/5e/deities/exandria-the-all-hammer-tdcsr.md) fashioned forge guardians to guard the divine furnaces and hearths that designed the first "dwarves". Shaped from extravagant marble and fused with adamantine, crafted with impeccable detail and care, these rare and massive constructs exemplify the highest form of artistry that every Exandrian blacksmith, forgemaster, and artisan spends a life-time hoping to achieve.

### Divine Spark

A faceless, tireless being of immense strength, a forge golem is gifted life by a single shard from the [All-Hammer's](compendium/5e/deities/exandria-the-all-hammer-tdcsr.md) own divine spark, lovingly kept safe inside a ring of arcane flame and ancient sigils. The [All-Hammer's](compendium/5e/deities/exandria-the-all-hammer-tdcsr.md) divinity is akin to a volcano inside the golem, turning the construct's blood into lava. Fire no longer harms the construct, but instead heals it.
...
Forge golems also serve as opponents for any wishing to engage in the [All-Hammer's](compendium/5e/deities/exandria-the-all-hammer-tdcsr.md) trial of worthiness. A golem's attacks blind prospective heroes, who must then earn back their vision by risking a deadly counterattack.
...
***Runeblade.*** *Melee Weapon Attack:* `dice:1d20+18|noform|noparens|text(+18)` to hit, reach 15 ft., one target. *Hit:* `dice:4d12+10|noform|noparens|avg|text(36)` (`4d12 + 10`) slashing damage, and the target must succeed on a DC 23 Constitution saving throw or be [blinded](rules/5e/conditions.md#Blinded) until it deals damage to the guardian.

***Kick.*** *Melee Weapon Attack:* `dice:1d20+18|noform|noparens|text(+18)` to hit, reach 10 ft., one target. *Hit:* `dice:2d12+10|noform|noparens|avg|text(23)` (`2d12 + 10`) bludgeoning damage, and the target is pushed up to 15 feet away from the guardian and knocked [prone](rules/5e/conditions.md#Prone).

***Bladestorm (Recharge 5-6).*** The guardian makes a Runeblade attack against every creature within 15 feet of it. On a hit, a target is also pushed up to 15 feet away from the guardian and knocked [prone](rules/5e/conditions.md#Prone).
