...
```ad-statblock
title: Replica Duodrone
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/OoW/Replica%20Duodrone.webp#token)
...
***Fist.*** *Melee Weapon Attack:* `dice:1d20+2|noform|noparens|text(+2)` to hit, reach 5 ft., one target. *Hit:* `dice:1d4|noform|noparens|avg|text(2)` (`d4`) bludgeoning damage.
