...
***Slam.*** *Melee Weapon Attack:* `dice:1d20+15|noform|noparens|text(+15)` to hit, reach 5 ft., one target. *Hit:* `dice:3d10+9|noform|noparens|avg|text(25)` (`3d10 + 9`) bludgeoning damage.

***Sword.*** *Melee Weapon Attack:* `dice:1d20+15|noform|noparens|text(+15)` to hit, reach 10 ft., one target. *Hit:* `dice:3d12+9|noform|noparens|avg|text(28)` (`3d12 + 9`) slashing damage.

***Spinning Cleave.*** The golem makes a sword attack against each creature within 10 feet of it.

***Magnetic Pulse (Recharge 6).*** The golem raises its arms and unleashes a magnetic pulse. All unattended metal objects within 30 feet of it are pulled to an unoccupied space within 5 feet of the golem. Each creature wearing metal armor or made of metal within 30 feet of the golem must succeed on a DC 20 Strength saving throw or be pulled to an unoccupied space within 5 feet of the golem, then fall [prone](rules/5e/conditions.md#Prone).
```
^statblock