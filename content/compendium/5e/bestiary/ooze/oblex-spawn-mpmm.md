...
***Pseudopod.*** *Melee Weapon Attack:* `dice:1d20+5|noform|noparens|text(+5)` to hit, reach 5 ft., one target. *Hit:* `dice:1d4+3|noform|noparens|avg|text(5)` (`1d4 + 3`) bludgeoning damage plus `dice:1d4|noform|noparens|avg|text(2)` (`d4`) psychic damage.
```
^statblock
