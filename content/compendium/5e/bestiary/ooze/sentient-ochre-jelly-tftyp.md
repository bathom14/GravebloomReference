...
***Pseudopod.*** *Melee Weapon Attack:* `dice:1d20+4|noform|noparens|text(+4)` to hit, reach 5 ft., one target. *Hit:* `dice:2d6+2|noform|noparens|avg|text(9)` (`2d6 + 2`) bludgeoning damage plus `dice:1d6|noform|noparens|avg|text(3)` (`d6`) acid damage.
