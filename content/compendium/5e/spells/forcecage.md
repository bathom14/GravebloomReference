...
An immobile, [Invisible](rules/5e/conditions.md#Invisible), [Cube](rules/5e/variant-rules/cube-area-of-effect-xphb.md)-shaped prison composed of magical force springs into existence around an area you choose within range. The prison can be a cage or a solid box, as you choose.
...
This spell can't be dispelled by [Dispel Magic](compendium/5e/spells/dispel-magic.md).

**Classes**: [Bard](compendium/5e/lists/list-spells-classes-bard.md); [Wizard (Evoker)](compendium/5e/lists/list-spells-classes-evoker.md "subclass=XPHB;class=XPHB"); [Warlock](compendium/5e/lists/list-spells-classes-warlock.md); [Wizard](compendium/5e/lists/list-spells-classes-wizard.md); [Cleric (Arcana Domain)](compendium/5e/lists/list-spells-classes-arcana-domain-scag.md "subclass=SCAG;class=XPHB"); [Cleric (Arcana Domain)](compendium/5e/lists/list-spells-classes-arcana-domain-scag.md "subclass=SCAG")
