...
- **Chaining.** Chains firmly rooted in the ground hold the target in place. The target has the [Restrained](rules/5e/conditions.md#Restrained) condition and can't be moved by any means.  
...
- **Slumber.** The target has the [Unconscious](rules/5e/conditions.md#Unconscious) condition and can't be awoken.  
