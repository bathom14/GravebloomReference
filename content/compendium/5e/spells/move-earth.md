...
At the end of every 10 minutes you spend [Concentrating](rules/5e/conditions.md#Concentration) on the spell, you can choose a new area of terrain to affect within range.

This spell can't manipulate natural stone or stone construction. Rocks and structures shift to accommodate the new terrain. If the way you shape the terrain would make a structure unstable, it might collapse.

Similarly, this spell doesn't directly affect plant growth. The moved earth carries any plants along with it.

**Classes**: [Bard](compendium/5e/lists/list-spells-classes-bard.md); [Sorcerer](compendium/5e/lists/list-spells-classes-sorcerer.md); [Druid](compendium/5e/lists/list-spells-classes-druid.md); [Wizard](compendium/5e/lists/list-spells-classes-wizard.md); [Cleric (Arcana Domain)](compendium/5e/lists/list-spells-classes-arcana-domain-scag.md "subclass=SCAG;class=XPHB"); [Cleric (Arcana Domain)](compendium/5e/lists/list-spells-classes-arcana-domain-scag.md "subclass=SCAG")
