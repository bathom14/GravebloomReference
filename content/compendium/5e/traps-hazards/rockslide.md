...
When a rockslide occurs, every creature in its path makes a DC 15 Dexterity saving throw. On a failed save, a creature takes `dice:2d10|noform|noparens|avg|text(11)` (`2d10`) Bludgeoning damage, has the [Prone](rules/5e/conditions.md#Prone) condition, and moves with the rockslide. On a successful save, a creature takes half as much damage only.

When the rockslide stops, its space becomes [Difficult Terrain](rules/5e/variant-rules/difficult-terrain-xphb.md), and all Prone creatures in its space are buried under rocks and debris. A creature buried in this way has the [Restrained](rules/5e/conditions.md#Restrained) condition and has [Total Cover](compendium/5e/tables/cover-xphb.md). As an action, a creature can try to crawl out from under the rock pile. If the creature succeeds on a DC 15 Strength ([Athletics](rules/5e/skills.md#Athletics)) check, it is no longer Restrained; instead, it has the [Prone](rules/5e/conditions.md#Prone) condition and is atop the rock pile. If the check fails, the creature remains buried and gains 1 [Exhaustion](rules/5e/conditions.md#Exhaustion) level.
