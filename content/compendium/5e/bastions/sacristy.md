...
- **Prerequisites**: Ability to use a [Holy Symbol](compendium/5e/items/holy-symbol.md) or [Druidic Focus](compendium/5e/items/druidic-focus.md) as a [Spellcasting Focus](rules/5e/variant-rules/spellcasting-focus-xphb.md)
- **Space**: Roomy (16 sq)
- **Hirelings**: 1
- **Order**: craft
...
- **Craft.** Holy Water. You commission the facility's hireling to craft a flask of [Holy Water](compendium/5e/items/holy-water.md). The work takes 7 days and costs no money. You can spend GP during the creation process to increase the potency of the Holy Water. For every 100 GP you spend, up to a maximum of 500 GP, the damage dealt by the Holy Water increases by `dice:1d8|noform|noparens|avg` (`d8`).  
