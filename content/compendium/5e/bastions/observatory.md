...
- **Prerequisites**: Ability to use a [Spellcasting Focus](rules/5e/variant-rules/spellcasting-focus-xphb.md)
- **Space**: Roomy (16 sq)
- **Hirelings**: 1
- **Order**: empower
...
You can use your Observatory to peer into the far corners of "Wildspace" and the "Astral Plane". After spending a Long Rest in your Observatory, you gain a magical [Charm](compendium/5e/rewards/observatory-charm-xdmg.md) (see ""Supernatural Gifts"" in "chapter 3") that lasts for 7 days or until you use it. The Charm allows you to cast [Contact Other Plane](compendium/5e/spells/contact-other-plane.md) without expending a spell slot. You can't gain this Charm again while you still have it.
