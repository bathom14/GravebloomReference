...
- **Craft.** Smith's Tools. The facility's hirelings craft anything that can be made with [Smith's Tools](compendium/5e/items/smiths-tools.md), using the rules in the "Player's Handbook".  
