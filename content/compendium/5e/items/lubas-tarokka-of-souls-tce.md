...
- 2 [minor detrimental](compendium/5e/tables/artifact-properties-minor-detrimental-properties.md) properties  
- 2 [minor beneficial](compendium/5e/tables/artifact-properties-minor-beneficial-properties.md) properties  

## Spells

While holding the deck, you can use an action to cast one of the following spells (save DC 18) from it: [comprehend languages](compendium/5e/spells/comprehend-languages.md), [detect evil and good](compendium/5e/spells/detect-evil-and-good.md), [detect magic](compendium/5e/spells/detect-magic.md), [detect poison and disease](compendium/5e/spells/detect-poison-and-disease.md), [locate object](compendium/5e/spells/locate-object.md), or [scrying](compendium/5e/spells/scrying.md). Once you use the deck to cast a spell, you can't cast that spell again from it until the next dawn.

## Enduring Vision

While holding the deck, you automatically succeed on Constitution saving throws made to maintain your [concentration](rules/5e/conditions.md#Concentration) on divination spells.
...
| dice: d100 | Card | Soul |
|------------|------|------|
| 1 | Artifact | [Flameskull](compendium/5e/bestiary/undead/flameskull.md) |
| 2 | Beast | [Wraith](compendium/5e/bestiary/undead/wraith.md) |
| 3 | Broken | [Banshee](compendium/5e/bestiary/undead/banshee.md) |
| 4 | Darklord | [Vampire](compendium/5e/bestiary/undead/vampire.md) |
| 5 | Donjon | [Mummy](compendium/5e/bestiary/undead/mummy.md) |
| 6 | Executioner | [Death knight](compendium/5e/bestiary/undead/death-knight.md) |
| 7 | Ghost | [Ghost](compendium/5e/bestiary/undead/ghost.md) |
| 8 | Horseman | [Mummy lord](compendium/5e/bestiary/undead/mummy-lord.md) |
| 9 | Innocent | [Ghost](compendium/5e/bestiary/undead/ghost.md) |
| 10 | Marionette | [Mummy](compendium/5e/bestiary/undead/mummy.md) |
| 11 | Mists | [Wraith](compendium/5e/bestiary/undead/wraith.md) |
| 12 | Raven | [Vampire spawn](compendium/5e/bestiary/undead/vampire-spawn.md) |
| 13 | Seer | [Vampire](compendium/5e/bestiary/undead/vampire.md) |
| 14 | Tempter | [Vampire spawn](compendium/5e/bestiary/undead/vampire-spawn.md) |
| 15-100 | — | — |
^souls-of-the-tarokka
...
Luba's Tarokka of Souls can be destroyed only if all fourteen souls within are released and destroyed. This reveals a fifteenth soul, a [lich](compendium/5e/bestiary/undead/lich.md), that inhabits the Nether card, which appears only when the fourteen souls are defeated. If this ancient entity is destroyed, the Nether card vanishes and the deck becomes a normal tarokka deck, with no special properties, but it includes a new card of the DM's design.
