...
While wearing this armor, you have a [Swim Speed](rules/5e/variant-rules/swim-speed-xphb.md) equal to your [Speed](rules/5e/variant-rules/speed-xphb.md). In addition, if you start your turn underwater with 0 [Hit Points](rules/5e/variant-rules/hit-points-xphb.md), you immediately regain `dice:1d4|noform|noparens|avg` (`d4`) [Hit Points](rules/5e/variant-rules/hit-points-xphb.md). The armor can't heal anyone again until the next dawn.
