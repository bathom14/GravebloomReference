...
You gain a +1 bonus to AC, and you can't be [charmed](rules/5e/conditions.md#Charmed) or [frightened](rules/5e/conditions.md#Frightened). Moreover, each creature of your choice within 30 feet of you has advantage on saving throws it makes to avoid being [charmed](rules/5e/conditions.md#Charmed) or [frightened](rules/5e/conditions.md#Frightened) or to end those conditions on itself.
