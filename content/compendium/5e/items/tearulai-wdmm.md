...
---
# Tearulai
*Weapon ([longsword](compendium/5e/items/longsword-phb.md)), very rare (requires attunement)*  
...
The longsword, Tearulai, is a sentient, neutral good [sword of sharpness](compendium/5e/items/sword-of-sharpness-dmg.md) with an emerald-colored blade and precious gemstones embedded in its hilt and pommel. The sword's magical properties are suppressed until it is removed from Valdemar's skull.
