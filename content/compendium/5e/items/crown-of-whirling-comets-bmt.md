...
- **Whirling Hail.** As an action, you can spend 3 charges and cast the [Ice Storm](compendium/5e/spells/ice-storm.md) spell (save DC 16).  

The crown regains `dice:1d6|noform|noparens|avg` (`d6`) expended charges daily at dawn.
