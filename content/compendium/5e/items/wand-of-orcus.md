...
---
# Wand of Orcus
*Weapon ([mace](compendium/5e/items/mace.md)), wand, artifact (requires attunement)*  

- **Damage**: 1d6 bludgeoning
- **Weight**: 4.0 lbs.

Crafted and wielded by [Orcus](compendium/5e/bestiary/npc/orcus-mpmm.md), this ghastly wand slips from the demon lord's grasp from time to time. When it does, it magically appears wherever the demon lord senses an opportunity to achieve some fell goal.
...
Any creature besides Orcus that tries to attune to the wand makes a DC 17 Constitution saving throw. On a successful save, the creature takes `dice:10d6|noform|noparens|avg` (`10d6`) Necrotic damage. On a failed save, the creature dies and, if it is a Humanoid, turns into a [Zombie](compendium/5e/bestiary/undead/zombie.md).

## Magic Weapon

You can wield the wand as a magic [Mace](compendium/5e/items/mace.md) that grants a +3 bonus to attack rolls and damage rolls made with it. The wand deals an extra `dice:2d12|noform|noparens|avg` (`2d12`) Necrotic damage on a hit.
...
You gain a +3 bonus to [Armor Class](rules/5e/variant-rules/armor-class-xphb.md) while holding the wand.
...
| Spell | Charge Cost |
|-------|-------------|
| [Animate Dead](compendium/5e/spells/animate-dead.md) | 1 |
| [Blight](compendium/5e/spells/blight.md) | 2 |
| [Circle of Death](compendium/5e/spells/circle-of-death.md) | 3 |
| [Finger of Death](compendium/5e/spells/finger-of-death.md) | 3 |
| [Power Word Kill](compendium/5e/spells/power-word-kill.md) | 4 |
| [Speak with Dead](compendium/5e/spells/speak-with-dead.md) | 1 |
^spell-charge-cost
...
While holding the wand, you can take a [Magic](rules/5e/actions.md#Magic) action to conjure 15 [Skeletons](compendium/5e/bestiary/undead/skeleton.md) and 15 [Zombies](compendium/5e/bestiary/undead/zombie.md). These Undead magically rise up from the ground or otherwise form in unoccupied spaces within 300 feet of you and obey your commands until they are destroyed or until the next dawn, when they collapse into inanimate piles of bones and rotting corpses. Once you use this property, you can't use it again until the next dawn.
...
The Wand of Orcus is a sentient Chaotic Evil item with an Intelligence of 16, a Wisdom of 12, and a Charisma of 16. It has hearing and [Darkvision](rules/5e/senses.md#Darkvision) out to 120 feet.
