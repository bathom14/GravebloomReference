...
You gain [darkvision](rules/5e/senses.md#Darkvision) out to 60 feet, or to an additional 60 feet if you already have that sense. Once per day, you can gain [blindsight](rules/5e/senses.md#Blindsight) out to 30 feet for 5 minutes.
...
If you deal fire damage to a creature or flammable object, it starts burning. At the start of each of its turns, a creature burning in this way takes `dice:1d6|noform|noparens|avg` (`d6`) fire damage. A creature that can reach the burning target can use an action to extinguish the fire.
