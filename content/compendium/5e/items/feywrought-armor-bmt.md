...
While wearing this armor, you have advantage on saving throws you make to avoid or end the [charmed](rules/5e/conditions.md#Charmed) condition on yourself.

This armor has 3 charges. You can use an action to expend a charge to cast the [Compulsion](compendium/5e/spells/compulsion.md) spell (save DC 15) from this armor. The armor regains `dice:1d3|noform|noparens|avg` (`d3`) expended charges daily at dawn.
