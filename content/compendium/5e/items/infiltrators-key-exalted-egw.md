...
- The key can be used as [thieves' tools](compendium/5e/items/thieves-tools.md) for the purpose of opening locks. When using the key, you are considered proficient in [thieves' tools](compendium/5e/items/thieves-tools.md) and you have advantage on ability checks made to open locks.  
- While holding the key, your steps are muffled, giving you advantage on Dexterity ([Stealth](rules/5e/skills.md#Stealth)) checks made to move silently.  
...
- While holding the key, you can use an action to cast one of the following spells from it: [alter self](compendium/5e/spells/alter-self.md), [invisibility](compendium/5e/spells/invisibility.md), [knock](compendium/5e/spells/knock.md), or [pass without trace](compendium/5e/spells/pass-without-trace.md). Once a spell has been cast using the key, it can't be used to cast that spell again until the next dawn.  
...
- While holding the key, you can use an action to cast one of the following spells from it: [dimension door](compendium/5e/spells/dimension-door.md), [gaseous form](compendium/5e/spells/gaseous-form.md), or [mislead](compendium/5e/spells/mislead.md). Once a spell has been cast using the key, it can't be used to cast that spell again until the next dawn.  
