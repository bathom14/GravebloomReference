...
---
# Hide of the Feral Guardian (Exalted)
*Light armor ([studded leather armor](compendium/5e/items/studded-leather-armor-phb.md)), legendary (requires attunement)*  
...
- As an action, you can use the armor to cast [polymorph](compendium/5e/spells/polymorph.md) on yourself, transforming into a [giant owl](compendium/5e/bestiary/celestial/giant-owl.md) while retaining your Intelligence, Wisdom, and Charisma scores. This property can't be used again until the next dawn.  
...
- When you cast the [polymorph](compendium/5e/spells/polymorph.md) spell using this armor, you can transform into a [cave bear](compendium/5e/bestiary/beast/polar-bear.md).  
...
- When you cast the [polymorph](compendium/5e/spells/polymorph.md) spell using this armor, you can transform into a [guardian wolf](compendium/5e/bestiary/monstrosity/guardian-wolf-egw.md).  
