...
While wearing this amulet, you can take a [Magic](rules/5e/actions.md#Magic) action to name a location that you are familiar with on another plane of existence. Then make a DC 15 Intelligence ([Arcana](rules/5e/skills.md#Arcana)) check. On a successful check, you cast [Plane Shift](compendium/5e/spells/plane-shift.md). On a failed check, you and each creature and object within 15 feet of you travel to a random destination determined by rolling `dice:1d100|noform|noparens|avg` (`d100`) and consulting the following table.

`dice: [](amulet-of-the-planes.md#^1-destination)`
