...
---
# Skysail
*Wondrous item, weapon ([quarterstaff](compendium/5e/items/quarterstaff-phb.md)), rare (requires attunement)*  
...
Additionally, while in contact with the skysail, you can use an action to cast the [fly](compendium/5e/spells/fly.md) spell on yourself, with a duration of 1 minute and requiring no [concentration](rules/5e/conditions.md#Concentration).
...
When the skysail is not in use, its wings can be retracted, and its pole can be used as a [quarterstaff](compendium/5e/items/quarterstaff-phb.md).
