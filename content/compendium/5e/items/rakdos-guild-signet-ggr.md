...
This ring, adorned with the symbol of Rakdos, allows you to cast [hellish rebuke](compendium/5e/spells/hellish-rebuke.md). A guild signet is sometimes awarded to a guild member whose renown score in that guild is 5 or higher, as a reward for performing special services for the guild. Aside from its magical properties, the ring is also an indicator of Rakdos' recognition and favor.
