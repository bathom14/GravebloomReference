...
Whenever you end your turn with 0 hit points, the docent can make a Wisdom ([Medicine](rules/5e/skills.md#Medicine)) check with a +6 bonus. If this check succeeds, the docent stabilizes you.
...
**Skills**. The docent has a +7 bonus to one of the following skills (roll a `dice:d4|noform|noparens|avg` (`d4`)): (1) [Arcana](rules/5e/skills.md#Arcana), (2) [History](rules/5e/skills.md#History), (3) [Investigation](rules/5e/skills.md#Investigation), or (4) [Nature](rules/5e/skills.md#Nature).

**Spells**. The docent knows one of the following spells and can cast it at will, requiring no components (roll a `dice:d6|noform|noparens|avg` (`d6`)): (1–2) [detect evil and good](compendium/5e/spells/detect-evil-and-good.md) or (3–6) [detect magic](compendium/5e/spells/detect-magic.md). The docent decides when to cast the spell.
