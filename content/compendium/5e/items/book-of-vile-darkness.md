...
[Nature](rules/5e/skills.md#Nature) can't abide the book's presence. Ordinary plants wither in its presence, common animals are unwilling to approach it, and the book gradually destroys whatever it touches. Even stone cracks and turns to powder if the book rests on it long enough.

Whenever a creature that isn't a Fiend or an Undead attunes to the Book of Vile Darkness, that creature makes a DC 17 Charisma saving throw. On a failed save, the creature is magically transformed into a [Larva](compendium/5e/bestiary/fiend/larva.md) under the DM's control. Only a [Wish](compendium/5e/spells/wish.md) spell can reverse this vile transformation.
...
The Book of Vile Darkness remains with you only as long as you strive to work evil in the world. If you fail to perform at least one evil act within the span of 10 days, or if you willingly perform a good act, the book disappears, your [Attunement](rules/5e/variant-rules/attunement-xphb.md) to it ends immediately, and you lose all benefits granted by it. If you die while attuned to the book, an entity of great evil claims your soul. You can't be restored to life by any means while your soul remains imprisoned.
...
While the book is on your person, you have [Immunity](rules/5e/variant-rules/immunity-xphb.md) to the [Exhaustion](rules/5e/conditions.md#Exhaustion) condition.

## Random Properties

The Book of Vile Darkness has the following random properties:

- 3 [minor beneficial](compendium/5e/tables/artifact-properties-minor-beneficial-properties-xdmg.md) properties  
- 1 [major beneficial](compendium/5e/tables/artifact-properties-major-beneficial-properties-xdmg.md) property  
- 3 [minor detrimental](compendium/5e/tables/artifact-properties-minor-detrimental-properties-xdmg.md) properties  
- 2 [major detrimental](compendium/5e/tables/artifact-properties-major-detrimental-properties-xdmg.md) properties  

## Spells

While holding the book and holding it, you can cast the following spells (save DC 18) from it:

- [Animate Dead](compendium/5e/spells/animate-dead.md)  
- [Circle of Death](compendium/5e/spells/circle-of-death.md)  
- [Dominate Monster](compendium/5e/spells/dominate-monster.md)  
...
You can reference the Book of Vile Darkness whenever you make an Intelligence check to recall information about some aspect of evil, such as lore about demons. When you do so, you have [Advantage](rules/5e/variant-rules/advantage-xphb.md) on that check.
...
If a [solar](compendium/5e/bestiary/celestial/solar.md) tears the book in two, the book is destroyed for `dice:1d100|noform|noparens|avg` (`d100`) years, after which it re-forms in some far corner of the multiverse.
