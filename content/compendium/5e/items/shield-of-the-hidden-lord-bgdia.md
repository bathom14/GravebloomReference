...
---
# Shield of the Hidden Lord
*Armor ([shield](compendium/5e/items/shield-phb.md)), legendary (requires attunement)*  
...
- The shield has an Intelligence of 22, a Wisdom of 18, and a Charisma of 24, as well as hearing and [truesight](rules/5e/senses.md#Truesight) out to a range of 120 feet.  
...
- The shield has 3 charges. You can use an action to expend 1 charge to cast [fireball](compendium/5e/spells/fireball.md) or 2 charges to cast [wall of fire](compendium/5e/spells/wall-of-fire.md) from the shield (save DC 21 for each). The [wall of fire](compendium/5e/spells/wall-of-fire.md) spell lasts for 1 minute (no [concentration](rules/5e/conditions.md#Concentration) required). The shield regains all expended charges daily at dawn.  
