...
---
# Spear of Backbiting
*Weapon ([spear](compendium/5e/items/spear-phb.md)), cursed item, very rare (requires attunement)*  

- **Damage**:
  - One-handed: 1d6 piercing
  - Two-handed: 1d8 piercing
- **Range**: 50/90
- **Properties**: [Cursed](rules/5e/item-properties.md#Cursed%20Items), [Thrown](rules/5e/item-properties.md#Thrown), [Versatile](rules/5e/item-properties.md#Versatile)
- **Weight**: 3.0 lbs.
...
This weapon is cursed, and becoming attuned to it extends the curse to you. Until the curse is broken with [remove curse](compendium/5e/spells/remove-curse.md) or similar magic, you are unwilling to part with the weapon, keeping it within reach at all times. In addition, you have disadvantage on attack rolls made with weapons other than this one.
