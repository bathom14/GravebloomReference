...
While wearing this armor, you can use it to cast either [Speak with Dead](compendium/5e/spells/speak-with-dead.md) or [Animate Dead](compendium/5e/spells/animate-dead.md). Once the armor has cast a spell in this way, it can't cast either spell until the next dawn.
