...
This pristine book smells faintly of a random scent you find pleasing. When found, the book contains the following spells: [antipathy/sympathy](compendium/5e/spells/antipathy-sympathy.md), [charm person](compendium/5e/spells/charm-person.md), [dominate person](compendium/5e/spells/dominate-person.md), [enthrall](compendium/5e/spells/enthrall.md), [hypnotic pattern](compendium/5e/spells/hypnotic-pattern.md), [modify memory](compendium/5e/spells/modify-memory.md), and [suggestion](compendium/5e/spells/suggestion.md). It functions as a spellbook for you.
