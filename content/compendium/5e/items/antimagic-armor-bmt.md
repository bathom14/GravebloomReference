...
In addition, while you wear this armor, you can use it to cast [Antimagic Field](compendium/5e/spells/antimagic-field.md), requiring no spell components. Once this property is used, it can't be used again until the next dawn.
