...
---
# Breastplate of Balance
*Medium armor ([breastplate](compendium/5e/items/breastplate-phb.md)), rare (requires attunement)*  
...
- **Expunge Imbalance.** As a bonus action, you can expend 2 charges to cast the [Lesser Restoration](compendium/5e/spells/lesser-restoration.md) spell from the armor.  

The armor regains `dice:1d4|noform|noparens|avg` (`d4`) expended charges daily at dawn.
