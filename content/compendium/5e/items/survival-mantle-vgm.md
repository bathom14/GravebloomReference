...
A creature wearing a survival mantle can breathe normally in any environment (including a vacuum) and has advantage on saving throws against harmful gases (such as those created by a [cloudkill](compendium/5e/spells/cloudkill.md) spell, a [stinking cloud](compendium/5e/spells/stinking-cloud.md) spell, inhaled poisons, and the breath weapons of some dragons).
