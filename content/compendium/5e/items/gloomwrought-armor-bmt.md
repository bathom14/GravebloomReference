...
This armor has 3 charges. You can expend a charge to cast the [Calm Emotions](compendium/5e/spells/calm-emotions.md) spell (save DC 15) from the armor. This armor regains `dice:1d3|noform|noparens|avg` (`d3`) expended charges daily at dawn.
