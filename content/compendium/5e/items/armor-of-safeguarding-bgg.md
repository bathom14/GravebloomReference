...
As an action, you can invoke the armor's rune to cast the [beacon of hope](compendium/5e/spells/beacon-of-hope.md) spell with it; the spell has a duration of 1 minute and doesn't require [concentration](rules/5e/conditions.md#Concentration). Once the rune has been invoked, it can't be invoked again until the next dawn.
