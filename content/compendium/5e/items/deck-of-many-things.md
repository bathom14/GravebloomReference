...
The next time you enter combat against one or more [Hostile](rules/5e/variant-rules/hostile-attitude-xphb.md) creatures, you can select one of them as your foe when you roll [Initiative](rules/5e/variant-rules/initiative-xphb.md). If you reduce your foe to 0 [Hit Points](rules/5e/variant-rules/hit-points-xphb.md) during that combat, you have [Advantage](rules/5e/variant-rules/advantage-xphb.md) on Death Saving Throws for 1 year. If someone else reduces your chosen foe to 0 [Hit Points](rules/5e/variant-rules/hit-points-xphb.md) or you don't choose a foe, this card has no effect.

## Donjon

You disappear and become entombed in a state of suspended animation in an extradimensional sphere. Everything you're wearing and carrying disappears with you except for Artifacts, which stay behind in the space you occupied when you disappeared. You remain imprisoned until you are found and removed from the sphere. You can't be located by any Divination magic, but a [Wish](compendium/5e/spells/wish.md) spell can reveal the location of your prison. You draw no more cards.
...
You have [Disadvantage](rules/5e/variant-rules/disadvantage-xphb.md) on [D20 Tests](rules/5e/variant-rules/d20-test-xphb.md) for the next 72 hours. Draw another card; this draw doesn't count as one of your declared draws.
...
You have [Advantage](rules/5e/variant-rules/advantage-xphb.md) on [D20 Tests](rules/5e/variant-rules/d20-test-xphb.md) for the next 72 hours, or you can draw two additional cards beyond your declared draws.
...
An NPC of the DM's choice becomes [Hostile](rules/5e/variant-rules/hostile-attitude-xphb.md) toward you. You don't know the identity of this NPC until they or someone else reveals it. Nothing less than a [Wish](compendium/5e/spells/wish.md) spell or divine intervention can end the NPC's hostility toward you.
...
An [Avatar of Death](compendium/5e/bestiary/undead/avatar-of-death-xdmg.md) appears in an unoccupied space as close to you as possible. The avatar targets only you with its attacks, appearing as a ghostly skeleton clad in a tattered black robe and carrying a spectral scythe. The avatar disappears when it drops to 0 [Hit Points](rules/5e/variant-rules/hit-points-xphb.md) or you die. If an ally of yours deals damage to the avatar, that ally summons another Avatar of Death. The new avatar appears in an unoccupied space as close to that ally as possible and targets only that ally with its attacks. You and your allies can each summon only one avatar as a consequence of this draw. A creature slain by an avatar can't be restored to life.
...
A magic item (chosen by the DM) appears on your person. In addition, you gain 10 [Temporary Hit Points](rules/5e/variant-rules/temporary-hit-points-xphb.md) daily at dawn until you die.
...
You gain proficiency and [Expertise](rules/5e/variant-rules/expertise-xphb.md) in your choice of [History](rules/5e/skills.md#History), [Insight](rules/5e/skills.md#Insight), [Intimidation](rules/5e/skills.md#Intimidation), or [Persuasion](rules/5e/skills.md#Persuasion). In addition, you gain rightful ownership of a small keep somewhere in the world. However, the keep is currently home to one or more monsters, which must be cleared out before you can claim the keep as yours.

## Void

Your soul is drawn from your body and contained in an object in a place of the DM's choice. One or more powerful beings guard the place. While your soul is trapped in this way, your body is inert, ceases aging, and requires no food, air, or water. A [Wish](compendium/5e/spells/wish.md) spell can't return your soul to your body, but the spell reveals the location of the object that holds your soul. You draw no more cards.
