...
|------------|----------------|
| 01-20 | The symbol of [Acererak](compendium/5e/bestiary/npc/acererak-toa.md) is burned into your flesh, a curse that can only be removed with a [remove curse](compendium/5e/spells/remove-curse.md) spell or similar magic. Until the curse ends, your hit points can't be restored by magic. |
| 21-35 | You grow larger as if affected by an [enlarge/reduce](compendium/5e/spells/enlarge-reduce.md) spell, except the effect lasts for 1 hour. |
| 36-50 | You grow smaller as if affected by an [enlarge/reduce](compendium/5e/spells/enlarge-reduce.md) spell, except the effect lasts for 1 hour. |
...
| 71-95 | You are [paralyzed](rules/5e/conditions.md#Paralyzed) for 1 minute or until this effect is ended with a [lesser restoration](compendium/5e/spells/lesser-restoration.md) spell or similar magic. |
| 96-00 | You become [petrified](rules/5e/conditions.md#Petrified). This effect can be ended only with a [greater restoration](compendium/5e/spells/greater-restoration.md) spell or similar magic. |
^black-skull-transformation
