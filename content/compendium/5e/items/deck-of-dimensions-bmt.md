...
- **Riffling Portal.** As an action, you can expend 3 charges to cast the [Arcane Gate](compendium/5e/spells/arcane-gate.md) spell from the deck. The deck vanishes, and fluttering cards create the spell's portal rings. When the spell ends, the deck reappears in your possession.  
...
The deck regains `dice:1d6|noform|noparens|avg` (`d6`) expended charges daily at dawn.
