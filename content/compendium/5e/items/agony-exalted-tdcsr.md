...
---
# Agony (Exalted)
*Weapon ([flail](compendium/5e/items/flail-phb.md)), legendary (requires attunement by a creature of non-good alignment)*  
...
- The extra damage when you hit a marked creature increases to `dice:2d8|noform|noparens|avg` (`2d8`).  
- When you score a critical hit with this weapon, the target must succeed on a DC 17 Wisdom saving throw or become [frightened](rules/5e/conditions.md#Frightened) of you for 1 minute. On a success, the target is immune to this effect for 24 hours.  
