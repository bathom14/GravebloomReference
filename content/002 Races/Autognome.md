...
**Alignment.** They are often constructed to replicate skilled, but tedious, labor. They are usually programmed to fulfill a designated task, and will unwaveringly strive to complete it in it's entireity. However, it is not uncommon for the initial programming to go awry and for Autognnomes to being to strive towards different goals with the same intensity. They tend towards Lawful, unwaveringly following their own code.
...
**Intelligent Design.** You know the [Mending](http://dnd5e.wikidot.com/spell:mending) cantrip. Wisdom, Intelligence, or Charisma is your spellcasting ability for it (choose when you select this race).
...
* In addition, your creator designed you to benefit from several spells that preserve life but that normally don't affect Constructs: [Cure Wounds](http://dnd5e.wikidot.com/spell:cure-wounds), [Healing Word](http://dnd5e.wikidot.com/spell:healing-word), [Mass Cure Wounds](http://dnd5e.wikidot.com/spell:mass-cure-wounds), [Mass Healing Word](http://dnd5e.wikidot.com/spell:mass-healing-word), and [Spare the Dying](http://dnd5e.wikidot.com/spell:spare-the-dying).
