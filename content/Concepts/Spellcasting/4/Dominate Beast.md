...
**At Higher Levels.** **Using a Higher-Level Spell Slot.** Your {@status Concentration|XPHB} can last longer with a spell slot of level 5 (up to 10 minutes), 6 (up to 1 hour), or 7+ (up to 8 hours).
